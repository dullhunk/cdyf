...
Polly loves object-oriented programming. She has lots of siblings, and [https://en.wikipedia.org/wiki/Isomorphism](a cousin called Isa). Instead of a CV or résumé, Polly has put some basic details on her LinkedIn profile which she primarily uses for professional social networking, see figure \@ref(fig:polly-fig).
