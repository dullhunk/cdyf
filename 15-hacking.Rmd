...
Marjorie loves version control, she is has very high [emotional intelligence](https://en.wikipedia.org/wiki/Emotional_intelligence). Her superpower are recognising emotions in herself and others and using that to resolve people's differences, see figure \@ref(fig:margeconflict-fig).
