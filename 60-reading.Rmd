...
According to [Harry Truman](https://en.wikipedia.org/wiki/Harry_S._Truman) “*Readers are preparing themselves for leadership. Not all readers become leaders, but all leaders must be readers.*” [@truman] So if you want *read* your future, there is no need to gaze into any [crystal balls](https://en.wikipedia.org/wiki/Crystal_ball) to have your fortune told. 🔮 
...
Some of the references below may require subscriptions, depending on the configuration of your [paywall](https://en.wikipedia.org/wiki/Paywall). Where possible I have linked to free or archived versions and only linked to paywalled content if its really worth reading.

<!--START MOVE-->

```{r truman-fig, echo = FALSE, fig.align = "center", out.width = "100%", fig.cap = "(ref:captiontruman)"}
knitr::include_graphics("images/harry-truman.jpeg")
```
(ref:captiontruman) According to [Harry Truman](https://en.wikipedia.org/wiki/Harry_S._Truman): “*readers are preparing themselves for leadership. Not all readers become leaders. But all leaders must be readers.*”[@truman] Public domain portrait of Harry S. Truman by the United States National Archives Catalog on Wikimedia Commons [w.wiki/6e8P](https://w.wiki/6e8P) adapted using the [Wikipedia App](https://apps.apple.com/us/app/wikipedia/id324715238)

<!--some spacing for linking to references-->
```{r, eval=knitr::is_html_output(), results='asis', echo=FALSE}
cat('<p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p>')
```
...
<!-- would like to add an image AFTER the references but can't work out how to do that yet, possibly lua-->