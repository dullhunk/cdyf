...
* won some awards for your hobby, like a [black belt](https://en.wikipedia.org/wiki/Black_belt_(martial_arts)) for example
...
Applications and CV's are often accompanied by covering letters or include some kind of personal statement. They are your [elevator pitch](https://en.wikipedia.org/wiki/Elevator_pitch) shown in figure \@ref(fig:elevator-fig). Whereas a lot of your CV is essentially a bulleted list of facts, numbers and evidence, a covering letter or personal statement gives you a chance to *really* demonstrate your fluent written communication skills in clear [prose](https://en.wikipedia.org/wiki/Prose). If you're going to include a `personal statement` or `profile` on your CV keep it short, unlike [Mike Rokernel](https://www.cdyf.me/mike_rokernel.pdf) who waffles on for ages without providing any evidence. This kind of information usually fits better in your covering letter anyway, because there isn't much space for it on a CV.
