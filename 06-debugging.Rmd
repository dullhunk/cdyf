...
If you have anything else you want to highlight besides your `Education`, `Experience`, `Projects` and `Leadership and Awards` you *may* still have room for one more optional extras section. Try to come up with a better names than: 
...
1. **Why you?** Why should `widget.com` employ you? What skills and experience make you stand out from all the other candidate widget engineers? What are your Unique Selling Points (USPs)? Say why *you* would be good for *them* (**not** why widget.com would be good for you and your career).
