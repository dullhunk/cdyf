...
* `3/3000`? More impressive
 ...
 Finally, your `awards` section might also include any courses you've done *outside* of the formal (compulsory) and university courses described in your `Education` section. This might include any [Massive Open Online Courses](https://en.wikipedia.org/wiki/Massive_open_online_course) (MOOCs) or any other credentials (digital or otherwise) you've collected such as those described in section \@ref(otherbadges). 🏆
