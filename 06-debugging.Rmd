...
Again, congratulations, but third place out of how many: `3/3`? Not so impressive. `3/30`? `3/300`? `3/3000`? More impressive. Numbers make a big difference so if you're going to mention awards, quantify^[even an approximation will do] where you can so the reader can understand what the prize was for. You may well be intimately acquaited with the [flibbertigibbet](https://en.wikipedia.org/wiki/Flibbertigibbet) competition but your reader probably won't of heard of it, so give some context. 🏆
