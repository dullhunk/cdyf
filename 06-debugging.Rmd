...
Bots, grammar checkers, Artificial Intelligence (AI) and spell checkers will improve your written applications and CV. However, you can't rely on machines and their algorithms completely. The résumé robots described in section \@ref(robotproof) will just encode the biases and prejudices of whoever wrote their algorithms. AI powered chatbots like [ChatGPT](https://en.wikipedia.org/wiki/ChatGPT), [Bing](https://blogs.microsoft.com/blog/2023/02/07/reinventing-search-with-a-new-ai-powered-microsoft-bing-and-edge-your-copilot-for-the-web/) and [Bard](https://blog.google/technology/ai/bard-google-ai-search-updates/) will be biased by whatever data they've been trained on. [@bingai] Basic spellcheckers can't be relied on completely either, as shown in the poem below:
