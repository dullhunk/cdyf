...
How you structure your CV will depend on who you are and what your story is. Recruiters at Google suggest you have four or five sections, that follow a header section. Before we look at those, lets look at some general points about CVs. Start by watching the short video shown in figure \@ref(fig:lopez-fig).
...
Unless you have a *significant* amount of experience, the `Education` section of your CV should be the first real section, after the header see figure \@ref(fig:blair-fig). Your `education` section needs to strike a balance between:
...
If you have anything else you want to highlight besides your `Education`, `Experience`, `Projects` and `Leadership and Awards` you *may* still have room for one more optional extras section. Try to come up with a better names for this sectionthan: 
