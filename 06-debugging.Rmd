...
It's fine to author your CV in Microsoft Word, but you'll want to save it as (or print to) PDF to make it more platform independent. LaTeX and overleaf can be used to create professional PDFs and there are plenty of good templates. See [Getting started with LaTeX (LaTeX4year1)](https://latex4year1.netlify.app/) if you've not used LaTeX before, or you need to refresh your memory. [@latex4year1]
...
### Embedded statement? {#bullshit}
You might be tempted to embed a short summary or `personal statement` section on your CV. If you're thinking about doing this, keep it short or just leave it out altogether. Why? Here's an example of how *not* to do it from Professor Hotair who holds the Chair of Rhetoric at the University of Poppleton:
...
(ref:captionbullshit) Yes, your CV is trying to persuade the reader to invite you to an interview. Being persuasive doesn't mean you have to tell lies or try and *bullshit* your reader. People who have to read your CV will probably be trawling through *hundreds* of others too. This means your readers will have *highly trained* bullshit detectors, so you should avoid having bullshit in your CV. Fair use image of the cover of Harry G. Frankfurt's book *[On Bullshit](https://en.wikipedia.org/wiki/On_Bullshit)* [@onbullshit] via Wikimedia Commons [w.wiki/6Bnu](https://w.wiki/6Bnu) adapted using the [Wikipedia app](https://apps.apple.com/us/app/wikipedia/id324715238)
...
Is this better? Personally, I think you should only be including a personal statement on your CV if you've got space to do so because you'll probably just repeat facts from your CV anyway, like Mike's example above. There are usually much more interesting things you can say about yourself on your CV. 
