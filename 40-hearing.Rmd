...
*Hearing Your Future* is the Coding Your Future podcast which accompanies this guidebook. We talk to [graduands](https://en.wiktionary.org/wiki/graduand) and graduates of computer science, to hear more about their journey from student to professional, see figure \@ref(fig:collage-fig). As part of their [exit interview](https://en.wikipedia.org/wiki/Exit_interview) we ask them what happens after graduation? What comes next?
...
(ref:captioncollage) Collage of Computer Scientist portraits re-used from LinkedIn and Github with permission. From left to right, top to bottom: thanks Steve (chapter \@ref(steve)), Cristian (chapter \@ref(cristian)), Stefania (chapter \@ref(stefania)), Bozhidar (chapter \@ref(bozhidar)), Eman (chapter \@ref(eman)), Asma (chapter \@ref(asma)), Jonathan (chapter \@ref(jonathan)), Ivo (chapter \@ref(ivo)), Ingy (chapter \@ref(ingy)), Nadine (chapter \@ref(nadine)), Pedro (chapter \@ref(pedro)), Amish (chapter \@ref(amish)), Raluca (chapter \@ref(raluca)), Jason (chapter \@ref(jason)), Brian (chapter \@ref(brian)), Carmen (chapter \@ref(carmen)), Sneha (chapter \@ref(sneha)) and Alice (chapter \@ref(alice)). 🙏
...
* YouTube: [youtube.com/\@coding-your-future/podcasts](https://www.youtube.com/\@coding-your-future/podcasts)
...
## Episode 24: Todd Davies on Google, Morgan Stanley and Competition Law {#ep24}

Meet Todd Davies, see figure \@ref(fig:todd-fig) and the show notes in chapter \@ref(todd).

```{r todd-fig, echo = FALSE, fig.show = "hold", out.width = "33%", fig.cap = "(ref:captionlinkedintodd)"}
knitr::include_graphics(rep("images/linkedintodd.png", 3))
```

(ref:captionlinkedintodd) Todd Davies, portrait re-used from [linkedin.com/in/daviestodd](https://www.linkedin.com/in/daviestodd/) with permission, thanks Todd. 🙏

(ref:podcastblurbshort)

```{r, eval=knitr::is_html_output(excludes = "epub"), results='asis', echo=FALSE}
cat('<iframe title="Libsyn Player" style="border: none" src="https://html5-player.libsyn.com/embed/episode/id/42375540/height/90/theme/custom/thumbnail/yes/direction/forward/render-playlist/no/custom-color/000000/" height="90" width="100%" scrolling="no"  allowfullscreen="" webkitallowfullscreen="true" mozallowfullscreen="true" allowfullscreen="true" msallowfullscreen="true" style="border: none;"></iframe>')
```

## Episode 23: Uli Sattler & Aphrodite Galata on presentations {#ep23}

Meet Afrodite Galata and Uli Sattler, see figure \@ref(fig:afruli2-fig) and the show notes in chapter \@ref(afruli).

```{r afruli2-fig, echo = FALSE, fig.align = "center", out.width = "100%", fig.cap = "(ref:captionafruli)"}
...
## Episode 22: Rosie Halsall on switching from Physics and working at BNY.com {#ep22}

Meet Rosie, see figure \@ref(fig:rosie2-fig) and the transcript and show notes in chapter \@ref(rosie).

```{r rosie2-fig, echo = FALSE, fig.show = "hold", out.width = "33%", fig.cap = "(ref:captionrosie)"}
knitr::include_graphics(rep("images/linkedinrosie.png", 3))
```

(ref:captionrosie) Rosie Halsall, portrait re-used from [linkedin.com/in/rosiehalsall](https://www.linkedin.com/in/rosiehalsall/) with permission, thanks Rosie. 🙏
...
## Episode 21: Muna Hassan on Couchbase and Lloyds Banking Group {#ep21}

Meet Muna Hassan, see figure \@ref(fig:muna2-fig) and the transcript and show notes in chapter \@ref(muna).

```{r muna2-fig, echo = FALSE, fig.show = "hold", out.width = "33%", fig.cap = "(ref:captionmuna)"}
knitr::include_graphics(rep("images/linkedinmuna.jpeg", 3))
```
...
## Episode 20: Sambbhav Khare on Atmos International and graduate visas {#ep20}

Meet Sambbhav Khare, see figure \@ref(fig:sambbhav2-fig) and the transcript and show notes in chapter \@ref(sambbhav).

```{r sambbhav2-fig, echo = FALSE, fig.show = "hold", out.width = "33%", fig.cap = "(ref:captionsambbhav)"}
knitr::include_graphics(rep("images/linkedinsambbhav.jpeg", 3))
```
...
## Episode 19: Minahil Tariq on AWS and UNICS {#ep19}

Meet Minahil Tariq, see figure \@ref(fig:mina2-fig) and the transcript and show notes in chapter \@ref(minahil).

```{r mina2-fig, echo = FALSE, fig.show = "hold", out.width = "33%", fig.cap = "(ref:captionminahil)"}
knitr::include_graphics(rep("images/linkedinminahil.jpg", 3))
```
...
## Episode 18: Asma Alshebli on AD Ports Group and UNICS {#ep18}

Meet Asma Alshebli, see figure \@ref(fig:asma2-fig) and the transcript and show notes in chapter \@ref(asma).

```{r asma2-fig, echo = FALSE, fig.show = "hold", out.width = "33%", fig.cap = "(ref:captionasmalink)"}
knitr::include_graphics(rep("images/linkedinasma.jpg", 3))
```

(ref:captionasmalink) Asma Alshebli, picture re-used from [linkedin.com/in/asma-alshebli-86a13a264](https://www.linkedin.com/in/asma-alshebli-86a13a264)
...
## Episode 17: Eman Ahsan on Bentley Motors {#ep17}

Meet Eman Ahsan, see figure \@ref(fig:eman2-fig) and the transcript and show notes in chapter \@ref(eman).

```{r eman2-fig, echo = FALSE, fig.show = "hold", out.width = "33%", fig.cap = "(ref:captionemanlink)"}
knitr::include_graphics(rep("images/linkedineman.jpg", 3))
```

(ref:captionemanlink) Eman Ahsan, picture re-used from [linkedin.com/in/emanahsan](https://www.linkedin.com/in/emanahsan)
...
## Episode 16: Bozhidar Klouchek on Oslo, Cantarus, Imago & Recourse  {#ep16}

Meet Bozhidar Klouchek, see figure \@ref(fig:boz2-fig) and the transcript and show notes in chapter \@ref(bozhidar).

```{r boz2-fig, echo = FALSE, fig.show = "hold", out.width = "33%", fig.cap = "(ref:captionbozlink)"}
knitr::include_graphics(rep("images/linkedinbozhidar.jpg", 3))
```

(ref:captionbozlink) Bozhidar Klouchek, picture re-used from [linkedin.com/in/bozhidar-klouchek-56449a18b](https://www.linkedin.com/in/bozhidar-klouchek-56449a18b)
...
## Episode 15: Stefania Chaplin on gitlab.com and devstefops.com {#ep15}

Meet Stefania Chaplin, see figure \@ref(fig:stefania2-fig) and the transcript and show notes in chapter \@ref(stefania).

```{r stefania2-fig, echo = FALSE, fig.show = "hold", out.width = "33%", fig.cap = "(ref:captionstefanialink)"}
knitr::include_graphics(rep("images/linkedinstefania.jpg", 3))
```

(ref:captionstefanialink) Stefania Chaplin, picture re-used from [linkedin.com/in/stefania-chaplin](https://www.linkedin.com/in/stefania-chaplin/)
...
## Episode 14: Cristian Bodnar on Improbable Worlds, PhDs and Microsoft {#ep14}

Meet Cristian Bodnar, see figure \@ref(fig:cristian2-fig) and the transcript and show notes in chapter \@ref(cristian).

```{r cristian2-fig, echo = FALSE, fig.show = "hold", out.width = "33%", fig.cap = "(ref:captioncristianlink)"}
knitr::include_graphics(rep("images/linkedincristian.jpg", 3))
```

(ref:captioncristianlink) Cristian Bodnar, picture re-used from [linkedin.com/in/crisbodnar](https://www.linkedin.com/in/crisbodnar/)
...
## Episode 13: Steve Furber on Acorn Computers, and the Universities of Cambridge and Manchester {#ep13}

Meet Steve Furber, see figure \@ref(fig:steve2-fig) and the transcript and show notes in chapter \@ref(steve).


```{r steve2-fig, echo = FALSE, fig.show = "hold", out.width = "33%", fig.cap = "(ref:captionstevelink)"}
knitr::include_graphics(rep("images/steve-furber-linkedin.jpeg", 3))
```

(ref:captionstevelink) Steve Furber, picture re-used from [linkedin.com/in/stevebfurber](https://www.linkedin.com/in/stevbefurber)
...
Meet Amish Shah, see figure \@ref(fig:amish2-fig) and the transcript and show notes in chapter \@ref(amish).
...
Meet Pedro Sousa, see figure \@ref(fig:pedro2-fig) and the transcript and show notes in chapter \@ref(pedro).
...
Meet Nadine Abdelhalim, see figure \@ref(fig:nadine2-fig) and the transcript and show notes in chapter \@ref(nadine).
...
Meet Ingy Abdelhalim, see figure \@ref(fig:ingy2-fig) and the transcript and show notes in chapter \@ref(ingy).
...
Meet Ivaylo (Ivo) Iliev, see figure \@ref(fig:ivo2-fig) and the transcript and show notes in chapter \@ref(ivo).
...
Meet Jonathan Cowling, see figure \@ref(fig:jonathan2-fig) and the transcript and show notes in chapter \@ref(jonathan).
...
Meet Alexandra (Alice) Păcuraru, see figure \@ref(fig:alice2-fig) and the transcript and show notes in chapter \@ref(alice).
...
Meet Sneha Kandane, see figure \@ref(fig:sneha2-fig) and the transcript and show notes in chapter \@ref(sneha).
...
Meet Carmen Faura Práxedes, see figure \@ref(fig:carmen2-fig) and the transcript and show notes in chapter \@ref(carmen)
...
Meet Brian Yim Tam, see figure \@ref(fig:brian2-fig) and the transcript and show notes in chapter \@ref(brian)
...
Meet Jason Ozuzu, see figure \@ref(fig:jason2-fig) and the transcript in chapter \@ref(jason).
...
Meet Raluca Cruceru, see figure \@ref(fig:raluca2-fig) and the transcript and show notes in chapter \@ref(raluca)
...
```{r yfnu-fig, echo = FALSE, fig.align = "center", out.width = "98%", fig.cap = "(ref:captionyfnu)"}
knitr::include_graphics("images/Your future wants you.png")
```

(ref:captionyfnu) Your ~~Country~~ Future Wants YOU. 🫵 Join your future. If you are a former student of Computer Science who'd like to appear on the show, [get in touch](https://personalpages.manchester.ac.uk/staff/duncan.hull/contact). I'm especially interested to hear from students who did internships or placements before they graduated in Computer Science. Your Future Needs You sketch by [Visual Thinkery](https://visualthinkery.com/) is licensed under [CC-BY-ND](https://creativecommons.org/licenses/by-nd/4.0/) inspired by an original public domain image of the [Lord Kitchener Wants You](https://en.wikipedia.org/wiki/Lord_Kitchener_Wants_You) poster by [Alfred Leete](https://en.wikipedia.org/wiki/Alfred_Leete) on Wikimedia Commons at [w.wiki/3xvX](https://w.wiki/3xvX)
...
This is a thought experiment. Imagine that the [board of governors](https://www.manchester.ac.uk/discover/governance/structure/board-governors/) and [senate of the University of Manchester](https://www.manchester.ac.uk/discover/governance/structure/senate/) had appointed you, instead of Duncan Ivison, see figure \@ref(fig:vc-fig). As VC, you now have responsibility for: 

* ~11,000 staff
* ~46,000 students
* ~500,000 alumni around the globe

You'll also take over as chair of the [russellgroup.ac.uk](https://russellgroup.ac.uk/). Since this is an optional question, you can dodge this bullet if you'd rather not attempt to answer it.

```{r vc-fig, echo = FALSE, fig.align = "center", out.width = "98%", fig.cap = "(ref:captionvc)"}
knitr::include_graphics("images/duncan-ivison-wiki.jpg")
```

(ref:captionvc) Professor [Duncan Ivison](https://en.wikipedia.org/wiki/Duncan_Ivison) has served as Vice Chancellor (VC) of the University of Manchester since 2024. If *you* were VC, what would you change about how teaching at the University? [CC BY](https://creativecommons.org/licenses/by/2.0/deed.en) portrait of Duncan Ivison on Wikimedia Commons [w.wiki/DVD8](https://w.wiki/DVD8) adapted using the [Wikipedia app](https://apps.apple.com/gb/app/wikipedia/id324715238)

So if you were Vice Chancellor, what would you change about the University of Manchester (and Universities generally) to improve the [teaching and learning](https://www.manchester.ac.uk/study/undergraduate/teaching-learning/)? What would be your first task to make a difference to students like yourself? How would we know when we'd made a significant difference to what people learn?
...
What conversations would you have with your younger self? What have you learned? Is there anything you know now, that you wish you'd known when you were younger? See figure \@ref(fig:firstyear-vid).

```{r firstyear-vid, echo = FALSE, fig.align = "center", out.width = "99%", fig.cap = "(ref:captionfirstyear)"}
knitr::include_url('https://www.youtube.com/embed/HHTrEagTjB8')
```

(ref:captionfirstyear) What advice would graduating students offer their first year self? What advice would you offer your first year self and any first year student? 🎓
...
(ref:captiongaga) All we hear is [Radio Ga Ga](https://en.wikipedia.org/wiki/Radio_Ga_Ga) but everything I had to know, I heard it on my radio. So don't become some background noise, a backdrop to the girls and boys, who just don't know and just don't care and just complain when you're not there. Radio. [@radiogaga]
...
### Thanks BBC Radio {#beeb}

This podcast has also borrowed ideas from the BBC, see figure \@ref(fig:beeb-fig). It's a cross between *Desert Island Discs*, *The Life Scientific* and *Young Again*. [@thelifescientific] Thanks to Jim Al-Khalili, Lauren Laverne, Sue Lawley, Kirsty Young, Michael Parkinson and Roy Plumley for the inspiration. [@desertislandddiscs;@youngagain]

```{r beeb-fig, echo = FALSE, fig.align = "center", out.width = "100%", fig.cap = "(ref:captionbeeb)"}
knitr::include_graphics("images/desert-island-scientific.png")
```

(ref:captionbeeb) *Hearing Your Future* (right) is a mixture of *Desert Island Discs* hosted by Lauren Laverne (left) and *The Life Scientific* hosted by Jim Al-Khalili (middle) and *Young Again with Kirsty Young*. Subscribe and listen wherever you get your podcasts. CC-BY-SA Portrait of Lauren Laverne by Jwslubbock on Wikimedia Commons [w.wiki/6z4z](https://w.wiki/6z4z), CC-BY-SA portrait of Jim Al-Khalili by Debbie Rowe at the Royal Society on Wikimedia Commons [w.wiki/_w2fh](https://w.wiki/_w2fh), CC-BY-ND Hearing your Future artwork by Visual Thinkery.
