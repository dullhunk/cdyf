...
You don't need to pay anything to read this book online because its not hiding behind a [paywall](https://en.wikipedia.org/wiki/Paywall), see the license terms (CC-BY-NC-ND) in section \@ref(licensing). Publishing this guidebook online makes it findable and accessible, something that isn't true of lots of knowledge locked up inside other books.
