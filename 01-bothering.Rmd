...
* Suggest changes via the (old school) Microsoft Word version at [cdyf.docx](http://cdyf.me/cdyf.docx). The text is all there, but the pagination and graphic placement isn't always pretty. Don't say I didn't warn you. Make sure you've turned on [track changes](https://support.microsoft.com/en-us/office/track-changes-in-word-197ba630-0f5f-4a8e-9a77-3712475e806a) if Word is your weapon of choice.
* If you don't want to use github or word and all else fails just [email me suggestions for improvements](http://www.cs.man.ac.uk/~hulld/contact.html)
...
* Audio interviews with Students in the [Coding your Future podcast](listening.html)
...
### I'm deliberately writing in first person narrative {#firstperson}
