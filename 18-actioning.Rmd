...
* `learned` (think about *what* you are learning)f
* `refined`
* `resolved` (a conflict)
...
* `researched`  
* `reviewed`
* `studied` (you are a student after all)
* `tested`
...
Your future is bright, your future needs actions. Actioning your future, will help you to deploy your future. Deploying your future will help you to start coding your future.
...
In the next part, chapter \@ref(organising): *Organising your Future* we'll look at how to schedule and organise your actions.
