...
CodeCrafters is a tool that helps you to sharpen your engineering skills and build your portfolio with a wide range of structured projects. Why? Because: 
...
(ref:captionwikicome) The phrase “_If You Build It, They Will Come_” is a slight misquote from the film _Field of Dreams_ where the lead character, played by Kevin Costner pictured above, hears a voice in his head telling him that “_If You Build It, He Will Come_”. [@fieldofdreams]

If you build it, they _will_ come because:

* Building stuff will help you learn new things
* Building interesting software and hardware will help your CV stand out from your competitors
...
* Building a range of projects will give you lots to talk about in job applications and interviews
* Building stuff for curiosity can be fun!

These are all strong arguments for working on `PROJECTS`, not just University coursework but personal, solo, voluntary, hacking, collaborative, freelance, tinkering and side projects done for _because it's there_, as outlined in section \@ref(projects). But:

* where do you start? 
* how can you keep going? 
* when will you finish, if you finish at all?

Open source software is great for portfolios but can be intimidating projects for beginners and outsiders, see section \@ref(opensource). Whether it's open or closed, building a portfolio can feel like drawing the owl shown in figure \@ref(fig:owl-fig): `Step 1`: draw some simple lines ...  `Step 2`: ... draw the rest owl. There's a **BIG** piece missing in the middle, the missing docs, to help you keep going and help you finish your engineering project(s). 

```{r owl-fig, echo = FALSE, fig.align = "center", out.width = "100%", fig.cap = "(ref:captionowl)"}
knitr::include_graphics("images/owldraw.png")
```

(ref:captionowl) Drawing an owl step by step should be an easy project: `Step 1` just your draw an oval and some simple lines, then `Step 2` fill in the rest of the owl. Easy? Not really, most people need more steps and help from the `missing docs`. Creative Commons licensed screenshot taken from Google's Tech Writing course, see section \@ref(techwriting). 🦉
...
Co-founded by [Sarup Banksota](https://www.linkedin.com/in/sarupbanskota/) and [Paul Kuruvilla](https://www.linkedin.com/in/rohitpaulk/), CodeCrafters was backed by [ycombinator.com](https://www.ycombinator.com/) in 2022. The free tier of codecrafters gives you limited content access and community features, but we're excited to offer you something better. 
...
Unfortunately, Summertime coding^[summertime or _any_ vacation, holiday, weekends or down-time] isn't always easy. Building a portfolio of interesting projects takes time and resilience. Codecrafters makes this _easi-er_ by giving you structured projects to work through in your own time at your own pace. Their projects will help you build your knowledge and provide a portfolio of concrete evidence of your skills that you can use in your job applications and job interviews.
...
Thanks to [Arpan Pandey](https://simple.arpanpandey.dev/) for negotiating and building CodeCrafters access for students at the University of Manchester, shown in figure \@ref(fig:mancraft-fig). 🙏
