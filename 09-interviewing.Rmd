...
There are a lots of resources to help you prepare for and practice coding interview questions, the best place to start is *Cracking the Coding Interview* by Gayle Laakmaan McDowell. [@cracking] As well as reading Gayle's book, there are lots of online resources to help you prepare for coding interviews. Before we look at those, recently graduated computer science student Petia Davidova explains some of the highs and lows of technical interviews in figure \@ref(fig:petia-fig).

`r if (knitr::is_html_output()) '
<iframe width="560" height="315" src="https://www.youtube.com/embed/qkeQNNjZuQk" frameborder="0" allowfullscreen></iframe>
'`
```{r petia-fig, echo = FALSE, fig.align = "center", out.width = "0.1%", fig.cap = "caption"}
knitr::include_graphics("images/emptyFFFFFF-0.png")

```

(ref:captionpetia) My worst software engineering interview fails, failing my Facebook and Google Interviews by Petia Davidova. Petia demonstrates her [growth mindset](#growthmindset) and productive failure, she failed her interviews, but learned lots from the process and went on to work at Bloomberg.

Coding interviews can be tough, but preparing for them, and doing them will make you a better engineer. So if you spectacularly wipeout in your coding interview, reflect and think how can I improve next time?
...
We've looked at a range of platforms and competitions that can help you prepare for coding interviews. These won't just make you better at coding interviews, they'll make you a better engineer too.
