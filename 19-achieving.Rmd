...
1. **What am I committing to?** At this point we're looking for expressions of interest, rather than firm commitment that you'll definintely sit the exam(s) in July. So you can change your mind, it's called [flexible learning]() for a reason [@georgepettifer] , but please only register if you're reasonably serious about having a go. 
1. **Can you offer Amazon / Google exams as well?** Not yet, but we may do in the future, see section \@ref(otherbadges)
