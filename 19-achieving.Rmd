...
* The University of Manchester, and many other institutions, offer these qualifications to students. Watch this space for details on how to enrol in these coursees, the material is already freely avaialble online if you follow the links above.

If you're not a student at the University of Manchester, its worth considering taking these training courses, or something simlar such as those described in section \@ref(otherbadges). They'll all help your CV stand out.

### Microsoft FAQ {#microfaq}

Here are the answers to some Frequently Asked Questions (FAQs) we've received about Microsoft Fundamentals: 


1. **What is the pass grade?** You need to score a scaled score of 700 to pass, see [learn.microsoft.com/en-us/credentials/certifications/exam-scoring-reports](https://learn.microsoft.com/en-us/credentials/certifications/exam-scoring-reports) [@micropass]
...
1. **Can I change exams?** If you change your mind about which courses you want to do after registering, we can accommodate this once you've been given access to the prodigy learning materials.
1. **Can I still do these exams in my final year of study** Yes, for as long as you have access to your `@student.manchester.ac.uk` email address [@graduandemail]
