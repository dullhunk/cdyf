...
```
(ref:captionfreebody) Opposing forces of anxiety 😰 + calmness 😎 and happiness 🙂 + sadness 🙁 normally balance each other out over time 😐. If you are affected by poor mental health, feelings of anxiety or sadness will outweigh their counterparts, leading to *persistent* anxiousness or depression. This chapter looks at what these mental health issues are and what you can do if you, or someone you know, is affected by poor mental health. Free body diagram by [Visual Thinkery](https://visualthinkery.com) is licensed under [CC-BY-ND](https://creativecommons.org/licenses/by-nd/4.0/)
