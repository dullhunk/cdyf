...
<!-- inclusion of note = {https://youtu.be/6x-Nl3_L1pA} in bib file for @isolation causes weird tex compilation error-->

(ref:captionjoydivision) It might not be immediately obvious to you that people around you are having suicidal thoughts. Ian Curtis was in a band called [Joy Division](https://en.wikipedia.org/wiki/Joy_Division), even his fellow band members like [Bernard Sumner](https://en.wikipedia.org/wiki/Bernard_Sumner) didn't realise how poor his mental health was. In retrospect it is obvious when you look at his lyrics [@isolation]. However, people who are affected by poor mental health often don't talk about it until it is too late - so it can be tricky to diagnose in time. Fair use picture of [Ian Curtis](https://en.wikipedia.org/wiki/Ian_Curtis) by [Kevin Cummins](https://en.wikipedia.org/wiki/Kevin_Cummins_(photographer)) on Wikimedia Commons [w.wiki/4iWJ](https://w.wiki/4iWJ) adapted using the [Wikipedia app](https://apps.apple.com/gb/app/wikipedia/id324715238).

Suicide is the biggest killer of under 35's in the UK. Globally, over 700,000 people die due to suicide every year, see [who.int/health-topics/suicide](https://www.who.int/health-topics/suicide). Every life lost to suicide is a tragedy because suicide is preventable. If you're feeling suicidal or you know someone who is, don't suffer (or let them suffer) in silence. Check out the resources in section \@ref(samaritans) and \@ref(papryus).
...
I'm **not** saying don't work hard, but I am recommending that you don't work *too* hard. Overworking will literally kill you. [@overworking]
