...
One of the main target audiences for this textbook is [Generation Z](https://en.wikipedia.org/wiki/Generation_Z), that's people born sometime between the mid-nineties to early 2000's. There's some evidence that Gen-Z-ers have a higher probability than previous generations of being, as *The Economist* puts it:
