...
knitr::include_graphics("images/aaron-swartz.jpeg")
```

<!-- inclusion of note = {https://youtu.be/6x-Nl3_L1pA} in bib file for @isolation causes weird tex compilation error that doesn't make sense-->

(ref:captionaaronswartz) [Aaron Swartz](https://en.wikipedia.org/wiki/Aaron_Swartz) was a [hacktivist](https://en.wikipedia.org/wiki/Hacktivism) and is another tragic example of a life ended prematurely by suicide, aged just 26. Some combination of depression and the impending court case of the [United States v. Swartz](https://en.wikipedia.org/wiki/United_States_v._Swartz) were the likely causes. [@ripaaron] *What is the most important thing you could be working on right now? ...  And if you're not working on that, why aren't you?* [CC BY](https://creativecommons.org/licenses/by/2.0/deed.en) portrait of Aaron Swartz by [Fred Benenson](http://fredbenenson.com/) on Wikimedia Commons [w.wiki/6ZvM](https://w.wiki/6ZvM) adapted using the [Wikipedia app](https://apps.apple.com/us/app/wikipedia/id324715238)


Globally, over 700,000 people die due to suicide every year, see [who.int/health-topics/suicide](https://www.who.int/health-topics/suicide). Every life lost to suicide is a tragedy because suicide is preventable, by talking and listening. If you're feeling suicidal or you know someone who is, don't suffer (or let others suffer) in silence. Help is available, check out the resources in section \@ref(samaritans) and \@ref(papryus).
