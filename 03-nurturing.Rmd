...
```
(ref:captionstresseddepressed) Are you stressed? Depressed? Exam obsessed? Are you more worried about getting good grades than drinking too much or having unplanned pregnancies? According to *The Economist* members of Generation Z are more likely to affected by stress, depression and exam obsession. [@generationz] Portrait of climate change activist [Aliénor Rougeot](https://en.wikipedia.org/wiki/Ali%C3%A9nor_Rougeot) campaigning for [Fridays4Future](https://en.wikipedia.org/wiki/School_Strike_for_Climate) by Dina Dong on Wikimedia Commons [w.wiki/4ueR](https://w.wiki/4ueR) adapted using the [Wikipedia app](https://apps.apple.com/gb/app/wikipedia/id324715238)
