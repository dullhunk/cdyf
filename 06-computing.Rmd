...
Besides the social arguments, there are also strong economic reasons for studying computing. The software engineer and investor [Marc Andreesen](https://en.wikipedia.org/wiki/Marc_Andreessen) has argued that [software is eating the world](https://a16z.com/2011/08/20/why-software-is-eating-the-world/). [@eatingtheworld] It's actually the combination of software *and* hardware in computing that dominates the list of the world's largest corporations by market capitalisation, shown in figure \@ref(fig:market-fig). It's not just software that's eating the world but computing.
