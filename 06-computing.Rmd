...
If academic disciplines are [playing card suits](https://en.wikipedia.org/wiki/Playing_card_suit), then Computer Science is the [joker in the pack](https://en.wikipedia.org/wiki/Joker_(playing_card)) shown in figure \@ref(fig:joker-fig). Although versatile, Computer Science doesn't *really* belong in any of the traditional four suits: diamonds, clubs, hearts and spades. Computing is a science *and* an art. Computing allows us to study human society and culture, so it's part of the humanities too. Alongside this, computing is also an engineering discipline, a technology and a branch of mathematics too. This means that the computational joker can be played whenever and wherever you like, making it an incredibly powerful and dangerous card, depending on the game you are playing. ♣♥♠♦🃏
...
```
(ref:captionjoker) Computer Science: The Joker in the Pack. The Jolly Nero, vintage Masenghini playing card printed in Bergamo, Italy, public domain image via Wikimedia Commons [w.wiki/35EW](https://w.wiki/35EW) adapted from the [joker playing card](https://en.wikipedia.org/wiki/Joker_(playing_card)) using the [Wikipedia app](https://apps.apple.com/gb/app/wikipedia/id324715238).
