...
What figure \@ref(fig:market-fig) and figure \@ref(fig:market-again-fig) show is that computing is eating the stock market. This means that commercial demand for software developers is high, comparable to teaching and nursing in terms of raw numbers. In the UK, the most common jobs for graduates from 2021 are shown in Figure \@ref(fig:nurses-fig), based on data taken from an article on [the graduate labour market in 2022](https://luminate.prospects.ac.uk/uk-graduate-labour-market-update-11-january) [@labourmarket2022]
...
nursesdata <- tribble(
  ~profession,        ~graduates,
  "Nurses",	6660,
  "Software developers",	4340,
  "Primary teachers",	3505,
  "Marketing associates",	3465,
  "Medical practitioners",	3240,
  "Secondary teachers",	2890,
  "Accountants",	2470	,
  "Financiers",	2050,
  "Graphic designers",	1715,
  "Sales executives",	1455

)

ggplot(data = nursesdata) +
  geom_bar(mapping = aes(x = profession, y = graduates), stat="identity") +  coord_flip()
```

<!--todo: label graduates as no of graduates-->

(ref:captionball) The top ten professions in the UK in 2021 (y axis) based on numbers of graduates starting work (x axis). Demand for software developers is high, comparable to teachers and nurses, according to data published by prospects.ac.uk [@labourmarket2022]
