...
```
(ref:captionmarket) If the stock markets are anything to go by, computing is eating the world. It would be difficult for Apple, Microsoft, Amazon, Google and Facebook to exist without computing. The economic weight of [Big Tech](https://en.wikipedia.org/wiki/Big_Tech) graphic by YBSLE on Wikimedia Commons [w.wiki/3KEU](https://w.wiki/3KEU)
