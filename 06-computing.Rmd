...
### Computing is creative {#creative}
...
```
(ref:captionsonicpi) Sam Aaron puts the creative case for computing by discussing programming as performance in his TEDx talk from 2016. [@youtube-sonicpi] The image in the figure is a screenshot, to [watch the 18 minute video on programming as performance here](https://www.youtube.com/watch?v=0lTZ8Tuyu5I).

Computing is also an intellectually stimulating subject to study in its own right. If you don't believe me, I'm not going to make the case here. Have a look at Silvio Peroni's free [comp-think](https://comp-think.github.io/) book, for teaching computational thinking and programming skills to people with a background in the humanities. [@peroni]

### Computing is eating the world {#eating}
Besides the social arguments, there are also strong economic
The software engineer and investor [Marc Andreesesn](https://en.wikipedia.org/wiki/Marc_Andreessen) once pointed out that [software is eating the world](https://a16z.com/2011/08/20/why-software-is-eating-the-world/). [@eatingtheworld] The combination of software and hardware dominates the list of the world's largest corporations by market capitalisation, shown in figure \@ref(fig:market-fig).
...
```
(ref:captionmarket) If the stock markets are anything to go by, computing is eating the world. Computing is central to Apple, Microsoft, Amazon, Google and Facebook. The economic weight of Big Tech by YBSLE on Wikimedia Commons [w.wiki/3KEU](https://w.wiki/3KEU)
