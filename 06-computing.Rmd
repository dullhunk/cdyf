...
nursesdata <- tribble(
  ...
  "Primary school teachers",	3505,
  "Marketing associates",	3465,
  "General medical practitioners",	3240,
  "Secondary school teachers",	2890,
  "Accountants",	2470	,
  "Financiers and investors",	2050,
  "Graphic and multimedia designers",	1715,
...
(ref:captionball) The top ten professions in the UK in 2021 based on numbers of graduates starting work (x axis). In 2019 there were 4340 graduate entrants to the job market in the UK as software developers, with many developer vacancies unfilled. So, demand for software developers is high, comparable to teachers and nurses, according to data published by prospects.ac.uk [@labourmarket2022]
