...
(ref:captionball) The top ten professions in the UK in 2021 based on numbers of graduates starting work (x axis). Demand for software developers is high, comparable to teachers and nurses, according to data published by prospects.ac.uk [@labourmarket2022]
