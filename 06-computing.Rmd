...
Besides the social arguments, there are also strong economic reasons for studying computing. In 2011, the software engineer and billionaire investor [Marc Andreesen](https://en.wikipedia.org/wiki/Marc_Andreessen) argued that [software is eating the world](https://a16z.com/2011/08/20/why-software-is-eating-the-world/). [@eatingtheworld] It's actually the combination of software *and* hardware that dominates the list of the world's largest corporations by [market capitalisation](https://en.wikipedia.org/wiki/Market_capitalization), shown in figure \@ref(fig:market-fig). So it's not just software that's eating the world but computing.
