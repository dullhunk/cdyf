...
(ref:captionball) The top ten professions in the UK in 2021 based on numbers of graduates starting work (x axis). In 2019, 4340 graduates started a job in the UK job as a software developer (or programmer), with many developer vacancies unfilled. So, demand for software developers is high, comparable to teachers and nurses, according to data published by prospects.ac.uk [@labourmarket2022]
