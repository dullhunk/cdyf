...
## Get paid to write Open Source Software {#gsocmore}
...
* [appinventor.mit.edu](https://appinventor.mit.edu/): allows everyone to build fully functional apps for Android phones, iPhones and Android/iOS tablets
...
* [hepsoftwarefoundation.org](https://hepsoftwarefoundation.org/): High Energy Physics (HEP) software used at CERN and elsewhere
...
* [sanger.ac.uk](https://www.sanger.ac.uk/): genomic research
...
1. Narrow your list down to one or two organisations, then talk to them via whatever chat channel they are using, see making first contact in section \@ref(firstcontact)
...
Once you've figured out which of the projects interest you most, it's time to start getting in touch with them.

## Making first contact with an OSS project {#firstcontact}

Here's what GSoC advice on making first contact with an Open Source Software (OSS) project, start by _observing_:
...
At the end of yocur “listening and research” phase you’ll understand how, where and when the community interacts and know the best way to ask questions and discuss your proposal. See [making first contact](https://google.github.io/gsocguides/student/making-first-contact) 


## Are you good enough for GSoC? {#iagefgsoc}
...
* You can communicate effectively, see figure \@ref(fig:allskills2-fig) 
...
```{r allskills2-fig, echo = FALSE, fig.align = "center", out.width = "100%", fig.cap = "(ref:captionallskills)"}
