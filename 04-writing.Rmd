...
* The $x$ page summary for management, it might be $x$ might be $1$, or $2$ or $6$ if you work at Amazon [@bezos; @mad]
...
(ref:captionbff) Eight reasons why writing is your new Best Friend Forever (BFF). 1. Communication 2. Recording 3. Leadership 4. Slowing down 5. Problem solving 6. Process not product 7. Therapy and 8. Speeding up. B.F.F. by [Visual Thinkery](https://visualthinkery.com/) is licensed under [CC-BY-ND](https://creativecommons.org/licenses/by-nd/4.0/))

So let's expand on each of the reasons in figure \@ref(fig:bff-fig) why writing is your new BFF:

### Communication {#communicating}
Writing is communication, see figure \@ref(fig:comms-fig). Well Duh! I'm stating the obvious, because you will sometimes hear software engineers talking disparingly about writing the (*sigh*)`documentation`. 
...
Engineers may sometimes tell you that writing about their software or hardware can be a chore. If they bother to write about their software at all, they often do it at the end, *if* there is time and there's no more features or bugs to added or removed. This might go some way to explaining why software and hardware documentation can be so bad because:
...
(ref:captionrecording) If you don't write it down there will be no record that it actually happened. Whatever *it* was. While its difficult to know in advance exactly what you'll need to record, the safest option is to write it down anyway, just in case. Old school reel to reel [tape recorder](https://en.wikipedia.org/wiki/Tape_recorder) sketch by [Visual Thinkery](https://visualthinkery.com/) is licensed under [CC-BY-ND](https://creativecommons.org/licenses/by-nd/4.0/))


If it is important, it is probably worth writing down. Even things you think are trivial are still worth writing down as they might turn out to be important later:
...
Have ever felt moved or influenced by a piece of writing, see figure \@ref(fig:constitution-fig)? Ever read something that motivated or influenced you in some way? Of course you have.
...
(ref:captionconstitution) *We hold these truths to be self-evident, that all men are created equal...* Just words on a piece of paper, but words that lead. United States Constitution sketch by [Visual Thinkery](https://visualthinkery.com/) is licensed under [CC-BY-ND](https://creativecommons.org/licenses/by-nd/4.0/))

Let's take the [United Sates Declaration of Independence](https://en.wikipedia.org/wiki/United_States_Declaration_of_Independence). We're still talking about more than 240 years after it was written. [@declarationofi] It's not just because it was influential, it's because somebody bothered to write it down. The seemingly mundane and low technology act of humble writing. The declaration is “just” words, written down on a piece of paper, but words that changed the course of history. 
...
Your brain tends to work *much* more quickly than your fingers can type or your hands can write. Your brain will often work faster than you can speak as well. Writing can slow that process down to something more manageable and concrete, by focussing on a given topic or problem, see figure \@ref(fig:slowing-fig).
...
Ever got stuck on a difficult problem? Ever tried writing that problem down or articulating the problem to a rubber duck? There's something about writing a problem down or articulating a problem to another person. Even a rubber duck will do, see figure \@ref(fig:rubber-duck-fig). So writing can be a useful technique for solving problems, even if nobody else reads what you've written. 
...
(ref:captionduck) Ever tried explaining that troublesome bug to a rubber duck? Welcome to [rubber duck debugging](https://en.wikipedia.org/wiki/Rubber_duck_debugging), a tried and tested technique for problems solving, either through written or spoken communication with an inanimate object. Rubber duck sketch by [Visual Thinkery](https://visualthinkery.com/) is licensed under [CC-BY-ND](https://creativecommons.org/licenses/by-nd/4.0/)) 
...
(ref:captionprocess) Sometimes the *process* of writing is more important than the *product* of writing. Process sketch by [Visual Thinkery](https://visualthinkery.com/) is licensed under [CC-BY-ND](https://creativecommons.org/licenses/by-nd/4.0/)) 

Here are some examples where the process of writing can be more important than the product:
...
Besides being a tool for communication, writing can be therapeutic for the writer too. The simple act of writing can help you tackle mental health issues discussed in chapter \@ref(nurturing). You might think it tragic somebody writing a diary that nobody reads, but actually, that's not the only point of the diary. The metacognition we described in section \@ref(product) is a valuable exercise in its own right. You could think of it like a therapists couch show in figure \@ref(fig:therapy-fig).
...
(ref:captiontherapy) Dear Diary ... The therapeutic effects of writing are well documented, writing doesn't *have* to be read by anyone to benefit the writer. Therapy sketch by [Visual Thinkery](https://visualthinkery.com/) is licensed under [CC-BY-ND](https://creativecommons.org/licenses/by-nd/4.0/)) 

Prime minister [Winston Churchill](https://en.wikipedia.org/wiki/Winston_Churchill) found that writing helped to keep the “black dog” of his depression under control, see section \@ref(depression) and figure \@ref(fig:winston-fig).
