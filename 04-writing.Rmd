...
1. articulate humanities graduates who are well read, well spoken but sometimes lack technical skills. In extreme cases, they can be scientificially and mathematically illiterate
...
Let's take the [United States Declaration of Independence](https://en.wikipedia.org/wiki/United_States_Declaration_of_Independence) shown in figure \@ref(fig:constitution-fig). We're still talking about it more than 200 years after it was written. [@declarationofi] That's not just because it was influential, it's because it was written down. The seemingly mundane and lo-tech but hi-fi act of humble writing. The declaration is “just” words, written down on a piece of paper, but words that changed the course of history. 
