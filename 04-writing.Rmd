...
(ref:captionmightypen) Need to arm yourself with another superpower for communication besides computing? Develop your written communication skills because [the pen (and keyboard) is mightier than the sword](https://en.wikipedia.org/wiki/The_pen_is_mightier_than_the_sword). Public domain image of drawing of Cardinal Richelieu by [Henry Alexander Ogden](https://en.wikipedia.org/wiki/Henry_Alexander_Ogden) via Wikimedia Commons [w.wiki/3WHg](https://w.wiki/3WHg) adapted using the Wikipedia app
