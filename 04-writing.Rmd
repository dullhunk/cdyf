...
(ref:captionmadscientist) Mad, bad and dangerous to know? You'll be familiar with the [mad scientist stereotype](https://en.wikipedia.org/wiki/Mad_scientist). Part of the problem with mad scientists and engineers (apart from their supposed insanity) is their poor communication skills. Don't perpetuate the stereotype by being a poor communicator. CC BY-SA cartoon of a mad scientist by J.J. on Wikimedia Commons [w.wiki/5JeU](https://w.wiki/5JeU) adapted using the [Wikipedia App](https://apps.apple.com/gb/app/wikipedia/id324715238)
...
* [Jupyter.org notebooks](https://jupyter.org/), code and natural language mixed together, as do many other systems like [bookdown.org](https://bookdown.org/)
