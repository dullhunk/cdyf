...
(ref:captioncpsnow) Many Computer Scientists are steeped in the culture of [Science, Technology, Engineering and Mathematics](https://en.wikipedia.org/wiki/Science,_technology,_engineering,_and_mathematics) (STEM), seperated by a gulf from their counterparts in the humanities. This gulf between the two cultures is bad for *both* sides as it handicaps our abilities to solve major global problems. [@twocultures] Fair use image of the cover of *[The Two Cultures](https://en.wikipedia.org/wiki/The_Two_Cultures)* via Wikimedia Commons [w.wiki/6Rhv](https://w.wiki/6Rhv) adapted using the [Wikipedia App](https://apps.apple.com/gb/app/wikipedia/id324715238)

 It probably doesn’t help that in the UK, and numerous other countries, many students in the latter stages of their education, choose between: 
...
1. graduate scientists and engineers who have weaker communication skills, both written and spoken, combined with cultural illiteracy
1. articulate humanities graduates with weaker technical & numeracy skills, who, in extreme cases, are scientificially and mathematically illiterate
