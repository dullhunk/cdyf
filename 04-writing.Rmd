...
(ref:captionchatgpt) Chat Generative Pre-trained Transformer ([ChatGPT](https://en.wikipedia.org/wiki/ChatGPT)) is a chatbot developed by [OpenAI.com](https://openai.com/) and launched in 2022. It is built on top of OpenAI's GPT-4 family of large [language models](https://en.wikipedia.org/wiki/Language_model) and has been fine-tuned using both supervised learning and reinforcement learning techniques. ChatGPT is one of several *writing machines* or *robo-writers* that you can potentially use as an assistant to help you communicate more quickly and clearly. Note that despite the name, the language model that ChatGPT is built on is NOT openly available. [@notopenai] OpenAI logo from Wikimedia Commons [w.wiki/6Lat](https://w.wiki/6Lat) adapted using the [Wikipedia App](https://apps.apple.com/us/app/wikipedia/id324715238)
...
Your future is bright, your future needs writing. Writing your future is designing your future. Designing your future is Coding your future. 
...
So communicating with other people is a key skill, see figure \@ref(fig:allpeople-fig). This chapter has looked at written communication, and its importance in persuading people to invite you to a job interview, in chapter \@ref(speaking) we will look at the closely related skill of spoken communication. 

In the next part, chapter \@ref(choosing): *Choosing your Future*, we'll look at deciding where to send your written job applications to. What are the possibilities, and how are you going to decide between them? 
