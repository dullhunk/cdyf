...
(ref:captiondogfooding) Reading your own writing (aloud) is like eating your own dog food. It's a simple technique for improving your written communication in job applications such as covering letters, CVs, personal statements and the like. Picture of dog eating  by Tyne \& Wear Archives \& Museums on Wikimedia Commons [w.wiki/3VBS](https://w.wiki/3VBS)
...
(ref:captiondeathstar)  Just like the [Death Star](https://en.wikipedia.org/wiki/Death_Star), this chapter is under construction. Image of agile space station construction methods via Wikimedia Commons [w.wiki/32PB](https://w.wiki/32PB)
