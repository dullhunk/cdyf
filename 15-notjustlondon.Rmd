...
A simple way to improve your job prospects is to [broaden and deepen your job search](#searching). One of the [ten simple rules for coding your future](#ruling), is to look beyond obvious employers and locations for jobs and [consider all the alternatives](#broadening). While there are lots of great careers in and around London and [Loxbridge](https://en.wikipedia.org/wiki/Loxbridge), they are not the whole story of employment in the UK. It's wrong to assume that capital cities are where *all* the best jobs are.
