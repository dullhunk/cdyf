...
> Sneha: The song that I chose was a November Rain  [@novemberrain] by Guns and Roses, see figure \@ref(fig:gnr-fig)

```{r gnr-fig, echo = FALSE, fig.align = "center", out.width = "100%", fig.cap = "(ref:captiongnr)"}
knitr::include_graphics("images/gunsnroses.jpeg")
```
(ref:captiongnr) Guns N' Roses are an American rock band from Los Angeles, California, [November Rain](https://en.wikipedia.org/wiki/November_Rain) was originally released in 1992. It was subsequently used in the Original Motion Picture Soundtrack for *Thor: Love and Thunder* in 2022. [@novemberrain; @loveandthunder] Portrait of band members Duff McKagan, Axl Rose, Slash and Melissa Reese performing at the London stadium in 2017 by [Raph PH](https://www.flickr.com/photos/raph_ph/) on Wikimedia Commons [w.wiki/_wB2e](https://w.wiki/_wB2e) adapted using the [Wikipedia App](https://apps.apple.com/us/app/wikipedia/id324715238) 🎩
