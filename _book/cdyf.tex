...
Thanks to my friends, especially those who I've enjoyed singing, dancing and live music with. I'm looking forward to the next time that we can meet again.
...
The fact that you enjoy \texttt{swimming}, \texttt{reading}, \texttt{football}, \texttt{cooking} and \texttt{hiking} is a bit vague and not likely to be a factor in the decision to interview you. There's nothing \emph{wrong} with these pastimes but there's not much point mentioning them on your CV unless you have, for example:
