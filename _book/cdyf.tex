...
\caption{People tell stories and stories paint pictures. Bryan Mathers speaking at TEDxGalway in 2021. The image above is a screenshot, you can watch the full 15 minute talk at \href{https://youtu.be/IapGM5ZYBEw}{youtu.be/IapGM5ZYBEw}}\label{fig:tedx-galway-fig}
\end{figure}
...
Thanks to my West Country friends, especially those who I've enjoyed live music, cycling and walking with, see figure \ref{fig:bradlads-fig}. I'm looking forward to our next adventure.
...
\caption{Crossing the highest mountain pass in Europe, the \href{https://en.wikipedia.org/wiki/Col_de_l\%27Iseran}{Col de l'Iseran}, with my fellow \emph{\href{https://en.wikipedia.org/wiki/King_of_the_Mountains}{Kings of the Mountains}}, Jim, Dan, Doug and Dan.}\label{fig:bradlads-fig}
\end{figure}



So, thank you for your friendship. Proper job! 🙏
...
You are reading the alpha version, the \href{https://en.wikipedia.org/wiki/Minimum_viable_product}{Minimum Viable Product} (MVP) of this guidebook, last updated on 07 December, 2021. That's software engineer talk for saying it isn't finished yet. Subsequent versions, will be continuously and iteratively released on a daily and weekly basis. They will include:
...
\item
  ...
  \tightlist
  \item
    \texttt{Woman\ *\ Genderqueer\ *\ Man} see \href{https://en.wikipedia.org/wiki/Gender_binary}{wikipedia.org/wiki/Gender\_binary} and \href{https://en.wikipedia.org/wiki/Non-binary_gender}{wikipedia.org/wiki/Non-binary\_gender}
  \end{itemize}
\item
  ...
  \tightlist
  \item
    \texttt{Feminine\ *\ Androgynous\ *\ Masculine} see \href{https://en.wikipedia.org/wiki/Gender_expression}{wikipedia.org/wiki/Gender\_expression}
  \end{itemize}
\item
  ...
  \tightlist
  \item
    \texttt{Female\ *\ Intersex\ *\ Male} \href{https://en.wikipedia.org/wiki/Sex}{wikipedia.org/wiki/Sex}
  \end{itemize}
\item
  ...
  \tightlist
  \item
    \texttt{Heterosexual\ *\ Bisexual\ *\ Homosexual\ *\ Asexual} see \href{https://en.wikipedia.org/wiki/Sexual_orientation}{wikipedia.org/wiki/Sexual\_orientation} and \href{https://en.wikipedia.org/wiki/Romance_(love)}{wikipedia.org/wiki/Romance\_(love)}
  \end{itemize}
\end{enumerate}
