...
You are reading the alpha version, the \href{https://en.wikipedia.org/wiki/Minimum_viable_product}{Minimum Viable Product} (MVP) of this guidebook, last updated on 06 August, 2021. That's software engineer talk for saying it isn't finished yet. Subsequent versions, will be continuously and iteratively released on a daily and weekly basis. They will include:
...
\caption{Reasons for being, a concept in Japanese known as \emph{ikigai}. According to ikigai, a meaningful life combines four intersecting sets: 1. What you are good at 2. What you love 3. What the world needs and 4. What you can get paid for. What do \emph{you} have in each of these sets and where do they intersect? Ikigai sketch by \href{https://visualthinkery.com}{Visual Thinkery} is licensed under \href{https://creativecommons.org/licenses/by-nd/4.0/}{CC-BY-ND}}\label{fig:iki-fig}
\end{figure}
...
\caption{The seemingly contradictory phrase \href{https://en.wikipedia.org/wiki/The_king_is_dead,_long_live_the_king!}{the king is dead, long live the king} simultaneously announces the death of the previous monarch and the accession of a new one. Likewise, the death of the CV (and résumé) has long been hailed but they keep coming back to reign again. The CV is dead, long live the CV! The résumé is dead, long live the résumé! Public domain image of a painting of \href{https://en.wikipedia.org/wiki/Charles_VII_of_France}{Charles VII of France} by Jean Fouquet on Wikimedia Commons \href{https://w.wiki/3e3K}{w.wiki/3e3K} adapted using the \href{https://apps.apple.com/us/app/wikipedia/id324715238}{Wikipedia app}}\label{fig:longlive-fig}
\end{figure}
...
ℹ️ \textbf{Coding Comment} ℹ️

LinkedIn is more than a tool for publishing your CV or Résumé because it also allows you to connect with professionals and recruiters while searching for jobs. We look at job searching in more detail in chapter \ref{finding}, for now note the similarities and differences between LinkedIn and CV's outlined in table \ref{tab:linkedintable}
...
Generally, no length limit & Limited length, typically one or two pages (for a graduate), see section \ref{length}\\
...
Only one profile, you can't easily transfer connections if you open more than one account & You might create multiple CV's that emphasise different skills and knowledge, or have different lengths e.g. one page résumé and two page CV\\
Generic, allows employers and recruiters to target you & Can be targeted to specific employers or vacancies\\
\bottomrule
\end{tabular}
\end{table}
...
Polly loves object-oriented programming. She has lots of siblings, and \href{https://en.wikipedia.org/wiki/Isomorphism}{a cousin called Isa}. Instead of a CV or résumé, Polly has put some basic details on her LinkedIn profile which she primarily uses for professional social networking, see figure \ref{fig:polly-fig}.
