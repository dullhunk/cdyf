...
Thanks to the rest of my St Laurence school teachers not pictured in figure \ref{fig:fitzmaurice-fig}. In alphabetical order: Phil Arthur, Sally Arthur, Maggie Bignell, \href{https://www.wiltshiretimes.co.uk/news/11774162.the-life-of-mrs-jackie-bolton/}{Jackie Bolton}, Tony Brooks, Dave Brush, \href{https://www.youtube.com/watch?v=Hg9irmFwFr8}{Andrew Butterworth}, Cathy Cooper, Ed Corrin, Brian Ellis, Myra Ettridge, Ms.~Gledhill, Roger Greenwood, Amanda Hodges, Steve Hollas, Mr Jones, Madame Lindsay, Karen Long, Sheila Macdonald, Simon Mitchell, Tim Noble, Roger Norgrove, Dave Pegg, Angela Pendennis, Steve Stretch, Mr Sadler, Mike Sullivan, Phil Smith, Beryl Tucker, \href{https://www.sourcewatch.org/index.php/James_Wetz}{James Wetz} and Bill Wheeler.

\textbackslash begin\{figure\}
\includegraphics[width=0.0909\linewidth]{images/st-laurence-school-logo} \includegraphics[width=0.0909\linewidth]{images/st-laurence-school-logo} \includegraphics[width=0.0909\linewidth]{images/st-laurence-school-logo} \includegraphics[width=0.0909\linewidth]{images/st-laurence-school-logo} \includegraphics[width=0.0909\linewidth]{images/st-laurence-school-logo} \includegraphics[width=0.0909\linewidth]{images/st-laurence-school-logo} \includegraphics[width=0.0909\linewidth]{images/st-laurence-school-logo} \includegraphics[width=0.0909\linewidth]{images/st-laurence-school-logo} \includegraphics[width=0.0909\linewidth]{images/st-laurence-school-logo} \includegraphics[width=0.0909\linewidth]{images/st-laurence-school-logo} \includegraphics[width=0.0909\linewidth]{images/st-laurence-school-logo} \textbackslash caption\{The badge of St.~Laurence School is an adaptation of the Fitzmaurice badge, the two \href{https://en.wikipedia.org/wiki/Gudgeon_(fish)}{gudgeon fish} symbolising the union of the two schools it was created from: Trinity secondary modern school and Fitzmaurice Grammar School\}\label{fig:laurence-fig}
...
You are reading the alpha version, the \href{https://en.wikipedia.org/wiki/Minimum_viable_product}{Minimum Viable Product} (MVP) of this guidebook, last updated on 14 December, 2021. That's software engineer talk for saying it isn't finished yet. Subsequent versions, will be continuously and iteratively released on a daily and weekly basis. They will include:
