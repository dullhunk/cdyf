...
\item
  From the command line \texttt{git\ clone\ https://github.com/dullhunk/cdyf.git} the repository to submit pull requests from your setup
\end{itemize}
...
Employers are often more interested in what you have \emph{done}, rather than just what you \emph{know}. Your actions are a key part of your story we discussed in section \ref{carstar}. A good technique for emphasising your actions is to lead the description of it with carefully chosen verbs.
...
By leading with verbs you will highlight what you \emph{actually done} rather than what you \emph{think} you know. See the verbs first section \ref{verbsfirst} of chapter \ref{debugging} \emph{debugging your future}.
