...
You are reading the alpha version, the \href{https://en.wikipedia.org/wiki/Minimum_viable_product}{Minimum Viable Product} (MVP) of this guidebook, last updated on 17 May, 2021. That's software engineer talk for saying it isn't finished yet. Subsequent versions, will be continuously and iteratively released on a daily and weekly basis. They will include:
...
Making software isn't all about what you can do as an individual but rather how you contribute to a team. It's easy to get carried away with your ego when you are preparing for coding interviews. Remember that the job itself requires \emph{lots} of softer people skills and collaboration, written communication is a huge part of that, see for example \href{https://www.youtube.com/watch?v=0SARbwvhupQ}{The Myth of the Genius Programmer}. \citep{Fitzpatrick}
...
\item
  Identify places to get started with computing, if you're not studying computer science
\item
...
At school, everyones learns to read, write and do maths:
...
Besides the social arguments, there are also strong economic reasons for studying computing. The software engineer and billionaire investor \href{https://en.wikipedia.org/wiki/Marc_Andreessen}{Marc Andreesen} has argued that \href{https://a16z.com/2011/08/20/why-software-is-eating-the-world/}{software is eating the world}. \citep{eatingtheworld} It's actually the combination of software \emph{and} hardware in computing that dominates the list of the world's largest corporations by market capitalisation, shown in figure \ref{fig:market-fig}. It's not just software that's eating the world but computing.
...
\midrule
Insight & Usually no contract. One to three weeks, sometimes known as work experience, work shadowing, spring weeks, vacation schemes or even “externships”. Usually unpaid, but often expensed. See [ratemyplacement.co.uk/insights](https://www.ratemyplacement.co.uk/insights) for examples\\
...
The choice of online learning can be bewildering. Some are free others are not, but your employer may subscribe to some of these services meaning they are free to you while you are an employee. There's a \href{https://www.businessinsider.com/online-learning-platform-comparison-udemy-skillshare-lynda-coursera}{good comparison of four different platforms here}. \citep{udemy} Stay in school!
