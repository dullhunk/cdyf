...
You are reading the alpha version, the \href{https://en.wikipedia.org/wiki/Minimum_viable_product}{Minimum Viable Product} (MVP) of this guidebook, last updated on 24 May, 2022. That's software engineer talk for saying it isn't finished yet. Subsequent versions, will be continuously and iteratively released on a daily and weekly basis. They will include:
...
If you are affected by mental ill health, talking about it is the first place to start, but often the hardest. Accepting yourself for who you are (see chapter \ref{knowing}), learning to identify and challenge unhelpful thinking patterns and trying not to compare yourself to other people are three more steps you can take to help yourself, see figure \ref{fig:mindyourhealth-fig}. In this chapter, I've outlined some ways you can help yourself alongside some of the services and people you can talk to if you need to.
...
It is good practice to \emph{triangulate} responses from your readers. For example, if three different people point out the same bug in your CV you know that the bug needs fixing. Such a bug is less likely to a result of bad advice from an opinionated but misguided reader.
...
\item
  Providing food, water, shelter, energy, education and healthcare for a global population which is rapidly approaching \href{https://www.worldometers.info/world-population/}{8 billion people}
\end{itemize}
