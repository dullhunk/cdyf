...
\item
  Search and navigate a large ``wordbase'' (this guidebook and the work it cites). A wordbase is like a \texttt{{[}codebase{]}(https://en.wikipedia.org/wiki/Codebase)}, only written predominantly in natural language.
\end{enumerate}
...
\item
  Chapter \ref{reviewing}: \emph{Reviewing their future} invites you to put yourself in the employers shoes by reviewing other people's CVs
\item
...
If you'd like to contribute this guidebook, I welcome constructive feedback from \href{https://en.wikipedia.org/wiki/Critical_friend}{critical friends}.

\hypertarget{dontbeshy}{%
\subsection{Contributions sought}\label{dontbeshy}}
...
\item
  Are there too many musical references or annoying emoji? Please bear in mind I'm trying to strike a light hearted and playful tone to improve readability 😜
\item
...
\caption{Hindsight is a great teacher. I wish that I knew what I know now, when I was younger, see \href{https://en.wikipedia.org/wiki/Ooh_La_La_(Faces_song)}{Ooh La La} \citep{faces} I've written some of what I know now in this guidebook,}\label{fig:faces-fig}
\end{figure}
...
You are reading the alpha version, the \href{https://en.wikipedia.org/wiki/Minimum_viable_product}{Minimum Viable Product} (MVP) of this guidebook, last updated on 11 June, 2021. That's software engineer talk for saying it isn't finished yet. Subsequent versions, will be continuously and iteratively released on a daily and weekly basis. They will include:
...
\caption{``I have such a stressful job that the only way I can get it out of my mind is by running hard; it's the only way I can get some release''. Like many, Turing found running a relief from the mental pressure he was under in his job. \citep{kottke} Public domain portrait of Alan Turing via Wikimedia Commons \href{https://w.wiki/oZx}{w.wiki/oZx}}\label{fig:turing-stress-fig}
\end{figure}
...
\caption{Do you have bugs or \href{https://en.wikipedia.org/wiki/Undocumented_feature}{undocumented features} on your CV or resume? Picture of gold-dust weevil \emph{Hypomeces squamosus} by \href{https://commons.wikimedia.org/wiki/User:Basile_Morin}{Basile Morin} is licensed CC BY SA 4.0 via Wikimedia Commons \href{https://w.wiki/3E62}{w.wiki/3E62}}\label{fig:notabug-fig}
\end{figure}
...
\item
  ✅ Have you reviewed other people's CV's? This will help you write a better CV, see chapter \ref{reviewing}
\item
...
\caption{This chapter is under construction. Image of the \href{https://en.wikipedia.org/wiki/Death_Star}{Death Star} via Wikimedia Commons \href{https://w.wiki/32PB}{w.wiki/32PB}}\label{fig:deathstar19-fig}
\end{figure}

\hypertarget{reviewing}{%
\chapter{Reviewing their future}\label{reviewing}}
...
There's at two kinds solutions to this problem, that involve \protect\hyperlink{dogfooding}{dogfooding}, we've already talked about in section \ref{dogfooding}:

\begin{enumerate}
\def\labelenumi{\arabic{enumi}.}
\tightlist
\item
  Eat your \emph{own} dogfood by reading your own written work ALOUD
\item
  Eat \emph{somebody elses} dogfood by:

  \begin{itemize}
  \tightlist
  \item
    Debugging a friends or peers CV by swapping with them and giving them constructive feedback
  \item
    Debugging the fictitious CVs below by ranking them against a job advert. Who would you want to interview and why?
  \end{itemize}
\end{enumerate}
