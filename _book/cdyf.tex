...
Thanks to Martin Clutterbuck, Rebecca Clare, Richard O'Beirne, Simon Witter and everyone else at \href{https://www.flickr.com/photos/dullhunk/4042838703}{Blackwell Science Ltd} and Eileen for looking after me in my first job as a freshly minted graduate.
...
Thanks to \href{https://en.wikipedia.org/wiki/Malcolm_Press}{Malcolm Press}, Helena Björn van Praagh, \href{https://en.wikipedia.org/wiki/Terry_Callaghan}{Terry Callaghan}, \href{https://www.brookes.ac.uk/ocsld/about-ocsld/staff-profiles/jackie-potter/}{Jackie Potter}, Rosie, Nick, Dylan, Kjell, Marion and everyone else at \href{https://en.wikipedia.org/wiki/Abisko_Scientific_Research_Station}{Abisko Scientific Research Station} (see figure \ref{fig:abisko-fig}) for hosting me as a summer research student investigating the effects climate change on subarctic heathlands. The best summer job I've ever had!
...
So thanks Abisko for the \href{https://en.wiktionary.org/wiki/fika}{fika}, \href{https://en.wikipedia.org/wiki/Midnight_sun}{midnight sun}, saunas and Swedish hospitality. 🇸🇪🙏
...
Thanks \href{https://www.tycerdd.org/branwen-munn}{Branwen Munn}, pictured on the left in figure \ref{fig:branwen-fig}, for introducing me (pictured on the right) to \href{https://en.wikipedia.org/wiki/While_loop}{\texttt{while} loops} on the Fitzmaurice Primary School \href{https://en.wikipedia.org/wiki/BBC_Micro}{BBC Micro} and your very own \href{https://en.wikipedia.org/wiki/Commodore_64}{Commmodore 64}. I don't think I'd have ended up where I am if it hadn't been for early exposure to computing in primary school.
...
\caption{Birdwatching at RSPB \href{https://en.wikipedia.org/wiki/Radipole_Lake}{Radipole Lake} in Weymouth, Dorset. Besides being members of the \href{https://en.wikipedia.org/wiki/Young_Ornithologists\%27_Club}{Young Ornithologists Club} (YOC) we also enjoyed \href{https://en.wikipedia.org/wiki/Breakdancing}{breakdancing}, music and computing. We'll always wear our geek badges with \textbf{pride}, see section \ref{entitled}.}\label{fig:branwen-fig}
\end{figure}
...
You are reading the alpha version, the \href{https://en.wikipedia.org/wiki/Minimum_viable_product}{Minimum Viable Product} (MVP) of this guidebook, last updated on 23 December, 2021. That's software engineer talk for saying it isn't finished yet. Subsequent versions, will be continuously and iteratively released on a daily and weekly basis. They will include:
