...
\caption{I wish that I knew what I know now, when I was younger. Hindsight is a great teacher, see \href{https://en.wikipedia.org/wiki/Ooh_La_La_(Faces_song)}{Ooh La La} \citep{faces}}\label{fig:faces-fig}
\end{figure}
...
When \href{https://en.wikipedia.org/wiki/Andy_Stanford-Clark}{Andy Stanford-Clark} started working at IBM, fresh out of University, his boss gave him the career advice shown in figure \ref{fig:andysc-fig}:
...
\caption{Nobody cares about your career except you. Anonymous quotation via Andy Stanford-Clark \citep{andystanfordclark}}\label{fig:andysc-fig}
\end{figure}
...
You are reading the alpha version, the \href{https://en.wikipedia.org/wiki/Minimum_viable_product}{Minimum Viable Product} (MVP) of this guidebook, last updated on 09 June, 2021. That's software engineer talk for saying it isn't finished yet. Subsequent versions, will be continuously and iteratively released on a daily and weekly basis. They will include:
