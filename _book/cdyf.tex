...
Besides the social arguments, there are also strong economic reasons for studying computing. The software engineer and investor \href{https://en.wikipedia.org/wiki/Marc_Andreessen}{Marc Andreesen} has argued that \href{https://a16z.com/2011/08/20/why-software-is-eating-the-world/}{software is eating the world}. \citep{eatingtheworld} The combination of software and hardware dominates the list of the world's largest corporations by market capitalisation, shown in figure \ref{fig:market-fig}. It's not just software that's eating the world but computing.
