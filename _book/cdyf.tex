...
\tightlist
\item
  Chapter \ref{bothering}: Surveying your future, discusses why you should bother reading any of this guidebook
\item
...
\item
  Chapter \ref{wellbeing}: Nurturing your future, encourages you to take care of your mental and physical health
\item
  Chapter \ref{communicating}: Writing your future, explores your soft skills, and how they complement your hard skills and why employers value them so much
\item
...
\item
  Chapter \ref{interviewing}: Speaking your future, looks how can you turn interviews to your advantage and negotiate any offers you receive
\item
...
\item
  Chapter \ref{studying}: Researching your future, discusses if a Masters degree or a PhD right for you?
\end{itemize}
...
\tightlist
\item
  Chapter \ref{ruling}: Ruling your future, provides \emph{Ten Simple Rules for Coding your Future}, this book in a nutshell
\item
  Chapter \ref{sampling}: Reading their future, invites you to put yourself in the employers shoes by reading some CVs
\item
  Chapter \ref{notjustlondon}: Moving your future, looks at opportunities outside of capital cities like London
\item
  Chapter \ref{listening}: Hearing your future, invites you to listen to students stories of their transition from education to employment
\item
...
\item
  Chapter \ref{scheduling}: Scheduling your future, invites you to set aside an hour each week for tackling the issues described in this book
\item
...
\caption{This guidebook will help you build a big bridge to your future. Picture of the iconic \href{https://en.wikipedia.org/wiki/Golden_Gate_Bridge}{Golden Gate Bridge} in California adapted from an original by Frank Schulenburg (CC BY-SA) on Wikimedia Commons \href{https://w.wiki/37kY}{w.wiki/37kY}}\label{fig:goldengate-fig}
\end{figure}
...
\tightlist
\item
  Click the \textbf{Edit this page}, which appears on the right hand side of every page of this guidebook published at \href{https://www.cdyf.me}{cdyf.me}
\item
...
\item
  Suggest changes via the (old school) Microsoft Word version at \href{http://cdyf.me/cdyf.docx}{cdyf.docx}. The text is all there, but the pagination and graphic placement isn't always pretty. Don't say I didn't warn you. Make sure you've turned on \href{https://support.microsoft.com/en-us/office/track-changes-in-word-197ba630-0f5f-4a8e-9a77-3712475e806a}{track changes} if Word is your weapon of choice.
\item
  If you don't want to use github or word and all else fails just \href{http://www.cs.man.ac.uk/~hulld/contact.html}{email me suggestions for improvements}
\end{itemize}
...
You are reading the alpha version, the \href{https://en.wikipedia.org/wiki/Minimum_viable_product}{Minimum Viable Product} (MVP) of this guidebook, last updated on 19 May, 2021. That's software engineer talk for saying it isn't finished yet. Subsequent versions, will be continuously and iteratively released on a daily and weekly basis. They will include:
...
\item
  Audio interviews with Students in the \href{listening.html}{Coding your Future podcast}
\item
...
\subsection{I'm deliberately writing in first person narrative}\label{firstperson}}
...
You are more than just a techie, so make sure you develop your non-technical skills as well. We've talked about softer skills in writing your future, chapter \ref{communicating}, but there's plenty of others to think about:
...
There are many online platforms for doing building your skills and knowledge, some examples include:
...
Whatever job you're doing, stay in school. Take advantage of any training on offer or go and find courses online that interest you.
