...
The full text of this guidebook is freely available at \href{https://www.cdyf.me/}{www.cdyf.me}, this means the web version (that's all the \texttt{*.html}) is searchable, browsable and linkable in any web browser on your phone, tablet or desktop computer.

If you'd prefer to read this guidebook in a single ebook file, you can download the automatically updated copy at \href{https://leanpub.com/cdyf}{leanpub.com/cdyf}, shown in figure \ref{fig:leanpub-fig}. Again its free, but you can make a donation to the charitable cause \href{https://codeclub.org/}{codeclub.org} if you choose.

\begin{figure}
\href{https://leanpub.com/cdyf}{\includegraphics[width=1\linewidth]{cdyf_files/figure-latex/leanpub-fig-1} }\caption{This guidebook is also available as a free ebook (pdf and epub) at \href{https://leanpub.com/cdyf}{leanpub.com/cdyf}}\label{fig:leanpub-fig}
\end{figure}
...
\item
  Suggest changes by editing the Microsoft Word version at \href{http://cdyf.me/cdyf.docx}{cdyf.docx}. The text is all there, but the images are all over the place. This is because the pagination, typesetting and graphic placement algorithms in Word aren't anything like as good as the LaTeX ones used to create the \href{https://leanpub.com/cdyf}{cdyf.pdf} (output) from the \href{https://cdyf.me/cdyf.tex}{cdyf.tex} (input).\footnote{Don't say I didn't warn you!} Make sure you've \href{https://support.microsoft.com/en-us/office/track-changes-in-word-197ba630-0f5f-4a8e-9a77-3712475e806a}{turned on track changes in Word}. Track changes is one of Microsoft Word's \href{https://en.wikipedia.org/wiki/Killer_feature}{killer features} that allows your corrections to be easily identified from the original text.
\item
...
\subsection{Thank you writers}\label{bloggers}}

Thanks to the artists, blaggers, bloggers, cartoonists, columnists, doodlers, diarists, essayists, film-makers, journalists, photographers, podcasters and writers on the internet whose \href{https://en.wikipedia.org/wiki/Words_and_Pictures_(TV_programme)}{words and pictures} I've enjoyed reading, watching and listening to see figure \ref{fig:keyboard-fig}.
...
So here is my \href{https://en.wiktionary.org/wiki/blogroll}{blogroll}:
...
\item
  \href{https://en.wikipedia.org/wiki/Kevin_Fong}{Kevin Fong} at \emph{13 minutes to the Moon} \href{https://bbc.in/35jDOwI}{bbc.in/35jDOwI}
\item
...
\tightlist
\item
  Help you maximise the \href{https://en.wikipedia.org/wiki/Return_on_investment}{return on investment} (ROI) of the substantial amount of your time and money you are putting (and have put) into your study
\item
...
\tightlist
\item
  \textbf{Married}\footnote{\ldots with kids} to the computing curriculum
\item
  Course textbook for COMP2CARS
\item
  Tailored to computing careers, see chapter \ref{computing}
\end{itemize}\strut
\end{minipage}\tabularnewline
\begin{minipage}[t]{(\columnwidth - 1\tabcolsep) * \real{0.50}}\raggedright
\begin{itemize}
...
\item
  Includes \href{https://en.wikipedia.org/wiki/Student_voice}{student voice}
\end{itemize}\strut
\end{minipage}\tabularnewline
\begin{minipage}[t]{(\columnwidth - 1\tabcolsep) * \real{0.50}}\raggedright
\begin{itemize}
...
You are reading the alpha version, the \href{https://en.wikipedia.org/wiki/Minimum_viable_product}{Minimum Viable Product} (MVP) of this guidebook, last updated on 11 April, 2022. That's software engineer talk for saying it isn't finished yet. Subsequent versions, will be continuously and iteratively released on a daily and weekly basis. They will include:
...
One of the main target audiences for this textbook is \href{https://en.wikipedia.org/wiki/Generation_Z}{Generation Z}, that's people born sometime between the mid-nineties to early 2000's. There's some evidence that Gen-Z-ers have a higher probability than previous generations of being, as \emph{The Economist} puts it:
...
If you're applying to big employers, you'll need to create a CV that is good enough to stand out before it disappears over the \href{https://en.wikipedia.org/wiki/Event_horizon}{event horizon} and into an employers black hole. It needs to be good enough to persuade an employer to invite you to an interview. You can start with an employer-agnostic CV but you may need to come back and revisit the issues in this chapter once you have identified some target employers, so that you can customise and tailor your CV and written applications.
...
\item
  \textbf{STYLE}: Does it look good, decent layout, appropriate use of LaTeX or Word or whatever? Are there any spelling mistakes, typos and grammar? Don't just rely on a spellchecker, some typos can only be \sout{spitted} spotted by a human reader see section \ref{spelling}
\item
...
Marjorie loves version control, she is has very high \href{https://en.wikipedia.org/wiki/Emotional_intelligence}{emotional intelligence}. Her superpower enables her to recognise emotions in herself and others then using that to resolve people's differences, see figure \ref{fig:margeconflict-fig}.
...
The best jobs are not always in the obvious places. The myth that all the best graduate jobs are in London (or Paris, Berlin, Silicon Valley etc) is clearly not the case, see figure \ref{fig:uuk-fig}.
...
So a simple way to broaden your future and open up more possibilities is to consider all the geographical options. Move your future: Hit the North, Hit the South, Hit the East, Hit the West! \citep{hitthenorth}
...
\hypertarget{week10}{%
\section{Week 10: Drop in session}\label{week10}}
