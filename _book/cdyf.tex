...
\item
  Most of the guidebook is generated from the \href{https://en.wikipedia.org/wiki/Markdown}{RMarkdown} (\texttt{*.Rmd}) files, so these are the files to edit because they generate everything else including the \texttt{*.html}, \texttt{*.pdf},\texttt{*.epub} and \texttt{*.docx}\\
\item
...
\item
  Fork the repository, make changes and submit a pull request \href{https://github.com/dullhunk/cdyf/pulls}{github.com/dullhunk/cdyf/pulls}, If you're not familiar with pull requests yet, see \href{http://makeapullrequest.com/}{makeapullrequest.com}
\item
...
You need this guidebook because it is different to all the other guidebooks! It will help you design, test, build, code and debug your future in computing. Come with me down the rabbit hole in figure \ref{fig:rabbit-fig} and let me explain while we reboot your future\ldots{} 🐇
...
You are reading the alpha version, the \href{https://en.wikipedia.org/wiki/Minimum_viable_product}{Minimum Viable Product} (MVP) of this guidebook, last updated on 27 May, 2021. That's software engineer talk for saying it isn't finished yet. Subsequent versions, will be continuously and iteratively released on a daily and weekly basis. They will include:
