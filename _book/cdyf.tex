...
\caption{Optimists will tell you that ``everyone has a book in them\ldots{}'', but pessimists like \href{https://en.wikipedia.org/wiki/Christopher_Hitchens}{Christopher Hitchens} will add that ``\ldots in most cases that's exactly where it should remain''. Despite Hitchens amusing trademark scepticism, I am optimistic about the power of natural languages. CC BY portrait of Christopher Hitchens by ensceptico via Wikimedia Commons \href{https://w.wiki/3YK7}{w.wiki/3YK7} adapted using the \href{https://apps.apple.com/us/app/wikipedia/id324715238}{Wikipedia app}}\label{fig:hitchens-fig}
\end{figure}



So thanks academics for being sceptical (figure \ref{fig:hitchens-fig}) and academic. 🙏
...
Thanks to all the \href{https://en.wikipedia.org/wiki/Wikipedia:Wikipedians}{thousands of editors}, administrators and engineers (see figure \ref{fig:wikipedians-fig}) that make Wikipedia one of the greatest triumphs of the internet.

\begin{figure}

{\centering \includegraphics[width=0.99\linewidth]{images/some-wikipedians-at-wikimania} 

}

\caption{A small fraction of the community that aims to give free access to the sum of all human knowledge to every single person on the planet. Some Wikipedians gathered at the annual \href{https://en.wikipedia.org/wiki/Wikimania}{Wikimania conference} 2019 in Stockholm, Sweden by Patricia Costillo, adapted from an original on Wikimedia Commons \href{https://w.wiki/3XxG}{wiki/3XxG}}\label{fig:wikipedians-fig}
\end{figure}



Thanks Wikipedians Caroline Ball, \href{https://en.wikipedia.org/wiki/Alex_Bateman}{Alex Bateman}, Dan Brickley, John Byrne, Daria Cybulska, Andrew Davidson, Paul Gardner, Melissa Highton, Darren Logan, \href{https://en.wikipedia.org/wiki/Magnus_Manske}{Magnus Manske}, \href{https://commons.wikimedia.org/wiki/User:Pigsonthewing}{Andy Mabbett}, Ewan McAndrew, Joshua Minor, \href{https://en.wikipedia.org/wiki/Peter_Murray-Rust}{Peter Murray-Rust}, Richard Nevell, Bhavesh Patel, Mike Peel, Martin Poulter, \href{https://en.wikipedia.org/wiki/Joseph_M._Reagle_Jr.}{Joseph Reagle}, Dario Taraborelli, Sara Thomas, \href{https://en.wikipedia.org/wiki/Denny_Vrande\%C4\%8Di\%C4\%87}{Denny Vrandečić}, \href{https://en.wikipedia.org/wiki/Jess_Wade}{Jessica Wade}, \href{https://en.wikipedia.org/wiki/Taha_Yasseri}{Taha Yasseri} for insights, \href{https://duncan.hull.name/2019/12/10/glasgow/}{inspiration}, \href{https://wiki-loves-scientists.org.uk/2020/05/21/wiki1000/}{support}, \href{https://apps.apple.com/us/app/wikipedia/id324715238}{software}, \href{https://www.wikidata.org/}{data}, \href{https://commons.wikimedia.org/}{pictures} and guidance. Thanks for help on issues of equality, diversity and inclusion, especially gender and race.
...
\item
  See chapters \ref{writing} and \ref{debugging}
\end{itemize}\strut
...
You are reading the alpha version, the \href{https://en.wikipedia.org/wiki/Minimum_viable_product}{Minimum Viable Product} (MVP) of this guidebook, last updated on 25 June, 2021. That's software engineer talk for saying it isn't finished yet. Subsequent versions, will be continuously and iteratively released on a daily and weekly basis. They will include:
...
\caption{Too long, didn't read? Each chapter in this guidebook has a summary at the end. Public domain picture of ancient greek \href{https://en.wikipedia.org/wiki/Muses}{muse} reading a scroll that's probably too long via Wikimedia Commons \href{https://w.wiki/3Xoh}{w.wiki/3Xoh} adapted using the \href{https://apps.apple.com/us/app/wikipedia/id324715238}{Wikipedia app}}\label{fig:tldr-fig}
\end{figure}
...
Let's pause here. Insert a \href{https://en.wikipedia.org/wiki/Breakpoint}{breakpoint} in your \texttt{code} and slowly step through it so we can examine the values of your variables and parameters.
...
\caption{\href{https://en.wikipedia.org/wiki/LinkedIn}{Linkedin} is a service which allows employers to advertise job vacancies online and candidates like you to apply for them. Social media caveats aside (see section \ref{signposts3}), LinkedIn can be useful tool for networking with other professionals and finding a job. Image via Wikimedia Commons adapted using the \href{https://apps.apple.com/us/app/wikipedia/id324715238}{Wikipedia app}}\label{fig:linkedin-fig}
\end{figure}
...
\caption{Beware of false or misleading information in the jobs marketplace. Are employers \emph{really} as good as they say they are? Are \emph{you} as good as you say you are? Or is it \href{https://en.wikipedia.org/wiki/Fake_news}{fake news}? Public domain official portrait of \href{https://en.wikipedia.org/wiki/Donald_Trump}{Donald Trump} taken by \href{Shealah\%20Craighead}{Shealah Craighead} via Wikimedia Commons \href{https://w.wiki/3XoY}{w.wiki/3XoY} adapted using the \href{https://apps.apple.com/us/app/wikipedia/id324715238}{Wikipedia app}}\label{fig:fakenews-fig}
\end{figure}
...
Salaries in the UK for interns (and graduates) range from \href{https://www.gov.uk/national-minimum-wage}{minimum wage} to £50k and over, with everything in between. So beware of under-selling yourself, know your value.
...
The phrase software engineering has been around since \href{https://en.wikipedia.org/wiki/Margaret_Hamilton_(software_engineer)}{Margaret Hamilton} (figure \ref{fig:hamilton-fig}) wrote code for NASA's Apollo program, and the practice of software engineering has been around even longer.
...
\caption{The role of software engineer has been around for a long time but there are plenty of other roles for computer scientists beyond software engineering. \href{https://en.wikipedia.org/wiki/Margaret_Hamilton_(software_engineer)}{Margaret Hamilton} in 1969 standing next to the (printed) navigation software that she and her MIT team produced for the Apollo program. Public domain image via Wikimedia Commons \href{https://w.wiki/3YJW}{w.wiki/3YJW} adapted using the \href{https://apps.apple.com/us/app/wikipedia/id324715238}{Wikipedia app}}\label{fig:hamilton-fig}
\end{figure}
...
Leading with verbs is a simple but powerful technique that enables you to provide evidence (rather than assertion) for the skills and knowledge you have. Choose your verbs carefully. Any missing verbs may help you identify gaps in your professional and personal development.
