...
\item
  \textbf{\texttt{D\ is\ for\ DATA}}: Facts, statistics, graphs and pictures collected together for your analysis
\item
  \textbf{\texttt{Y\ is\ for\ YOU}}: This book is all about you, with activities and other \emph{coding challenges} for you to do in addition to just reading
\item
...
{\centering \includegraphics[width=0.79\linewidth]{images/Hello-my-name-is-Duncan} 
...
If you like what you're reading here, I'd really appreciate some \href{https://stars.github.com/}{stars.github.com} at \href{https://github.com/dullhunk/cdyf}{github.com/dullhunk/cdyf} to help people find us. 🤩⭐️🤩
...
You are reading the alpha version, the \href{https://en.wikipedia.org/wiki/Minimum_viable_product}{Minimum Viable Product} (MVP) of this guidebook, last updated on 15 July, 2022. That's software engineer talk for saying it isn't finished yet. Subsequent versions, will be continuously and iteratively released on a daily and weekly basis. They will include:
...
\caption{Just like the \href{https://en.wikipedia.org/wiki/Death_Star}{Death Star}, this \sout{galactic superweapon} book is under construction. As of 15 July, 2022 this book is an estimated \textbf{35\% complete}. Image of agile weapon engineering in \emph{Star Wars} via Wikimedia Commons \href{https://w.wiki/5N6q}{w.wiki/5N6q} adapted using the \href{https://apps.apple.com/gb/app/wikipedia/id324715238}{Wikipedia app}}\label{fig:deathstar-fig}
\end{figure}
...
\emph{Hearing your Future} is the Coding your Future podcast where we talk to students of computer science to hear more about their journey from student to professional. What happens after graduation like the one shown in figure \ref{fig:graduation-fig}? What comes next?
...
You can subscribe by searching for \texttt{Coding\ your\ Future} or \texttt{Hearing\ your\ Future} from your podcast provider. You will see the logo shown in figure \ref{fig:hearing-fig} when you search for it, or you can just follow one of the links below to your favourite podcast tool:
...
\begin{figure}
\includegraphics[width=0.32\linewidth]{images/sneha} \includegraphics[width=0.32\linewidth]{images/sneha} \includegraphics[width=0.32\linewidth]{images/sneha} \caption{Sneha Kandane. Picture reused from \href{https://www.linkedin.com/in/sneha-kandane-931346183/}{linkedin.com/in/sneha-kandane-931346183} with permission, thanks Sneha.}\label{fig:sneha2-fig}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.32\linewidth]{images/carmen} \includegraphics[width=0.32\linewidth]{images/carmen} \includegraphics[width=0.32\linewidth]{images/carmen} \caption{Carmen Faura Práxedes. Picture reused from \href{https://www.linkedin.com/in/carmen-faura/}{linkedin.com/in/carmen-faura} with permission, thanks Carmen.}\label{fig:carmen2-fig}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.32\linewidth]{images/brian} \includegraphics[width=0.32\linewidth]{images/brian} \includegraphics[width=0.32\linewidth]{images/brian} \caption{Brian Yim Tam. Picture reused with permission from \href{hhttps://www.linkedin.com/in/byt411/}{linkedin.com/in/byt411}, thanks Brian.}\label{fig:brian2-fig}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.32\linewidth]{images/jason} \includegraphics[width=0.32\linewidth]{images/jason} \includegraphics[width=0.32\linewidth]{images/jason} \caption{Jason Ozuzu. Picture reused with permission from \href{https://www.linkedin.com/in/jason-ozuzu-a87049173/}{linkedin.com/in/jason-ozuzu-a87049173}, thanks Jason.}\label{fig:jason2-fig}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.32\linewidth]{images/raluca} \includegraphics[width=0.32\linewidth]{images/raluca} \includegraphics[width=0.32\linewidth]{images/raluca} \caption{Raluca Cruceru is a software engineer at CERN, standing here in front of \href{https://en.wikipedia.org/wiki/ALICE_experiment}{A Large Ion Collider Experiment (ALICE)} part of the Large Hadron Collider at CERN, see \href{https://careers.cern/Raluca}{careers.cern/Raluca}. Picture reused with permission from \href{https://www.linkedin.com/in/raluca-cruceru/}{linkedin.com/in/raluca-cruceru}, thanks Raluca.}\label{fig:raluca2-fig}
\end{figure}

\hypertarget{you}{%
\section{\texorpdfstring{Episode \(x\): it could be YOU!}{Episode x: it could be YOU!}}\label{you}}

YOUR FUTURE WANTS YOU: Join your future! If you'd like to be interviewed for the show, \href{https://personalpages.manchester.ac.uk/staff/duncan.hull/contact}{get in touch}, see figure \ref{fig:yfnu-fig}. Besides interviewing current graduates, I'm interested in speaking to former graduates, especially those that did placements or internships as undergraduate or postgraduate students. I'm also interested in speaking to people who graduated a while back, not just this years graduates, but any back to 1965. 🎓 \citep{babygrowsup}
...
All your dreams are made, when you're chained to \href{https://en.wikipedia.org/wiki/Comparison_of_issue-tracking_systems}{the tracker} and the software trade, see figure \ref{fig:gallagher2-fig}. What's your story, coding glory?
...
Inspired by the \href{https://en.wikipedia.org/wiki/Philip_K._Dick}{Philip K. Dick} novel \emph{The Minority Report} and subsequent film adaptation, see figure \ref{fig:minority-fig}, minority report asks:

\begin{itemize}
\tightlist
\item
  Are you a member of a minority group? If so which one(s)?
\item
  What has your experience been at University and in the workplace?
\item
  How can teaching and learning be made more \href{https://en.wikipedia.org/wiki/Diversity,_equity,_and_inclusion}{equitable, diverse and inclusive} for members of your minority group(s)?
\item
  What else can universities do to make campuses more welcoming to members of your minority group(s)?
\item
  What can employers do to make workplaces more welcoming to members of your minority group(s)?
\end{itemize}
...
We love our tunes, podcasts and films and make gratuitous references to them throughout \emph{Coding your Future}. Critics say our playlist is clogged up with \href{https://en.wikipedia.org/wiki/Dad_rock}{DadRock}, cardigan-swinging indie \href{https://en.wikipedia.org/wiki/Shoegaze}{shoegazing}, Lancashire boy bands (both the Mancs and the Scousers) alongside other antiques from a bygone era. \citep{dadrock} So can you recommend us:

\begin{itemize}
\tightlist
\item
  \textbf{TUNE!} One tune to rejuvenate and freshen up our playlist. Why is it important to you? Perhaps it makes you relax, feel happy or comforted? Maybe it reminds you of special people, a special time or special place in your life? \href{https://en.wikipedia.org/wiki/Sign_of_the_horns}{🤘}🎸
\item
...
This podcast is inspired and supported by \href{https://www.linkedin.com/in/jez-lloyd-84077069}{Jez Lloyd}, host, producer and mastermind of the excellent CS@Manchester podcast. Thanks Jez! 🙏

\begin{figure}
\href{https://www.podomatic.com/podcasts/cs-engagement}{\includegraphics[width=1\linewidth]{cdyf_files/figure-latex/include-url-1} }\caption{The CS@Manchester podcast was produced and hosted by Jez Lloyd and ran from 2015 to 2020. This podcast, \emph{Hearing your future}, is following in all 38 of its audible footsteps, see \href{https://www.podomatic.com/podcasts/cs-engagement}{podomatic.com/podcasts/cs-engagement}}\label{fig:include-url}
\end{figure}
...
\caption{Raluca Cruceru is a software engineer at CERN, standing here in front of \href{https://en.wikipedia.org/wiki/ALICE_experiment}{A Large Ion Collider Experiment (ALICE)} part of the Large Hadron Collider at CERN, see \href{https://careers.cern/Raluca}{careers.cern/Raluca}. Picture reused with permission from \href{https://www.linkedin.com/in/raluca-cruceru/}{linkedin.com/in/raluca-cruceru}, thanks Raluca.}\label{fig:raluca-fig}
\end{figure}
