...
\tightlist
\item
  Add comments by annotating \href{https://www.cdyf.me/cdyf.pdf}{cdyf.pdf} using your weapon of choice (iPad, \href{https://en.wikipedia.org/wiki/ReMarkable}{reMarkable} or whatever) and \href{http://www.cs.man.ac.uk/~hulld/contact.html}{emailing your updated version to me}
\item
...
Any corrections or suggestions will be thankfully noted in the acknowledgements section \ref{thanks}, unless you tell me otherwise. I welcome all improvements, big and small.
...
You are reading the alpha version, the \href{https://en.wikipedia.org/wiki/Minimum_viable_product}{Minimum Viable Product} (MVP) of this guidebook, last updated on 21 May, 2021. That's software engineer talk for saying it isn't finished yet. Subsequent versions, will be continuously and iteratively released on a daily and weekly basis. They will include:
...
Those project names are pretty opaque and don't give the reader much to go on. What was the story (the context, action and result (CAR) we described in section \ref{carstar}) of those projects? How many people were in your team? How long did you collaborate for? What did you build? What was it called? What did it do? What roles and responsibilities did you have in the team? Was their conflict in the team? How did you resolve it? How did you motivate the free-riders in the team to contribute?
...
\tightlist
\item
  ✅ Has it been reviewed by several people? Given enough eyeballs all bugs are shallow
\item
...
\item
  ✅ Does the style look good? Is it easy on the eye?
\item
...
\item
  ✅ Is your year of graduation, degree program, University and expected (or achieved) overall degree classification clear?
\item
...
\item
  ✅ Is it balanced, including technical and non-technical soft skills? See section \ref{casual}
\item
