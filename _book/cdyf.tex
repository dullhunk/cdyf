...
The third part of this book, looks at deployment issues that follow from you design, build and test phases above. You'll need good deployment strategies to help with the inevitable stresses and strains of building your future as shown in \ref{fig:clifton-fig}
...
You are reading the alpha version, the \href{https://en.wikipedia.org/wiki/Minimum_viable_product}{Minimum Viable Product} (MVP) of this guidebook, last updated on 30 November, 2022. That's software engineer talk for saying \emph{it isn't finished yet}. Subsequent versions, will be continuously and iteratively released on a daily and weekly basis. They will include:
...
\caption{Just like the \href{https://en.wikipedia.org/wiki/Death_Star}{Death Star}, this \sout{galactic superweapon} book is under construction. As of 30 November, 2022 this book is an estimated \textbf{37\% complete}. Image of agile weapon engineering in \emph{Star Wars} via Wikimedia Commons \href{https://w.wiki/5N6q}{w.wiki/5N6q} adapted using the \href{https://apps.apple.com/gb/app/wikipedia/id324715238}{Wikipedia app}}\label{fig:deathstar-fig}
\end{figure}
...
\item
  \textbf{NUMBERS}: Have you \emph{quantified} the context, action, results and evidence on your CV where possible? See (\texttt{C.A.R.E.}) in section \ref{care}
\item
...
Again, congratulations, but third place out of how many: \texttt{3/3}? Not so impressive. \texttt{3/30}? \texttt{3/300}? \texttt{3/3000}? More impressive. Numbers make a big difference so if you're going to mention awards, quantify\footnote{even an approximation will do} where you can so the reader can understand what the prize was for. You may well be intimately acquaited with the \href{https://en.wikipedia.org/wiki/Flibbertigibbet}{flibbertigibbet} competition but your reader probably won't of heard of it, so give some context. 🏆
