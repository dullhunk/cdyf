...
Thank you \href{https://en.wikipedia.org/wiki/Carole_Goble}{Carole Goble} for building the community that supported me through postgraduate study. Thanks for creating the environment which this book was written in, especially the Information Management Group (IMG), Software Sustainability Institute (\href{https://software.ac.uk/}{software.ac.uk}) and their spin-offs. Thanks for patiently re-teaching me how to write by covering early drafts of my Masters thesis in red ink and less patiently (on subsequent revisions) swear words. 🤬
...
So thanks Stockport for the magnificent \href{https://en.wikipedia.org/wiki/Stockport_Viaduct}{Stockport Viaduct} and for \href{https://en.wikipedia.org/wiki/Stockport_County_F.C.}{The Hatters}: It's all that matters, Stockport Hatters. 🙏
...
Thanks to the British Universities North America Club (\href{https://en.wikipedia.org/wiki/BUNAC}{BUNAC}) for sponsoring my \href{https://travel.state.gov/content/travel/en/us-visas/study/exchange.html}{Exchange Visitor Student Visa} which allowed me to cook breakfasts for summer guests at the \href{https://www.oceancity.com/end-of-an-era-beach-plaza-hotel-closing-permanently/}{Phillips Beach Plaza Hotel} in \href{https://en.wikipedia.org/wiki/Ocean_City,_Maryland}{Ocean City, Maryland}. Thanks to Andy B. for flagging it. 🇺🇸
...
\item
  ...
  \item
    Bosco Ho at \href{https://boscoh.com/}{boscoh.com}
  \item
...
You are reading the alpha version, the \href{https://en.wikipedia.org/wiki/Minimum_viable_product}{Minimum Viable Product} (MVP) of this guidebook, last updated on 17 February, 2022. That's software engineer talk for saying it isn't finished yet. Subsequent versions, will be continuously and iteratively released on a daily and weekly basis. They will include:
...
Marjorie loves version control, she is has very high \href{https://en.wikipedia.org/wiki/Emotional_intelligence}{emotional intelligence} and her superpower is resolving people's differences, see figure \ref{fig:margeconflict-fig}.
