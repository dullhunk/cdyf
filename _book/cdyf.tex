...
\tightlist
\item
  \emph{Coding your Future} (COMP2ARS and COMP2TUT) takes place on Mondays at midday, see \href{https://timetables.manchester.ac.uk/}{timetables.manchester.ac.uk} for details, the only exception is in welcome week, see section \ref{week0}
\end{itemize}
