...
\item
  Not used for teaching, not embedded in curriculum \textbar{} - Course textboo
\item
...
\item
  ...
  k for COMP2CARS, embedded in the curriculum
\item
...
You are reading the alpha version, the \href{https://en.wikipedia.org/wiki/Minimum_viable_product}{Minimum Viable Product} (MVP) of this guidebook, last updated on 29 July, 2022. That's software engineer talk for saying \emph{it isn't finished yet}. Subsequent versions, will be continuously and iteratively released on a daily and weekly basis. They will include:
...
\caption{Just like the \href{https://en.wikipedia.org/wiki/Death_Star}{Death Star}, this \sout{galactic superweapon} book is under construction. As of 29 July, 2022 this book is an estimated \textbf{35\% complete}. Image of agile weapon engineering in \emph{Star Wars} via Wikimedia Commons \href{https://w.wiki/5N6q}{w.wiki/5N6q} adapted using the \href{https://apps.apple.com/gb/app/wikipedia/id324715238}{Wikipedia app}}\label{fig:deathstar-fig}
\end{figure}
...
\item
  \emph{\href{https://en.wikipedia.org/wiki/Uptown_Funk}{Uptown Funk}} by \href{https://en.wikipedia.org/wiki/Mark_Ronson}{Mark Ronson} \citep{uptownfunk} is in this playlist because Aidan Blowers use of music in teaching has inspired me, see section \ref{st-laurence} \citep{blowers} Thanks Aidan 🙏
\end{enumerate}
...
\hypertarget{lancs}{%
\section{The Lancashire playlist}\label{lancs}}
...
We'll leave the last words on podcasting to \emph{\href{https://en.wikipedia.org/wiki/The_Buggles}{The Buggles}} and \emph{\href{https://en.wikipedia.org/wiki/Queen_(band)}{Queen}}. Podcasting an evolution and mutation of radio but did video kill the radio star? \citep{videokilled} What if everything you had to know, you could hear it on your radio, see figure \ref{fig:gaga-fig}? Tune in to find out.
...
So you've done a summer job Web applications UK, which is now called, they've changed their name now to \href{https://www.koder.ly/}{Koder.ly} with a \texttt{K}. So, you've got, you've got a sort of broad exposure to different sort of software engineering ideas, I guess, working in a team and that kind of stuff.
...
\hypertarget{advice-to-your-former-self}{%
\section{Advice to your former self}\label{advice-to-your-former-self}}
...
\hypertarget{jasontravel}{%
\section{Advice to your former self}\label{jasontravel}}
...
\hypertarget{one-tune-1}{%
\section{One tune}\label{one-tune-1}}
