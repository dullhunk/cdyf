...
\item
  Click on the \texttt{Edit\ this\ page} link, which appears on the right hand side of every page published at \href{https://www.cdyf.me}{cdyf.me}
\item
...
\caption{Keep the header of your CV simple. Just your name, email phone number and any relevant links are all you really need. Anything additional information risks wasting valuable space and distracting your reader.}\label{fig:turinghead-fig}
\end{figure}
...
\item
  ✅ Have you added context using relevant hyperlinks than an interested reader can click on? See section \ref{links}
\item
...
\item
  ✅ Does it fit comfortably on exactly one page (resume) or a two pages (CV)? Not 1.5 pages or more than two? See section \ref{length}
\end{enumerate}
