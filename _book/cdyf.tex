...
The TL;DR for this chapter is, you should read this guidebook to maximise your future, it is your own responsibility to do so. No-one else is going to do this for you. You degree will help open up your career, but it is not enough by itself. It's too late when you graduate and \emph{YES} this will be on the exam (set by future employers). There are signposts to help you navigate, design, build, test, debug and code your future in computing. Bon voyage! 🇫🇷
...
\caption{``Start where you are, use what you have, help who you can.'' ---Greg Wilson at \href{https://third-bit.com/}{third-bit.com} and \href{https://software-carpentry.org/}{software-carpentry.org}. CC BY Portrait of Greg Wilson by Chris Fournier on Wikimedia Commons \href{https://w.wiki/3Zy6}{w.wiki/3Zy6} adapted using the \href{https://apps.apple.com/gb/app/wikipedia/id324715238}{Wikipedia App}.}\label{fig:greg-wilson-fig}
\end{figure}



When you're job hunting you can sometimes fall into thinking:

\begin{itemize}
\tightlist
\item
  ``If I had a better, different degree from a different university, I'd be more sucessful\ldots{}'' see section \ref{entitled}
\item
  ``If I had more experience, more voluntary work, more internships, I'd stand a better chance\ldots{}'' see section \ref{areuexperienced}
\item
  ``If I'd done more projects and extra-curricular activities\ldots{}'' etc see section \ref{mycvpj}
\end{itemize}

This is all nonsense from your inner critic that you can safely ignore, see section \ref{lays}. Start from where you are, use whatever you have and help who you can.
