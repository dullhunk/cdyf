...
This guidebook will NOT teach you how to write code, there's already lots of fantastic resources to help you do that. We discuss some of them in chapter @ref\{coding\} on \emph{computing your future}.
...
If you'd like to contribute this guidebook, I welcome constructive feedback. There are lots of ways you can contribute to this guide:
...
\item
  Suggest changes via the (old school) Microsoft Word version at \href{http://cdyf.me/cdyf.docx}{cdyf.docx}. The text is all there, but the pagination and graphic placement isn't always pretty.\footnote{Don't say I didn't warn you!} Make sure you've turned on \href{https://support.microsoft.com/en-us/office/track-changes-in-word-197ba630-0f5f-4a8e-9a77-3712475e806a}{track changes} if you suggest changes via Word.
\item
  If you don't want to use github or Word, just \href{http://www.cs.man.ac.uk/~hulld/contact.html}{email me suggestions for improvements}
\end{itemize}

Any corrections or suggestions that get included will be fully acknowledged in the acknowledgements section \ref{thanks}, unless you tell me otherwise. I welcome all improvements, however small.
...
Get credit for your contributions. As well as being openly accessible on the web, this book is open source too. What this means is, you can contribute in several ways described in section \ref{contributing}. All the written content for this guidebook is licensed under CC-BY-NC-ND, see the license.
...
Whatever job you're doing, stay in school. Take advantage of any training on offer or go and find courses online that help you develop professionally and personally.
...
\caption{Your network can help you before, during and after your employment, so be sure to grow your network when you can. \href{https://bryanmmathers.com/its-all-about-people/}{It's all about people} by \href{https://visualthinkery.com/}{Visual Thinkery} is licensed under \href{https://creativecommons.org/licenses/by-nd/4.0/}{CC-BY-ND}}\label{fig:allpeople-fig}
\end{figure}
...
\caption{What actions have you taken and what stories can you tell about the results and your impact? \href{https://bryanmmathers.com/your-actions-define-your-impact/}{Your actions define your impact} by \href{https://visualthinkery.com/}{Visual Thinkery} is licenced under \href{https://creativecommons.org/licenses/by-nd/4.0/}{CC-BY-ND}}\label{fig:action-fig}
\end{figure}
...
\item
  Where are the verbs?
\item
  Are verbs buried deep in long sections of prose or do they prominently lead description of your activities?
\item
...
You might find it a bit scary thinking about your future. You might be tempted to procrastinate making important decisions as you head into the great unknown world of employment, see figure \ref{fig:schedule-fig}. This guidebook and the live \emph{Coding your Future} (COMP2CARS) sessions are here to help.
...
\caption{The biggest waste of time is the time spent not getting started on a project, and that includes your future. \href{hhttps://bryanmmathers.com/new-project-every-time/}{New Project? Every time\ldots{}} by \href{https://visualthinkery.com/}{Visual Thinkery} is licenced under \href{https://creativecommons.org/licenses/by-nd/4.0/}{CC-BY-ND}}\label{fig:schedule-fig}
\end{figure}
