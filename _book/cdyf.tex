...
\item
  Most of the guidebook is generated from the \href{https://en.wikipedia.org/wiki/Markdown}{RMarkdown} (\texttt{*.Rmd} files), so these are the only files you need to edit because they generate everything else including the \texttt{*.html}, \texttt{*.tex}, \texttt{*.pdf},\texttt{*.epub} and \texttt{*.docx} files
\item
...
You are reading the alpha version, the \href{https://en.wikipedia.org/wiki/Minimum_viable_product}{Minimum Viable Product} (MVP) of this guidebook, last updated on 01 June, 2021. That's software engineer talk for saying it isn't finished yet. Subsequent versions, will be continuously and iteratively released on a daily and weekly basis. They will include:
...
\tightlist
\item
  Raise an issue via the projct's issue tracker, such as \href{https://guides.github.com/features/issues/}{github issues} \citep{githubissues}
\item
...
\caption{Rejection is a normal part of applying for jobs, some of your application may disappear without trace into employers black holes, especially if they are large and have a strong gravitational force on job applicants. CC-BY image of the core the black hole in \href{https://en.wikipedia.org/wiki/Messier_87}{Messier 87} by the \href{Event\%20Horizon\%20Telescope}{Event Horizon Telescope} team via Wikimedia Commons \href{https://w.wiki/3RCa}{w.wiki/3RCa}}\label{fig:blackhole-fig}
\end{figure}
