...
This acknowledgements section is long because I try to practice what I preach about the importance of expressing gratitude, see section \ref{lays} and \ref{signposts3}. It also serves as a live demonstration of a public \href{https://en.wikipedia.org/wiki/Gratitude_journal}{gratitude journal}. If you want to cut to the chase of this book you can skip this and go straight to chapter \ref{rebooting}.
...
You are reading the alpha version, the \href{https://en.wikipedia.org/wiki/Minimum_viable_product}{Minimum Viable Product} (MVP) of this guidebook, last updated on 20 December, 2021. That's software engineer talk for saying it isn't finished yet. Subsequent versions, will be continuously and iteratively released on a daily and weekly basis. They will include:
