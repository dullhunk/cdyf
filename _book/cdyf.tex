...
\item
  \href{http://news.bbc.co.uk/local/gloucestershire/hi/people_and_places/newsid_8741000/8741279.stm}{Vicky Tuck} at \href{https://en.wikipedia.org/wiki/Cheltenham_Ladies\%27_College}{Cheltenham Ladies' College}, Cheltenham, Gloucestershire. This was tge first time I'd set foot in a private school, making it through \href{https://en.wikipedia.org/wiki/Checkpoint_Charlie}{Checkpoint Charlie} to cross Michael Gove's \href{https://en.wikipedia.org/wiki/Berlin_Wall}{Berlin Wall} of education. It was an enlightening experience! \citep{berlinwall, cheltenham}
\item
...
You are reading the alpha version, the \href{https://en.wikipedia.org/wiki/Minimum_viable_product}{Minimum Viable Product} (MVP) of this guidebook, last updated on 30 May, 2022. That's software engineer talk for saying it isn't finished yet. Subsequent versions, will be continuously and iteratively released on a daily and weekly basis. They will include:
