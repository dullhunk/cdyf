...
You are reading the alpha version, the \href{https://en.wikipedia.org/wiki/Minimum_viable_product}{Minimum Viable Product} (MVP) of this guidebook, last updated on 26 May, 2021. That's software engineer talk for saying it isn't finished yet. Subsequent versions, will be continuously and iteratively released on a daily and weekly basis. They will include:
...
\item
  ✅ Has you got a second opinion from a ``resume robot''? Is it robot proof? See section \ref{robotproof} 🤖
\item
...
\item
  working in computing but not just be a software engineer?
\end{itemize}
