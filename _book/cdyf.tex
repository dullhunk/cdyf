...
Pictures help us explain. Pictures help you to understand. Pictures help you imagine. So this book uses pictures (and conversations) to help you imagine and visualise your future.
...
\tightlist
\item
  \textbf{Code:} Instructions, algorithms, recipes and strategies contained in this guidebook. This \texttt{code} is designed for consumption by humans not machines. Meatspace not cyberspace
\item
...
The TL;DR for this chapter is, you should read this guidebook to maximise your future, it is your own responsibility to do so. No-one else is going to do this for you. Your degree will help open up future options, but it is not enough by itself you'll need to maximise the return on your investment. If you're a procrastinator, it's too late when you graduate and \emph{YES} this will be on the exam (set by future employers). There are signposts to help you navigate, design, build, test, debug and code your future in computing. \href{https://en.wikipedia.org/wiki/Bon_Voyage}{Bon voyage}! 🇫🇷
...
\item
  ``\emph{If I'd been to a different school, I could be more successful\ldots{}}'' see the \href{https://www.93percent.club/}{93percent.club}
\end{itemize}

Coulda. Woulda. Shoulda. This is all nonsense from your inner critic that you can safely ignore, see section \ref{lays}. Start from where you are, use whatever you have and help who you can.
...
Part of what you learn during your education is \emph{how} to learn. But your learning shouldn't finish when you leave University. Computer science is a young and rapidly changing discipline which means you can not afford to be left behind. Never stop learning, see chapter \ref{achieving}.
