...
You need this guidebook because it is different to all the other guidebooks! It will help you design, test, build, code and debug your future in computing. Come with me down the rabbit-hole in Figure \ref{fig:rabbit-fig} and let me explain while you reboot\ldots{} 🐇
