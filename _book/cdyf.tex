...
Hello and welcome to \emph{Coding Your Future} (\href{https://www.cdyf.me}{cdyf.me}) the guidebook that will help you to design, build, test and \texttt{code} your future in computing. Also published at \href{https://www.cdyf.me/cdyf.pdf}{cdyf.pdf} \& \href{https://www.cdyf.me/cdyf.epub}{cdyf.epub}, this book is aimed at ALL students in higher education. This guide supports undergraduate teaching at the University of Manchester, but it doesn't actually matter:
...
A lot of self-help literature can be dry, dull, textbooky and boring with few illustrations and conversations. In the novel \emph{\href{https://en.wikipedia.org/wiki/Alice\%27s_Adventures_in_Wonderland}{Alice's Adventures in Wonderland}} \citep{wonderland} shown in figure \ref{fig:aiw-fig}, the protagonist Alice wonders why her sister is reading a book without pictures.
...
\caption{Don't read this book, gut it like a fish. \href{https://en.wikipedia.org/wiki/Disembowelment}{Disembowel it}. Eviscerate it. You will need to decide which parts are flesh and which are guts. CC0 Public domain image of fish gutting by Wilfredor via Wikimedia commons \href{https://w.wiki/_23m}{w.wiki/\_23m} adapted using the \href{https://apps.apple.com/gb/app/wikipedia/id324715238}{Wikipedia app}}\label{fig:gut-fig}
\end{figure}
...
Most of the guidebook is generated from the \href{https://en.wikipedia.org/wiki/Markdown}{RMarkdown} (that's the \texttt{*.Rmd} files). Markdown files are the only ones you should need to edit because everything else is generated from them including the \texttt{*.html}, \texttt{*.tex}, \texttt{*.pdf},\texttt{*.epub} and \texttt{*.docx} files.
...
\caption{Named after its \href{https://en.wikipedia.org/wiki/Roman_Baths_(Bath)}{Roman Baths}, \href{https://en.wikipedia.org/wiki/Bath,_Somerset}{Bath} is the largest city in the county of Somerset, England. The city is home to the University of Bath which was named University of the year by \emph{The Sunday Times} in 2011. Picture of \href{https://en.wikipedia.org/wiki/Pulteney_Bridge}{Pulteney Bridge} by Diego Delso CC BY-SA via Wikimedia Commons at \href{https://w.wiki/3VWY}{w.wiki/3VWY} adapted using the Wikipedia app}\label{fig:bath-fig}
\end{figure}
...
\caption{Good governance is crucial to good schools. Many schools like St.~Anne's, and the hundreds of children they educate every year, need help from skilled people on their governing boards. Why not serve your local community as a ``\href{https://en.wikipedia.org/wiki/Critical_friend}{critical friend}'' on the governing board of a school? All ages are welcome, but especially younger governors, see \href{https://www.theguardian.com/teacher-network/2015/mar/11/young-people-school-governors}{Where are all the young school governors?} \citep{youngovernors} Take a look at \href{https://governorsforschools.org.uk/}{governorsforschools.org.uk}. Fair use image via Wikimedia Commons \href{https://w.wiki/3Swt}{w.wiki/3Swt} made with the \href{https://apps.apple.com/us/app/wikipedia/id324715238}{Wikipedia app}}\label{fig:st-annes-fig}
\end{figure}
...
You will spend lots of time in this wonderland, potentially as much as 80,000 hours of your life. \citep{iip1, iip2} So join me down the rabbit hole, it's fun (honest), and sooner or later you'll have to come down here anyway.
...
\caption{The attitude ``I'll get my degree out of the way first then worry about jobs and careers when I finish University'' is bad procrastination. It's too late when you graduate to start thinking about what comes next \citep{procrastination} Stresssed procrastinator picture by MismibaTinasheMadando on Wikimedia Commons \href{https://w.wiki/3TXo}{w.wiki/3TXo}}\label{fig:procrastination-fig}
\end{figure}
...
You are reading the alpha version, the \href{https://en.wikipedia.org/wiki/Minimum_viable_product}{Minimum Viable Product} (MVP) of this guidebook, last updated on 16 June, 2021. That's software engineer talk for saying it isn't finished yet. Subsequent versions, will be continuously and iteratively released on a daily and weekly basis. They will include:
...
\caption{\href{https://en.wikipedia.org/wiki/Storytelling}{Storytelling} is an ancient art. Who doesn't love a good story? What's your story, coding glory? As a species \emph{Homo sapiens}, we need to tell and hear stories to understand the world around us. Public domain image of a painting by John Everett Millais, with a seafarer telling the story of what happened out at sea, via Wikimedia Commons \href{https://w.wiki/3VHM}{w.wiki/3VHM}}\label{fig:storytelling-fig}
\end{figure}
...
\caption{Just like the \href{https://en.wikipedia.org/wiki/Death_Star}{Death Star}, this \sout{galactic superweapon} chapter is under construction. Image of agile weapon engineering via Wikimedia Commons \href{https://w.wiki/32PB}{w.wiki/32PB} adapted using the \href{https://apps.apple.com/gb/app/wikipedia/id324715238}{Wikipedia app}}\label{fig:deathstar-fig}
\end{figure}
...
Whatever future world you enter into after you graduate, there's a good chance it has already been eaten by software. In 2011, the software engineer and billionaire investor \href{https://en.wikipedia.org/wiki/Marc_Andreessen}{Marc Andreesen} shown in figure \ref{fig:eating-fig} explained why software is eating the world, in the \emph{Wall Street Journal} \citep{eatingtheworld}.
...
\caption{Do you have bugs or \href{https://en.wikipedia.org/wiki/Undocumented_feature}{undocumented features} on your CV or resume? Although tolerated in software, bugs in your CV or resume can be fatal. Picture of gold-dust weevil \emph{Hypomeces squamosus} by \href{https://commons.wikimedia.org/wiki/User:Basile_Morin}{Basile Morin} is licensed CC BY SA 4.0 via Wikimedia Commons \href{https://w.wiki/3E62}{w.wiki/3E62}}\label{fig:notabug-fig}
\end{figure}
...
One way to structure descriptions of items within each section of your CV is to use \textbf{C}ontext, \textbf{A}ction and \textbf{R}esult (CAR) sometimes called STAR (\textbf{S}ituation \textbf{T}ask \textbf{A}ction \textbf{R}esult) to tell your stories. This method can also be useful for structuring answers to interview questions, especially if you get nervous. So for example, rather than just listing \texttt{Python} as a skill, you should tell the reader more about the context in which you've used python, what you actually did with it and what the result was. You really need to spell it out.
...
\caption{I would have written a shorter \sout{letter}, \sout{CV}, Résumé but I did not have the time. This quote (or meme) is frequently attributed to Blaise Pascale in his \emph{\href{https://en.wikipedia.org/wiki/Lettres_provinciales}{Lettres provinciales}} \citep{shorterletter} Public domain image by Gallica on Wikimedia Commons \href{https://w.wiki/3Uzn}{w.wiki/3Uzn}}\label{fig:shorterletter-fig}
\end{figure}
...
\caption{The autocomplete algorithm of a well known search engine gives you an idea of what \emph{some} people think about \emph{some} recruiters. This doesn't mean you should avoid them completely, just be careful how you use them and remember who they work for.}\label{fig:recruiter-fig}
\end{figure}
...
\caption{Beware of \href{https://en.wikipedia.org/wiki/Fake_news}{fake news} and misleading information in the jobs marketplace. Are employers \emph{really} as good as they say they are? Are \emph{you} as good as you say you are? Public domain cartoon by Frederick Burr Opper via Wikimedia Commons \href{https://w.wiki/3KKt}{w.wiki/3KKt}}\label{fig:fakenews-fig}
\end{figure}
...
There are highs and lows in job hunting, you will ride the job search rollercoaster shown in figure \ref{fig:rollercoaster-fig}. There will be highs, you'll be invited to interviews, but there will be also be lows too, such as rejection in section \ref{rejection}. It will be a rollercoaster, which ends on the high of a job offer you accept. Enjoy the ride and good luck with your applications and interviews! ☘️
...
\caption{The greater your code, the greater your superpower. The greater your superpower, the greater your responsibility. What are your responsibilities and how can you use your power responsibly? \citep{spiderman, responsiblecs}}\label{fig:spiderman-fig}
\end{figure}
...
\hypertarget{soul}{%
\section{Do I need to sell my soul?}\label{soul}}

You'll sometimes hear people saying you need to sell your soul to your employer, see \href{https://www.thevectorimpact.com/selling-your-soul/}{Am I Selling My Soul to Work for My Company?} and \href{http://news.bbc.co.uk/1/hi/england/2051061.stm}{Soul sold for less than £12}. When you're searching for jobs and finding out about employers, you should find out what the values and ethical principles of an employer are see section \ref{beware}. It's a quick way to find out what makes the organisation who they are. Most employers publish their values and ethics openly, here's a selection to give you a flavour:

\begin{itemize}
\tightlist
\item
  Amazon's leadership principles \href{https://www.amazon.jobs/en/principles}{amazon.jobs/en/principles}
\item
  Microsoft values \href{https://www.microsoft.com/en-us/about/corporate-values}{microsoft.com/en-us/about/corporate-values}
\item
...
\item
  Commit to Diversity \& Inclusion: Value individual and cultural differences as a defining strength
\item
...
\caption{Remember to toggle your mute / unmute settings if you have a teleconference interview on zoom or similar. \href{https://bryanmmathers.com/bob/}{Bob\ldots{}} by \href{https://visualthinkery.com/}{Visual Thinkery} is licensed under \href{https://creativecommons.org/licenses/by-nd/4.0/}{CC-BY-ND}}\label{fig:bobonmute-fig}
\end{figure}
...
It's very easy to overlook mistakes in your own writing. That's true of any written communication such as a covering letter, personal statement, email or any message that you write. Mistakes are particularly common in CVs (or resumes) because you can spend \emph{hours} carefully polishing the words and the formatting but not see a fatal error at the top of page one. Hacking other people's CV's will help you improve your own. You may need to use ingenious hacks like the one on the bridge in figure \ref{fig:kludge-fig}. Returning to the bridge analogy from section \ref{parti}, fixing other peoples bridges will help you improve your own bridges. You'll build better bridges to more ambitious destinations.
...
\item
  \textbf{Even Better If?} (EBI) What could be fixed or improved
\item
...
Reading and hacking other people's CVs will help you improve your own because you're putting yourself in the shoes of your reader. Here are some samples:
...
\item
  \texttt{generated}
\item
  \texttt{increased} make sure you quantify it, see section \ref{carstar}
\item
  \texttt{refined}
\item
...
If you want to have your future read, you can read all about it. Books, journals, websites, magazines and anywhere else you find the written word will help you to read your future. There is no need to gaze into any \href{https://en.wikipedia.org/wiki/Crystal_ball}{crystal balls}! Get reading your future now, because reading is good for your mind, body and soul. Libraries give us power, see figure \ref{fig:library-power-fig}.
...
\caption{Libraries give you power, the power to read your future. These references are a digital library to search and browse. Panorama of the \href{https://en.wikipedia.org/wiki/British_Museum_Reading_Room}{British Museum Reading Room} by David Iliff on Wikimedia Commons \href{https://w.wiki/3BEs}{w.wiki/3BEs}}\label{fig:library-power-fig}
\end{figure}
