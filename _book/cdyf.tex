...
If you don't want to (or can't) use Git or \href{https://github.com/}{github.com} then you can:
...
\caption{Good governance is crucial to good schools. Many schools like St.~Anne's, and the hundreds of children they educate every year, need help from skilled people on their governing boards. Why not serve your local community as a ``\href{https://en.wikipedia.org/wiki/Critical_friend}{critical friend}'' on the governing board of a school? All ages are welcome, but especially younger governors. \citep{youngovernors} Take a look at \href{https://governorsforschools.org.uk/}{governorsforschools.org.uk}. Fair use image via Wikimedia Commons \href{https://w.wiki/3Swt}{w.wiki/3Swt} made with the \href{https://apps.apple.com/us/app/wikipedia/id324715238}{Wikipedia app}}\label{fig:st-annes-fig}
\end{figure}
...
You might be tempted to postpone making difficult career decisions. I'll do it tomorrow. I'll do it next week. I'll do it next year. I'll finish this assignment. I'll finish this exam. I'll finish this semester. Procrastination is a part of the \href{https://en.wikipedia.org/wiki/Human_condition}{human condition}. There is \href{http://paulgraham.com/procrastination.html}{good and bad procrastination}, see figure \ref{fig:procrastination-fig} \citep{procrastination}.
...
You are reading the alpha version, the \href{https://en.wikipedia.org/wiki/Minimum_viable_product}{Minimum Viable Product} (MVP) of this guidebook, last updated on 14 June, 2021. That's software engineer talk for saying it isn't finished yet. Subsequent versions, will be continuously and iteratively released on a daily and weekly basis. They will include:
...
\caption{``I have such a stressful job that the only way I can get it out of my mind is by running hard; it's the only way I can get some release''. Like many, Turing found running a relief from the mental pressure he was under in his job. \citep{kottke} Your academic performance at University can be significantly improved by taking regular exercise and it will improve your mental health too. Public domain portrait of Alan Turing via Wikimedia Commons \href{https://w.wiki/oZx}{w.wiki/oZx}}\label{fig:turing-stress-fig}
\end{figure}
...
\subsection{Computing your future}\label{creative}}
...
\hypertarget{seating}{%
\section{Software is eating the world}\label{seating}}

Whatever world you enter into after you graduate, there's a good chance it has already been changed by software and will continue to be in the future. In 2011, the software engineer and billionaire investor \href{https://en.wikipedia.org/wiki/Marc_Andreessen}{Marc Andreesen} argued that \href{https://a16z.com/2011/08/20/why-software-is-eating-the-world/}{software is eating the world}, see figure \ref{fig:eating-fig}.
...
\caption{Whatever world you enter after you graduate, software has either eaten it, currently eating it or working out how to do so. \citep{eatingtheworld} Picture of Marc Andreessen by JD Lasica on Wikimedia Commons \href{https://w.wiki/3V48}{w.wiki/3V48}}\label{fig:eating-fig}
\end{figure}
...
Besides the social arguments, there are also strong economic reasons for studying computing. It's not just software that's eating the world, but its combination with hardware that dominates the list of the world's largest corporations by \href{https://en.wikipedia.org/wiki/Market_capitalization}{market capitalisation}, shown in figure \ref{fig:market-fig}. So it's not just software that's eating the world but computing.
...
It's very easy to overlook mistakes in your own writing. That's true of any written communication such as a covering letter, personal statement, email or any message that you write. Mistakes are particularly common in CVs (or resumes) because you can spend \emph{hours} carefully honing the words and the formatting but not see a fatal error at the top of page one. You may need hack your CV and those of your peers, which could involve \href{https://en.wikipedia.org/wiki/Kludge}{kludges} like the one shown in figure \ref{fig:kludge-fig}.
...
\hypertarget{hack-their-cv}{%
\section{Hack their CV}\label{hack-their-cv}}

A useful hacking technique is to take somebody elses stuff and fix or improve it. That works for writing as well as actual \texttt{code}. The \protect\hyperlink{dogfooding}{dogfooding} technique, we've already talked about in section \ref{dogfooding} is a useful hacking technique which you can use by:
...
\item
  \texttt{automated} (e.g.~builds and tests)
\item
  \texttt{built}
\item
...
\item
  \texttt{measured}
\item
  \texttt{modeled} (in a computational or mathematical sense)
\item
  \texttt{proved}
\item
