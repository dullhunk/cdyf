...
I'm looking for all kinds of constructive feedback from \href{https://en.wikipedia.org/wiki/Critical_friend}{critical friends}. This includes small things (like typos and grammatical errors) through to bigger issues for each chapter such as:
...
So thanks Manchester\footnote{Manc-you very much. Sorry, can't resist. I'll get my coat..} for being Mancunian. 🙏
...
\tightlist
\item
  debug your CV (or job applications) some more, see chapter \ref{debugging}
\item
  develop a better job search strategy, which we'll look at in this chapter, chapter \ref{finding}
\item
