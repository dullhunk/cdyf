...
\caption{Where will you be five years from now? Best-selling author of \emph{Colouring Your Parachute} Dick Bolles discusses the gaps between education and employment. You can watch also watch the full 32 minute video embedded in this figure at \href{https://youtu.be/oeP6Pm3Xf-8}{youtu.be/oeP6Pm3Xf-8} \citep{youtube-bolles}}\label{fig:bolles-fig}
\end{figure}
