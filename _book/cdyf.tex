...
You will spend lots of time in this wonderland, potentially as much as 80,000 hours of your life. \citep{iip1, iip2} So join me down the rabbit hole, it's fun (honest), and sooner or later you'll have to come down here anyway. So open up the door to new possibilities.

\hypertarget{opening}{%
\section{Opening your future}\label{opening}}

Studying at University is about opening up to a new and exciting doors to the future, as \href{https://en.wikipedia.org/wiki/Lemn_Sissay}{Lemn Sissay} once said (figure \ref{fig:lemn-fig}):
...
Once you've thought about these questions, you stand a much better chance of working out if a given employer is a good match for you. So do you have to sell your soul as shown in figure \ref{fig:soul-fig}? It depends on what's in your soul if an employer shares those values with you.
...
\item
  \textbf{Even Better If?} (EBI) What could be fixed or improved, can you hack it?
\item
...
Penny Tester, or Pen as her friends call her, loves cybersecurity and reverse engineering. She has a real passion for finding vulnerabilities in software and hardware. Just don't call her a hacker she hates that word, see \ref{fig:pentester-fig}.
