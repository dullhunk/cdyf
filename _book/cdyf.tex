...
Hello and welcome to \emph{Coding Your Future} (\href{https://www.cdyf.me}{cdyf.me}) the guidebook that will help you to design, build, test, hack and \texttt{code} your future in computing. Also published at \href{https://www.cdyf.me/cdyf.pdf}{cdyf.pdf} \& \href{https://www.cdyf.me/cdyf.epub}{cdyf.epub}, this book is aimed at ALL students in higher education. This guide supports undergraduate teaching at the University of Manchester, but it doesn't actually matter:
...
You will spend lots of time in this wonderland, potentially as much as 80,000 hours of your life. \citep{iip1, iip2} So join me down the rabbit hole, it's fun (honest), and sooner or later you'll have to come down here anyway. So open up to the possibilities.

\hypertarget{opening}{%
\section{Opening your future}\label{opening}}

Studying at University is about opening up to a new and exciting future, as \href{https://en.wikipedia.org/wiki/Lemn_Sissay}{Lemn Sissay} once said (figure \ref{fig:lemn-fig}):
...
\caption{Open the book, open the challenge, with open eyes. Open. Out. Look. Open all minds, open all dreams, research, question. Open all doors, open all senses, open all defences, ask: What were these closed for? \citep{sissay} Portrait of \href{https://en.wikipedia.org/wiki/Lemn_Sissay}{Lemn Sissay} speaking in 2010 by Philosophy Football via Wikimedia Commons \href{https://w.wiki/3VYT}{w.wiki/3VYT} adapted using the Wikipedia app}\label{fig:lemn-fig}
\end{figure}
...
Look at these values, or choose the values of another employer you're interesteed in. Here are some \href{https://en.wikipedia.org/wiki/Breakpoint}{breakpoints}, pause your program and check these parameters and variables:

\begin{itemize}
\tightlist
\item
  How closely do the employers stated values align with your own? See section \ref{no42}.
...
\item
  Are there any unwritten rules? What they say and do may be contradictory.
\end{itemize}
