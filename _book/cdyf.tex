...
So thanks Manchester for being Mancunian. \href{https://www.youtube.com/watch?v=PszMmYpQjPo}{This is the place}! \citep{longfella} 🙏
...
Thanks to the British Universities North America Club (\href{https://en.wikipedia.org/wiki/BUNAC}{BUNAC}) for sponsoring my temporary worker visa which allowed me to cook breakfasts for guests at the \href{https://phillipsseafood.com/}{Phillips Sea Food} restaurant and hotel in \href{https://en.wikipedia.org/wiki/Ocean_City,_Maryland}{Ocean City, Maryland}.
...
Thanks to Mitch at \href{https://greentortoise.com/}{Green Tortoise Adventure Travel} for driving and feeding a bus load of us \href{https://en.wikipedia.org/wiki/San_Francisco_(Be_Sure_to_Wear_Flowers_in_Your_Hair)}{hippies with flowers in our hair} from San Francisco to New York via some of America's finest wildernesses (and cookouts) in \href{Yellowstone\%20National\%20Park}{Yellowstone National Park}, \href{Grand\%20Teton\%20National\%20Park}{Grand Teton National Park}, \href{https://en.wikipedia.org/wiki/Badlands_National_Park}{Badlands National Park}.

Thanks to \href{https://wi.mit.edu/news/memoriam-thomas-gochberg}{Thomas Gochberg} and Letty Gochberg for looking after me in New York and showing me around the sites of Manhattan. Thanks Pat Willmott and Rob Willmott for the introduction via the \href{https://en.wikipedia.org/wiki/Tall_Ships_America}{Tall Ships America} in Plymouth, Devon from where the \href{https://en.wikipedia.org/wiki/Mayflower}{Mayflower} set off for the New World in 1620.
...
Thanks Boston for hosting \href{https://en.wikipedia.org/wiki/Boston_Tea_Party}{magnificent tea parties} via the \href{https://www.w3.org/wiki/HCLSIG}{W3C healthcare and life sciences interest group} and the Association for the Advancement of Artificial Intelligence (AAAI) conference \citep{aaai}. Thanks Joanne Luciano for showing us the sights of Boston and \href{https://en.wikipedia.org/wiki/Cambridge,_Massachusetts}{the ``other'' Cambridge}. Thanks Bertram Ludäscher for hosting workflow collaborations at UCSD.
