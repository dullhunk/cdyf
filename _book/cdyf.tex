...
You are reading the alpha version, the \href{https://en.wikipedia.org/wiki/Minimum_viable_product}{Minimum Viable Product} (MVP) of this guidebook, last updated on 08 September, 2021. That's software engineer talk for saying it isn't finished yet. Subsequent versions, will be continuously and iteratively released on a daily and weekly basis. They will include:
...
\tightlist
\item
  A panel of students returning from industrial experience will share their stories of recruitment and employment, read \emph{Experiencing your future} chapter \ref{experiencing}
\end{itemize}

\hypertarget{week2}{%
\section{Week Two}\label{week2}}
...
\tightlist
\item
  \emph{Either} COMP2CARS: read \emph{Debugging your future} (chapter \ref{debugging}) and \emph{Hacking your future} (chapter \ref{hacking}): CVs, Resumes and LinkedIn
\item
...
\hypertarget{week3}{%
\section{Week Three}\label{week3}}
...
\tightlist
\item
  \emph{Either} COMP2CARS: read \emph{Debugging your future} (chapter \ref{debugging}) and \emph{Hacking your future} (chapter \ref{hacking}): CVs, Resumes and LinkedIn (repeated session from last week for those that met their personal tutors last week)
\item
...
\tightlist
\item
  \emph{Finding your future}, read chapter \ref{finding}: How can you adapt and optimise your job search strategies?
\end{itemize}

\hypertarget{week5}{%
\section{Week Five}\label{week5}}
...
\tightlist
\item
  \emph{Nurturing your future}, health and happiness, read chapter \ref{nurturing}: mental and physical health, anxiety and depression
\end{itemize}

\hypertarget{week6}{%
\section{Week Six}\label{week6}}
...
\tightlist
\item
  \emph{Knowing your future} read chapter \ref{knowing}
\end{itemize}

\hypertarget{week7}{%
\section{Week Seven}\label{week7}}
...
\hypertarget{week8}{%
\section{Week Eight}\label{week8}}
...
\tightlist
\item
  \emph{Writing your future} part 1 of 2: read chapter \ref{writing} and \href{https://developers.google.com/tech-writing/one}{developers.google.com/tech-writing/one}
\end{itemize}

\hypertarget{week9}{%
\section{Week Nine}\label{week9}}
...
\tightlist
\item
  \emph{Writing your future} part 2 of 2: read chapter \ref{writing} see \href{https://developers.google.com/tech-writing/one}{developers.google.com/tech-writing/one}
\end{itemize}

\hypertarget{week10}{%
\section{Week Ten}\label{week10}}
...
\tightlist
\item
  \emph{Broadening your future} (read chapter \ref{broadening}) and \emph{Achieving your future} (read chapter \ref{achieving})
\end{itemize}

\hypertarget{week11}{%
\section{Week Eleven}\label{week11}}
...
\tightlist
\item
  \emph{Speaking your future} read chapter \ref{speaking}, preparing for interviews
\end{itemize}

\hypertarget{week12}{%
\section{Week Twelve}\label{week12}}
...
\hypertarget{week13}{%
\section{Week Thirteen}\label{week13}}
