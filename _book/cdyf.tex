...
You are reading the alpha version, the \href{https://en.wikipedia.org/wiki/Minimum_viable_product}{Minimum Viable Product} (MVP) of this guidebook, last updated on 04 January, 2023. That's software engineer talk for saying \emph{it isn't finished yet}. Subsequent versions, will be continuously and iteratively released on a daily and weekly basis. They will include:
...
\tightlist
\item
  a predominantly {[}science, technology, engineering, and mathematics{]}(\url{https://en.wikipedia.org/wiki/Science,_technology,_engineering,_and_mathematics} (STEM) path OR
\item
...
\caption{Just like the \href{https://en.wikipedia.org/wiki/Death_Star}{Death Star}, this \sout{galactic superweapon} book is under construction. As of 04 January, 2023 this book is an estimated \textbf{37\% complete}. Image of agile weapon engineering in \emph{Star Wars} via Wikimedia Commons \href{https://w.wiki/5N6q}{w.wiki/5N6q} adapted using the \href{https://apps.apple.com/gb/app/wikipedia/id324715238}{Wikipedia app}}\label{fig:deathstar-fig}
\end{figure}
...
Thes titles sound like dumping grounds for the leftovers. You might decide to have a dedicated \texttt{skills} or \texttt{personal\ statement} section but see section \ref{mycvsk} and @ref().
...
\item
  won some awards for your hobby, like a \href{https://en.wikipedia.org/wiki/Black_belt_(martial_arts)}{black belt} for example
\item
...
\subsection{Embedded statement?}\label{statement}}

You might be tempted to embed a short summary or \texttt{personal\ statement} section on your CV. If you're thinking about doing this, keep it short or just leave it out altogether. Why? Here's an example of what you should try to avoid from a fictitous Professor at the University of Poppleton:

\texttt{I\ have\ a\ proven\ track\ record\ of\ delivering\ excellent\ teaching\ and\ outstanding\ experiences\ for\ all\ of\ my\ students,\ whatever\ their\ background.\ I\ am\ also\ a\ committed\ and\ persistent\ leader\ who\ can\ deliver\ large\ and\ ambitious\ projects\ on\ time\ and\ to\ budget.\ This\ makes\ me\ capable\ of\ leading\ cross-disclipinary\ teams\ of\ colleagues\ towards\ excellent\ and\ innovative\ results\ inline\ with\ strategic\ educational\ objectives.}

Are you persuaded by this personal statement? I hope you aren't because it \href{https://en.wikipedia.org/wiki/On_Bullshit}{smells like bullshit}, see figure \ref{fig:bullshit-fig}. One of the reasons the statement smells bad is because it makes lots of assertions without providing any evidence. It seems like the author might be trying to persuade us with little regard for the truth or the facts. Without evidence, it is hard to tell which assertions are true or false, so the whole statement risks being ignored as bullshit or lies. \citep{onbullshit}
...
\caption{Yes, your CV is trying to persuade the reader to invite you to an interview. Being persuasive doesn't mean you have to tell lies or try and \emph{bullshit} your reader. People who have to read your CV will also have to read hundreds of others too. This means your readers will have \emph{highly trained} bullshit detectors, so you should avoid having bullshit in your CV and especially in your personal statement. Fair use image of the cover of Harry G. Frankfurt's book \emph{\href{https://en.wikipedia.org/wiki/On_Bullshit}{On Bullshit}} \citep{onbullshit} via Wikimedia Commons \href{https://w.wiki/6Bnu}{w.wiki/6Bnu} adapted using the \href{https://apps.apple.com/us/app/wikipedia/id324715238}{Wikipedia app}}\label{fig:bullshit-fig}
\end{figure}



On a one page CV, you rarely have space to include any of this kind of stuff anyway. High level statements usually fit better on a covering letter described in section \ref{we3qs}. A shorter, less bullshitty personal statement from a student is shown below:

\texttt{I\ am\ a\ second\ year\ student\ in\ Computer\ Science\ at\ the\ University\ of\ Poppleton\ looking\ for\ an\ industrial\ placement\ in\ software\ engineering}

Is this better? Personally, I think you should only be including a personal statement on your CV if you've got space to do so because it just repeats what can already be inferred from the facts on your CV anyway. There are usually much more interesting things you can say about yourself on your CV.
