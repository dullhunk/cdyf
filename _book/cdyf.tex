...
I'm looking for feedback on smaller things (like typos and grammatical errors) through to bigger issues for each chapter such as:
...
So thanks Manchester for being Mancunian.\footnote{Manc-you very much. Sorry, can't resist. I'll get my coat..} 🙏
...
You are reading the alpha version, the \href{https://en.wikipedia.org/wiki/Minimum_viable_product}{Minimum Viable Product} (MVP) of this guidebook, last updated on 04 June, 2021. That's software engineer talk for saying it isn't finished yet. Subsequent versions, will be continuously and iteratively released on a daily and weekly basis. They will include:
...
\caption{Rejection is a normal part of applying for jobs, some of your applications may disappear without trace into employers ``black holes'', especially if they are large and have a strong gravitational force on job applicants. CC-BY image of the supermassive black hole in \href{https://en.wikipedia.org/wiki/Messier_87}{Messier 87} by the \href{https://en.wikipedia.org/wiki/Event_Horizon_Telescope}{Event Horizon Telescope} team via Wikimedia Commons \href{https://w.wiki/3RCa}{w.wiki/3RCa}}\label{fig:blackhole-fig}
\end{figure}
