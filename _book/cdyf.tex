...
Thanks to St Laurence school (\href{https://st-laurence.com/}{st-laurence.com}), a community I am proud and lucky to have grown up in. I'm especially grateful for the ongoing friendship of those I've enjoyed music, cycling, walking, travelling and drinking with over the years, some of whom you can see figure \ref{fig:bradlads-fig}. I'm looking forward to our next adventure.
...
\caption{Crossing the highest paved mountain pass in Europe, the \href{https://en.wikipedia.org/wiki/Col_de_l\%27Iseran}{Col de l'Iseran} in France, with my fellow \href{https://en.wikipedia.org/wiki/King_of_the_Mountains}{Kings of the Mountains} and alpinists: Jim, Dan, Doug and Dan. Rest in Peace Dan, you were a fantastic companion and we all miss you terribly.}\label{fig:bradlads-fig}
\end{figure}



Special thanks my friend, former St.~Laurence school student and \href{https://st-laurence.com/sixth-form}{current sixth form head} Aidan Blowers for leading by example, see figure \ref{fig:uptown-funk-fig}. Aidans approach inspired the ongoing musical experiment that is \href{http://www.cs.man.ac.uk/~hulld/research.html\#tuningcomplete}{Tuning Complete}.
...
\caption{Year 11 leavers of Melksham Oak Community School (MOCS) dance to \href{https://en.wikipedia.org/wiki/Uptown_Funk}{Uptown Funk} in 2015 with help from Mark Ronson, Bruno Mars and Aidan Blowers. The image above is a screenshot. Don't believe me, just watch, come on! \href{https://youtu.be/z8qH05teRMM}{youtu.be/z8qH05teRMM}}\label{fig:uptown-funk-fig}
\end{figure}
...
Thanks to my \href{https://www.fitzmauriceschool.info/}{Fitzmaurice Primary School} school teachers: Mrs Cripps, Mrs Clary, Mr Clay, Mr Fleming, Mr Jackson, Val Payne, Mrs Sheldon, Hugh Solomon, Miss Uncles and Mrs White. I used to foolishly think it was secondary schools that did all the serious teaching, but they'd be \emph{nowhere} without the foundations laid in primary school.

So, thank you to the community that is St.~Laurence school, Fitzmaurice Primary School and \href{https://en.wikipedia.org/wiki/Edmond_Fitzmaurice,_1st_Baron_Fitzmaurice}{Edmond Fitzmaurice} for educating me the \href{https://en.wikipedia.org/wiki/West_Country}{West Country} way. Proper job! 🙏
...
You are reading the alpha version, the \href{https://en.wikipedia.org/wiki/Minimum_viable_product}{Minimum Viable Product} (MVP) of this guidebook, last updated on 10 December, 2021. That's software engineer talk for saying it isn't finished yet. Subsequent versions, will be continuously and iteratively released on a daily and weekly basis. They will include:
