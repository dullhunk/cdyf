...
You are reading the alpha version, the \href{https://en.wikipedia.org/wiki/Minimum_viable_product}{Minimum Viable Product} (MVP) of this guidebook, last updated on 14 July, 2022. That's software engineer talk for saying it isn't finished yet. Subsequent versions, will be continuously and iteratively released on a daily and weekly basis. They will include:
...
\caption{Just like the \href{https://en.wikipedia.org/wiki/Death_Star}{Death Star}, this \sout{galactic superweapon} book is under construction. As of 14 July, 2022 this book is an estimated \textbf{35\% complete}. Image of agile weapon engineering in \emph{Star Wars} via Wikimedia Commons \href{https://w.wiki/5N6q}{w.wiki/5N6q} adapted using the \href{https://apps.apple.com/gb/app/wikipedia/id324715238}{Wikipedia app}}\label{fig:deathstar-fig}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.32\linewidth]{images/raluca} \includegraphics[width=0.32\linewidth]{images/raluca} \includegraphics[width=0.32\linewidth]{images/raluca} \caption{Raluca Cruceru is a software engineer at CERN, standing here in front of \href{https://en.wikipedia.org/wiki/ALICE_experiment}{A Large Ion Collider Experiment (ALICE)}, see \href{https://careers.cern/Raluca}{careers.cern/Raluca}. Picture reused with permission from \href{https://www.linkedin.com/in/raluca-cruceru/}{linkedin.com/in/raluca-cruceru}, thanks Raluca.}\label{fig:raluca2-fig}
\end{figure}

\hypertarget{you}{%
\section{Episode x: it could be you!}\label{you}}

If you'd like to be interviewed for the show, get in touch, see figure \ref{fig:yfnu-fig}. Your future needs you! Besides interviewing current graduates, I'm interested in speaking to former graduates, especially those that did placements or internships as undergraduate or postgraduate students.

\begin{figure}
\includegraphics[width=0.32\linewidth]{images/your-future-wants-you} \includegraphics[width=0.32\linewidth]{images/your-future-wants-you} \includegraphics[width=0.32\linewidth]{images/your-future-wants-you} \caption{Your \sout{country} future needs you! If you're a former student of Computer Science who'd like to appear on the show, \href{https://personalpages.manchester.ac.uk/staff/duncan.hull/contact}{get in touch}. I'm especially interested to hear from students who did internships or placements during their undergraduate degree in Computer Science, not just those from the University of Manchester. Picture adapted from an original public domain image of the \href{https://en.wikipedia.org/wiki/Lord_Kitchener_Wants_You}{Lord Kitchener Wants You} poster by \href{https://en.wikipedia.org/wiki/Alfred_Leete}{Alfred Leete} on Wikimedia Commons at \href{https://w.wiki/3xvX}{w.wiki/3xvX}}\label{fig:yfnu-fig}
\end{figure}
