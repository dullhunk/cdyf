...
You've worked incredibly hard to get the grades you needed to get into University. You've spent (or are spending) a significant amount of time and money studying your chosen discipline. You are really \emph{geeking out} by going deep into your subject for three years or more. Some say \href{https://en.wikipedia.org/wiki/Geek}{the geeks} will inherit the earth, see figure \ref{fig:geekout-fig}. You are a geek\footnote{By geek I mean in a good sense: someone who is interested in a subject for its own sake. That's a compliment, not an insult!}, so where is \emph{your} inheritance?
...
You are reading the alpha version, the \href{https://en.wikipedia.org/wiki/Minimum_viable_product}{Minimum Viable Product} (MVP) of this guidebook, last updated on 13 September, 2021. That's software engineer talk for saying it isn't finished yet. Subsequent versions, will be continuously and iteratively released on a daily and weekly basis. They will include:
