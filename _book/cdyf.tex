...
Thanks to St Laurence school (\href{https://st-laurence.com/}{st-laurence.com}), a community I am proud and lucky to have grown up in. I'm especially grateful for the friendship of former St Laurence school students I've enjoyed music, cycling, walking, travelling and drinking with over the years, \emph{some} of whom you can see figure \ref{fig:bradlads-fig}. I'm looking forward to our next adventure / gig / session.
...
\caption{Crossing the highest paved mountain pass in Europe, the \href{https://en.wikipedia.org/wiki/Col_de_l\%27Iseran}{Col de l'Iseran} in France, with my fellow alpinists and \href{https://en.wikipedia.org/wiki/King_of_the_Mountains}{Kings of the Mountains}: Jim, Dan, Doug and Dan. Rest in Peace Dan, you were a fantastic companion, we all love you and miss you terribly.}\label{fig:bradlads-fig}
\end{figure}
