...
You are reading the alpha version, the \href{https://en.wikipedia.org/wiki/Minimum_viable_product}{Minimum Viable Product} (MVP) of this guidebook, last updated on 24 November, 2022. That's software engineer talk for saying \emph{it isn't finished yet}. Subsequent versions, will be continuously and iteratively released on a daily and weekly basis. They will include:
...
\tightlist
\item
  Forces that make you unhappy: \textbf{\(F~SAD~\)}
\item
  Forces that make you happy: \textbf{\(F~HAPPY~\)}
\item
  Forces that make you anxious: \textbf{\(F~ANXIOUS~\)}
\item
  Force that make you calm: \textbf{\(F~CALM~\)}
\end{itemize}
...
\caption{Just like the \href{https://en.wikipedia.org/wiki/Death_Star}{Death Star}, this \sout{galactic superweapon} book is under construction. As of 24 November, 2022 this book is an estimated \textbf{37\% complete}. Image of agile weapon engineering in \emph{Star Wars} via Wikimedia Commons \href{https://w.wiki/5N6q}{w.wiki/5N6q} adapted using the \href{https://apps.apple.com/gb/app/wikipedia/id324715238}{Wikipedia app}}\label{fig:deathstar-fig}
\end{figure}
...
Again, congratulations, but third place out of how many: \texttt{3}? Not so impressive. \texttt{30}? \texttt{300}? \texttt{3000}? More impressive. Numbers make a big difference so if you're going to mention awards, quantify\footnote{even an approximation will do} where you can so the reader can understand what the prize was for. You may well be intimately acquaited with the \href{https://en.wikipedia.org/wiki/Flibbertigibbet}{flibbertigibbet} competition but your reader probably won't of heard of it, so give some context. 🏆
...
If you want to have your future read, you can read all about it right here. There is no need to gaze into any \href{https://en.wikipedia.org/wiki/Crystal_ball}{crystal balls}! These books, journals, websites, magazines will help you to read your future. Reading is good for your mind, body and soul because \href{https://en.wikipedia.org/wiki/A_Design_for_Life}{libraries give us power} \citep{designforlife, librariesgaveuspower}, see figure \ref{fig:library-power-fig}.
