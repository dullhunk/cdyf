...
You are reading the alpha version, the \href{https://en.wikipedia.org/wiki/Minimum_viable_product}{Minimum Viable Product} (MVP) of this guidebook, last updated on 12 November, 2022. That's software engineer talk for saying \emph{it isn't finished yet}. Subsequent versions, will be continuously and iteratively released on a daily and weekly basis. They will include:
...
\ldots{} so you will need several different techniques to develop better self-awareness. Your education is a big part of your identity so being concious of how your education has already changed you is an important step in developing self-awareness. Identifying what your formal education \emph{can't} do for you, is just as crucial too. Before we look at some techniques for improving your self-awareness, let's look at the fundamental \emph{protected} parts of your identity. Some parts of your identity are so important that they are protected by legislation, in the UK and in other countries. The next section looks at those.
...
\item
  \textbf{Conflict and change}: Bettering yourself inevitably involves change so:
...
\caption{Just like the \href{https://en.wikipedia.org/wiki/Death_Star}{Death Star}, this \sout{galactic superweapon} book is under construction. As of 12 November, 2022 this book is an estimated \textbf{37\% complete}. Image of agile weapon engineering in \emph{Star Wars} via Wikimedia Commons \href{https://w.wiki/5N6q}{w.wiki/5N6q} adapted using the \href{https://apps.apple.com/gb/app/wikipedia/id324715238}{Wikipedia app}}\label{fig:deathstar-fig}
\end{figure}
...
\begin{Shaded}
\begin{Highlighting}[]
\SpecialStringTok{* }\NormalTok{Won third prize in a competition}
\end{Highlighting}
\end{Shaded}

Again, congratulations, but third place out of how many: 3? Not so impressive. 30? 300? 3000? More impressive. Numbers make a big difference so if you're going to mention awards, quantify\footnote{even an approximate estimate will do} and give the context where you can so the reader can understand what the prize was for. 🏆
