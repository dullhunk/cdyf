...
\caption{This is Captain \href{https://en.wikipedia.org/wiki/Jean-Luc_Picard}{Jean-Luc Picard}, engage with your future. Make it so. Fair use image of actor Patrick Stewart adapted using the Wikipedia app}\label{fig:startrek-fig}
\end{figure}
