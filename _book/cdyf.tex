...
\item
  \href{http://news.bbc.co.uk/local/gloucestershire/hi/people_and_places/newsid_8741000/8741279.stm}{Vicky Tuck} at \href{https://en.wikipedia.org/wiki/Cheltenham_Ladies\%27_College}{Cheltenham Ladies' College}, Cheltenham, Gloucestershire. This was the first time I'd set foot in a private school, managing to sneak through \href{https://en.wikipedia.org/wiki/Checkpoint_Charlie}{Checkpoint Charlie} un-noticed to cross Michael Gove's \href{https://en.wikipedia.org/wiki/Berlin_Wall}{Berlin Wall} of education. It was an enlightening experience! \citep{berlinwall, cheltenham}
\item
...
You are reading the alpha version, the \href{https://en.wikipedia.org/wiki/Minimum_viable_product}{Minimum Viable Product} (MVP) of this guidebook, last updated on 15 June, 2022. That's software engineer talk for saying it isn't finished yet. Subsequent versions, will be continuously and iteratively released on a daily and weekly basis. They will include:
...
Our human race faces some huge challenges in the 21st century:
...
\item
  Tackling rising global inequalities of wealth, income and gender \citep{stanley}
\item
  Providing adequate food, water, shelter, energy, education and healthcare for a global population which is rapidly approaching \href{https://www.worldometers.info/world-population/}{8 billion people}
\item
...
\tightlist
\item
  \href{https://en.wikipedia.org/wiki/Green_computing}{Greener computing} \citep{greencomputing}
\item
  Net zero computing \citep{netzero}
\item
  \href{https://en.wikipedia.org/wiki/Smart_city}{Smarter cities} which use resources more efficiently \citep{smartercities}
\item
  Technologies like \href{https://en.wikipedia.org/wiki/AlphaFold}{Alphafold} could enable quicker and cheaper development of new vaccines and drugs \citep{Jumper2021}
\item
  Scientific computing for the benefit of humanity, e.g.~better climate modelling and see section \ref{rse}
\end{itemize}
