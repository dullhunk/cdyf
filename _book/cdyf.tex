...
You are reading the alpha version, the \href{https://en.wikipedia.org/wiki/Minimum_viable_product}{Minimum Viable Product} (MVP) of this guidebook, last updated on 31 May, 2022. That's software engineer talk for saying it isn't finished yet. Subsequent versions, will be continuously and iteratively released on a daily and weekly basis. They will include:
...
\item
  Meeting all these goals \href{https://en.wikipedia.org/wiki/Sustainability}{sustainably} without irreversibly depleting natural resources
\end{itemize}
