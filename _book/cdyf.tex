...
Sometimes a desire to be productive by overworking has the opposite effect, because the sacrifices you make can be counter-productive.
...
\caption{If stock markets are anything to go by, computing is eating the world. It would be impossible for \href{https://en.wikipedia.org/wiki/Big_Tech}{Big Tech} companies like Apple, Microsoft, Amazon, Alphabet (Google) and Meta (Facebook) to exist without computing. The ten largest corporations by market capitalisation (as of 2021) graphic by YBSLE on Wikimedia Commons \href{https://w.wiki/3KEU}{w.wiki/3KEU}}\label{fig:market-fig}
\end{figure}
