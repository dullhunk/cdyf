...
If you're familiar with the tools used to create this book you can:
...
\tightlist
\item
  Add comments by annotating \href{https://www.cdyf.me/cdyf.pdf}{cdyf.pdf} using your weapon of choice (iPad, \href{https://en.wikipedia.org/wiki/ReMarkable}{reMarkable} or whatever) and \href{http://www.cs.man.ac.uk/~hulld/contact.html}{email it to me}
\item
  Suggest changes via the Microsoft Word version at \href{http://cdyf.me/cdyf.docx}{cdyf.docx}, which is solely for editing purposes. The text is all there, but the pagination and graphic placement in Word isn't as good as in the pdf version.\footnote{Don't say I didn't warn you!} Make sure you've \href{https://support.microsoft.com/en-us/office/track-changes-in-word-197ba630-0f5f-4a8e-9a77-3712475e806a}{turned on track changes in Word} so that corrections are easily identified.
\item
...
\SpecialStringTok{* }\NormalTok{Collaborated with one other contributor for two days at a hackathon using pair programming}
\SpecialStringTok{* }\NormalTok{Designed and implemented an API using a RESTful approach}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{In my second year CS29328 software engineering module I used Java, Eclipse and}
\NormalTok{JUnit to test and build an open source Massively Multiplayer Online Role{-}Playing Game (MMORPG)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{Built and tested a large open{-}source codebase using Eclipse, Ant, JUnit and Jenkins ...”}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{Added and deployed new features to a Massively Multiplayer Online Role{-}Playing Game (MMORPG) in Java...}
\end{Highlighting}
\end{Shaded}
...
Your actions define your impact, see figure \ref{fig:action-fig}. When writing job applications, think about the stories you can tell and the verbs you can use to describe your actions to date. What was the context, action and result (CAR) we discussed in section \ref{carstar}?
...
\caption{What actions have you taken and what stories can you tell about the results and your impact? What are the best verbs for highlighting your actions? \href{https://bryanmmathers.com/your-actions-define-your-impact/}{Your actions define your impact} by \href{https://visualthinkery.com/}{Visual Thinkery} is licenced under \href{https://creativecommons.org/licenses/by-nd/4.0/}{CC-BY-ND}}\label{fig:action-fig}
\end{figure}
...
\caption{Libraries give you power, the power to read your future. The British Museum Reading Room panorama by David Iliff on Wikimedia Commons \href{https://w.wiki/3BEs}{w.wiki/3BEs}}\label{fig:library-power-fig}
\end{figure}
