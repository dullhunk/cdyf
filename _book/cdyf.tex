...
You are reading the alpha version, the \href{https://en.wikipedia.org/wiki/Minimum_viable_product}{Minimum Viable Product} (MVP) of this guidebook, last updated on 22 September, 2021. That's software engineer talk for saying it isn't finished yet. Subsequent versions, will be continuously and iteratively released on a daily and weekly basis. They will include:
...
\item
  ✅ Has it been reviewed by other people? Do a CV swap with a critical friend and score each others CV's using \href{https://www.cdyf.me/CV-rubric.pdf}{this rubric}. According to \href{https://en.wikipedia.org/wiki/Linus\%27s_law}{Linus's law} ``given enough eyeballs all bugs are shallow'' \citep{Raymond1999}
\item
...
\tightlist
\item
  \emph{Coding your Future} (COMP2ARS and COMP2TUT) takes place every Monday at midday in semester 1, see \href{https://timetables.manchester.ac.uk/}{timetables.manchester.ac.uk} for details, the only exception is in welcome week, see section \ref{week0}
\end{itemize}
...
\tightlist
\item
  \textbf{Tuesday 21st September 10am to midday}, Following from the welcome back to year 2, a panel of students returning from their year of industrial experience will share their stories of recruitment and employment. They will be answering any questions that you have for them about their placements and their transition from students to professionals. Read \emph{Experiencing your future} chapter \ref{experiencing}
\item
  \textbf{Thursday 23rd September 10am} Alumni from the University will talk about the careers after graduating from Computer Science. See your my Manchester timetable for details.
\end{itemize}

\hypertarget{week1}{%
\section{Week 1: Debugging}\label{week1}}

\textbf{Monday 27th September} at midday: Depending on your when you meet your tutor

\begin{itemize}
\tightlist
\item
  \emph{Either} COMP2CARS: Debug your CV (self study) using section \ref{checklist} in \emph{Debugging your future} (chapter \ref{debugging})
\item
...
\textbf{Monday 4th October} at midday: Depending on your when you meet your tutor
...
\item
  \emph{Either} COMP2CARS: Debug your CV (self study) using section \ref{checklist}. Read \emph{Debugging your future} (chapter \ref{debugging}) and \emph{Hacking your future} (chapter \ref{hacking}):
\end{itemize}

\hypertarget{week3}{%
\section{Week 3: Hacking and finding}\label{week3}}
...
\tightlist
\item
  \emph{Hacking your Future} and \emph{Finding your future}. Lecture and workshop in \href{https://www.manchester.ac.uk/discover/maps/interactive-map/?id=540}{Engineering Building A}, Lecture Theatre B, see \href{https://timetables.manchester.ac.uk/}{timetables.manchester.ac.uk}. Read chapter \ref{hacking} and \ref{finding}: What will your job search strategy be? How can you adapt and optimise your job search strategies?
\end{itemize}

\hypertarget{week4}{%
\section{Week 4: Nurturing}\label{week4}}
...
\tightlist
\item
  \emph{Nurturing your future}, health, happiness, anxiety and depression. Lecture and workshop in \href{https://www.manchester.ac.uk/discover/maps/interactive-map/?id=540}{Engineering Building A}, Lecture Theatre B, see \href{https://timetables.manchester.ac.uk/}{timetables.manchester.ac.uk}. Why should you take your mental and physical health more seriously? Read chapter \ref{nurturing}.
\end{itemize}
