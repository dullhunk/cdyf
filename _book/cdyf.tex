...
\item
  \textbf{Futures:} Possible futures for you to think about. Try not to dwell on the past. Think about the future. \citep{thinkaboutthefuture, wroteforluck} Think about your future.
\item
...
It's often better to describe what YOU did before you describe what the software, hardware or project did. Your reader is likely to be more interested in the former, so instead of saying:
...
You could reverse the order to change the emphasis like this:
...
The latter has all the same information, but by leading with the verbs, it's much clearer what the
