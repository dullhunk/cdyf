...
Thanks to all of the \href{https://governorsforschools.org.uk/}{school governors} for holding the leaders of St.~Laurence to account. (\href{https://www.93percent.club/}{\#StateSchoolProud})
...
You are reading the alpha version, the \href{https://en.wikipedia.org/wiki/Minimum_viable_product}{Minimum Viable Product} (MVP) of this guidebook, last updated on 03 June, 2022. That's software engineer talk for saying it isn't finished yet. Subsequent versions, will be continuously and iteratively released on a daily and weekly basis. They will include:
...
Knowing your value is crucial if you're going to negotiate any job offers you receive, see section \ref{offers}.
