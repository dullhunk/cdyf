...
Thanks to Greater Mancunians beyond the University of Manchester: Mark Anderton, Rob Aspin, Jon Atkinson, Charlie Ball, Paul Bason, Julian Bass, Dean Belfield, Lisa Chan Brown, Martin Bryant, Gemma Cameron, Matthew Clark, Jeremy Coates, Darren Dancey, Craig Dean, Farhat Din, Anne Dornan, David Edmundson-Bird, Diana Erskine, Sherelle Fairweather, Shaun Fensom, Steven Flower, Tony Foggett, Katie Gallagher, Emma Grant, David Haikney, Mehran Jalaei, Daniel Jamieson, Matt Jarvis, Jamil Khalil, Ross Keeping, Val Kelly, David Levine, Julie Lowndes, Tony McGrath, Chris Marsh, Claire McDonald, Keith Miller, Geraint North, Tomas Paulik, Damian Payton, Francesco Petrogalli, Paul Sherwood, Adrian Slatcher, Jason Souloglou, Joe Sparrow, Martyn Spink, \href{https://www.katiesteckles.co.uk/}{Katie Steckles}, Matt Squire, Julian Tait, Rob Taylor, Rachel Thompson, Andrew Toolan, Hannah Tracey, Wesley Verne, Paul Vlissidis, \href{https://en.wikipedia.org/wiki/Tony_Walsh_(poet)}{Tony Walsh}, Travis Walton, Ben Webb and Paul Wilshaw for friendly Northern support and advice.
...
You are reading the alpha version, the \href{https://en.wikipedia.org/wiki/Minimum_viable_product}{Minimum Viable Product} (MVP) of this guidebook, last updated on 14 January, 2022. That's software engineer talk for saying it isn't finished yet. Subsequent versions, will be continuously and iteratively released on a daily and weekly basis. They will include:
...
I am neither a medical doctor or a psychologist: If you're affected by mental ill health, you should speak to a trained professional.
...
So this chapter gives you a quick overview of mental health and points you to where you can find out more.
...
\item
  Excessive personal data such birth dates, passport numbers and bank details. These could be used for identity theft, fraud or other criminal activities \citep{jobscammers2}
\item
