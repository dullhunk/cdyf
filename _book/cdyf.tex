...
\begin{figure}
\includegraphics[width=0.99\linewidth]{images/alicequotation} \caption{Alice was beginning to get very tired of sitting by her sister on the bank, and of having nothing to do: once or twice she had peeped into the book her sister was reading, but it had no pictures or conversations in it, ``and what is the use of a book,'' thought Alice ``without pictures or conversations? \citep{wonderland} Public domain image of the cover of the 1898 edition of the novel *\href{https://en.wikipedia.org/wiki/Alice\%27s_Adventures_in_Wonderland}{Alice's Adventures in Wonderland} via Wikimedia Commons \href{https://w.wiki/3S4C}{w.wiki/3S4C}}\label{fig:aiw-fig}
\end{figure}
...
\caption{Nobody cares about your career except you. Unattributed quotation via \href{https://en.wikipedia.org/wiki/Andy_Stanford-Clark}{Andy Stanford-Clark} \citep{andystanfordclark}}\label{fig:andysc-fig}
\end{figure}
...
You might be tempted to postpone making difficult career decisions. I'll do it tomorrow. I'll do it next week. I'll do it next year. I'll finish this assignment. I'll finish this exam. I'll finish this semester. I'll finish my degree first. Procrastination is a part of the \href{https://en.wikipedia.org/wiki/Human_condition}{human condition}. There is \href{http://paulgraham.com/procrastination.html}{good and bad procrastination}, see figure \ref{fig:procrastination-fig} \citep{procrastination}.
...
If you want to work for a big name like those in section \ref{bignames} or \ref{studentjobs}, many of the larger graduate employers expect you to have \emph{some} experience (see chapter \ref{experiencing}) \emph{before} you graduate. A large chunk of vacancies on graduate schemes are filled people who have already been employed as interns or placement students within that (or another) organisation. So the sooner you start investigating employers by getting some experience the better decisions you'll be able to make about what comes next. It's too late when you graduate.
...
You are reading the alpha version, the \href{https://en.wikipedia.org/wiki/Minimum_viable_product}{Minimum Viable Product} (MVP) of this guidebook, last updated on 15 June, 2021. That's software engineer talk for saying it isn't finished yet. Subsequent versions, will be continuously and iteratively released on a daily and weekly basis. They will include:
...
Many companies test their products by trialling them on their own employees, this is known as \href{https://en.wikipedia.org/wiki/Eating_your_own_dog_food}{eating your own dogfood} shown in figure \ref{fig:dogfooding-fig}. Tasty, tasty dogfood. 🐶
...
\caption{Just like the \href{https://en.wikipedia.org/wiki/Death_Star}{Death Star}, this chapter is under construction. Image of agile space station construction methods via Wikimedia Commons \href{https://w.wiki/32PB}{w.wiki/32PB}}\label{fig:deathstar-fig}
\end{figure}
...
\caption{Just like the \href{https://en.wikipedia.org/wiki/Death_Star}{Death Star}, this chapter is under construction. Image of agile space station construction methods via Wikimedia Commons \href{https://w.wiki/32PB}{w.wiki/32PB}}\label{fig:deathstar2-fig}
\end{figure}
...
\section{Computing for everybody}\label{creative}}
...
\caption{Whatever world you enter after you graduate, software has either eaten it, currently eating it or working out how to do so. Andreessen explains \href{https://a16z.com/2011/08/20/why-software-is-eating-the-world/}{why software is eating the world}. Software is eating your future. Portrait of \href{https://en.wikipedia.org/wiki/Marc_Andreessen}{Marc Andreesen} by JD Lasica on Wikimedia Commons \href{https://w.wiki/3V48}{w.wiki/3V48} made using the \href{https://apps.apple.com/gb/app/wikipedia/id324715238}{Wikipedia app}}\label{fig:eating-fig}
\end{figure}
...
\caption{Just like the \href{https://en.wikipedia.org/wiki/Death_Star}{Death Star}, this chapter is under construction. Image of agile space station construction methods via Wikimedia Commons \href{https://w.wiki/32PB}{w.wiki/32PB}}\label{fig:deathstar3-fig}
\end{figure}
...
\caption{I would have written a shorter \sout{letter} CV but I did not have the time. This quote (or meme) is frequently attributed to Blaise Pascale in his \emph{\href{https://en.wikipedia.org/wiki/Lettres_provinciales}{Lettres provinciales}} \citep{shorterletter} Public domain image by Gallica on Wikimedia Commons \href{https://w.wiki/3Uzn}{w.wiki/3Uzn}}\label{fig:shorterletter-fig}
\end{figure}
...
\item
  ✅ Have you got a second opinion from a ``resume robot''? Is it robot proof? See section \ref{robotproof} 🤖
\item
...
\item
  ✅ Does it fit comfortably on exactly one page (resume) or a two pages (CV)? Not one-and-a-half pages or more than two? See section \ref{length}
\end{enumerate}
...
\caption{Just like the \href{https://en.wikipedia.org/wiki/Death_Star}{Death Star}, this chapter is under construction. Image of agile space station construction methods via Wikimedia Commons \href{https://w.wiki/32PB}{w.wiki/32PB}}\label{fig:deathstar5-fig}
\end{figure}
...
\caption{Just like the \href{https://en.wikipedia.org/wiki/Death_Star}{Death Star}, this chapter is under construction. Image of agile space station construction methods via Wikimedia Commons \href{https://w.wiki/32PB}{w.wiki/32PB}}\label{fig:deathstar8-fig}
\end{figure}
...
\caption{Just like the \href{https://en.wikipedia.org/wiki/Death_Star}{Death Star}, this chapter is under construction. Image of agile space station construction methods via Wikimedia Commons \href{https://w.wiki/32PB}{w.wiki/32PB}}\label{fig:deathstar6-fig}
\end{figure}
...
\caption{Just like the \href{https://en.wikipedia.org/wiki/Death_Star}{Death Star}, this chapter is under construction. Image of agile space station construction methods via Wikimedia Commons \href{https://w.wiki/32PB}{w.wiki/32PB}}\label{fig:deathstar7-fig}
\end{figure}
...
\caption{Just like the \href{https://en.wikipedia.org/wiki/Death_Star}{Death Star}, this chapter is under construction. Image of agile space station construction methods via Wikimedia Commons \href{https://w.wiki/32PB}{w.wiki/32PB}}\label{fig:deathstar9-fig}
\end{figure}
...
\caption{Just like the \href{https://en.wikipedia.org/wiki/Death_Star}{Death Star}, this chapter is under construction. Image of agile space station construction methods via Wikimedia Commons \href{https://w.wiki/32PB}{w.wiki/32PB}}\label{fig:deathstar19-fig}
\end{figure}

\hypertarget{hacking}{%
\chapter{Hacking your future}\label{hacking}}

It's very easy to overlook mistakes in your own writing. That's true of any written communication such as a covering letter, personal statement, email or any message that you write. Mistakes are particularly common in CVs (or resumes) because you can spend \emph{hours} carefully polishing the words and the formatting but not see a fatal error at the top of page one. Hacking other people's CV's will help you improve your own, and you may need to use \href{https://en.wikipedia.org/wiki/Kludge}{kludges} like the one shown on the million dollar bridge in figure \ref{fig:kludge-fig}. Returning to the bridge analogy introduced in section \ref{parti}, fixing other peoples bridges will help you improve your own.
...
A useful hacking technique is to take somebody elses stuff and fix or improve it. That works for written communication as well as actual \texttt{code}. The \protect\hyperlink{dogfooding}{dogfooding} technique, we've already talked about in section \ref{dogfooding} is a useful hacking technique which you can use by:
