...
\caption{Opposing forces of anxiety 😰 + calmness 😎 and happiness 🙂 + sadness 🙁 normally balance each other out over time 😐. If you are affected by poor mental health, feelings of anxiety or sadness will outweigh their counterparts, leading to \emph{persistent} anxiousness or depression. This chapter looks at what these mental health issues are and what you can do if you, or someone you know, is affected by poor mental health. Free body diagram by \href{https://visualthinkery.com}{Visual Thinkery} is licensed under \href{https://creativecommons.org/licenses/by-nd/4.0/}{CC-BY-ND}}\label{fig:free-body-fig}
\end{figure}
