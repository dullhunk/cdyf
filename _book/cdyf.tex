...
Hello and welcome to \emph{Coding Your Future}, the guidebook that will help you to design, build, test, debug and code your future in computing. This guidebook is aimed at students in higher education, both those studying Computer Science and those who are \emph{computationally curious}.

This guidebook (\href{https://www.cdyf.me}{cdyf.me}, \href{https://www.cdyf.me/cdyf.pdf}{cdyf.pdf} \& \href{https://www.cdyf.me/cdyf.epub}{cdyf.epub}) supports teaching at the University of Manchester, but it DOES NOT MATTER:
...
In most cases you shouldn't have to pay recruiters up front but job scammers will sometimes pose as recruiters so beware.

\hypertarget{beware-of-the-job-scammers}{%
\subsection{Beware of the job scammers}\label{beware-of-the-job-scammers}}

You are vulnerable when you are job hunting, and you may become more vulnerable over time if you are getting repeated rejections (which is quite normal). Unfortunately there are people looking to exploit your vulnerability through various kinds of employment fraud. You should be wary of anyone asking you for:
...
\item
  Lots of personal data which could be used for identity theft or other fraud
\item
  See for example \href{https://www.google.com/search?q=job+scam}{google.com/search?q=job+scam}
\end{itemize}
