...
Hello and welcome to \emph{Coding Your Future}, the guidebook that will help you to design, build, test and \emph{code} your future in computing. Published at \href{https://www.cdyf.me}{cdyf.me}, \href{https://www.cdyf.me/cdyf.pdf}{cdyf.pdf} \& \href{https://www.cdyf.me/cdyf.epub}{cdyf.epub}, it is aimed at ALL students in higher education. Although this guide supports teaching at the University of Manchester, it doesn't actually matter:
...
This guidebook will NOT teach you how to write code, there's already lots of fantastic resources to help you do that. We discuss some of them in chapter on \protect\hyperlink{computing}{computing your future}.
...
\tightlist
\item
  \href{bothering.html}{Surveying your future} discusses why you should bother reading any of this guidebook
\item
...
\item
  \href{listening.html}{Hearing your future} invites you to listen to students stories of their transition from education to employment
\item
  \href{actioning.html}{Actioning your future} gets you to think about your actions by emphasising verbs on your job applications
\item
...
\caption{This guidebook will help you build bridges to your future. Picture of the iconic \href{https://en.wikipedia.org/wiki/Golden_Gate_Bridge}{Golden Gate Bridge} in California adapted from an original by Frank Schulenburg (CC BY-SA) on Wikimedia Commons \href{https://w.wiki/37kY}{w.wiki/37kY}}\label{fig:goldengate-fig}
\end{figure}
...
\item
  Thanks to \href{https://www.gla.ac.uk/schools/computing/staff/quintincutts/}{Quintin Cutts}, \href{https://www.dur.ac.uk/research/directory/staff/?mode=staff\&id=106}{Steven Bradley}, \href{http://eecs.qmul.ac.uk/profiles/waitejanelisa.html}{Jane Waite} and \href{https://www.gla.ac.uk/pgrs/nicolalooker/}{Nicola Looker} for helping me setup and run \href{https://sigcse.cs.manchester.ac.uk/}{SIGCSE journal club}. Thanks to all the \href{https://sigcse.cs.manchester.ac.uk/who/}{journal clubbers} too, many of our journal club conversations have fed directly into the content of this guidebook
\item
...
What do they all have in common? They're all written in natural languages like the \href{Ehttps://en.wikipedia.org/wiki/English_language}{English language}, but without them, the software or hardware they describe and discuss would be useless.
...
Reading other people's code will improve your software engineering skills. Likewise, reading other peoples writing will improve your natural language engineering skills. Read anything, it might be novels, magazines, newspapers, stuff online or any of the books cited in the \href{reading.html}{references}. Find a time and place to do this every day and stick to it.
...
\item
  ...
  \end{itemize}
\item
  IBM hosts the annual Call for Code \href{https://developer.ibm.com/callforcode}{developer.ibm.com/callforcode} unlike other competitions, these have a \href{https://en.wikipedia.org/wiki/Social_responsibility}{social responsibility} themes for the benefit of society at large
\item
...
\caption{Casual work in hospitality or retail, such a supermarket like Budgens where I used to work as a teenager, is worth mentioning on your CV. If you have any experience of this kind, make sure you mention it and describe the skills you developed. Think carefully about the \protect\hyperlink{actioning}{verbs can you use} to describe casual experience.}\label{fig:budgens-fig}
\end{figure}
...
\subsection{Computing is creative}\label{creative}}

In the english speaking world, EVERYONE studies maths and english (or their native tongue):

\begin{itemize}
\tightlist
\item
  Why did you learn English? Was it so that you could become a professional writer?
\item
  Why did you learn Mathematics? Was it so that you could become a professional mathematician?
\end{itemize}

Of course not. You studied English because it's a tool that helps you express yourself and communicate with others. You studied maths so that you could become numerate, reason about the world, analyse data and solve problems.
...
\caption{Sam Aaron puts the creative case for computing by discussing programming as performance in his TEDx talk from 2016. \citep{youtube-sonicpi} The image in the figure is a screenshot, to \href{https://www.youtube.com/watch?v=0lTZ8Tuyu5I}{watch the 18 minute video on programming as performance here}.}\label{fig:sonicpi-fig}
\end{figure}



Computing is also an intellectually stimulating subject to study in its own right. If you don't believe me, I'm not going to make the case here. Have a look at Silvio Peroni's free \href{https://comp-think.github.io/}{comp-think} book, for teaching computational thinking and programming skills to people with a background in the humanities. \citep{peroni}

\hypertarget{eating}{%
\subsection{Computing is eating the world}\label{eating}}

Besides the social arguments, there are also strong economic
The software engineer and investor \href{https://en.wikipedia.org/wiki/Marc_Andreessen}{Marc Andreesesn} once pointed out that \href{https://a16z.com/2011/08/20/why-software-is-eating-the-world/}{software is eating the world}. \citep{eatingtheworld} The combination of software and hardware dominates the list of the world's largest corporations by market capitalisation, shown in figure \ref{fig:market-fig}.
...
\caption{If the stock markets are anything to go by, computing is eating the world. Computing is central to Apple, Microsoft, Amazon, Google and Facebook. The economic weight of Big Tech by YBSLE on Wikimedia Commons \href{https://w.wiki/3KEU}{w.wiki/3KEU}}\label{fig:market-fig}
\end{figure}



Even if you don't want to work for any of these organisations, this is good news for Computer Scientists. For example, demand of software developers (jokers?) is high, on a par with teaching and nursing in terms of numbers. In the UK, the most common jobs for graduates from 2017-18 are shown in Figure \ref{fig:nurses-fig}, based on data taken from an article on \href{https://wonkhe.com/blogs/what-might-the-graduate-labour-market-look-like-in-2021/}{the graduate labour market in 2021} \citep{wonkyball}
...
The flexibility of computing as a career means you have a broad range of options on where you can apply your computational skills.
...
It's all very well \emph{designing} your future but now you need to actually \emph{build} and \emph{test} it. An obvious place to start is with your CV, because that's where most people get going. How can you create a bug-free CV, resume or completed application form? How can you support applications with a strong personal statement or covering letter? These documents are your future so how can you debug your future? 🐛
...
\caption{\href{https://twitter.com/jonathanpblack}{Jonathan Black}, head of the careers service at the University of Oxford, explains how to create a top notch CV by replacing meaningless assertions with meaningful evidence. \citep{topnotchcv} The image in this figure is a screenshot, you can \href{https://www.youtube.com/watch?v=yjdvCHWVtE4}{watch the video here}}\label{fig:black-fig}
\end{figure}
...
\caption{How long should your CV be? Should you write a two page European style CV or an American style resume (one pager)? \citep{youtube-resume-or-cv} The image in the figure is a screenshot, you can \href{https://www.youtube.com/watch?v=0abDOKHS5T0}{watch the video here}}\label{fig:oneortwopager-fig}
\end{figure}
...
\caption{\label{tab:jobterms}How we use terms for jobs in this guidebook}
\centering
\begin{tabular}[t]{ll}
\toprule
Name & Job contract\\
\midrule
Insight & One to three weeks, sometimes known as “work experience”, “work shadowing”, “spring weeks”, “vacation schemes” or even “externship”. Usually unpaid, no job contract but often expensed. See [ratemyplacement.co.uk/insights](https://www.ratemyplacement.co.uk/insights) for example\\
Internship & Fixed term contract, typically 3 months full-time over summer, but anywhere between 1 and 6 months. Sometimes part-time, may be an assessed part of a degree award\\
Placement & Fixed term contract, typically 12 months long and an assessed part of a degree. In America these are [known as co-ops](https://career.vt.edu/experience/ceip/ceip-internship-coop.html)\\
Graduate job & Full-time permanent contract typically working in one department of an employer\\
Graduate scheme & Full-time permanent contract. Fast-track or high-flier scheme, up to two years, often rotating round different departments\\
\bottomrule
\end{tabular}
\end{table}
...
\tightlist
\item
  \textbf{SELLING}: You're trying to sell your services in a marketplace, for the best price you can get
\item
...
When people sell things, overselling and fake news shown in figure \ref{fig:fakenews-fig}, are often found.
...
\caption{Beware of fake news in the marketplace for jobs. Are employers as good as they say they are? Are you as good as you say you are? Public domain cartoon by Frederick Burr Opper via Wikimedia Commons \href{https://w.wiki/3KKt}{w.wiki/3KKt}}\label{fig:fakenews-fig}
\end{figure}



There's two kinds of overselling in the marketplace:
...
\item
  You exaggerate your achievements: It can be tempting to overstate your case to sell your services in the marketplace. A good reader or interviewer will be able to spot your fake news and find you out, see the \href{https://www.cdyf.me/debugging.html}{debugging chapter}
\end{enumerate}
...
Evidence can be classified into four categories:

\begin{enumerate}
\def\labelenumi{\arabic{enumi}.}
\tightlist
\item
  \textbf{Membership} are there professional organisations you can join? Do informal groups exist within the organisation that you can join? Are there committees you can become a member of?
\item
  \textbf{Participation} what communities or activities are you involved in?
\item
  \textbf{Capability} what skills and knowledge can you demonstrate capability of? What professional accreditation exist for these?
\item
  \textbf{Mastery} in the longer term, how can you demonstrate mastery of particular skills and knowledge?
\end{enumerate}

These badges may be generic or specific to the particular sector you are working in. Some examples of technical badges include:
...
Just three examples, there are many others covering both technical and non-technical skills. In many cases, your employer will encourage and possibly pay for you to get these certifications. There are many online platforms for doing so, some examples include:
...
See \href{https://www.cdyf.me/Peter_Byte.pdf}{cdyf.me/Peter\_Byte.pdf}
...
See \href{https://www.cdyf.me/Neil_Pointer.pdf}{cdyf.me/Neil\_Pointer.pdf}
...
See \href{https://www.cdyf.me/bryn.pdf}{cdyf.me/bryn.pdf} a snapshot taken in 2021 from \href{http://bryn.co.uk}{bryn.co.uk}
...
Finding a job often involves moving to another city or even country. So a simple way to improve your job prospects is to \href{finding.html}{broaden and deepen your job search} and \href{broadening.html}{consider all the alternatives}, geographically and otherwise.
...
Live \emph{Coding your Future} (COMP2CARS) sessions will be back in September 2021, see \href{https://www.manchester.ac.uk/discover/key-dates/}{manchester.ac.uk/discover/key-dates}

In the meantime see the \emph{Wednesday Waggle} at \href{https://waggle.cs.manchester.ac.uk/}{waggle.cs.manchester.ac.uk}

The weekly schedule for the live (synchronous) sessions for Coding Your Future will be published here.
