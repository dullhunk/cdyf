...
\caption{Don't read this book, gut it like a fish. \href{https://en.wikipedia.org/wiki/Disembowelment}{Disembowel it}. Eviscerate it. Which parts are nourishing flesh and which are less appetising gastrointestinal tract will depend on who you are and where you're at. CC0 Public domain image of fish gutting by Wilfredor via Wikimedia commons \href{https://w.wiki/_23m}{w.wiki/\_23m} adapted using the \href{https://apps.apple.com/gb/app/wikipedia/id324715238}{Wikipedia app}}\label{fig:gut-fig}
\end{figure}
...
Studying at University is about opening new doors to the future, some of which will take you down rabbit holes. As the poet \href{https://en.wikipedia.org/wiki/Lemn_Sissay}{Lemn Sissay} once said (figure \ref{fig:lemn-fig}):
...
You are reading the alpha version, the \href{https://en.wikipedia.org/wiki/Minimum_viable_product}{Minimum Viable Product} (MVP) of this guidebook, last updated on 17 June, 2021. That's software engineer talk for saying it isn't finished yet. Subsequent versions, will be continuously and iteratively released on a daily and weekly basis. They will include:
...
Whatever subject you are currently studying, adding some computing to your education will equip you with the computational thinking skills you need to be a creator, not just a consumer in modern society. Computing can open up new opportunities for you and improve your social mobility.
