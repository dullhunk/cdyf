...
Hello and welcome to \emph{Coding Your Future} (\href{https://www.cdyf.me}{cdyf.me}) the guidebook that will help you to design, build, test, hack and \texttt{code} your future in computing. Also published at \href{https://www.cdyf.me/cdyf.pdf}{cdyf.pdf} \& \href{https://www.cdyf.me/cdyf.epub}{cdyf.epub}, this book is aimed at ALL students in higher education. While the guide supports undergraduate teaching at the University of Manchester, it doesn't actually matter:
...
\caption{Don't read this book, gut it like a fish. \href{https://en.wikipedia.org/wiki/Disembowelment}{Disembowel it}. Eviscerate it. Enjoy the nourishing flesh and discard the less appetising organs of the gastrointestinal tract. You'll need to decide which is which. CC0 Public domain image of fish gutting by Wilfredor via Wikimedia commons \href{https://w.wiki/_23m}{w.wiki/\_23m} adapted using the \href{https://apps.apple.com/gb/app/wikipedia/id324715238}{Wikipedia app}}\label{fig:gut-fig}
\end{figure}
...
\item
  Chapter \ref{badging}: \emph{Badging your future} looks at evidence you should collect of your learning and development using various kinds of badges, digital and otherwise
\item
...
If you'd like to contribute this guidebook, I welcome constructive feedback from \href{https://en.wikipedia.org/wiki/Critical_friend}{critical friends}. I'm looking for feedback and contributions on everything in this guidebook from the small things like typos, grammatical errors and spelling mistakes through to bigger issues for each chapter such as:
...
\item
  Thanks to \href{https://www.dur.ac.uk/research/directory/staff/?mode=staff\&id=106}{Steven Bradley}, \href{https://www.gla.ac.uk/schools/computing/staff/quintincutts/}{Quintin Cutts} and \href{http://eecs.qmul.ac.uk/profiles/waitejanelisa.html}{Jane Waite} for helping me setup and run \href{https://sigcse.cs.manchester.ac.uk/}{SIGCSE journal club}. Thanks to all the \href{https://sigcse.cs.manchester.ac.uk/who/}{journal clubbers} too, both regular and irregular including \href{https://www.brettbecker.com/}{Brett Becker}, Ceredig Cattanach-Chell, \href{https://en.wikipedia.org/wiki/James_H._Davenport}{James Davenport}, \href{https://www.nottingham.ac.uk/computerscience/people/colin.johnson}{Colin Johnson} and \href{https://www.gla.ac.uk/pgrs/nicolalooker/}{Nicola Looker}, \href{https://www.gcu.ac.uk/cebe/staff/jim\%20paterson/}{Jim Paterson}, \href{https://en.wikipedia.org/wiki/Sue_Sentance}{Sue Sentance} and \href{https://www.brookes.ac.uk/templates/pages/staff.aspx?uid=p0073862}{David Sutton}. Many of our journal club conversations have fed directly into the content of this guidebook
\item
...
You are reading the alpha version, the \href{https://en.wikipedia.org/wiki/Minimum_viable_product}{Minimum Viable Product} (MVP) of this guidebook, last updated on 19 June, 2021. That's software engineer talk for saying it isn't finished yet. Subsequent versions, will be continuously and iteratively released on a daily and weekly basis. They will include:
...
The art of communication is a huge subject which extends far beyond the scope of this guidebook. So for the rest of this chapter, we'll focus on written communication. The pen is mightier than the sword, see figure \ref{fig:mighty-pen-fig}.
...
\caption{Need to arm yourself with a powerful weapon for communication? Develop your written communication skills because \href{https://en.wikipedia.org/wiki/The_pen_is_mightier_than_the_sword}{the pen (and keyboard) is mightier than the sword}. Public domain image of drawing of Cardinal Richelieu by \href{https://en.wikipedia.org/wiki/Henry_Alexander_Ogden}{Henry Alexander Ogden} via Wikimedia Commons \href{https://w.wiki/3WHg}{w.wiki/3WHg} adapted using the Wikipedia app}\label{fig:mighty-pen-fig}
\end{figure}
...
Whatever future world you enter into after you graduate, there's a good chance it has already been eaten by software. In 2011, the software engineer and billionaire investor \href{https://en.wikipedia.org/wiki/Marc_Andreessen}{Marc Andreesen} (figure \ref{fig:eating-fig}) outlined why (in his opinion) software is eating the world, in \emph{The Wall Street Journal} \citep{eatingtheworld}.
...
\item
  \textbf{EVIDENCE}: Where evidence exists, you should point to it. It might be a certificate, a badge (see chapter \ref{badging}) or the actual software itself
\end{itemize}
...
\item
  ...
  -Google job search is an impressive product, but it doesn't index \emph{everything}. See \href{https://www.bbc.co.uk/news/technology-44853472}{Google's job hunting service comes to UK} \citep{noindeed} If you're looking for a job AT google, they have moved from \href{https://jobs.google.com/about/}{jobs.google.com} to \href{https://careers.google.com/}{careers.google.com}, see also section \ref{bignames}
\item
...
\caption{Rejection is a normal part of applying for jobs, some of your applications may disappear without trace into employers ``black holes'', especially if they are large and have a strong gravitational force on job applicants like you. CC-BY image of the supermassive black hole in \href{https://en.wikipedia.org/wiki/Messier_87}{Messier 87} created using the \href{https://en.wikipedia.org/wiki/CHIRP_(algorithm)}{CHIRP algorithm} by the \href{https://en.wikipedia.org/wiki/Event_Horizon_Telescope}{Event Horizon Telescope} team via Wikimedia Commons \href{https://w.wiki/3RCa}{w.wiki/3RCa}}\label{fig:blackhole-fig}
\end{figure}
...
\hypertarget{beware-of-the-rollercoaster}{%
\subsection{Beware of the rollercoaster}\label{beware-of-the-rollercoaster}}
...
\caption{The greater your code, the greater your superpower. The greater your superpower, the greater your responsibility. What are your responsibilities and how can you use your power responsibly? \citep{spiderman, responsiblecs, Shapiro2021}}\label{fig:spiderman-fig}
\end{figure}
...
\caption{In European folklore, doing a \href{https://en.wikipedia.org/wiki/Deal_with_the_Devil}{deal with the devil} is a cultural motif that recurs in works of art. Wealth and power are just two of the items exchanged for a persons soul as part of diabolical deal. Public domain image of a painting of diabolical dealing by \href{https://en.wikipedia.org/wiki/Michael_Pacher}{Michael Pacher} on Wikimedia Commons at \href{https://w.wiki/3VvX}{w.wiki/3VvX} adapted using the \href{https://apps.apple.com/gb/app/wikipedia/id324715238}{Wikipedia app}}\label{fig:diabolical-fig}
\end{figure}
...
Let's take a break. Here are some \href{https://en.wikipedia.org/wiki/Breakpoint}{breakpoints}, pause your code and check these parameters and variables:
...
It will go badly, you will struggle to fit in and won't meet the expectations of your employer. Once you were \href{https://en.wikipedia.org/wiki/Star-crossed}{star-crossed lovers}, (see figure \ref{fig:romeo-fig}) but the relationship has turned sour and may end diving into tragedy. \citep{romeo, goblewroe}
...
\hypertarget{badging}{%
\chapter{Badging your future}\label{badging}}

Learning is a life-long process, a \href{https://en.wikipedia.org/wiki/While_loop}{\texttt{while} loop} in which you continuously develop new skills and knowledge. As you loop the loop, you can collect evidence of your personal and professional development. Some of this evidence can be ``badged'' in various ways and collected to form part of your professional identity, the jar called \texttt{ME} in figure \ref{fig:while-learning-fig}.
...
\caption{A degree certificate is an offline paper badge that provides evidence of your academic skills and learning while at University. \href{https://bryanmmathers.com/a-certificate-is-just-an-offline-badge/}{A certificate is just an offline badge} by \href{https://visualthinkery.com/}{Visual Thinkery} is licenced under \href{https://creativecommons.org/licenses/by-nd/4.0/}{CC-BY-ND}}\label{fig:degree-cert-fig}
\end{figure}
...
These details give a bit more detail that a degree certificate does not but they are limited to academic achievements. You are \emph{much} more than your grades, because there's a lot about your character that is difficult or impossible to measure, see figure \ref{fig:more-than-grades-fig}.
...
\caption{\href{https://bryanmmathers.com/open-badges-paint-a-better-picture/}{Open Badges paint a better picture\ldots{}} by \href{https://visualthinkery.com/}{Visual Thinkery} is licenced under \href{https://creativecommons.org/licenses/by-nd/4.0/}{CC-BY-ND}}\label{fig:fine-grained-fig}
\end{figure}
...
Digital badges provide a solution to this problem, just like your degree certificate is a verified indicator of your accomplishment, a digital badge does the same but in a more detailed way. Rather than being physical, a digital badge is virtual and transferable. It's just a \texttt{*.png} graphic file which has been digitally signed and contains metadata. This means it can be displayed on your CV, on social media or ``stacked'' into a digital portfolio collection as shown in figure \ref{fig:badge-properties-fig}.

The Mozilla Foundation have defined an open standard for digital badges \citep{openbadges} so they can be issued and hosted by different organisations. \citep{belshaw}
...
\item
  \texttt{issuer} the organisation awarding the badge, e.g.~The University of Poppleton
\item
...
\caption{what are badges \href{https://bryanmmathers.com/open-badges-data-inside/}{There's data inside open badges} by \href{https://visualthinkery.com/}{Visual Thinkery} is licenced under \href{https://creativecommons.org/licenses/by-nd/4.0/}{CC-BY-ND} for the \href{https://en.wikipedia.org/wiki/City_and_Guilds_of_London_Institute}{City and Guilds of London Institute}}\label{fig:data-inside-fig}
\end{figure}



Your University or employer can issue badges, so for example, the University of Manchester issues badges for leaders of its Peer Assisted Study Scheme (PASS) \href{http://www.peersupport.manchester.ac.uk/}{www.peersupport.manchester.ac.uk}. As example of a PASS leader badge is shown in
...
\caption{There are many different activities which badges can be awarded for including membership, participation, capability and mastery. \href{https://bryanmmathers.com/badge-taxonomy-v0-2/}{Badge taxonomy} by \href{https://visualthinkery.com/}{Visual Thinkery} is licensed under \href{https://creativecommons.org/licenses/by-nd/4.0/}{CC-BY-ND}}\label{fig:badgetype-fig}
\end{figure}
...
\item
  CS50 certificates from EdX \href{https://cs50.harvard.edu/x/2020/certificate/}{cs50.harvard.edu/x/2020/certificate}
\item
  RedHat certification \href{https://www.redhat.com/en/services/certifications}{redhat.com/en/services/certifications}
\end{itemize}
...
\caption{An example of an Amazon badge provided by \href{https://info.credly.com/}{credly.com} for an \href{https://www.credly.com/org/amazon-web-services/badge/aws-certified-developer-associate}{AWS certified developer}.}\label{fig:amazon-badge-fig}
\end{figure}
...
\hypertarget{tldrb}{%
\section{Summarising your badges}\label{tldrb}}
...
\caption{skills \ldots{} by \href{https://visualthinkery.com/}{Visual Thinkery} is licenced under \href{https://creativecommons.org/licenses/by-nd/4.0/}{CC-BY-ND} for the \href{https://en.wikipedia.org/wiki/City_and_Guilds_of_London_Institute}{City and Guilds of London Institute}}\label{fig:skills-bills-fig}
\end{figure}
