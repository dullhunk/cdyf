...
Another good source of projects is to \href{https://dev.to/rose/fixing-a-bug-on-my-open-source-project-from-start-to-finish-1749}{fix a bug in an open source project}. \citep{fixabug} It might sound trivial, but fixing a bug demonstrates that you can collaborate with others, understand the toolchain being used (which might be complex) and solve problems.
