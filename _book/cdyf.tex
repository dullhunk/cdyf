...
\item
  From the command line \texttt{git\ clone\ https://github.com/dullhunk/cdyf.git} the repository and submit pull requests from your own setup
\end{itemize}
...
\subsection{Specific contributions sought}\label{dontbeshy}}
...
You are reading the alpha version, the \href{https://en.wikipedia.org/wiki/Minimum_viable_product}{Minimum Viable Product} (MVP) of this guidebook, last updated on 02 June, 2021. That's software engineer talk for saying it isn't finished yet. Subsequent versions, will be continuously and iteratively released on a daily and weekly basis. They will include:
...
\tightlist
\item
  Raise an issue via the project's issue tracker, such as \href{https://guides.github.com/features/issues/}{github issues} \citep{githubissues}
\item
  \href{https://dev.to/rose/fixing-a-bug-on-my-open-source-project-from-start-to-finish-1749}{Fix a bug}. \citep{fixabug} It might sound trivial, but fixing a bug demonstrates that you can collaborate with others, understand the architecture and toolchain being used (which might be complex) and solve problems. Github has a \texttt{good\ first\ issue} tag which helps new contributors identify starting points, see \href{https://goodfirstissue.dev/}{goodfirstissue.dev} for some examples.
\end{enumerate}
...
At school, everyone learns to the read, write and do maths. These are sometimes known as \href{https://en.wikipedia.org/wiki/The_three_Rs}{the three Rs} but:
...
So you worked in a team? \texttt{Worked} is vague. What was your role and contribution? How long did the project last? How many people were on your team? What was the result?
...
\hypertarget{misc}{%
\subsection{Your extras}\label{misc}}

If you've anything else you want to highlight besides education, experience, projects and awards you \emph{may} have room for one more section. Try to come up with a better name than \texttt{Miscellaneous} (which sounds like a dumping ground) or you might decide to have a dedicated \texttt{skills} section but see \ref{mycvsk}.
...
\caption{Rejection is a normal part of applying for jobs, some of your applications may disappear without trace into employers ``black holes'', especially if they are large and have a strong gravitational force on job applicants. CC-BY image of the black hole in \href{https://en.wikipedia.org/wiki/Messier_87}{Messier 87} by the \href{https://en.wikipedia.org/wiki/Event_Horizon_Telescope}{Event Horizon Telescope} team via Wikimedia Commons \href{https://w.wiki/3RCa}{w.wiki/3RCa}}\label{fig:blackhole-fig}
\end{figure}
...
\tightlist
\item
  Eat your own dogfood, read your own written work ALOUD
\item
  Eat somebody elses dogfood
