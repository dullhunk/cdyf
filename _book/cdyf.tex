...
\item
  Add comments by annotating the \href{https://www.cdyf.me/cdyf.pdf}{cdyf.pdf} using your weapon of choice (iPad, \href{https://en.wikipedia.org/wiki/ReMarkable}{reMarkable} or whatever) and \href{http://www.cs.man.ac.uk/~hulld/contact.html}{email it to me}
\item
...
\item
  Suggest changes via the Microsoft Word version at \href{http://cdyf.me/cdyf.docx}{cdyf.docx}, which is solely for editing purposes. The text is all there, but the pagination and graphic placement as good as the pdf version.\footnote{Don't say I didn't warn you!} Make sure you've turned on \href{https://support.microsoft.com/en-us/office/track-changes-in-word-197ba630-0f5f-4a8e-9a77-3712475e806a}{track changes} if you want to suggest changes via Word.
\item
  If you don't want to use the \href{https://github.com/}{github.com}, PDF or Word versions, just \href{http://www.cs.man.ac.uk/~hulld/contact.html}{email me suggestions for improvements}
\end{itemize}

Any corrections or suggestions that get included will be listed in the acknowledgements section \ref{thanks}, unless you tell me otherwise. I welcome all improvements, however small.
...
The \emph{images} used in this guidebook are published under different licenses, depending on their source. For example, Bryan Mathers illustrations are licensed CC-BY-ND, see figure \ref{fig:kapow-fig}. Other images have different licences, for example, images from Wikimedia Commons (\href{https://commons.wikimedia.org/}{commons.wikimedia.org}) are published under CC-BY or CC-BY-SA or public domain. Each figure caption gives details of its licence.
...
This site is hosted on \href{https://www.netlify.com/}{netlify.com}, see the \href{https://www.netlify.com/privacy/}{netlify privacy policy}. This site also uses \href{https://docs.netlify.com/monitor-sites/analytics/}{netlify analytics} and \href{https://en.wikipedia.org/wiki/Google_Analytics}{Google Analytics} to monitor use, both of which comply with the General Data Protection Regulation (GDPR).
...
You are reading the alpha version, the \href{https://en.wikipedia.org/wiki/Minimum_viable_product}{Minimum Viable Product} (MVP) of this guidebook, last updated on 20 May, 2021. That's software engineer talk for saying it isn't finished yet. Subsequent versions, will be continuously and iteratively released on a daily and weekly basis. They will include:
...
\caption{Reading The Friendly Manual(s) (\href{https://en.wikipedia.org/wiki/RTFM}{RTFM}) some of it you will love, some of it you won't. Either way, reading allows you to learn from other people's hard won experience \emph{and} improve your own written communication skills. Just like you improve your coding skills by writing and reading code, you will improve your written communication skills by reading and writing in natural langauges like English. \href{https://bryanmmathers.com/the-motivation-for-reading/}{The motivation for reading} by \href{https://visualthinkery.com/}{Visual Thinkery} is licenced under \href{https://creativecommons.org/licenses/by-nd/4.0/}{CC-BY-ND} with help from \href{https://en.wikipedia.org/wiki/Michael_Rosen}{Michael Rosen}}\label{fig:rtfm-fig}
\end{figure}
...
\subsection{Other training course}\label{othertrain}}
...
\caption{Your network can help you before, during and after your employment, so be sure to grow your network when you can. This includes both the stronger ties of trusted friends alongside the the weaker ties too, described in section \ref{weakties}. Both are important. \href{https://bryanmmathers.com/its-all-about-people/}{It's all about people} by \href{https://visualthinkery.com/}{Visual Thinkery} is licensed under \href{https://creativecommons.org/licenses/by-nd/4.0/}{CC-BY-ND}}\label{fig:allpeople-fig}
\end{figure}
...
Your actions define your impact, see figure \ref{fig:action-fig}. When writing job applications, think about the stories you can tell with your actions.ß What was the context, action and result (CAR) we discussed in section \ref{carstar}?
...
\caption{The biggest waste of time is the time spent not getting started on a project. Your future might seem big and unknown but not as scary as you might think and getting started can be surprisingly enjoyable. \href{hhttps://bryanmmathers.com/new-project-every-time/}{New Project? Every time\ldots{}} by \href{https://visualthinkery.com/}{Visual Thinkery} is licenced under \href{https://creativecommons.org/licenses/by-nd/4.0/}{CC-BY-ND}}\label{fig:schedule-fig}
\end{figure}
...
\caption{Libraries give us power. The British Museum Reading Room panorama by David Iliff on Wikimedia Commons \href{https://w.wiki/3BEs}{w.wiki/3BEs}}\label{fig:library-power-fig}
\end{figure}
