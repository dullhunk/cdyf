...
\item
  Experiment with using some job search strategies
\item
...
We all procrastinate because there's an infinite number of tasks we could be doing but a finite amount of time in which to do them, around four thousand weeks. \citep{fourthousandweeks}
...
I'm writing this guidebook because I think students like you need resources to help you design, build, test and code your future in computing. I'm offering information, advice and guidance to help you learn to compete for jobs while at University, or shortly after graduating, in a flexible way. This means you can choose your own:

\begin{itemize}
\tightlist
\item
  \textbf{PACE} By giving you greater control over how much, at what level, and what kind of intensity you study, see section \ref{gut}
\item
...
\item
  \textbf{PATHWAY} By choosing your own path through this course, and evidencing the parts you care about with stackable microcredentials as part of your lifelong learning, see chapter \ref{achieving}
\end{itemize}
...
You are reading the alpha version, the \href{https://en.wikipedia.org/wiki/Minimum_viable_product}{Minimum Viable Product} (MVP) of this guidebook, last updated on 11 January, 2023. That's software engineer talk for saying \emph{it isn't finished yet}. Subsequent versions, will be continuously and iteratively released on a daily and weekly basis. They will include:
...
\caption{Just like the \href{https://en.wikipedia.org/wiki/Death_Star}{Death Star}, this \sout{galactic superweapon} book is under construction. As of 11 January, 2023 this book is an estimated \textbf{37\% complete}. Image of agile weapon engineering in \emph{Star Wars} via Wikimedia Commons \href{https://w.wiki/5N6q}{w.wiki/5N6q} adapted using the \href{https://apps.apple.com/gb/app/wikipedia/id324715238}{Wikipedia app}}\label{fig:deathstar-fig}
\end{figure}
