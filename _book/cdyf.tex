...
If you find what you're reading here useful and you think other people might benefit too, I'd really appreciate some stars (likes) on the guidebook's repository at \href{https://github.com/dullhunk/cdyf}{github.com/dullhunk/cdyf} to help people find us. 🤩⭐️🤩
...
You are reading the alpha version, the \href{https://en.wikipedia.org/wiki/Minimum_viable_product}{Minimum Viable Product} (MVP) of this guidebook, last updated on 15 July, 2022. That's software engineer talk for saying \emph{it isn't finished yet}. Subsequent versions, will be continuously and iteratively released on a daily and weekly basis. They will include:
...
\begin{figure}
\includegraphics[width=0.33\linewidth]{images/raluca} \includegraphics[width=0.33\linewidth]{images/raluca} \includegraphics[width=0.33\linewidth]{images/raluca} \caption{Raluca Cruceru is a software engineer at CERN, standing here in front of \href{https://en.wikipedia.org/wiki/ALICE_experiment}{A Large Ion Collider Experiment (ALICE)} part of the Large Hadron Collider at CERN, see \href{https://careers.cern/Raluca}{careers.cern/Raluca}. Picture reused with permission from \href{https://www.linkedin.com/in/raluca-cruceru/}{linkedin.com/in/raluca-cruceru}, thanks Raluca.}\label{fig:raluca2-fig}
\end{figure}
...
I'm also interested in speaking to people who graduated a while back, not just this years graduates, but any back to 1965. 🎓 \citep{babygrowsup}
...
\begin{quote}
``All your dreams are made, when you're chained to \href{https://en.wikipedia.org/wiki/Comparison_of_issue-tracking_systems}{the tracker} and the software trade. What's your story, coding glory?'' (with apologies to the Gallagher brothers see figure \ref{fig:gallagher2-fig})
\end{quote}
...
This is an optional question inspired by the \href{https://en.wikipedia.org/wiki/Philip_K._Dick}{Philip K. Dick} novel \emph{\href{https://en.wikipedia.org/wiki/The_Minority_Report}{The Minority Report}} and subsequent film adaptation, see figure \ref{fig:minority-fig}, minority report asks our guests:
...
We love our music, films and podcasts and make gratuitous references to them throughout \emph{Coding your Future}. Critics say our playlist is clogged up with:

\begin{itemize}
\tightlist
\item
  \href{https://en.wikipedia.org/wiki/Dad_rock}{DadRock} 🎸
\item
  \href{https://en.wikipedia.org/wiki/Shoegaze}{cardigan-swinging indie shoegazing}
\item
  Lancashire boy bands, especially the Mancs \emph{and} the Scousers \citep{mancashire}
\item
  other antiquities from a bygone era \citep{dadrock}
\end{itemize}
