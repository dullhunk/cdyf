...
\item
  Chapter \ref{reviewing}: \emph{Reviewing their future} invites you to put yourself in the employers shoes by reading some CVs
\item
...
\item
  Click on the \texttt{Edit\ this\ page} link, which appears on the bottom right hand side of every page published at \href{https://www.cdyf.me}{cdyf.me} when viewed with a reasonably large screen
\item
  Most of the book is generated from the \texttt{*.Rmd} files, so these are the files to edit
\item
...
There's at two kinds solutions to this problem, that involve \protect\hyperlink{dogfooding}{dogfooding}:

\begin{enumerate}
\def\labelenumi{\arabic{enumi}.}
\tightlist
\item
  Eat your own dogfood: we've already talked about in section \ref{dogfooding}, this means reading your own written work ALOUD
\item
  Eat somebody elses dog, debug a friends or peers CV by swapping with them and giving them constructive feedback
