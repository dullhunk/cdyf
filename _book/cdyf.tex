...
Thanks to Martin Clutterbuck, Rebecca Clare, Richard O'Beirne, Simon Witter, Paddy, Isobel, Howard, Gavin, Sara, Spiro and everyone else in the journal production team at \href{https://www.flickr.com/photos/dullhunk/4042838703}{Blackwell Science Ltd} for looking after me in my first job as a freshly minted graduate. Thanks to Eileen, Anne \& Richard for giving me a home from home.
...
So thanks Manchester for \href{https://en.wikipedia.org/wiki/Popular_music_of_Manchester}{the music}, the best football team in the world and being Mancunian. \href{https://www.youtube.com/watch?v=PszMmYpQjPo}{This is the place}! \citep{longfella} 🙏
...
Thanks to Mitch at \href{https://greentortoise.com/}{Green Tortoise Adventure Travel} for driving, entertaining and feeding a bus load of us \href{https://en.wikipedia.org/wiki/San_Francisco_(Be_Sure_to_Wear_Flowers_in_Your_Hair)}{hippies with flowers in our hair} from San Francisco to New York via some of America's finest wildernesses (and cookouts) in the \href{https://en.wikipedia.org/wiki/Yellowstone_National_Park}{Yellowstone}, \href{https://en.wikipedia.org/wiki/Grand_Teton_National_Park}{Grand Teton} and \href{https://en.wikipedia.org/wiki/Badlands_National_Park}{Badlands} National Parks.

Thanks to \href{https://wi.mit.edu/news/memoriam-thomas-gochberg}{Thomas Gochberg} and Letty Gochberg for your excellent hospitality in New York, transatlantic history lessons and showing me the best parts of Manhattan. Thanks Pat, Colin and Rob Willmott for the introduction via \href{https://en.wikipedia.org/wiki/Tall_Ships_America}{Tall Ships America} in Plymouth, Devon from where the \href{https://en.wikipedia.org/wiki/Mayflower}{Mayflower} (eventually) set off for the \href{https://en.wikipedia.org/wiki/New_World}{New World} in 1620.
...
You are reading the alpha version, the \href{https://en.wikipedia.org/wiki/Minimum_viable_product}{Minimum Viable Product} (MVP) of this guidebook, last updated on 10 January, 2022. That's software engineer talk for saying it isn't finished yet. Subsequent versions, will be continuously and iteratively released on a daily and weekly basis. They will include:
...
\tightlist
\item
  \href{https://aws.amazon.com/education/awseducate/aws-educate-job-board/}{aws.amazon.com/education} is a dedicated jobs board for students with (or working towards) Amazon Web Services (AWS) cloud computing skills
\item
