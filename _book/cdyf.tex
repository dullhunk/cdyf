...
\tightlist
\item
  \textbf{Code:} Instructions, algorithms, recipes and strategies contained in this guidebook. This \texttt{code} is for you, not a machine.
\item
...
It looks like the reboot has finished, so we're ready to go. In the next chapter, we'll starting with who you are. What's your story, coding glory?
