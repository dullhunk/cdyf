# Raluca's Story {#raluca}

Meet Raluca Cruceru, shown in figure \@ref(fig:raluca-fig). She graduated with a Bachelor of Science degree in Human-Computer Interaction (HCI) with Industrial Experience in 2020 when this episode was first recorded. She completed her industrial experience at [home.cern](https://home.cern/) and a summer internship at [www.koder.ly](https://www.koder.ly/) in Oldham, Greater Manchester.
...
cat('<iframe data-testid="embed-iframe" style="border-radius:12px" src="https://open.spotify.com/embed/episode/2KWMfGfBUTQMyzFTsZlf60" width="100%" height="152" frameBorder="0" allowfullscreen="" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture" loading="lazy"></iframe>')
```
...
## Why study Computer Science? {#raluca-why}

(You're) about to graduate and go off into the big wide world. So I think it's always interested me hearing what made what made people study computer science so what was it that made want to study it? While you were doing your exams, applying to Manchester and what why did you study why did you choose to study computer science as a subject? Not why Manchester necessarily, but why computer science?
...
## Web Applications UK, now Koder.ly {#koderly}
...
```{r koderly-fig, echo = FALSE, fig.align = "center", out.width = "100%", fig.cap = "(ref:captionkoderly)"}
knitr::include_graphics("images/koderly.png")
```
(ref:captionkoderly) Formerly known as Web Applications UK, koder.ly are a bespoke software company based in Oldham, Manchester. For details of their summer internships and placements, see [koder.ly/work-placements](https://www.koder.ly/work-placements/) Screenshot of the koder.ly website taken in 2023.


> Raluca: Well, to be honest, I was very focused on CERN because I knew I wanted to work there. However, my I was very doubtful. Regarding my chances. I thought it was my only option. I applied for other companies in the UK. In places like CERN will expect you to have, or your application will stand out a lot more if you've got some experience like Yeah.

So you've done a summer job Web applications UK, which is now called, they've changed their name now to [Koder.ly](https://www.koder.ly/) with a `K` (see figure \@ref(fig:koderly-fig)). So, you've got a broad exposure to different sorts of software engineering ideas, working in a team and that kind of stuff.
...
(ref:captioncern2) CERN employs ten times more engineers and technicians than physicists [@hullcern]. [Fair use](https://en.wikipedia.org/wiki/Fair_use) image via Wikimedia Commons [w.wiki/4qmF](https://w.wiki/4qmF) adapted using the [Wikipedia app](https://apps.apple.com/) 🇪🇺
...
## Audio podcast on YouTube {#ralucatube}

You can listen to this episode wherever you get your podcasts including Apple, Spotify, Amazon, YouTube and more, see section \@ref(subscribing) and figure \@ref(fig:raluca-vid)

```{r raluca-vid, echo = FALSE, fig.align = "center", out.width = "99%", fig.cap = "(ref:captionyoupodcast)"}
knitr::include_url('https://www.youtube.com/embed/Rnj_xG5BcCc')
```
