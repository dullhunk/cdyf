...
So, here are some fictitious CVs for you to debug, from students of Computer Science. They are based on CVs I've seen, warts and all. Can you spot their triumphs and tragedies? Can you debug their CV against the sample job description below?
...
Neil loves the C programming language, but his half-brother from his fathers second marriage, Neil Pointer-Exception, prefers Java. There is lots of sibling rivalry between


## Sample CoolTech Job advert
