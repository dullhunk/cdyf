...
\caption{How long should your CV be? Should you write a two page European style CV or an American style resume (one pager)? [@youtube-resume-or-cv]}(\#fig:oneortwopager-fig)
\end{figure}
