...
* Chapter \@ref(reviewing): *Reviewing their future* invites you to put yourself in the employers shoes by reviewing other people's CVs
...
If you'd like to contribute this guidebook, I welcome constructive feedback. There are lots of ways you can contribute, depending on how comfortable you are with Git:
...
* Most of the guidebook is generated from the [RMarkdown](https://en.wikipedia.org/wiki/Markdown) (`*.Rmd` files), so these are the only files you need to edit because they generate everything else including the `*.html`, `*.tex`, `*.pdf`,`*.epub` and `*.docx`  files
...
* Fork the repository, make changes and submit a pull request [github.com/dullhunk/cdyf/pulls](https://github.com/dullhunk/cdyf/pulls). If you need to brush-up on your forking skills see [makeapullrequest.com](http://makeapullrequest.com/)
...
### Specific contributions sought {#dontbeshy}

I'm looking for all kinds of constructive feedback from [critical friends](https://en.wikipedia.org/wiki/Critical_friend). This includes small things (like typos and grammatical errors) through to bigger issues for each chapter such as:

* Does the chapter make sense, is it clear?
* Does it have the right tone, is it pitched at the right level? Not patronising?
* Is it too long and waffly or too short?
* Are there too many (or too few) pictures?
* Is it well scoped? Too broad or too narrow?
* Are the stated learning objectives met by the chapter?
* Are the activities clear? Can students understand why the activities are recommended?
* Will it make sense to global readers e.g. some students come from China and India may not understand the quirks and idioms of English language
...
* Any issues with equality, diversity and inclusion?
...
(ref:captionstannes) Good governance is crucial to good schools. Many schools like St. Anne's, and the hundreds of children they educate every year, need help from skilled people on their governing boards. Why not serve your local community as a “[critical friend](https://en.wikipedia.org/wiki/Critical_friend)” on the governing board of a school? All ages are welcome, but especially younger governors. [@youngovernors] Take a look at [governorsforschools.org.uk](https://governorsforschools.org.uk/). Fair use image via Wikimedia Commons [w.wiki/33Xs](https://w.wiki/33Xs) made with the [Wikipedia app](https://apps.apple.com/us/app/wikipedia/id324715238)
...
Keith Mitchell ([\@apiadventures](https://github.com/apiadventures)), Jan Machacek ([\@janm399](https://github.com/janm399)), Zee Somji ([\@ezeethg](https://github.com/ezeethg)), Tsvetankov ([\@Tsvetankov](https://github.com/Tsvetankov)), teobalmos ([\@teobalmos](https://github.com/teobalmos)), Richard Gourley ([\@richardgourley](https://github.com/richardgourley)), captaman0 ([\@captaman0](https://github.com/captaman0)), iliketohelp ([\@iliketohelp](https://github.com/iliketohelp))
...
The first part of this book is about designing your future. So before we get started, we need to reboot and tackle a fundamental design issue. Why the hell would you want to bother with your future? Why should read this guidebook when you have so many other things to do right now:
...
* Reboot your future by
    + Setting your expectations for using this guidebook
    + Travelling down the rabbit hole into the underworld of employment
    + Discuss some of the gaps that exist between education and employment and how you can fill them
...
You will spend lots of time in this wonderland, potentially as much as 80,000 hours of your life. [@iip1; @iip2] So join me down the rabbit hole, it's fun (honest), and sooner or later you'll have to come down here anyway.
...
You might be tempted to postpone making difficult career decisions. I'll do it tomorrow. I'll do it next week. I'll do it next year. I'll finish this assignment. I'll finish this exam. I'll finish this semester. Procrastination is a part of the human condition. There is [good and bad procrastination](http://paulgraham.com/procrastination.html) [@procrastination].
...
You are reading the alpha version, the [Minimum Viable Product](https://en.wikipedia.org/wiki/Minimum_viable_product) (MVP) of this guidebook, last updated on 28 May, 2021. That's software engineer talk for saying it isn't finished yet. Subsequent versions, will be continuously and iteratively released on a daily and weekly basis. They will include:
...
### Your future is first person {#firstperson}
...
\caption{Palliative care nurse Bronnie Ware explains the top five regrets of the dying. [@youtube-bronnie] Bronnie learned a lot from looking after people on their deathbeds, then wrote it all down in a fantastic book [@regrets]. The image in the figure is a screenshot, you can [watch the two minute video here](https://www.youtube.com/watch?v=nayz3xJxRTA) }(\#fig:bronnie-fig)
\end{figure}
...
\caption{Where will you be five years from now? Best-selling author of *Colouring Your Parachute* Dick Bolles discusses the gaps between education and employment. [@youtube-bolles] The image in the figure is a screenshot, you can [watch the full 32 minute talk here](https://www.youtube.com/watch?v=oeP6Pm3Xf-8) }(\#fig:bolles-fig)
\end{figure}
...
> [pic.twitter.com/D2SP4iJspT](https://t.co/D2SP4iJspT)
>
> --- lizandmollie (\@lizandmollie) [February 23,
> 2020](https://twitter.com/lizandmollie/status/1231605700960432128)
...
(ref:captionsocialmedia) Social media like LinkedIn clearly has its uses (see section \@ref(links)) but you you don't *have* to be on it at all. Poor mental health is just one reason to be wary of social media, for nine other reasons read Jaron Lanier's polemic. [@lanier] Notes to Strangers by [andy-leek.com](http://www.andy-leek.com/) photographed by [Duncan Cumming](https://www.flickr.com/photos/duncan/51014540593)
...
* [Self-documenting code](https://en.wikipedia.org/wiki/Self-documenting_code) self descriptive code
...
Making software isn't all about what you can do as an individual but rather how you contribute to a team. It's easy to get carried away with your ego. Remember that most jobs require *lots* of softer people skills and collaboration, written communication is a huge part of that, see for example [The Myth of the Genius Programmer](https://www.youtube.com/watch?v=0SARbwvhupQ). [@Fitzpatrick]
...
* personal notes gathered somewhere (e.g. private github repository or wherever)
...
\caption{(ref:captionalrtfm)}(\#fig:rtfm-fig)
\end{figure}
...
<div class="vembedr">
<div>
<iframe src="https://www.youtube.com/embed/pGFGD5pj03M" width="533" height="300" frameborder="0" allowfullscreen=""></iframe>
</div>
</div>
```
-->
...
\caption{(ref:captiongrades)}(\#fig:not-just-grades-fig)
\end{figure}
...
* Voluntary work, not necessarily technical
...
* Amazon hosts the Alexa challenge, see [developer.amazon.com/alexaprize](https://developer.amazon.com/alexaprize/challenges/current-challenge/rules)
...
Another good source of experience is open source software projects. Find a piece of open source software you're interested in, and there's two ways you can get involved:

1. Raise an issue via the projct's issue tracker, such as [github issues](https://guides.github.com/features/issues/) [@githubissues]
1. [Fix a bug](https://dev.to/rose/fixing-a-bug-on-my-open-source-project-from-start-to-finish-1749). [@fixabug] It might sound trivial, but fixing a bug demonstrates that you can collaborate with others, understand the architecture and toolchain being used (which might be complex) and solve problems. Github has a `good first issue` tag which helps new contributors identify starting points, see [goodfirstissue.dev](https://goodfirstissue.dev/) for some examples.

There are lots of different motivations for getting involved in open source, shown in figure \@ref(fig:opensource-fig). Whatever your motivation, contributing to open source software is fun, you'll learn heaps and it will look great on your CV. Open source software is widely used by, so contributing is a great way to get some real world experience of software development. You can get paid to develop open source software and many open source projects are funded by employers both large and small. [@gsoc] 
...
\end{figure}
(ref:captionopensource) There are lots of good reasons for getting involved in open source software. [Open Source Motivations](https://bryanmmathers.com/open-source-motivations) by [Visual Thinkery](https://visualthinkery.com) is licensed under [CC-BY-ND](https://creativecommons.org/licenses/by-nd/4.0/)
...
\caption{(ref:justme)}(\#fig:justme-fig)
\end{figure}
...
{\centering \includegraphics[width=0.8\linewidth]{images/not-very-good-at-this} 

}

\caption{(ref:captionnotverygood)}(\#fig:grades-fig)
\end{figure}
...
It's all very well *designing* your future but now you need to actually *build* and *test* it. An obvious place to start is with your CV, because that's where most people get going. How can you create a bug-free CV, resume or completed application form? How can you support applications with a strong personal statement or covering letter? These documents are crucial part of your future so how can you debug them? 🐛
...
Before we get started, let's consider some advice from software engineer [Gayle Laakmann McDowell](https://en.wikipedia.org/wiki/Gayle_Laakmann_McDowell) shown in figure \@ref(fig:gayle-fig). Gayle is an experienced software engineer who has worked at the [biggest technology employers in the world](https://en.wikipedia.org/wiki/Big_Tech), Apple, Microsoft and Google. She's also authored a cracking series of books on technology careers, particularly *Cracking the Coding Interview* [@cracking] which we'll come across in chapter \@ref(speaking). Gayle refers to the employer “black hole”:
...
* Microsoft Office is *not* generally a very interesting skill because everyone has it. Don't waste space talking about it unless you've done something advanced with it, like some complicated integration with other software.
...
* **RESULT**: What was the result and how can you measure it? You picked up some knew skills? What was the impact? Perhaps you made something that was inefficient and awkward into something better, cheaper or faster?

Similar to CAR and STAR, recruiters at Google (see Figure \@ref(fig:lopez-fig)) advise candidates to describe your experience and projects using this simple pattern:
...
(ref:captiononeortwopager) How long should your CV be? Should you write a two page European style CV or an American style resume (one pager)? [@youtube-resume-or-cv] The image in the figure is a screenshot, you can [watch the five minute video on how long your CV should be here](https://www.youtube.com/watch?v=0abDOKHS5T0).

At this stage in your career you *should* be able to fit everything on to one page. However, it can be challenging squeezing it all on:
...
* Is your layout and design robot friendly? Sometimes tables and two column layouts can get horribly mangled, see [what happens to resume tables and columns in an applicant tracking system](https://www.jobscan.co/blog/resume-tables-columns-ats/) [@jobscan]
...
1. ✅ Have you reviewed other people's CV's? This will help you write a better CV, see chapter \@ref(reviewing)
1. ✅ Have you got a second opinion from a “resume robot”? Is it robot proof? See section \@ref(robotproof) 🤖
...
1. ✅ Does it fit comfortably on exactly one page (resume) or a two pages (CV)? Not one-and-a-half pages or more than two? See section \@ref(length)
...
\caption{(\#tab:jobterms)Terms used in this guidebook to describe employment opportunities for undergraduates and graduates}
\centering
\begin{tabular}[t]{ll}
\toprule
...
> Job requirements:
> [pic.twitter.com/4QB1oPyxU0](https://t.co/4QB1oPyxU0)
>
> --- Mubeen (\@Mubeeen\_) [July 28,
> 2020](https://twitter.com/Mubeeen_/status/1288115932154363905)
...
Repeated rejections are a normal part of job searching. They can take a heavy toll on your mental health described in chapter \@ref(nurturing) and it can be a struggle. Some employers won't even reply, welcome to the black hole described in section \@ref(blackhole). If you're getting too many rejections it might be Because
...
\caption{(\#tab:shortcuts)Where, when and how to apply for vacancies, internships, placements, graduate jobs and schemes in large multinational corporations and small to medium sized enterprises (SMEs)}
\centering
\begin{tabular}[t]{lll}
\toprule
...
(ref:captionpetia) Petia describes her worst software engineering interview failures. [@youtube-petia] Petia demonstrates her [growth mindset](#growthmindset) and productive failure(s). Although she failed her interviews, she learned lots from the process and went on to get a job she wanted. The image above is a screenshot, you can [watch the full 16 minute video on software engineering fails here](https://www.youtube.com/watch?v=qkeQNNjZuQk).
...
{\centering \includegraphics[width=1\linewidth]{images/ken-robinson-teaching} 

}

\caption{(ref:captionkenrob)}(\#fig:teach-fig)
\end{figure}
...
\caption{(ref:captionbadges)}(\#fig:while-fig)
\end{figure}
(ref:captionbadges) Your education doesn't finish when you start work, it should be a loop where you constantly acquire knowledge and skills during your career. You don't stop learning when you leave University. Surviving and thriving in the workplace will be dependent on your ability to constantly acquire new skills and knowledge, some of which will be *badged* in various ways. [Computing Badges](https://bryanmmathers.com/computing-badges/) by [Visual Thinkery](https://visualthinkery.com/) is licenced under [CC-BY-ND](https://creativecommons.org/licenses/by-nd/4.0/)
...
It will go OK, you'll meet the expectations of your employer and become and valued employee. If your employer has a probationary period, you'll pass your probationary review without any problems. Most employees fit in to this category. 🆗
...
> [pic.twitter.com/wu4uWS0Ftc](https://t.co/wu4uWS0Ftc)
>
> --- 🔎Julia Evans🔍 (\@b0rk) [September 21,
> 2018](https://twitter.com/b0rk/status/1043277965394681856)
...
\end{figure}
(ref:captionbadgetype) Keep a record of evidence you have for any skills or knowledge you gain on the job. These include membership, participation, capability and mastery. [Badge taxonomy](https://bryanmmathers.com/badge-taxonomy-v0-2/) by [Visual Thinkery](https://visualthinkery.com/) is licensed under [CC-BY-ND](https://creativecommons.org/licenses/by-nd/4.0/)

Evidence of your professional development can be classified into four categories:

1. **Membership** are there professional organisations you can join? Do informal groups exist within the organisation that you can join? Are there committees you can serve on?
1. **Participation** what communities or activities are you involved in?
1. **Capability** what skills and knowledge can you demonstrate capability of? What professional accreditations exist for these skills?
1. **Mastery** in the longer term, how can you demonstrate mastery of particular skills and knowledge?
...
The choice of online learning can be bewildering. Some platforms provide free resources, others do not, but your employer may subscribe to these services making them free to you while you are an employee. If that's the case, make good use of the services while you can. There's a [useful comparison of four different online learning platforms here](https://www.businessinsider.com/online-learning-platform-comparison-udemy-skillshare-lynda-coursera). [@udemy]
...
> ([\@OUPAcademic](https://twitter.com/OUPAcademic)
> <https://t.co/Q9dTmWQ9iF>) is out today. Preview on Google Books
> <https://t.co/US8O2EeaQf> /
> [\#howtogetyourphd](https://twitter.com/hashtag/howtogetyourphd)
> (14/14)
>
> --- Gavin (\@profgavinbrown) [March 1,
> 2021](https://twitter.com/profgavinbrown/status/1366390620504399872)
...
<!--chapter:end:12-researching.Rmd-->
...
# Reviewing their future {#reviewing}
...
There's at two kinds solutions to this problem, that involve [dogfooding](#dogfooding), we've already talked about in section \@ref(dogfooding):

1. Eat your own dogfood, read your own written work ALOUD <!--self assess using the rubric-->
1. Eat somebody elses dogfood
    - Debug a friends or peers CV by swapping with them and giving them constructive feedback
    - Debug the fictitious CVs below by ranking them against a job advert. Who would you interview and why?

So, here are some fictitious CVs for you to debug, from students of Computer Science. They are based on CVs I've seen, warts and all, with personal information removed and anonymised. Can you spot their triumphs and tragedies? Can you debug their CV and work out which candidate is best for the sample job description at CoolTech in section \@ref(cooltech)?
...
Peter and his [twin sister Peta](https://en.wikipedia.org/wiki/Peta_(given_name)), both love big data, machine learning, statistics, data science and Artificial Intelligence (AI). They come from a big family with nine siblings, Deca, Hector, Kilo, Megan, Giga, Terry, Exa, Zita and Yotta. They are wildly ambitious, but critics say the Byte family have been terribly over-hyped, see figure \@ref(fig:peterbyte-fig).
...
<!--chapter:end:17-actioning.Rmd-->

# Scheduling your future {#scheduling}
You might find it a bit scary thinking about your future. You might be tempted to procrastinate making important decisions as you head into the great unknown^[that is the world of employment, in case you are wondering], see figure \@ref(fig:schedule-fig). There is a risk of getting stuck in a `do-nothing` or [busy waiting](https://en.wikipedia.org/wiki/Busy_waiting) loop. This guidebook is here to help you break out of that loop. One way to breakout of an unproductive loop is to schedule some time every week where you work on job applications. Doing good applications takes time and you'll probably find you can't do as many applications as you might like.
...
\end{figure}
(ref:captionschedule) The biggest waste of time is the time spent not getting started on a project. Your future might seem big and unknown but it's really not as scary as you might think and getting started can be surprisingly enjoyable. [New Project? Every time…](hhttps://bryanmmathers.com/new-project-every-time/) by [Visual Thinkery](https://visualthinkery.com/) is licenced under [CC-BY-ND](https://creativecommons.org/licenses/by-nd/4.0/)
...
For small group sessions and one-to-one meetings with your tutor, please [turn your camera on](#cameras).
...
* *Either* COMP2CARS: Debug their CV, see chapter \@ref(reviewing)
...
* *Either* COMP2CARS: Debug their CV, see chapter \@ref(reviewing) repeated session
* *Or* COMP2TUT: Meet your tutor see [studentnet.cs.manchester.ac.uk/ugt/tutorgroups.php?level=2](http://studentnet.cs.manchester.ac.uk/ugt/tutorgroups.php?level=2)


### Monday 22nd Feb {#week3}   
* Looking after your future, see chapter \@ref(wellbeing.html)-->
...
If you want to have your future read, hit the library. You can read about your future in books, journals, websites, magazines and anywhere else you find the written word. There is no need to gaze into any [crystal balls](https://en.wikipedia.org/wiki/Crystal_ball)! Get reading your future now, because reading is good for your mind, body and soul. Libraries give us power, see figure \@ref(fig:library-power-fig).
...
\end{figure}
(ref:captionlibpower) Libraries give you power, the power to read your future. These references are a digital library to search and browse. Panorama of the [British Museum Reading Room](https://en.wikipedia.org/wiki/British_Museum_Reading_Room) by David Iliff on Wikimedia Commons [w.wiki/3BEs](https://w.wiki/3BEs)
