...
\begin{figure}
\includegraphics[width=0.0909\linewidth]{images/st-laurence-school-logo} \includegraphics[width=0.0909\linewidth]{images/st-laurence-school-logo} \includegraphics[width=0.0909\linewidth]{images/st-laurence-school-logo} \includegraphics[width=0.0909\linewidth]{images/st-laurence-school-logo} \includegraphics[width=0.0909\linewidth]{images/st-laurence-school-logo} \includegraphics[width=0.0909\linewidth]{images/st-laurence-school-logo} \includegraphics[width=0.0909\linewidth]{images/st-laurence-school-logo} \includegraphics[width=0.0909\linewidth]{images/st-laurence-school-logo} \includegraphics[width=0.0909\linewidth]{images/st-laurence-school-logo} \includegraphics[width=0.0909\linewidth]{images/st-laurence-school-logo} \includegraphics[width=0.0909\linewidth]{images/st-laurence-school-logo} \caption{(ref:captiongudgeon)}(\#fig:laurence-fig)
\end{figure}
...
\caption{(ref:captionclinton)}(\#fig:clinton-fig)
\end{figure}
...
\caption{(ref:captionradipole)}(\#fig:branwen-fig)
\end{figure}
...
\caption{(ref:captionnhs)}(\#fig:nhs-fig)
\end{figure}
...
\begin{figure}
\includegraphics[width=1\linewidth]{images/acropolis-at-night} \caption{(ref:captionacropolis)}(\#fig:acropolis-fig)
\end{figure}
...
\caption{(ref:captionfaces)}(\#fig:faces-fig)
\end{figure}
...
\caption{(ref:captionkapow)}(\#fig:kapow-fig)
\end{figure}
...
(ref:transcript-disclaimer) Please note these transcripts are generated with speech to text software and are not perfect word-for-word transcriptions. Some [speech disfluency](https://en.wikipedia.org/wiki/Speech_disfluency) has been manually removed and links, cross references and pictures have been manually added to add extra context. To give clarification, extra (non-quoted) words are given in brackets like this: (some text added afterwards).
...
\caption{(ref:captionlemn)}(\#fig:lemn-fig)
\end{figure}
...
\caption{(ref:captionandysc)}(\#fig:andysc-fig)
\end{figure}
...
\caption{(ref:captiongeekout)}(\#fig:geekout-fig)
\end{figure}
...
> \hfill --- Sally Fincher [@fincherreview]
...
\caption{(ref:captionprocrastination)}(\#fig:procrastination-fig)
\end{figure}
...
(ref:dehumanised) Top down, corporation driven, bland and sometimes impersonal

(ref:grassroots) Bottom up, grassroots driven, colourful and personal
...
\caption{(ref:captionsignposting)}(\#fig:signposting-fig)
\end{figure}
...
\caption{(ref:captiondescriptive)}(\#fig:descriptive-fig)
\end{figure}
...
You are reading the alpha version, the [Minimum Viable Product](https://en.wikipedia.org/wiki/Minimum_viable_product) (MVP) of this guidebook, last updated on 12 August, 2022. That's software engineer talk for saying *it isn't finished yet*. Subsequent versions, will be continuously and iteratively released on a daily and weekly basis. They will include:
...
\caption{(ref:captionagile)}(\#fig:agile-vs-waterfall-fig)
\end{figure}
...
\caption{(ref:captionstartrek)}(\#fig:startrek-fig)
\end{figure}
...
\caption{(ref:captionfrylecture)}(\#fig:stephen-fry-lecture-fig)
\end{figure}
...
\caption{(ref:captiongenderbread)}(\#fig:genderbread-fig)
\end{figure}
...
\caption{(ref:captionstorytelling)}(\#fig:storytelling-fig)
\end{figure}
...
\caption{(ref:captionhhh)}(\#fig:headhearthands-fig)
\end{figure}
...
\caption{(ref:captionheart)}(\#fig:heart-fig)
\end{figure}
...
\caption{Palliative care nurse Bronnie Ware explains the top five regrets of the dying. [@youtube-bronnie] Bronnie learned a lot from looking after people on their deathbeds, then wrote it all down in a fantastic book [@regrets]. The image in the figure is a screenshot, you can watch the two minute video here at [youtu.be/nayz3xJxRTA](https://youtu.be/nayz3xJxRTA) }(\#fig:bronnie-fig)
\end{figure}
...
\caption{Where will you be five years from now? Best-selling author of *Colouring Your Parachute* Dick Bolles discusses the gaps between education and employment. [@youtube-bolles] The image in the figure is a screenshot, you can watch the full 32 minute talk at [youtu.be/oeP6Pm3Xf-8](https://youtu.be/oeP6Pm3Xf-8) }(\#fig:bolles-fig)
\end{figure}
...
\caption{(ref:captiondelphi)}(\#fig:delphi-fig)
\end{figure}
...
\caption{(ref:captionmathersknown)}(\#fig:mathers-known-fig)
\end{figure}
...
\caption{(ref:captionturingstress)}(\#fig:turing-stress-fig)
\end{figure}
...
\caption{(ref:captionfreebody)}(\#fig:free-body-fig)
\end{figure}
...
\caption{(ref:captionjoydivision)}(\#fig:joydivision-fig)
\end{figure}
...
\caption{(ref:captionlaurie)}(\#fig:laurie-fig)
\end{figure}
...
\caption{Students explain in their own words how calling Nightline helped them whilst at university. [@youtube-nightline]}(\#fig:nightline-fig)
\end{figure}
...
\caption{Ruby Wax describes being affected by depression in her childhood and how mindfulness and cognitive behavioural therapy (CBT) provided an alternative to medical treatment enabling her to dodge the bullets of mental health. [@youtube-wax]}(\#fig:rubywax-fig)
\end{figure}
...
\caption{Stephen Fry, President of Mind, describes how MIND tackles misconceptions around mental health and social stigmas. [@youtube-we-are-mind] }(\#fig:stephenfry-fig)
\end{figure}
...
\caption{Talking about mental health is a crucial part of helping those who are suffering from it [@youtube-student-minds]}(\#fig:studentminds-fig)
\end{figure}
<!-- to do
...
\caption{A quick look inside togetherall, an online community for people who are stressed, anxious or feeling low. [@youtube-togetherall]}(\#fig:togetherall-fig)
\end{figure}
...
\caption{(ref:captionfixedmindset)}(\#fig:fixedminset-fig)
\end{figure}
...
\caption{(ref:captiondweck)}(\#fig:not-fig)
\end{figure}
...
\caption{(ref:captionhaig)}(\#fig:haig-fig)
\end{figure}
...
\begin{figure}
\includegraphics[width=0.32\linewidth]{images/you-dont-have-to-be-on-social-media} \includegraphics[width=0.32\linewidth]{images/you-dont-have-to-be-on-social-media} \includegraphics[width=0.32\linewidth]{images/you-dont-have-to-be-on-social-media} \caption{(ref:captionsocialmedia)}(\#fig:socialmedia-fig)
\end{figure}
...
\begin{figure}
\includegraphics[width=1\linewidth]{images/accept-yourself} \caption{(ref:captionmindyourhealth)}(\#fig:mindyourhealth-fig)
\end{figure}
...
\caption{(ref:captionnowriting)}(\#fig:no-writing-fig)
\end{figure}
...
\caption{(ref:captionachilles)}(\#fig:achilles-fig)
\end{figure}
...
\caption{(ref:captionallskills)}(\#fig:allskills-fig)
\end{figure}
...
\caption{(\#tab:iotable)The inputs and outputs of the fundamental assembly languages of human communication }
\centering
\begin{tabular}[t]{lll}
\toprule
 & Input & Output\\
...
\caption{(ref:captionmadscientist)}(\#fig:madscientist-fig)
\end{figure}
...
\caption{(ref:captionmightypen)}(\#fig:mighty-pen-fig)
\end{figure}
...
\caption{(ref:captionrosetta)}(\#fig:rosetta-fig)
\end{figure}
...
\caption{(ref:captionvonahn)}(\#fig:vonahn-fig)
\end{figure}
...
\caption{(ref:captionwinston)}(\#fig:winston-fig)
\end{figure}
...
\caption{(ref:captiondogfooding)}(\#fig:dogfooding-fig)
\end{figure}
...
\caption{(ref:captionreading)}(\#fig:reading-fig)
\end{figure}
...
\caption{(ref:captionrtfm)}(\#fig:rtfm-fig)
\end{figure}
...
\caption{(ref:captionotherpeople)}(\#fig:otherpeople-fig)
\end{figure}
...
\caption{(ref:captionallaboutpeople)}(\#fig:allpeople-fig)
\end{figure}
...
\caption{(ref:captiondeathstar)}(\#fig:deathstar-fig)
\end{figure}

(ref:captiondeathstar)  Just like the [Death Star](https://en.wikipedia.org/wiki/Death_Star), this ~~galactic superweapon~~ book is under construction. As of 12 August, 2022 this book is an estimated **35% complete**. Image of agile weapon engineering in *Star Wars* via Wikimedia Commons [w.wiki/5N6q](https://w.wiki/5N6q) adapted using the [Wikipedia app](https://apps.apple.com/gb/app/wikipedia/id324715238)
...
\caption{(ref:caption404)}(\#fig:404-fig)
\end{figure}
...
\caption{(ref:captionrelevantexp)}(\#fig:relevance-fig)
\end{figure}
...
\caption{(ref:captionexperience)}(\#fig:experience-fig)
\end{figure}
...
1. experience validates what you have already learned, see Sneha's story in chapter \@ref(sneha)
...
1. experience builds your professional network of contacts, particuarly the crucial weaker ties described in section \@ref(weakties)
...
\caption{(\#tab:jobterms)Are you experienced? Terms used throughout this guidebook to describe experience, employment and their definitions}
\centering
\begin{tabular}[t]{ll}
\toprule
...
\caption{(ref:captionvolunthero)}(\#fig:volunthero-fig)
\end{figure}
...
\caption{(ref:captionbigname)}(\#fig:bigname-fig)
\end{figure}
...
\caption{(ref:captiongsoc)}(\#fig:gsoc-fig)
\end{figure}
...
\caption{(ref:captionopensource)}(\#fig:opensource-fig)
\end{figure}
...
\caption{(ref:captionpaperboy)}(\#fig:paperboy-fig)
\end{figure}
...
\caption{(ref:captionbudgens)}(\#fig:budgens-fig)
\end{figure}
...
\caption{(ref:captiondeathstar)}(\#fig:deathstar2-fig)
\end{figure}
...
\caption{(ref:captionnotcoding)}(\#fig:not-coding-fig)
\end{figure}
...
\caption{(ref:captionsonicpi)}(\#fig:sonicpi-fig)
\end{figure}
...
\caption{(ref:captioneating)}(\#fig:eating-fig)
\end{figure}
...
\caption{(ref:captionmarket)}(\#fig:market-fig)
\end{figure}
...
\caption{(ref:captionmarketagain)}(\#fig:market-again-fig)
\end{figure}
...
\caption{(ref:captionball)}(\#fig:nurses-fig)
\end{figure}
...
\caption{(ref:captionjoker)}(\#fig:joker-fig)
\end{figure}
...
\caption{(ref:captiondeathstar)}(\#fig:deathstar3-fig)
\end{figure}
...
\caption{(ref:captionbuggingcv)}(\#fig:bugfeature-fig)
\end{figure}
...
\caption{(ref:captiongayle)}(\#fig:gayle-fig)
\end{figure}
...
\caption{(ref:captionlonglive)}(\#fig:longlive-fig)
\end{figure}
...
\caption{(ref:captionnotabug)}(\#fig:notabug-fig)
\end{figure}
...
{\centering \includegraphics{images/rick-urshion} 

}

\caption{this is a caption}(\#fig:cv-fig)
\end{figure}
...
{\centering \includegraphics[width=1\linewidth]{images/marissa} 

}

\caption{this is a sample CV}(\#fig:marissa-fig)
\end{figure}
-->
...
* Bullet points with verbs first (see section \@ref(verbsfirst)) will:
  + allow your reader to quickly scan your CV because [employers don't read CVs, they scan them](https://readabilityguidelines.co.uk/content-design/how-people-read/) [@scanning]
...
\caption{(ref:captiongooglerecruiters)}(\#fig:lopez-fig)
\end{figure}
...
\caption{(ref:captionjonathanblack)}(\#fig:black-fig)
\end{figure}
...
\caption{(ref:captioncvheader)}(\#fig:turinghead-fig)
\end{figure}
...
\caption{(ref:captionwhathaveudone)}(\#fig:done-fig)
\end{figure}
...
\caption{(ref:captionfeynman)}(\#fig:feynman-fig)
\end{figure}
...
\caption{(ref:captionfodder)}(\#fig:cvfodder-fig)
\end{figure}
...
\caption{(ref:captionquidditch)}(\#fig:quidditch-fig)
\end{figure}
...
\caption{(ref:captiongallagher)}(\#fig:gallagher-fig)
\end{figure}
...
\caption{(ref:captionworkcv)}(\#fig:cvwork-fig)
\end{figure}
...
\caption{(ref:captiononeortwopager)}(\#fig:oneortwopager-fig)
\end{figure}
...
\caption{(ref:captionshorterletter)}(\#fig:shorterletter-fig)
\end{figure}
...
\caption{(ref:captionmorefeatures)}(\#fig:morefeatures-fig)
\end{figure}
...
\caption{(ref:captionlovelace)}(\#fig:lovelace-fig)
\end{figure}
...
\caption{(\#tab:linkedintable)Comparison of LinkedIn with conventional CV's and résumés. The two mediums have a lot in common but also provide different communication channels which can be complementary, e.g. you include your LinkedIn profile on your CV to augment it.}
\centering
\begin{tabular}[t]{ll}
\toprule
...
\caption{(ref:captionmachines)}(\#fig:machines-fig)
\end{figure}
...
1. ✅ Is it in reverse chronological order with the most recent things **first**? Can your timeline be easily scanned, with all dates clearly aligned for easy reading? See [Neil Pointer](https://www.cdyf.me/Neil_Pointer.pdf) as an example with a clear timeline using right-aligned dates.
...
\caption{(ref:captionwonderfuldarling)}(\#fig:wonderfuldarling-fig)
\end{figure}
...
\caption{(ref:captionyesbut)}(\#fig:yesbut-fig)
\end{figure}
...
It can be bewildering knowing where to start your job search, because the possibilities are endless. There are many parameters and variables in your search and the search space can be dauntingly massive. Here are some basic strategies to help you start to [decompose](https://en.wikipedia.org/wiki/Decomposition_(computer_science)) the complex problem of job hunting into smaller, more manageable problems you can start to tackle. We've already mentioned eight:

1. 👨‍🔬 by role, see section \@ref(by-role)
1. 📊 by sector, see section \@ref(by-sector)
1. 💪 by skills, see section \@ref(by-skills)
1. 🕰 by time, see section \@ref(by-time)
1. 🚛 by size, see section \@ref(by-size)
1. 🌇 by location, see section \@ref(by-location)
1. ⚖️ by quantity, see section \@ref(by-quantity)
1. 👨‍👩‍👧‍👦 by network, see section \@ref(weakties)

Each strategy has is own strengths and weaknesses, so you'll probably want to use more than one and experiment with different strategies as your search progresses. No doubt, you'll have some extra strategies of your own, this is not an exhaustive list:
...
```md
* I'm interested in the financial sector, particularly FinTech
```
...
### By skills {#by-skills}
Is there a specific skill you have you enjoy using, or a technology you know about that has promise? You could use this as a way to find jobs. Take [Amazon Web Services](https://en.wikipedia.org/wiki/Amazon_Web_Services) (AWS) for example:
...
Likewise, if you know you want to work for a multi-national, that gives you a list of employers you can target. Picking a size, can help you identify employers you'd like to work for. Table \@ref(tab:shortcuts) summarises some of the when and where some employers typically advertise.

\begin{table}

\caption{(\#tab:shortcuts)The practicalities of applying for vacancies, internships, placements, graduate jobs and schemes in large multinational employers and small to medium sized enterprises (SMEs)}
\centering
\begin{tabular}[t]{lll}
\toprule
...
Locations can help you define your problem space. For example, if you're looking in Manchester, you can get started at [git.io/manc](https://git.io/manc). Picking a location can also help you identify networking opportunities for hidden, un-advertised vacancies and making speculative applications. You could find out about employers by attending [meetup.com](https://www.meetup.com/) events in your chosen location.
...
\caption{(ref:captionblunderbuss)}(\#fig:blunderbuss-fig)
\end{figure}
...
```md
* I'll spend two hours per week coding my future
```
...
\caption{(ref:captionbumped)}(\#fig:bumped-fig)
\end{figure}
...
\caption{(ref:captionnetworks)}(\#fig:net-fig)
\end{figure}
...
{\centering \includegraphics[width=0.8\linewidth]{images/teachers-purveyors-of-confidence} 

}

\caption{(ref:captionpurveyors)}(\#fig:teachers-fig)
\end{figure}
...
\caption{(ref:captiongooglejobsearch)}(\#fig:googlejobs-fig)
\end{figure}
...
\caption{(ref:captionlinkedin)}(\#fig:linkedin-fig)
\end{figure}
...
\caption{(ref:captionrecruiter)}(\#fig:recruiter-fig)
\end{figure}
...
\caption{(ref:captionjobscams)}(\#fig:jobscams-fig)
\end{figure}
...
\caption{(ref:captionfakenews)}(\#fig:fakenews-fig)
\end{figure}
...
\caption{(ref:captionfurber)}(\#fig:furber-fig)
\end{figure}
...
\caption{(ref:captiontimesink)}(\#fig:timesink-fig)
\end{figure}
...
\caption{(ref:captionblackhole)}(\#fig:blackhole-fig)
\end{figure}
...
\caption{(ref:captionrollercoaster)}(\#fig:rollercoaster-fig)
\end{figure}
...
\caption{(ref:captiondeathstar)}(\#fig:deathstar5-fig)
\end{figure}
<!--
...
\caption{(ref:captiondefaultuser)}(\#fig:default-user-fig)
\end{figure}
...
\caption{(ref:captionhamilton)}(\#fig:hamilton-fig)
\end{figure}
...
\caption{(ref:captioncern)}(\#fig:cern-fig)
\end{figure}
...
\caption{(ref:captionspiderman)}(\#fig:spiderman-fig)
\end{figure}
...
\caption{(ref:captiondevildeal)}(\#fig:diabolical-fig)
\end{figure}
...
\caption{(ref:captionmorganstanley)}(\#fig:morgan-stanley-fig)
\end{figure}
...
* Ensuring algorithms benefit *everyone* in society, not just the (predominantly) old rich [technocratic](https://en.wikipedia.org/wiki/Technocracy) white men that control them, see figure \@ref(fig:justice-fig)
* Ensuring that technology *enables* democracy, rather than undermining it, as commentators like [Jamie Bartlett](https://en.wikipedia.org/wiki/Jamie_Bartlett_(journalist)) and [Carl Miller](https://en.wikipedia.org/wiki/Carl_Miller_(author)) have argued. [@deathofthegods; @bartlett]
...
\caption{(ref:captionclimate)}(\#fig:greta-fig)
\end{figure}
...
\caption{(ref:captionjoy)}(\#fig:justice-fig)
\end{figure}
...
\caption{(ref:captionsoul)}(\#fig:soul-fig)
\end{figure}
...
\caption{(ref:captiondeathstar)}(\#fig:deathstar8-fig)
\end{figure}
...
\caption{(ref:captionbugfree)}(\#fig:bugfree-fig)
\end{figure}
...
\caption{(ref:bobonmute)}(\#fig:bobonmute-fig)
\end{figure}
...
\caption{(ref:captionoverthinking)}(\#fig:overthinking-fig)
\end{figure}
...
\caption{(ref:captionpetia)}(\#fig:petia-fig)
\end{figure}
...
\caption{(ref:captionhackerrank)}(\#fig:hackerrank-fig)
\end{figure}
...
\caption{(ref:captioneuler)}(\#fig:euler-fig)
\end{figure}
...
\caption{(ref:captioncodewars)}(\#fig:codewars-kata-fig)
\end{figure}
...
\caption{(ref:captionicpc)}(\#fig:icpc-fig)
\end{figure}
...
\caption{(ref:captiongoble)}(\#fig:carole-goble-fig)
\end{figure}
...
\caption{(ref:captiondeathstar)}(\#fig:deathstar6-fig)
\end{figure}
...
\caption{(ref:captionsurvival)}(\#fig:survival-fig)
\end{figure}
...
\caption{(ref:captionromeo)}(\#fig:romeo-fig)
\end{figure}
...
\caption{(ref:captiondeathstar)}(\#fig:deathstar7-fig)
\end{figure}
...
\caption{(ref:captionunibadges)}(\#fig:while-learning-fig)
\end{figure}
...
\caption{(ref:captiondegreecert)}(\#fig:degree-cert-fig)
\end{figure}
...
\caption{(ref:captionmoregrades)}(\#fig:more-than-grades-fig)
\end{figure}
...
\caption{(ref:captionfinegrain)}(\#fig:fine-grained-fig)
\end{figure}
...
\caption{(ref:captionbadgeproperties)}(\#fig:badge-properties-fig)
\end{figure}
...
\caption{(ref:captiondatainside)}(\#fig:data-inside-fig)
\end{figure}
...
\caption{(ref:captionpassleader)}(\#fig:pass-leader-fig)
\end{figure}
...
\caption{(ref:captionbadgetype)}(\#fig:badgetype-fig)
\end{figure}
...
\caption{(ref:captionamazonbadge)}(\#fig:amazon-badge-fig)
\end{figure}
...
\caption{(ref:captionskillsbills)}(\#fig:skills-bills-fig)
\end{figure}
...
\caption{(ref:captioneinstein)}(\#fig:einstein-fig)
\end{figure}
...
\caption{(ref:captionrealworld)}(\#fig:realworld-fig)
\end{figure}
...
\caption{(ref:captiondeathstar)}(\#fig:deathstar9-fig)
\end{figure}
...
\caption{(ref:captiontensimple)}(\#fig:ten-simple-fig)
\end{figure}
...
\caption{(ref:captionknowmyself)}(\#fig:knowing-fig)
\end{figure}
...
\caption{(ref:captionlookafteragain)}(\#fig:lookafter-again-fig)
\end{figure}
...
\caption{(ref:captionusewhatyouhave)}(\#fig:usewhatyouhave-fig)
\end{figure}
...
\caption{(ref:captiongregwilson)}(\#fig:greg-wilson-fig)
\end{figure}
...
\caption{(ref:captionyournetwork)}(\#fig:yournetwork-fig)
\end{figure}
(ref:captionyournetwork) Grow and use your networks, both the strong ties and the weak ties described in section \@ref(weakties). Grow your network by [Visual Thinkery](https://visualthinkery.com) is licensed under [CC-BY-ND](https://creativecommons.org/licenses/by-nd/4.0/)
...
\caption{(ref:captionestherdyson)}(\#fig:esther-dyson-fig)
\end{figure}
...
\caption{(ref:captionhelp)}(\#fig:helpandthank-fig)
\end{figure}
...
\caption{(ref:captionbinoculars)}(\#fig:binoculars-fig)
\end{figure}
...
\caption{(ref:captionstayinschool)}(\#fig:stayinschool-fig)
\end{figure}
...
\caption{(ref:captioncomfortzone)}(\#fig:comfortzone-fig)
\end{figure}
...
\caption{(ref:captionkatebush)}(\#fig:katebush-fig)
\end{figure}
...
\caption{(ref:captiondeathstar)}(\#fig:deathstar19-fig)
\end{figure}
...
\caption{(ref:captionkludge)}(\#fig:kludge-fig)
\end{figure}
...
\caption{(ref:captionpentester)}(\#fig:pentester-fig)
\end{figure}
...
\caption{(ref:captionrick)}(\#fig:rickurshion-fig)
\end{figure}
...
\caption{(ref:captionmarge)}(\#fig:margeconflict-fig)
\end{figure}
...
\caption{(ref:captionmike)}(\#fig:mikrokernel-fig)
\end{figure}
...
\caption{(ref:captionflo)}(\#fig:floatingpoint-fig)
\end{figure}
...
\caption{(ref:captionpeter)}(\#fig:peterbyte-fig)
\end{figure}
...
\caption{(ref:captionpolly)}(\#fig:polly-fig)
\end{figure}
...
\caption{(ref:captionneil)}(\#fig:neilpointer-fig)
\end{figure}
...
\caption{(ref:captionbryn)}(\#fig:bryn-fig)
\end{figure}
...
\begin{figure}
\includegraphics[width=0.32\linewidth]{images/notjustlondon} \includegraphics[width=0.32\linewidth]{images/notjustlondon} \includegraphics[width=0.32\linewidth]{images/notjustlondon} \caption{(ref:captionnojustlondon)}(\#fig:northern-fig)
\end{figure}
...
\begin{figure}
\includegraphics[width=1\linewidth]{images/uuk} \caption{(ref:captionuuk)}(\#fig:uuk-fig)
\end{figure}
...
\caption{(ref:captionenjoying)}(\#fig:enjoying-fig)
\end{figure}
...
In *Hearing your Future* (chapter \@ref(hearing)) we ask our guests (coders) to recommend a tune that is important to them. These are gathered together in *The Coder’s Playlist* and incremented by one with every new episode of the podcast. In the words of [Arthur O'Shaughnessy](https://en.wikipedia.org/wiki/Arthur_O%27Shaughnessy), figure \@ref(fig:music-makers-fig): We are the music makers and we are the dreamers of dreams. Wandering by lone sea-breakers, and sitting by desolate streams; World-losers and world-forsakers, On whom the pale moon gleams: Yet we are the movers and shakers of the world for ever, it seems.

\begin{figure}
\includegraphics[width=0.99\linewidth]{images/we-are-the-music-makers} \caption{(ref:captionmusicmakers)}(\#fig:music-makers-fig)
\end{figure}
...
\begin{figure}
\includegraphics[width=0.33\linewidth]{images/draughts} \includegraphics[width=0.33\linewidth]{images/draughts} \includegraphics[width=0.33\linewidth]{images/draughts} \caption{(ref:captiondraughts)}(\#fig:draughts-fig)
\end{figure}
...
Using Turing's code the computer scientist [Christopher Strachey](https://en.wikipedia.org/wiki/Christopher_Strachey) wrote programs to play music. Strachey's first success was a version of the UK's national anthem *God Save the King* [@godsavethequeen] which was played at the end of what is very probably the first video ever game created, [draughts](https://en.wikipedia.org/wiki/Checkers) shown in figure \@ref(fig:draughts-fig). [@programmingenter] The earliest existing recording of computer-generated music was made in 1951 by the BBC.
...
1. *[God Save the King](https://en.wikipedia.org/wiki/God_Save_the_Queen)* [@godsavethequeen]
...
\begin{figure}
\includegraphics[width=0.33\linewidth]{images/the-beatles} \includegraphics[width=0.33\linewidth]{images/the-beatles} \includegraphics[width=0.33\linewidth]{images/the-beatles} \caption{(ref:captionbeatles)}(\#fig:the-beatles-fig)
\end{figure}
...
Bursting with Lancastrian Red Roses (see figure \@ref(fig:roses-fig)) this playlist will educate and entertain you in equal measure, [while my keyboard gently weeps](https://en.wikipedia.org/wiki/While_My_Guitar_Gently_Weeps) [@weeps]. To paraphrase [Robbie Williams](https://en.wikipedia.org/wiki/Robbie_Williams) shown in figure \@ref(fig:robbie-williams-fig):

\begin{figure}
\includegraphics[width=0.99\linewidth]{images/let-me-entertain-you-let-me-educate-you} \caption{(ref:captionrobbie)}(\#fig:robbie-williams-fig)
\end{figure}
...
\begin{figure}
\includegraphics[width=0.2\linewidth]{images/Red-Rose-of-Lancaster} \includegraphics[width=0.2\linewidth]{images/Red-Rose-of-Lancaster} \includegraphics[width=0.2\linewidth]{images/Red-Rose-of-Lancaster} \includegraphics[width=0.2\linewidth]{images/Red-Rose-of-Lancaster} \includegraphics[width=0.2\linewidth]{images/Red-Rose-of-Lancaster} \caption{(ref:captionredrose)}(\#fig:roses-fig)
\end{figure}
...
\begin{figure}
\includegraphics[width=0.99\linewidth]{images/jimi-hendrix} \caption{(ref:captionhendrix)}(\#fig:jimi-hendrix-fig)
\end{figure}

(ref:captionhendrix) Are you experienced in Dad-rock? [@hendrix] Definitions vary, but there's plenty of Dads who believe this playlist includes some of the best music ever made. By real musicians. With real musical instruments. Public domain image of [Jimi Hendrix](https://en.wikipedia.org/wiki/Jimi_Hendrix) performing on the *[Hoepla](https://en.wikipedia.org/wiki/Hoepla)* show in 1967 by A. Vente via Wikimedia Commons [w.wiki/5WHj](https://w.wiki/5WHj) adapted using the [Wikipedia App](https://apps.apple.com/gb/app/wikipedia/id324715238)
...
\begin{figure}
\includegraphics[width=0.99\linewidth]{images/glastonbury-festival} \caption{(ref:captionglastonbury)}(\#fig:glastonbury-fig)
\end{figure}
...
\caption{(ref:captionatlas)}(\#fig:atlassuite-fig)
\end{figure}
...
\caption{(ref:captionactions)}(\#fig:action-fig)
\end{figure}
...
\caption{(ref:captionpankhurst)}(\#fig:pankhurst-fig)
\end{figure}
...
\caption{(ref:captionschedule)}(\#fig:schedule-fig)
\end{figure}
...
\caption{(ref:captiongraduation)}(\#fig:graduation-fig)
\end{figure}
...
\begin{figure}
\includegraphics[width=0.33\linewidth]{images/Hearing-your-future} \includegraphics[width=0.33\linewidth]{images/Hearing-your-future} \includegraphics[width=0.33\linewidth]{images/Hearing-your-future} \caption{(ref:captionhearing)}(\#fig:hearing-fig)
\end{figure}
...
\begin{figure}
\includegraphics[width=0.33\linewidth]{images/sneha} \includegraphics[width=0.33\linewidth]{images/sneha} \includegraphics[width=0.33\linewidth]{images/sneha} \caption{(ref:captionsneha)}(\#fig:sneha2-fig)
\end{figure}
...
\begin{figure}
\includegraphics[width=0.33\linewidth]{images/carmen} \includegraphics[width=0.33\linewidth]{images/carmen} \includegraphics[width=0.33\linewidth]{images/carmen} \caption{(ref:captioncarmen)}(\#fig:carmen2-fig)
\end{figure}
(ref:podcastblurbshort)
...
\begin{figure}
\includegraphics[width=0.33\linewidth]{images/brian} \includegraphics[width=0.33\linewidth]{images/brian} \includegraphics[width=0.33\linewidth]{images/brian} \caption{(ref:captionbrian)}(\#fig:brian2-fig)
\end{figure}
...
\begin{figure}
\includegraphics[width=0.33\linewidth]{images/jason} \includegraphics[width=0.33\linewidth]{images/jason} \includegraphics[width=0.33\linewidth]{images/jason} \caption{(ref:captionjason)}(\#fig:jason2-fig)
\end{figure}
...
\begin{figure}
\includegraphics[width=0.33\linewidth]{images/raluca} \includegraphics[width=0.33\linewidth]{images/raluca} \includegraphics[width=0.33\linewidth]{images/raluca} \caption{(ref:captionraluca)}(\#fig:raluca2-fig)
\end{figure}
...
\begin{figure}
\includegraphics[width=0.33\linewidth]{images/your-future-wants-you} \includegraphics[width=0.33\linewidth]{images/your-future-wants-you} \includegraphics[width=0.33\linewidth]{images/your-future-wants-you} \caption{(ref:captionyfnu)}(\#fig:yfnu-fig)
\end{figure}
...
What's your [origin story](https://en.wikipedia.org/wiki/Origin_story)?
...
\caption{(ref:caption2gallagher)}(\#fig:gallagher2-fig)
\end{figure}
...
\caption{(ref:captionminority)}(\#fig:minority-fig)
\end{figure}
...
\caption{(ref:captionfaces2)}(\#fig:faces2-fig)
\end{figure}
...
\caption{(ref:captiongaga)}(\#fig:gaga-fig)
\end{figure}

(ref:captiongaga) All we hear is [Radio Ga Ga](https://en.wikipedia.org/wiki/Radio_Ga_Ga) but everything I had to know, I heard it on my radio. [@radiogaga] So don't become some background noise, a backdrop to the girls and boys, who just don't know and just don't care and just complain when you're not there.
...
\begin{figure}
\href{https://www.podomatic.com/podcasts/cs-engagement}{\includegraphics[width=1\linewidth]{cdyf_files/figure-latex/jez-fig-1} }\caption{(ref:captionjez)}(\#fig:jez-fig)
\end{figure}
...
\caption{(ref:captionraluca)}(\#fig:raluca-fig)
\end{figure}
...
So you've done a summer job Web applications UK, which is now called, they've changed their name now to [Koder.ly](https://www.koder.ly/) with a `K`. So, you've got a broad exposure to different sorts of software engineering ideas, working in a team and that kind of stuff.
...
\caption{(ref:captioncern2)}(\#fig:cern2-fig)
\end{figure}

(ref:captioncern2) CERN employs ten times more engineers and technicians than physicists [@hullcern]. Fair use image via Wikimedia Commons [w.wiki/4qmF](https://w.wiki/4qmF) adapted using the [Wikipedia app](https://apps.apple.com/)
...
> Raluca: Yes, it's the experimental physics department and it's on the [ALICE experiment](https://en.wikipedia.org/wiki/ALICE_experiment), which I can talk about if you want. Yeah. So that'll be another adventure. Then I guess, in terms of stuff that your stuff that you're going to be learning
...
## Advice to your former self {#rselfie}
...
> Raluca: Yes, yes, I had. I had two others. There was [DataStax](https://en.wikipedia.org/wiki/DataStax) and Koderly right. So I got to know that I could go there.
...
\caption{(ref:captionbrian)}(\#fig:brian-fig)
\end{figure}
...
\caption{(ref:captionjason)}(\#fig:jason-fig)
\end{figure}
...
\caption{(ref:captiontimesq)}(\#fig:timesq-fig)
\end{figure}

(ref:captiontimesq) Jason's portrait being projected in Times Square New York, during the pandemic in 2020. Picture re-used with permission from Jason. As of 2022, this post has 17,712 reactions and 713 Comments on LinkedIn. [@jasontimes]
...
Okay good. So to finish up then, this podcast is part of *coding your future* and it has a soundtrack (see chapter \@ref(enjoying)) with it. There are musical references in the text but because I'm older, a lot of the references are old. So, can you recommend us
...
>Jason: I mean, if you're a big fan of hip hop, I'm a really big fan of hip hop, but that kind of thing, American rap and stuff. So, I say anything by [Don Toliver](https://en.wikipedia.org/wiki/Don_Toliver). [@noidea] People probably might not have hard of it. I'm big. Big, big, big fan, right? So anything by him. If you want, like a chill, like hip hop, kind of vibe type thing.

## One podcast {#jpodcast}
...
\caption{(ref:captionmatrix)}(\#fig:matrix-fig)
\end{figure}
(ref:captionmatrix) *The Matrix* depicts a dystopian future in which humanity is unknowingly trapped inside a simulated reality, the Matrix, which intelligent machines have created to distract humans while using their bodies as an energy source. [@thematrix]
...
\caption{(ref:captioncarmen)}(\#fig:carmen-fig)
\end{figure}
...
\caption{(ref:captionmckinsey)}(\#fig:mckinsey-fig)
\end{figure}
...
\caption{(ref:captionshestheman)}(\#fig:shes-the-man-fig)
\end{figure}
...
\caption{(ref:captionsneha)}(\#fig:sneha-fig)
\end{figure}
...
> Sneha: The song that I chose was a November Rain by Guns and Roses. [@novemberrain]
...
Love and thunder and it's used on that it was [@lovethunder]
...
\caption{(ref:captionidiots)}(\#fig:three-idiots-fig)
\end{figure}
...
\caption{(ref:captionalice)}(\#fig:alice-fig)
\end{figure}
...
\caption{(ref:captionlibpower)}(\#fig:library-power-fig)
\end{figure}
(ref:captionlibpower) Libraries give you power, the power to read your future. These references are a digital library you can search and browse. Panorama of the [British Museum Reading Room](https://en.wikipedia.org/wiki/British_Museum_Reading_Room) by David Iliff on Wikimedia Commons [w.wiki/3BEs](https://w.wiki/3BEs)
...
\caption{(ref:captionbillgates)}(\#fig:billgates-fig)
\end{figure}
