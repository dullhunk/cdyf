...
An edited podcast transcript will appear here in due course. In the meantime, an un-edited, [raw machine-generated transcript can be found here](https://github.com/dullhunk/cdyf/blob/master/raw-transcript-ivo.md). Ivo gave a guest lecture on his experiences shown in figure \@ref(fig:ivotalking-fig).
...
(ref:captionivotalking) Ivo delivering a guest lecture as part of COMP101. [@ivotimes]
