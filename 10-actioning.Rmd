...
* `spearheaded` Really, are you some kind of hunter-gatherer? Howabout `led`, `managed`, `co-ordinated` or `organised`?  
* `streamlined` Something smells a bit dodgy, it's the kind of thing a politician would say
* `leveraged` I'm not sure about this one, smells a bit dodgy?
* `relished` 
* `delighted` 
* `thrilled`
* `fascinated` 
* `imagineer` Yes, good engineers often have good imaginations. But software imagineering? Really? C'mon! 
