...
(ref:captionmachiavelli) What kind of leader do you want to be? There are many ways to lead: `loved` and `feared` are two styles that [Niccolò Machiavelli](https://en.wikipedia.org/wiki/Niccol%C3%B2_Machiavelli) discussed. Many other kinds of leadership are available, with a wide range of verbs to describe them: `mentored`, `motivated`, `demonstrated`, `facilitated`,  and `supervised` etc. Public domain image of a portrait of Niccolò Machiavelli by [Santi di Tito](https://en.wikipedia.org/wiki/Santi_di_Tito) on Wikimedia Commons [w.wiki/5FCv](https://w.wiki/5FCv) and adapted using the [Wikipedia app](https://apps.apple.com/gb/app/wikipedia/id324715238) 
...
<!--## Missing verbs? {#missing} Are there any missing verbs?-->
