...
Your actions define your impact, see figure \@ref(fig:action-fig). When writing job applications, think about the stories you can tell with the verbs you used to describe your actions to date. What was the context, action and result (CAR) we discussed in section \@ref(carstar)?
