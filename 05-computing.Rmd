...
During 2022 and 2023, there were significant redundancies at [Big Tech](https://en.wikipedia.org/wiki/Big_Tech) companies. [@downturn] Despite this, there's still plenty of room for optimisim because what figure \@ref(fig:market-fig) and figure \@ref(fig:market-again-fig) show is that computing is still eating the stock market. This means that commercial demand for software developers is high, comparable to teaching and nursing in terms of raw numbers. In the UK, the most common jobs for graduates from 2019 are shown in figure \@ref(fig:nurses-fig), based on data taken from an [update on the graduate labour market in 2022](https://luminate.prospects.ac.uk/uk-graduate-labour-market-update-11-january) [@labourmarket2022]
