...
Thanks to bloggers, columnists and diarists on the internet whose words I've enjoyed reading, see figure \@ref(fig:keyboard-fig).
...
```
(ref:captionkeyboard) The pen is mightier than the sword, and so is the keyboard. Thank you mighty writers for your words which provides an existence proof that engineers and scientists should also be good communicators. CC BY SA picture of a backlit keyboard adapted from an original by [Colin](https://commons.wikimedia.org/wiki/User:Colin) on Wikimedia Commons [w.wiki/4sQd](https://w.wiki/4sQd)
