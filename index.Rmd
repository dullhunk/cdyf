...
1. **Even Better If** (`EBI`) how can we make it better, what is missing? Which bits are boring or unclear? Which bits needlessly replicate better resources freely and openly found elsewhere? Too long, didn’t read ([TL;DR](https://en.wiktionary.org/wiki/too_long;_didn%27t_read))?
