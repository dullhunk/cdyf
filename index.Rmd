...
(ref:captionwaggle) Bees symbolise both community and work ethic and have been a [Manchester icon](https://en.wikipedia.org/wiki/Symbols_of_Manchester) since the industrial revolution in the 19th Century. We also use it for our Wednesday [waggle.cs.manchester.ac.uk](https://waggle.cs.manchester.ac.uk/) jobs newsletter for students. [Waggle dance](https://en.wikipedia.org/wiki/Waggle_dance) artwork by [Visual Thinkery](https://visualthinkery.com/) is licensed under [CC-BY-ND](https://creativecommons.org/licenses/by-nd/4.0/) 🐝
