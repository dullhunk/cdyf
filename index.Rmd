...
Thanks to St Laurence school ([st-laurence.com](https://st-laurence.com/)), a community I am proud and lucky to have grown up in. I'm especially grateful for the friendship of former St Laurence school students I've enjoyed music, cycling, walking, travelling and drinking with over the years, *some* of whom you can see figure \@ref(fig:bradlads-fig). I'm looking forward to our next adventure / gig / session.
...
```
(ref:captionbradlads) Crossing the highest paved mountain pass in Europe, the [Col de l'Iseran](https://en.wikipedia.org/wiki/Col_de_l%27Iseran) in France, with my fellow alpinists and [Kings of the Mountains](https://en.wikipedia.org/wiki/King_of_the_Mountains): Jim, Dan, Doug and Dan. Rest in Peace Dan, you were a fantastic companion, we all love you and miss you terribly.

<!--Branwen Munn-->

Special thanks my friend, former St Laurence school student and [current sixth form head](https://st-laurence.com/sixth-form) Aidan Blowers for leading by example, wearing a white shirt in figure \@ref(fig:uptown-funk-fig). Aidan's performance inspired the ongoing musical experiment that is [Tuning Complete](http://www.cs.man.ac.uk/~hulld/research.html#tuningcomplete).
