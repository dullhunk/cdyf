...
Thanks to [St. Laurence school](https://st-laurence.com/), a community I am proud and lucky to have grown up in. I'm especially grateful to school friends I've enjoyed music, cycling, walking, travelling and drinking with over the years, see figure \@ref(fig:bradlads-fig). I'm looking forward to our next adventure.
...
```
(ref:captionbradlads) Crossing the highest mountain pass in Europe, the [Col de l'Iseran](https://en.wikipedia.org/wiki/Col_de_l%27Iseran) in France, with my fellow alpine [Kings of the Mountains](https://en.wikipedia.org/wiki/King_of_the_Mountains): Jim, Dan, Doug and Dan. Rest in Peace Dan, you were a fantastic companion and we all miss you terribly.

Special thanks to fellow St. Laurence student Aidan Blowers for leading by example with *Uptown Funk*, see figure \@ref(fig:uptown-funk-fig), an approach which inspired the ongoing musical experiment that is [Tuning Complete](http://www.cs.man.ac.uk/~hulld/research.html#tuningcomplete).
