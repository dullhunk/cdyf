...
This acknowledgements section is long because I try to practice what I preach about the importance of expressing gratitude, see section \@ref(lays). It also serves as a live demonstration of a public [gratitude journal](https://en.wikipedia.org/wiki/Gratitude_journal). Showing gratitude, both public and private, is a proven technique for improving mental health, see \@ref(signposts3).
...
```
(ref:captionmsc) Masters and Mistresses of Science, part of the [MSc Computer Science](https://web.archive.org/web/20030825205716/http://www.cs.man.ac.uk/Study_subweb/Postgrad/ACS-CS/webpages/handbook/CSHandbook.pdf) class of 2003. [Where's Wally?](https://en.wikipedia.org/wiki/Where%27s_Wally%3F) You should be able to find me although I'm *not* wearing a red and white stripy jumper. Picture by [Richard Giordano](https://www.southampton.ac.uk/healthsciences/about/staff/richard_giordano.page).  
...
Thanks to Martin Clutterbuck, Rebecca Clare, Richard O'Beirne, Simon Witter and everyone else at [Blackwell Science Ltd](https://www.flickr.com/photos/dullhunk/4042838703) and Eileen for looking after me in my first job as a freshly minted graduate.
...
Thanks to [Christoph Steinbeck](https://en.wikipedia.org/wiki/Christoph_Steinbeck), [Nico Adams](https://scholar.google.com/citations?user=3-PcEsEAAAAJ), Marcus Ennis, Janna Hastings, Paula de Matos, Adriano Dekker, [Kenneth Haug](https://twitter.com/kennethhaug  ), [Jo McEntyre](https://twitter.com/jomcentyre), Pablo Moreno, [Helen Parkinson](https://twitter.com/drp_stuff) and Mark Rijnbeek at the [European Bioinformatics Institute](https://en.wikipedia.org/wiki/European_Bioinformatics_Institute) (EBI, see figure \@ref(fig:cambridge-fig)) for looking after me during my year in Cambridge.
...
Thanks to [Malcolm Press](https://en.wikipedia.org/wiki/Malcolm_Press), Helena Björn van Praagh, [Terry Callaghan](https://en.wikipedia.org/wiki/Terry_Callaghan), [Jackie Potter](https://www.brookes.ac.uk/ocsld/about-ocsld/staff-profiles/jackie-potter/), Rosie, Nick, Dylan, Kjell, Marion and everyone else at [Abisko Scientific Research Station](https://en.wikipedia.org/wiki/Abisko_Scientific_Research_Station) (see figure \@ref(fig:abisko-fig)) for hosting me as a summer research student investigating the effects climate change on subarctic heathlands. The best summer job I've ever had!
...
So thanks Abisko for the [fika](https://en.wiktionary.org/wiki/fika), [midnight sun](https://en.wikipedia.org/wiki/Midnight_sun), saunas and Swedish hospitality. 🇸🇪🙏
...
Thanks [Branwen Munn](https://www.tycerdd.org/branwen-munn), pictured on the left in figure \@ref(fig:branwen-fig), for introducing me (pictured on the right) to [`while` loops](https://en.wikipedia.org/wiki/While_loop) on the Fitzmaurice Primary School [BBC Micro](https://en.wikipedia.org/wiki/BBC_Micro) and your very own [Commmodore 64](https://en.wikipedia.org/wiki/Commodore_64). I don't think I'd have ended up where I am if it hadn't been for early exposure to computing in primary school.
...
```
(ref:captionradipole) Birdwatching at RSPB [Radipole Lake](https://en.wikipedia.org/wiki/Radipole_Lake) in Weymouth, Dorset. Besides being members of the [Young Ornithologists Club](https://en.wikipedia.org/wiki/Young_Ornithologists%27_Club) (YOC) we also enjoyed [breakdancing](https://en.wikipedia.org/wiki/Breakdancing), music and computing. We'll always wear our geek badges with **pride**, see section \@ref(entitled).

So thanks Branwen, for breakdancing, birdwatching, music and computing.
