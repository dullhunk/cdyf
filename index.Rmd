...
1. **Discussing** [breakpoints](https://en.wikipedia.org/wiki/Breakpoint) of discussion with your peers and friends, where you stop the code and think about the variables and parameters you are using
...
### Thank you Bath {#bath}
<!--### Thanks Bath, Swindon, Shaftesbury & Stockport {#bath}-->
As a graduate of the [Postgraduate Certificate in Education](https://en.wikipedia.org/wiki/Postgraduate_Certificate_in_Education) (PGCE) course at the [University of Bath](https://en.wikipedia.org/wiki/University_of_Bath) (graduated 2011), I have been heavily influenced by course leaders Malcolm, Caroline Padley and fellow students.

```{r echo = FALSE, fig.align = "center", out.width = "100%", fig.cap = "(ref:captionbath)"}
knitr::include_graphics("images/bath-panorama.png")
```
(ref:captionbath) Panormama of the City of [Bath, Somerset](https://en.wikipedia.org/wiki/Bath,_Somerset). Image cropped from Photo by David Iliff available under CC BY-SA 3.0 license via Wikimedia Commons at [w.wiki/32BS](https://w.wiki/32BS)

Thanks teacher trainers for training me to teach. Thanks Bath for the [Aquae Sulis](https://en.wikipedia.org/wiki/Aquae_Sulis).

### Thank you Shaftesbury {#shaftesbury}
Thanks to Stuart Ferguson, David Booth and Chris Almond who hosted me as a PGCE student at [Shaftesbury School](https://en.wikipedia.org/wiki/Shaftesbury_School). Thanks also to my fellow Shaftesbury/Bath trainees Katharine Platt, Harriet Edwards, Vicky Dury and Joan Shaw keeping me awake on the long commutes to and from deepest darkest Dorset.

<!--### Thanks to schools {#canteach}
Thanks Moravian
Thanks Stockport
Thanks Shaftesbury
Thanks to staff (particularly Stuart Ferguson and Chris Almond and students at [Shaftesbury School](https://en.wikipedia.org/wiki/Shaftesbury_School) in Dorset, [Greendown Community School](https://en.wikipedia.org/wiki/Lydiard_Park_Academy) in Swindon, Wiltshire, and [St Annes RC High School](St Anne's RC Voluntary Academy), Stockport who helped me to improve my teaching. Thanks to Malcolm and
