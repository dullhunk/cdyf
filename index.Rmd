...
(ref:captionhellomyname) Hello my name is [Duncan](https://en.wikipedia.org/wiki/Duncan_(given_name)). Please don't call me Professor or Doctor, because titles are tinsel. [@shelley] If you're feeling a bit lost, follow me and together we can starting coding your future. Image adapted from *Hello my name is ... sticker* by Eviatar Bach, public domain [w.wiki/32RV](https://w.wiki/32RV)
