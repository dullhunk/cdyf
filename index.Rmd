...
* Click on the `Edit this page` link, which appears on the bottom right hand side of every page published at [cdyf.me](https://www.cdyf.me) when viewed with a reasonably large screen
* Most of the book is generated from the `*.Rmd` files, so these are the files to edit
...
<!--### contributions welcome email to toby, learning objectives, mixed metaphors -->
