...
* Marie Getheridge at [Writhlington School](https://en.wikipedia.org/wiki/Writhlington_School), Radstock, Somerset, see their amazing Orchid project [wsbeorchids.org](https://wsbeorchids.org/thirty-years-of-the-writhlington-schools-orchid-project-a-teachers-view-by-simon-pugh-jones/) run by [Simon Pugh-Jones](https://www.bristol.ac.uk/graduation/honorary-degrees/honorary-graduates-2019/simon-pugh-jones/)
...
* Patrick Hazlewood at [St John's Marlborough](https://en.wikipedia.org/wiki/St_John%27s_Marlborough), Wiltshire - not to be confused its posher and more famous next door neighbour [Marlborough College](https://en.wikipedia.org/wiki/Marlborough_College)
...
Thanks to Martin Clutterbuck, Rebecca Clare, Richard O'Beirne, Simon Witter, Paddy, Isobel, Howard, Gavin and everyone else in the journal production team at [Blackwell Science Ltd](https://www.flickr.com/photos/dullhunk/4042838703) for looking after me in my first job as a freshly minted graduate. Thanks to Eileen, Anne & Richard for giving me a home from home.
...
So thanks Manchester for being Mancunian. [This is the place](https://www.youtube.com/watch?v=PszMmYpQjPo)! [@longfella] 🙏
...
Thanks to the British Universities North America Club ([BUNAC](https://en.wikipedia.org/wiki/BUNAC)) for sponsoring my temporary worker visa which allowed me to cook breakfasts and wash pots for guests at the [Phillips Sea Food](https://phillipsseafood.com/) restaurant and hotel in [Ocean City, Maryland](https://en.wikipedia.org/wiki/Ocean_City,_Maryland).
...
Thanks to Mitch at [Green Tortoise Adventure Travel](https://greentortoise.com/) for transporting and feeding a bus load of us from San Francisco to New York via some of America's finest wildernesses (and cookouts) in [Yellowstone National Park](Yellowstone National Park), [Grand Teton National Park](Grand Teton National Park), [Badlands National Park](https://en.wikipedia.org/wiki/Badlands_National_Park).

Thanks to [Thomas Gochberg](https://wi.mit.edu/news/memoriam-thomas-gochberg) and Letty Gochberg for looking after me in New York and showing me around the sites of Manhattan. Thanks Pat Willmott and Rob Willmott for the introduction via the [Tall Ships America](https://www.tallshipsamerica.org/) in Plymouth, Devon from where the [Mayflower](https://en.wikipedia.org/wiki/Mayflower) embarked.

Thanks [Timo Hannay](https://en.wikipedia.org/wiki/Timo_Hannay) for letting me gatecrash the best party in Silicon Valley: [Science Foo Camp](https://en.wikipedia.org/wiki/Science_Foo_Camp) at the Googleplex in California in 2007 and again in 2009.
...
```
(ref:captionbradlads) Crossing the highest paved mountain pass in Europe, the [Col de l'Iseran](https://en.wikipedia.org/wiki/Col_de_l%27Iseran) in France, with my fellow alpinists and [Kings of the Mountains](https://en.wikipedia.org/wiki/King_of_the_Mountains): Jim, Dan, Doug and Dan. [Rest in Peace Dan](https://www.wiltshiretimes.co.uk/announcements/deaths/deaths/14828732.Daniel_Feane/), you were a cherished friend, we all loved you and miss you terribly. Repose en paix. 🇫🇷

Special thanks my friend, former St Laurence school student and [current sixth form head](https://st-laurence.com/sixth-form) Aidan Blowers for showing me around [The Clarendon School](https://en.wikipedia.org/wiki/The_Clarendon_Academy) in Trowbridge, Wiltshire and leading by example. Aidan's performance as *Lord of the Dance* (wearing a white shirt in figure \@ref(fig:uptown-funk-fig)), inspired the ongoing musical experiment that is [Tuning Complete](http://www.cs.man.ac.uk/~hulld/research.html#tuningcomplete).
...
Thanks to all of the [school governors](https://governorsforschools.org.uk/) for holding its leaders to account.
...
(ref:captionacropolis) The [Acropolis of Athens](https://en.wikipedia.org/wiki/Acropolis_of_Athens)  is dedicated to [Αθήνα](https://en.wikipedia.org/wiki/Athena): the goddess of wisdom. Picture of the Acropolis at night from the [Pnyx](https://en.wikipedia.org/wiki/Pnyx) with [Hymettus](https://en.wikipedia.org/wiki/Hymettus) in the background by [George E. Koronaios](https://commons.wikimedia.org/wiki/User:George_E._Koronaios) adapted from an original on Wikimedia Commons [w.wiki/4c2t](https://w.wiki/4c2t).
