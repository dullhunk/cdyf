...
Thanks to [Carole Goble](https://en.wikipedia.org/wiki/Carole_Goble) for patiently re-teaching me how to write by covering early drafts of my Masters thesis in red ink and less patiently (on subsequent revisions) swear words. 🤬

Thanks to [Steve Furber](https://en.wikipedia.org/wiki/Steve_Furber) for playing bass guitar in our “boy band” [Tuning Complete](http://www.cs.man.ac.uk/~hulld/research.html#tuningcomplete). 🎸
