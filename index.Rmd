...
* [St John's Marlborough](https://en.wikipedia.org/wiki/St_John%27s_Marlborough), Wiltshire - not to be confused with [Marlborough College](https://en.wikipedia.org/wiki/Marlborough_College)
...
* [Cheltenham Ladies' College](https://en.wikipedia.org/wiki/Cheltenham_Ladies%27_College), Gloucestershire^[As a newly qualified Jedi knight, freshly armed with a PGCE, I was anxious for my first job and momentarily considered using my powers on the “dark side” of private education. [@nicebutdim]]
