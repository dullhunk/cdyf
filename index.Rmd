...
Thanks to the British Universities North America Club ([BUNAC](https://en.wikipedia.org/wiki/BUNAC)) for sponsoring my temporary worker visa which allowed me to cook breakfasts for guests at the [Phillips Sea Food](https://phillipsseafood.com/) restaurant and hotel in [Ocean City, Maryland](https://en.wikipedia.org/wiki/Ocean_City,_Maryland). 🇺🇸
...
Thanks to Mitch at [Green Tortoise Adventure Travel](https://greentortoise.com/) for driving and feeding a bus load of us [hippies with flowers in our hair](https://en.wikipedia.org/wiki/San_Francisco_(Be_Sure_to_Wear_Flowers_in_Your_Hair)) from San Francisco to New York via some of America's finest wildernesses (and cookouts) in [Yellowstone National Park](Yellowstone National Park), [Grand Teton National Park](Grand Teton National Park), [Badlands National Park](https://en.wikipedia.org/wiki/Badlands_National_Park).

Thanks to [Thomas Gochberg](https://wi.mit.edu/news/memoriam-thomas-gochberg) and Letty Gochberg for looking after me in New York and showing me around the sites of Manhattan. Thanks Pat, Colin and Rob Willmott for the introduction via the [Tall Ships America](https://en.wikipedia.org/wiki/Tall_Ships_America) in Plymouth, Devon from where the [Mayflower](https://en.wikipedia.org/wiki/Mayflower) set off for the New World in 1620.
...
Thanks Boston for hosting [magnificent tea parties](https://en.wikipedia.org/wiki/Boston_Tea_Party) via the [W3C healthcare and life sciences interest group](https://www.w3.org/wiki/HCLSIG) and the Association for the Advancement of Artificial Intelligence (AAAI) conference [@aaai]. Thanks Joanne Luciano for showing us the sights of Boston and [the "other" Cambridge](https://en.wikipedia.org/wiki/Cambridge,_Massachusetts). Thanks Bertram Ludäscher for hosting workflow collaborations at UCSD.
...
Thanks to St Laurence school ([st-laurence.com](https://st-laurence.com/)), a community I am proud and lucky to have grown up in: Adam, Alan, Andrew, Anna, Charlotte, Catherine, Clare, Dan, Doug, Debbie, Jenny, Jim, Jon, John, Jo, Jon, Lou, Marcus, Marjorie, Matthew, Portia, Richard, Sasha, Scott, Simon, Sophie, Sophia, Stephen, Steve & Wilf. I'm especially grateful for the friendship of former St Laurence school students I've enjoyed music, cycling, football, walking, travelling, holidaying, drinking and camaraderie with: *Vive le Tour*, see figure \@ref(fig:bradlads-fig). I'm looking forward to our next adventure, gig, match, session or meetup.
...
(ref:captionacropolis) The [Acropolis of Athens](https://en.wikipedia.org/wiki/Acropolis_of_Athens)  is dedicated to [Αθήνα](https://en.wikipedia.org/wiki/Athena): the goddess of wisdom and warfare. Picture of the Acropolis at night from the [Pnyx](https://en.wikipedia.org/wiki/Pnyx) with [Hymettus](https://en.wikipedia.org/wiki/Hymettus) in the background by [George E. Koronaios](https://commons.wikimedia.org/wiki/User:George_E._Koronaios) adapted from an original on Wikimedia Commons [w.wiki/4c2t](https://w.wiki/4c2t).
