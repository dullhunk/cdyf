...
```
(ref:captionradipole) Birdwatching at [Radipole Lake](https://en.wikipedia.org/wiki/Radipole_Lake) in Weymouth, Dorset. Besides being members of the [Young Ornithologists Club](https://en.wikipedia.org/wiki/Young_Ornithologists%27_Club) (YOC) we also enjoyed [breakdancing](https://en.wikipedia.org/wiki/Breakdancing), music and computer programming. We've always worn our geek badges with pride, see section \@ref(entitled).

So thanks Branwen, for breakdancing, birdwatching, music and computer programming.
