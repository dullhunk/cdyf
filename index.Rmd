...
Thanks to Martin Clutterbuck, Rebecca Clare, Richard O'Beirne, Lillian Spearing, Simon Witter at [Blackwell Science Limited](https://www.flickr.com/photos/dullhunk/4042838703) for looking after me in my first job out of University. Thanks to Kal Ahmed, Clare Ashton, John Chelsom, Mavis Cournane, Eddie Dillon, Niki Dinsey, Phil Gooch, Antony Grinyer, Gareth Hudson, Steve Horwood, Chris Joyce, Joe McCann, Keith McCann, Dave Nurse, Ian Packard, Mark Pengelly, Omar Tamer and the rest of the team at CSW Informatics Ltd ([csw.co.uk](https://csw.co.uk/)) for teaching me about [Oxford Innovation](https://oxin-centres.co.uk/).
...
(ref:captionoxford) Sunrise over Oxford's [dreaming spires](https://en.wikipedia.org/wiki/Thyrsis_(poem)) from [South Park](https://en.wikipedia.org/wiki/South_Park,_Oxford) looking West across St Clements to the city. Picture adapted from an original by Tejvan Pettinger on Wikimedia Commons [w.wiki/4Y25](https://w.wiki/4Y25)

Thanks to [Jane Langdale](https://en.wikipedia.org/wiki/Jane_A._Langdale), [Steven A. Hill](https://en.wikipedia.org/wiki/Steven_A._Hill) and [Chris Leaver](https://en.wikipedia.org/wiki/Chris_J._Leaver) at the University of Oxford ([plants.ox.ac.uk](https://www.plants.ox.ac.uk/)) for teaching me a painful but important lesson about the value of my education and grades.

So thanks Oxford for the dreaming spires, see figure \@ref(fig:oxford-fig). 🙏

### Thank you Cambridge {#cambridge}
Thanks to [Christoph Steinbeck](https://en.wikipedia.org/wiki/Christoph_Steinbeck), Nico Adams, Marcus Ennis, Janna Hastings, Paula de Matos, Adriano Dekker, Kenneth Haug, Pablo Moreno, Helen Parkinson and Mark Rijnbeek at the [European Bioinformatics Institute](https://en.wikipedia.org/wiki/European_Bioinformatics_Institute) for looking after me during my year in Cambridge.
...
So thanks Cambridge for a fen-tastic time. 🙏
...
Special thanks my friend, former St Laurence school student and [current sixth form head](https://st-laurence.com/sixth-form) Aidan Blowers for leading by example, see figure \@ref(fig:uptown-funk-fig). Aidan's performance inspired the ongoing musical experiment that is [Tuning Complete](http://www.cs.man.ac.uk/~hulld/research.html#tuningcomplete).
...
Thanks to the rest of my St Laurence school teachers not pictured in figure \@ref(fig:fitzmaurice-fig). In alphabetical order: Phil Arthur, Sally Arthur, Maggie Bignell, [Jackie Bolton](https://www.wiltshiretimes.co.uk/news/11774162.the-life-of-mrs-jackie-bolton/), Tony Brooks, Dave Brush, Andrew Butterworth, Cathy Cooper, Ed Corrin, Brian Ellis, Myra Ettridge, Ms. Gledhill, Roger Greenwood, Amanda Hodges, Steve Hollas, Mr Jones, Madame Lindsay, Karen Long, Sheila Macdonald, Simon Mitchell, Tim Noble, Roger Norgrove, Dave Pegg, Angela Pendennis, Steve Stretch, Mr Sadler, Mike Sullivan, Phil Smith, Beryl Tucker, James Wetz and Bill Wheeler.

```{r laurence-fig, echo = FALSE, fig.show = "hold", out.width = "9.09%", fig.cap = ""}
