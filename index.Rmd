...
Tell us how we can improve this guidebook and we'll give you some GitLab swag in return, see figure \@ref(fig:gitswag-fig). The most actionable and constructive suggestions will get the best swag.
...
(ref:captiongitswag) We want your honest frank feedback. The most constructive and actionable feedback will receive (in ascending order) GitLab stickers, GitLab branded M&Ms and GitLab noetbooks. The foxy logo isn't actually fox but a [Japanese raccoon dog](https://en.wikipedia.org/wiki/Japanese_raccoon_dog), who knew? Not me. [@tanuki] 🦊

We'd like to know how we can improve your future, specifically these three points::
...
1. **Even Better If** (EBI) how can we make it better, what is missing? Which bits are boring, unclear or too long? Which bits replicate better material found elsewhere?
1. **Any other business** (AOB) other comments or suggestions, e.g. would you buy a printed copy if one was available?

Send us your suggestions by:

* Raising an issue privately on GitLab issues (login required) [gitlab.cs.man.ac.uk/duncan.hull/cdyf/-/issues/new](https://gitlab.cs.man.ac.uk/duncan.hull/cdyf/-/issues/new), if you check the `this issue is confidential` it won't be seen by anybody except you and me
* Publicly on GitHub (login required) see section \@ref(techies)
* Anonymously via this form (login required) but we won't see your name at [forms.office.com/e/1U4TCfc8Aa](https://forms.office.com/e/1U4TCfc8Aa)


...by **5pm on Friday 17th May**. Besides bagging some swag, we'll be eternally grateful to you for telling us how to make this guidebook better for future students. 
