...
Thank you [Carole Goble](https://en.wikipedia.org/wiki/Carole_Goble) for building the community that supported me through postgraduate study. Thanks for creating the environment which this book was written in, especially the Information Management Group (IMG) and its spin-offs. Thanks for patiently re-teaching me how to write by covering early drafts of my Masters thesis in red ink and less patiently (on subsequent revisions) swear words. 🤬
