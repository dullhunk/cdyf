...
This acknowledgements section is long because I try to practice what I preach about the importance of expressing gratitude, see section \@ref(lays) and \@ref(signposts3). It also serves as a live demonstration of a public [gratitude journal](https://en.wikipedia.org/wiki/Gratitude_journal). If you want to cut to the chase of this book you can skip this and go straight to chapter \@ref(rebooting).
