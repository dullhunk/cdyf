...
This guidebook aims to help you bridge from where you are now to where you'd like to be in the future. Each chapter of the book contains the following recurring themes:
...
```
(ref:captiongoldengate) The iconic [Golden Gate Bridge](https://en.wikipedia.org/wiki/Golden_Gate_Bridge), adapted from an original by Frank Schulenburg (CC BY-SA) from Wikimedia Commons [w.wiki/37kY](https://w.wiki/37kY)
...
So thanks Shaftesbury for lessons on top of Gold Hill and the Hovis Advert, voted one of Britain's best-loved adverts. [@hovisadvert] 🍞
