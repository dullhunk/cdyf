...
```
(ref:captiongoldengate) This guidebook will help you build a big bridge to your future. Picture of the iconic [Golden Gate Bridge](https://en.wikipedia.org/wiki/Golden_Gate_Bridge) in California adapted from an original by Frank Schulenburg (CC BY-SA) on Wikimedia Commons [w.wiki/37kY](https://w.wiki/37kY)
...
* Add comments by annotating the [cdyf.pdf](https://www.cdyf.me/cdyf.pdf) using your weapon of choice (iPad, [reMarkable](https://en.wikipedia.org/wiki/ReMarkable) or whatever) and [email it to me](http://www.cs.man.ac.uk/~hulld/contact.html)
...
* Suggest changes via the  Microsoft Word version at [cdyf.docx](http://cdyf.me/cdyf.docx), which is solely for editing purposes. The text is all there, but the pagination and graphic placement as good as the pdf version.^[Don't say I didn't warn you!] Make sure you've turned on [track changes](https://support.microsoft.com/en-us/office/track-changes-in-word-197ba630-0f5f-4a8e-9a77-3712475e806a) if you want to suggest changes via Word.
* If you don't want to use the [github.com](https://github.com/), PDF or Word versions, just [email me suggestions for improvements](http://www.cs.man.ac.uk/~hulld/contact.html)
...
This site is hosted on [netlify.com](https://www.netlify.com/), see the [netlify privacy policy](https://www.netlify.com/privacy/). This site also uses [netlify analytics](https://docs.netlify.com/monitor-sites/analytics/) and [Google Analytics](https://en.wikipedia.org/wiki/Google_Analytics) to monitor use, both of which comply with the General Data Protection Regulation (GDPR).
