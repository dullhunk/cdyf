...
Thanks to all the [thousands of editors](https://en.wikipedia.org/wiki/Wikipedia:Wikipedians) and engineers that make Wikipedia one of the greatest communities on the internet, see figure \@ref(fig:wikipedians-fig).
