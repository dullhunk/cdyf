...
The web version of this book will always be available at [www.cdyf.me](https://www.cdyf.me/), so the `*.html` version will always be searchable and linkable. If you'd rather read this guidebook in ebook format, you can buy the automatically updated pdf and epub on leanpub.com, shown in figure \@ref(fig:leanpub-fig):

<!-- see https://bookdown.org/yihui/rmarkdown-cookbook/include-url.html -->
```{r, leanpub-fig, echo = FALSE, out.width='100%', fig.cap="This guidebook is also avaialble as an ebook on leanpub.com", dev='png', cache=TRUE, screenshot.opts=list(vwidth=992)}
