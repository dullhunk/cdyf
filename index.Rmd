...
* Help with existing issues at [github.com/dullhunk/cdyf/issues](https://github.com/dullhunk/cdyf/issues)
* Submit a pull request [github.com/dullhunk/cdyf/pulls](https://github.com/dullhunk/cdyf/pulls), If you're not familiar with pull requests yet, see [makeapullrequest.com](http://makeapullrequest.com/)
* From the command line `git clone https://github.com/dullhunk/cdyf.git` the repository to submit pull requests from your setup
...
So thanks Manchester^[Manc-you very much. Sorry, I can't resist...] for being Mancunian. 🙏
