...
* Most of the guidebook is generated from the [RMarkdown](https://en.wikipedia.org/wiki/Markdown) (`*.Rmd` files), so these are the files to edit because they generate everything else including the `*.html`, `*.tex`, `*.pdf`,`*.epub` and `*.docx`  files
