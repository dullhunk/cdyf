...
## Aims of Coding your Future {#vaccine}
This guidebook will help you develop healthier habits of mind, body and soul using five key ingredients:

1. **C**ode: Various instructions
1. **D**ata: You need to take into consideration
1. **Y**ou: This guidebook needs you to do things
1. **F**utures: Think about the future, rather than dwelling on the past
1. **M**e: I'm your tour guide

These ingredients are intended techniques for making decisions about your future, job searching, submitting applications and competing successfully in interviews and the workplace.
...
* The chapter on [why bother?](bothering.html) looks at why you should bother reading any of this book
* The chapter on [who are you?](knowing.html) challenges you to reflect on who you are, what makes you unique and why you are here
* The chapter on [your well-being](wellbeing.html) encourages you to take care of your mental and physical health
* The chapter on [soft skills are hard](communicating.html) explores your soft skills, and how they complement your hard skills and why employers value them so much
* The chapter on [are you experienced?](experiencing.html) asks you to reflect on your work experience and help identify where you can improve it
* The chapter on [computing your future](computing.html) looks at the role computing can play in your career, with or without a Computer Science degree
...
* The chapter [debugging your CV](debugging.html) alongside other written communication such as covering letters,  application forms and digital portfolios.
* The chapter on [your job search and networks](finding.html), looks at where and how can you look for interesting opportunities
* The chapter on [your interviews and offers](interviewing.html), looks how can you turn interviews to your advantage and negotiate any offers you receive
* The chapter on [your survival and promotion](surviving.html) looks at the next steps. Once you've landed a job, how will you survive and thrive outside (and after) University
* The chapter on [postgraduate study](studying.html) discusses if a Masters degree or a PhD right for you?
* The chapter on [your alternatives](broadening.html) encourages you to broaden your horizons. Maybe you want to start your own business and employ others or you'd like to work in the non-profit or public sector? Perhaps you could be a freelancer or contractor? The possibilities are endless.

### Rebooting your future {#partiii}

The third part of this book, contains supporting material that will help the design, build and test phases described above:

* The [Ten Simple Rules for Coding your Future](ruling.html) provides an alternative summary of this book
* The chapter on [debugging their CV](sampling.html) invites you to put yourself in the shoes of your potential employer by
* The chapter on [Not Just London](notjustlondon.html) looks at opportunities outside of capital cities like London
* The chapter on [listening to your future](listening.html) invites you to hear students stories of their transition from education to employment
* The chapter on [actioning your future](verbsfirst.html) gets you to think about your actions by emphasising verbs on your job applications
* the chapter on [scheduling your future](scheduling.html) invites you to set aside an hour each week for tackling the issues described in this book
* The last chapter on [reading your future](references.html) provides the essential signposts alongside everything (yes, everything!) else I've cited in this guidebook
<!--
* algorithms?
...
1. **Speaking your future**
1. **Writing your future** written exercises using natural language
1. **Reading your future** reading exercises
1. **Quizzing and assessing your future** activities and quizzes that will be assessed either by yourself, your peers, an employer or an academic (depending on who and where you are)
1. **Challenging your future** coding challenges are designed to take you out of your comfort zone by experiment with your thoughts, discussions and actions
1. **Signposting your future** - seriously useful resources that I recommend you read, listen to or watch
...
<!--### Thanks to schools {#canteach}
Thanks to staff (particularly Stuart Ferguson and Chris Almond and students at [Shaftesbury School](https://en.wikipedia.org/wiki/Shaftesbury_School) in Dorset, [Greendown Community School](https://en.wikipedia.org/wiki/Lydiard_Park_Academy) in Swindon, Wiltshire, and [St Annes RC High School](St Anne's RC Voluntary Academy), Stockport who helped me to improve my teaching. Thanks to Malcolm and my fellow teacher trainees Katharine Platt, Harriet Edwards, Joana Shaw, Vicky Dury at the University of Bath.-->
