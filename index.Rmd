...
This full text of this book is freely available at [www.cdyf.me](https://www.cdyf.me/), making the  web version (`*.html`) searchable, browsable and linkable. If you'd rather read this guidebook in ebook format than a web browser, you can buy the automatically updated epub and pdf at [leanpub.com/cdyf](https://leanpub.com/cdyf), shown in figure \@ref(fig:leanpub-fig).
...
This acknowledgements section is long because I try to practice what I preach about the importance of expressing gratitude, see section \@ref(lays). It also serves as a live demonstration of a (public) [gratitude journal](https://en.wikipedia.org/wiki/Gratitude_journal). Expressing gratitude, publicly and privately, is a simple and proven technique for improving your mental health. It will also improve the mental health of the people who you thank, see \@ref(signposts3).
...
Thanks to the artists, bloggers, cartoonists, columnists, doodlers, diarists, essayists, photographers and writers on the internet whose [words and pictures](https://en.wikipedia.org/wiki/Words_and_Pictures_(TV_programme)) I've enjoyed reading, see figure \@ref(fig:keyboard-fig) and the list below.
...
```
(ref:captionkeyboard) The pen is mightier than the sword, and so is the keyboard. Thank you incisive writers for your mighty words which provide an existence proof that engineers and scientists should also be good communicators. CC BY SA picture of a backlit keyboard adapted from an original by [Colin](https://commons.wikimedia.org/wiki/User:Colin) on Wikimedia Commons [w.wiki/4sQd](https://w.wiki/4sQd)
