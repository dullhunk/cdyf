...
Thanks to St Laurence school ([st-laurence.com](https://st-laurence.com/)), a community I am proud and lucky to have grown up in. I'm especially grateful for the ongoing friendship of those I've enjoyed music, cycling, walking, travelling and drinking with over the years, some of whom you can see figure \@ref(fig:bradlads-fig). I'm looking forward to our next adventure.
...
Special thanks my friend, former St Laurence school student and [current sixth form head](https://st-laurence.com/sixth-form) Aidan Blowers for leading by example, see figure \@ref(fig:uptown-funk-fig). Aidan's approach inspired the ongoing musical experiment that is [Tuning Complete](http://www.cs.man.ac.uk/~hulld/research.html#tuningcomplete).
...
```
(ref:captionuptown) Year 11 leavers of Melksham Oak Community School (MOCS) dance to [Uptown Funk](https://en.wikipedia.org/wiki/Uptown_Funk) in 2015 with help from Mark Ronson, Bruno Mars and Aidan Blowers. The image above is a screenshot. Don't believe me, just watch, come on! [youtu.be/z8qH05teRMM](https://youtu.be/z8qH05teRMM)
...
Thanks to my [Fitzmaurice Primary School](https://www.fitzmauriceschool.info/) school teachers: Mrs Cripps, Mrs Clary, Mr Clay, Mr Fleming, Mr Jackson, Val Payne, Mrs Sheldon, Hugh Solomon, Miss Uncles and Mrs White. I used to foolishly think it was secondary schools that did all the serious teaching, but they'd be *nowhere* without the foundations laid in primary school.
