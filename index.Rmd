...
So there is something in this guidebook for every student.

<!--todo check github-repo-->

## Aims of this guidebook

So *coding your future* explores techniques for making career decisions, job searching, submitting applications and competing successfully in interviews and the workplace.
...
To aid gutting, the version published at [cdyf.me](https://www.cdyf.me/) has a built in search and tables of contents.

This guidebook is split into three parts, the first part is on [designing your future](bothering.html) while the second is on [building and testing your future](debugging.html) which are shown in Figure \@ref(fig:map-fig). The final part is a [help](ruling.html) section, for supporting your future.
...
Let's look in a bit more detail at the content of each of the three parts of this guidebook:
...
First and foremost, I'd like to thank all the students who have helped with this book, both directly and indirectly. I can't name you all but if you have studied some flavour of Computer Science at the University of Manchester since 2012, there's a good chance you have contributed to this book. Thank you for being ambitious, hard working, talented, fearless, creative and inspirational! It has been a pleasure and a privilege working with you all.
...
I'd especially like to thank industrial experience (IE) students who completed a year in industry as part of their degree as well as those who have done summer internships, either as part of the Master of Engineering (MEng) program or otherwise. In addition, the [PASS leaders](http://www.pass.manchester.ac.uk) and facilitators, [UniCSmcr.com](https://unicsmcr.com/), [HackSoc](https://github.com/unicsmcr/hacksoc.com),  [CSSoc](https://github.com/cssoc) and [Manchester Ultimate Programming](https://github.com/Man-UP) members have all been influential on the content of this book. I've learned heaps from trawling through thousands of CVs too, so if you've shown me a copy of your CV, thanks! The chapters on [debugging your CV](debugging.html) and [debugging their CV](sampling.html) are based on the most common bugs (or are they features?) I've seen in CVs and resumes.
<!--
...
I'm standing on the shoulders of students. So, thank you students for being studious. 🙏

### Thanks to employers {#employers}

Thanks to all the employers who have employed students from the Department of Computer Science as either summer interns, year long placements or graduates. A big chunk of this guidebook documents their experience of employers and their graduate recruitment programs.
...
Special thanks to Sharif Salah at Google for introducing me to Google's Technical Writing course. [@googling]

So, thanks employers for employing our students. 🙏

### Thanks to colleagues {#colleagues}
I would especially like to thank [Jim Miles](https://en.wikipedia.org/wiki/James_John_Miles) for encouraging me to write a book shortly after he offered me a job. I thought he was joking (about the book) but it turned out to be another one of Jim's great ideas. Thanks Jim. 🙏

Thanks to past and present academic colleagues, PhD students and teachers at the University of Manchester who have contributed to this guidebook and the environment it was written in. They include (in alphabetical order) Sophia Ananiadou, Sam Bail, Richard Banach, Cassie Barlow, Riza Batista-Navarro, Niall Beard, Sean Bechhofer, Rupert Blackstone, Stewart Blakeway, Petrut Bogdan, Caroline Bowsher, Andy Bridge, Andy Brass, Gavin Brown, Grant Campbell, Angelo Cangelosi, Peter Capon, Andy Carpenter, Barry Cheetham, Ke Chen, Sarah Clinch, Paul Dobson, Clare Dixon, Danny Dresner, Doug Edwards, Suzanne Embury, Michael Emes, Alvaro Fernandes, Nick Filer, Steve Furber, Andre Freitas, Aphrodite Galata, Matthew Gamble, Jim Garside, Chris Gilbert, Danielle George, Richard Giordano, Birte Glimm, Carole Goble, Antoon Goderis, Roy Goodacre, Bernardo Cuenca Grau, Peter Green, Keith Gull, John Gurd, Lucy Harris, Robert Haines, Guy Hanke, Simon Harper, Jonathan Heathcote, Gareth Henshall, Andrew Horn, Matthew Horridge, Ian Horrocks, Toby Howard, Roger Hubbold, Jules Irenge, Daniel Jameson, Caroline Jay, Mirantha Jayathilaka, Huw Jones, John Keane, Douglas Kell, Joshua Knowles, Dirk Koch, Alice Larkin, Peter Lammich, John Latham, Kung-Kiu Lau, Dave Lester, Peter Li, Zewen Liu, Phil Lord, Mikel Lujan, Boris Motik, Christoforos Moutafis, Vanessa McQuillan, Tingting Mu, Aleksandra Nenadic, Goran Nenadic, Steve McDermott, Jock McNaught, Mary McGee-Wood, Pedro Mendes, Sarah Mohammad-Qureshi, Tim Morris, Steve Oliver, Mario Ramirez Orihuela, Stuart Owen, Pavlos Petoumenos, Jac Potter, Malcolm Press, Colin Puleston, Paul Nutter, Dario Panada, Michael Parkin, Bijan Parsia, Jon Parkinson, Norman Paton, Steve Pettifer, Allan Ramsay, Alasdair Rawsthorne, Farshid Rayhan, Alan Rector, Giles Reger, Graham Riley, Clare Roebuck, Mauricio Jacobo Romero, Nancy Rothwell, William Rowe, Oliver Rhodes, Graham Riley, Danielle Ryding, Ulrike Sattler, Ahmed Saeed, Pejman Saeghe, Rizos Sakellariou, Pedro Sampaio, Sandra Sampaio, John Sargeant, Andrea Schalk, Viktor Schlegel, Renate Schmidt, Jonathan Shapiro, Elaine Sheehan, Liz Sheffield, Bushra Sikander, Bushra Sikander, Stian Soiland-Reyes, Kieran Smallbone, Robert Stevens, Neil Swainston, Paul Taplin, Chris Taylor, Tom Thomson, Dave Thorne, David Toluhi, Jake Vasilakes, Laura Vasques, Markel Vigo, Louise Walker, Alex Walker, Anna Warburton-Ball, Sarah White, Dieter Wiechart, Natalie Wood, Igor Wodiany, Chris Wroe, Crystal Wu, Lisheng Wu, Yifan Xu, Viktor Yarmolenko, Serafeim Zanikolas, Xiao-Jun Zeng, Jun Zhao, Liping Zhao, Ning Zhang and Evgeny Zolin.


Optimists will tell you that “everyone has a book in them...”, although pessimists like [Christoph Hitchens](https://en.wikipedia.org/wiki/Christopher_Hitchens) will add that “...in most cases that's where it should remain”. [@everyone] Despite Hitchens amusing trademark cynicism shown in figure \@ref(fig:hitchens-fig), I am an optimist when it comes to the power of natural languages.
...
Thanks also to the fantastic support staff (past and present) from professional services who make all the magic of teaching and learning possible: Jennie Ball-Foster, Karen Butterworth, Chris Connolly, Gavin Donald, Miriam Cadney, Ben Carter, Hannah Cousins, Holly Dewsnip, Tammy Goldfeld, Penney Gordon-Lanes, Iain Hart, Kath Hopkins, Lynn Howarth, Radina Ivanova, Alex Jones, Mike Keeley, Jez Lloyd, Dominic Laing, Gill Lester, Ruth Maddocks, Karon Mee, Anne Milligan, Rachel Mutters, Chris Page, Melanie Price, Chris Rhodes, Angela Standish, Bernard Strutt, Jannine Thomas, Elizabeth Wilkinson, Sarah White, Andrew Whitmore and Mabel Yau.

And Wendy, we all miss and love you Wendy. [#JusticeForWendy](https://www.justgiving.com/crowdfunding/byte-cafe) ✊🏽
...
* Thanks to [Laurie Santos](https://en.wikipedia.org/wiki/Laurie_R._Santos) ([\@lauriesantos](https://twitter.com/lauriesantos)), for *The Science of Well-being* (TSOWB) [@lauriesantos] which was been a significant influence on this book had a dramatic effect on my personal and professional life
...
* Thanks to [David Malan](https://en.wikipedia.org/wiki/David_J._Malan) ([\@malan](https://cs.harvard.edu/malan/)) for [CS50](https://en.wikipedia.org/wiki/CS50) which continues to be an inspiration. [@cs50; @cs50mcr; @cs50zoom] Thanks to [Cristian Bodnar](https://crisbodnar.github.io/) for inviting David to run [CS50 in Manchester](http://cs50.hacksoc.com) in 2017.
...
Thanks to everyone who has contributed via github. I will credit *any* github contributors here, small or large. Even the typos, it all counts. I've left some deliberate mistakes in so you can easily add yourself to this roll call by correcting them. 😉
...
So, thanks Bryan for your witty illustrations, this book wouldn't be the same without your visual thinkery. I'm so glad we bumped into each other. 🙏

### Thanks to my friends {#friends}  
Thanks to my friends, especially those who I've enjoyed live music and dancing with. I hope we can sing and dance together to live music again before too long.
