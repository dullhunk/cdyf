...
(ref:captionhellomyname) Hello my name is Duncan. Are you feeling a bit lost? Follow me. Image adapted from "Hello my name is sticker" by Eviatar Bach, public domain [w.wiki/32RV](https://w.wiki/32RV)
...
Thanks also to the superb support staff (past and present) from professional services, especially the Academic Support Office (ACSO), Student Suport Office (SSO) and external affairs office in the Kilburn building. Professional services staff continue to make all the magic of teaching and learning possible: Alyx Adams, Jennie Ball-Foster, Emma Bentley, Christine Bowers, Karen Butterworth, Chris Connolly, Jean Davison, Gavin Donald, Miriam Cadney, Chris Calland, Ben Carter, Hannah Cousins, Holly Dewsnip, Tammy Goldfeld, Penney Gordon-Lanes, Amelia Graham, Iain Hart, Kath Hopkins, Lynn Howarth, Susie Hymas, Radina Ivanova, Alex Jones, Jessicca Kateryniuk-Smith, Mike Keeley, Jez Lloyd, Dominic Laing, Gill Lester, Ruth Maddocks, Cameron Macdonald, Tony McDonald, Karon Mee, Anne Milligan, Rachel Mutters, Chris Page, Melanie Price, Chris Rhodes, Graham Richardson, Martin Ross, Angela Standish, Martine Storey, Bernard Strutt, Jannine Thomas, Joseph Tirone, Daisy Towers, Anna Warburton-Ball, Richard Ward, Sarah White, Elizabeth Wilkinson, Andrew Whitmore, Lisa Wright and Mabel Yau.
...
```
(ref:captionbath) Panormama of the beautiful Georgian City of [Bath, Somerset](https://en.wikipedia.org/wiki/Bath,_Somerset). Image cropped from Photo by David Iliff available under CC BY-SA 3.0 license via Wikimedia Commons at [w.wiki/32BS](https://w.wiki/32BS)
...
Thanks to Stuart Ferguson, David Booth, Chris Almond, David Ball, Caroline Dallimore, Mr Travers and Caroline Moss who hosted my first PGCE student placement at [Shaftesbury School](https://en.wikipedia.org/wiki/Shaftesbury_School). Thanks also to my fellow Shaftesbury/Bath trainees Katharine Platt, Harriet Edwards, Vicky Dury and Joan Shaw for sharing their knowledge through [peer learning](https://en.wikipedia.org/wiki/Peer_learning). Thanks Joan for keeping me awake on the long trans-[West country](https://en.wikipedia.org/wiki/West_Country) route to and from deepest darkest Dorset and sharing the heavy driving burden of commuting.
...
* [Wrightlington School](https://en.wikipedia.org/wiki/Writhlington_School), Radstock, Somerset, see their amazing Orchid project [wsbeorchids.org](https://wsbeorchids.org/thirty-years-of-the-writhlington-schools-orchid-project-a-teachers-view-by-simon-pugh-jones/)
...
* [St John's Marlborough](https://en.wikipedia.org/wiki/St_John%27s_Marlborough), Marlborough, Wiltshire - not to be confused with [Marlborough College](https://en.wikipedia.org/wiki/Marlborough_College)
...
* [Cheltenham Ladies' College](https://en.wikipedia.org/wiki/Cheltenham_Ladies%27_College), Cheltenham, Gloucestershire^[As a newly qualified Jedi, freshly armed with a PGCE, I was so anxious for a job by this point that I momentarily considered using my powers on the “dark side” of private education. [@nicebutdim]]
* [Blackburn College](https://en.wikipedia.org/wiki/Blackburn_College_(Blackburn_with_Darwen)), Lancashire  “I heard the news today, oh boy! Four thousand holes in Blackburn, Lancashire”

So thanks schools, for schooling. 🙏

### Thank you Stockport {#stockport}

Thanks to Joanne Meredith,<!--https://web.archive.org/web/20131202172038/http://www.st-annes.stockport.sch.uk/about-us/meet-the-head--> her team of staff and the students at [St. Annes R.C. High School](https://en.wikipedia.org/wiki/St_Anne%27s_RC_Voluntary_Academy), Stockport for hosting the first part of my [Newly Qualified Teacher](https://en.wikipedia.org/wiki/Newly_qualified_teacher) (NQT) year. Thanks to Keith Doran and other members of the alternative staff room for emotional and practical support under challenging circumstances, figure \@ref(fig:st-annes-fig). The *Manchester Evening News* dubbed St. Anne's the “forgotten school” [@stannes1; @stannes2] but I'll never forget you.
...
(ref:captionstannes) Good governance is crucial to good schools. Many schools like St. Annes, and the hundreds of children they educate, need help from people like you. Why not serve your local community as a school governor? Take a look at [governorsforschools.org.uk](https://governorsforschools.org.uk/). Fair use image via Wikimedia Commons [w.wiki/33Xs](https://w.wiki/33Xs) adapted using the [Wikipedia application](https://apps.apple.com/us/app/wikipedia/id324715238)

So thanks Stockport for being Stockport, and for [The Hatters](https://en.wikipedia.org/wiki/Stockport_County_F.C.)! It's all that matters. ⚽️🎩🙏
<!--
Thanks Moravian
 -->
