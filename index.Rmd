...
1. **`D is for DATA`**: Facts, statistics, graphs and pictures collected together for your analysis
1. **`Y is for YOU`**: This book is all about you, with activities and other *coding challenges* for you to do in addition to just reading
...
1. **`.me is for ME`**: Hello, my name is Duncan. I'm your tour guide here. If you're feeling a bit lost, follow me and I'll help you code your future.


```{r hello-my-name-fig, echo = FALSE, fig.align = "center", out.width = "79%", fig.cap = "(ref:captionhellomyname)"}
