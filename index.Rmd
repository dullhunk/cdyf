...
### Thank you Bath {#bath}
As a graduate of the [Postgraduate Certificate in Education](https://en.wikipedia.org/wiki/Postgraduate_Certificate_in_Education) (PGCE) in Science  at the [University of Bath](https://en.wikipedia.org/wiki/University_of_Bath), [Department of Education](https://www.bath.ac.uk/education) (graduated 2011), I have been heavily influenced by the fantastic work of PGCE course leaders Caroline Padley (Physics), Steve Cooper (Chemistry), Malcolm (Biology), fellow students, guest speakers such as [Steve Mould](https://en.wikipedia.org/wiki/Steve_Mould).<!-- vortex cannon guy https://www.youtube.com/watch?v=IyAyd4WnvhU-->
...
Thanks Bath for the initial teacher training (ITT), all the medicinal [Aquae Sulis](https://en.wikipedia.org/wiki/Aquae_Sulis) and the beautiful [Cotwolds](https://en.wikipedia.org/wiki/Cotswolds) Area of Outstanding Natural Beauty ([AONB](https://en.wikipedia.org/wiki/Area_of_Outstanding_Natural_Beauty)). 🙏
