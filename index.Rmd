...
Tell us how we can improve this guidebook and we'll give you our eternal gratitude and some GitLab swag in return, see figure \@ref(fig:gitswag-fig). The most actionable and constructive suggestions will get the best swag.
...
(ref:captiongitswag) We want your honest frank feedback. The most constructive and actionable feedback will receive (in ascending order) GitLab stickers, GitLab branded M&Ms and GitLab noetbooks. The foxy GitLab logo isn't actually fox but a [Japanese raccoon dog](https://en.wikipedia.org/wiki/Japanese_raccoon_dog), who knew? [@tanuki] 🦊
...
1. **Even Better If** (EBI) how can we make it better, what is missing? Which bits are boring, unclear or too long? Which bits pointlessly replicate better material found elsewhere?
...
* Publicly on GitHub (login required), get public credit and build your digital profile with your contributions, see section \@ref(techies)
