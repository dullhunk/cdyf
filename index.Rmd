...
(ref:breakpoint) Let's pause, insert a [breakpoint](https://en.wikipedia.org/wiki/Breakpoint) in your `code` and slowly step through to examine the values of your variables and parameters.
