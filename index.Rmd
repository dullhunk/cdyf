...
```
Hello and welcome to *Coding Your Future*, the guidebook that will help you to design, build, test and *code* your future in computing. Published at [cdyf.me](https://www.cdyf.me), [cdyf.pdf](https://www.cdyf.me/cdyf.pdf) & [cdyf.epub](https://www.cdyf.me/cdyf.epub), it is aimed at ALL students in higher education. Although this guide supports undergraduate teaching at the University of Manchester, it doesn't actually matter:
...
This guidebook will NOT teach you how to write code, there's already lots of fantastic resources to help you do that. We discuss some of them in chapter \@ref{coding} on *computing your future*.
...
* Suggest changes via the (old school) Microsoft Word version at [cdyf.docx](http://cdyf.me/cdyf.docx). The text is all there, but the pagination and graphic placement isn't always pretty.^[Don't say I didn't warn you!] Make sure you've turned on [track changes](https://support.microsoft.com/en-us/office/track-changes-in-word-197ba630-0f5f-4a8e-9a77-3712475e806a) if you suggest changes via Word.
