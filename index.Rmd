...
<!--boilerplate text-->
(ref:breakpoint) Let's pause, insert a [breakpoint](https://en.wikipedia.org/wiki/Breakpoint) and step through your `code` to examine the values of your variables and parameters.
