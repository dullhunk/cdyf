...
link-citations: yes
description: "Welcome to coding your future. This guidebook will teach you how to design, build, test and code your future. You'll be introduced to professional issues in computer science, exploring techniques for making career decisions, job searching, submitting applications and competing successfully in interviews and the workplace. Alongside the practical engineering issues of coding and testing your future, this guidebook also encourages you to design your future by taking a step back and thinking more theoretically. You will apply computational thinking techniques, to reflect on who you are, what your story is, how you communicate with other people, what your experience is to date and where you want to be in the future. "
...
It doesn't matter what stage of your study you are at, there's something here for you. The content happens to support second year teaching at the University of Manchester, it doesn't matter what stage of your undergraduate or postgraduate study you are.
...
1. Undergraduate and postgraduate students studying *any* subject, with little or no Computer Science at all. You are curious to know about what role computing could play in your future career.  

So the prerequisites for this book are that you are studying (or have studied) at University, probably in the United Kingdom. You *may* have some experience already, either casual, voluntary or otherwise, but this book does **not** assume that you have already been employed in some capacity.

### Don't read this, gut it!
...
So gut this book like a fish. Identify the chapters that are most useful to you (the flesh), and skip the rest (the guts). Which chapters are flesh and which are guts will depend on what stage of the journey you are at. This guidebook is designed to be as “guttable” as possible.  `r if (knitr::is_html_output()) '
To aid gutting, the web based form at published at [www.cdyf.me](https://www.cdyf.me/) has a built in search, and two tables of contents:

1. One for the entire guidebook, which you will see on the left hand side 👈
1. One for the chapter you are currently in, which you will see on to the right hand side 👉'`

This guidebook is split into three parts, the first part is on [designing your future](#bothering) while the second is on [building and testing your future](#debugging) which are shown in Figure \@ref(fig:map-fig). The final part is a [help](#ruling) section, supporting your future.
...
* The first chapter [why bother?](#bothering) looks at why you should bother reading any of this book
* The second chapter [who are you?](#knowing) challenges you to reflect on who you are, what makes you unique and why you are here
* The third chapter looks at [your well-being](#wellbeing), taking care of your mental and physical health
* The fourth chapter [soft skills are hard](#communicating) explores your soft skills, how they complement your hard skills and why employers value them so much
* The fifth chapter [are you experienced?](#experiencing) asks you to reflect on your work experience and help identify where you can improve it
* The sixth chapter [computing your future](#computing) looks at the role computing can play in your career, with or without a Computer Science degree


### PART II: Building and testing your future
...
* The seventh chapter helps you to [debug your CV](#debugging) alongside other written communication such as covering letters,  application forms and digital portfolios.
* The eighth chapter looks at [your job search and networks](#finding), where can you look for interesting opportunities
* The ninth chapter looks [your interviews and offers](#interviewing), how can you turn interviews to your advantage and negotiate any offers you receive
* The tenth chapter looks at [your survival and promotion](#surviving), once you've landed a job, how will you survive and thrive outside (and after) University
* The eleventh chapter looks at [postgraduate study](#studying) is a Masters or a PhD right for you?
* The twelfth chapter looks at [your alternatives](#broadening) and encourages you to broaden your horizons. Perhaps you could be a freelancer, contractor? Maybe you want to start your own business and employ others or you'd like to work in the non-profit or public sector?

### PART III: Supporting your future

The third part of this book, contains supporting material that will help the design, build and test phases described above:

* The thirteenth chapter summarises the whole guidebook in [Ten Simple Rules for Coding your Future](#ruling).
* The fourteenth chapter introduces you to some fictitious candidates and invites you to [Debug their CV](#sampling)
* The fifteenth chapter looks at careers outside of the capital because it's [Not Just London](#notjustlondon)
* The sixteenth chapter interviews students after returning from their placements in the [Coding your Future podcast](#podcast)
* The seventeenth chapter shows how to emphasising your actions on your CV by putting the [verbs first](#verbs)
* The [references section](http://cdyf.me/references.html) provides the essential signposts alongside everything (yes, everything!) else I've cited in this guidebook
<!--
* algorithms?
...
### Thanks to students
First and foremost, I'd like to thank all the students who have helped with this book, both directly and directly. If you have studied some flavour of Computer Science as an undergraduate at the University of Manchester since 2012, there's a good chance you have contributed to this book. Thank you! I can't name everyone, but I'd especially like to thank industrial experience (IE) students who completed a year in industry as part of their degree as well as those who have done summer internships, either as part of the Master of Engineering (MEng) program or otherwise. In addition, the [PASS leaders](http://www.pass.manchester.ac.uk) and facilitators, [UniCS.com](https://unicsmcr.com/),  HackSoc and [Manchester Ultimate Programming](https://github.com/Man-UP) members have all been influential on the content of this book. I've trawled through hundreds of CVs too, so if you've shown me a copy of your CV, thanks! The chapter on [debugging your CV](#debugging) is based on the most common bugs (or are they features?) I've seen in CVs and resumes.
<!--
...
Thank you students for being studious. 🙏
...
Thanks to my colleagues in the Department of Computer Science and the careers service at the University of Manchester who have contributed directly (or indirectly) to this book. I would like to thank [Jim Miles](https://www.linkedin.com/in/jim-miles-5b0b7919/) for encouraging me to write a book. Optimists will tell you that “everyone has a book in them...”, although pessimists say that “...in most cases that's where it should remain”. [@everyone] I am an optimist when it comes to the power of written communication.

Sean Bechhofer, Suzanne Embury, Steve Furber, Carole Goble, Gareth Henshall, Toby Howard, Tim Morris, Paul Nutter, Steve Pettifer, Ulrike Sattler, Andrea Schalk, Robert Stevens and Alex Walker.

Thanks also to support staff from professional services and the alumni office: Mabel Yau, Hannah Cousins, Jez Lloyd, Ben Carter, Penney Gordon-Lanes, Dominic Laing, Alex Jones, Angela Standish, Anne Milligan, Jannine Thomas, Elizabeth Wilkinson, Andrew Whitmore, Rachel Mutters and Tammy Goldfeld.

So, thanks current and former colleagues at the University of Manchester for being collegiate. 🙏
...
* Thanks to [Gayle Laakman McDowell](https://en.wikipedia.org/wiki/Gayle_Laakmann_McDowell) ([\@gayle](https://twitter.com/gayle)), for her cracking series of books  [@techcareer; @cracking; @crackingpm; @crackingthepmcareer] which have been very useful resources both for students I've worked with and myself.
...
* Thanks to Garrett Grolemund ([\@garrettgman](https://github.com/garrettgman))and [Hadley Wickham](https://en.wikipedia.org/wiki/Hadley_Wickham) ([\@hadley](https://github.com/hadley)) for *R for Data Science* [@r4ds] from which helped me get started with R and bookdown. If you're reading this page in some kind of web browser, the stylesheet used here is re-used from [r4ds.had.co.nz](https://r4ds.had.co.nz/)
* Thanks to [Laurie Santos](https://en.wikipedia.org/wiki/Laurie_R._Santos) ([\@lauriesantos](https://twitter.com/lauriesantos)), for her *Science of Well-being course* which was been a significant influence on this book and my personal and professional life
...
<!--
* Thanks to [David Malan](https://en.wikipedia.org/wiki/David_J._Malan) ([\@malan](https://cs.harvard.edu/malan/)) for [CS50](https://en.wikipedia.org/wiki/CS50) which has inspired some of the  implementation of this course. [@cs50; @cs50mcr; @cs50zoom] Thanks to [Cristian Bodnar](https://crisbodnar.github.io/) for inviting David to run [CS50 in Manchester](http://cs50.hacksoc.com) in 2017.


* Thanks to [Tim Bray](https://en.wikipedia.org/wiki/Tim_Bray) ([\@timbray](https://twitter.com/timbray)) who's [ongoing blog](https://www.tbray.org/ongoing/) I've enjoyed reading since it started way back when. Tim's blog is an inspiring existence proof that engineers can (and should) write well. Joel Spolsky, -->
...
Thanks to everyone who's contributed via github so far. We'll credit any github contributors here, small or large.
...
### About me
Hello, my name is [Duncan Hull](http://www.cs.man.ac.uk/~hulld/) and I'm the author of this guidebook which I wrote for undergraduate and postgraduate students. I'm a lecturer in the [Department of Computer Science at the University of Manchester](https://www.cs.manchester.ac.uk/) and have targeted this guidebook at students who are either studying computer science or are interested in finding out more about it as a career option.

So what's *my* story? Like many people, my path has been what Helen Tupper and Sarah Ellis call a “squiggly career” rather than classic linear one. [@squiggly] I have worked as a paperboy, supermarket cashier, shelf stacker, factory worker, chef, dogsbody, field assistant, database administrator, secondary school teacher, postdoc, research scientist, software engineer, lecturer, external examiner, tutor and academic. I've done a range of voluntary work too, serving as a competition judge, fundraiser, code club \& coderdojo leader, digital council member, school governor, curator, trainer and editor.  But as Ronnie Lane and Ronnie Wood once said:
...
Most of what I have learned about employment comes from advising, watching and listening to undergraduate and postgraduate students interacting with employers as they take the first steps in their careers. So reading this book will help you learn from their successes and their mistakes too.
...
Images in this have guidebook are published different licenses, depending on the source. For example, Bryan Mathers illustrations are licensed CC-BY-ND, others are different. Each figure caption gives details.
...
Some of these services use cookies. These can be disabled in your browser.
