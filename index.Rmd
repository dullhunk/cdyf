...
* [Vicky Tuck](http://news.bbc.co.uk/local/gloucestershire/hi/people_and_places/newsid_8741000/8741279.stm) at [Cheltenham Ladies' College](https://en.wikipedia.org/wiki/Cheltenham_Ladies%27_College), Cheltenham, Gloucestershire.
    - This was the first time I'd ever set foot in a [private school](https://en.wikipedia.org/wiki/Independent_school_(United_Kingdom)), managing to sneak through [Checkpoint Charlie](https://en.wikipedia.org/wiki/Checkpoint_Charlie) un-challenged to cross Michael Gove's [Berlin Wall](https://en.wikipedia.org/wiki/Berlin_Wall) of education. It was an enlightening experience! [@berlinwall; @cheltenham]
...
## About me {#duncan}
Hello, my name is [Duncan Hull](https://personalpages.manchester.ac.uk/staff/duncan.hull/) and I'm writing this guidebook for undergraduate and postgraduate students as part of my day job at the University of Manchester where I'm a lecturer (≈ [Assistant Professor](https://en.wikipedia.org/wiki/Assistant_professor)) in the [Department of Computer Science](https://www.cs.manchester.ac.uk/).
...
(ref:transcript-disclaimer) Please note these transcripts are not exact or precise, please listen to the original audio. They have been made using speech to text software and later corrected by hand. They are not perfect (verbatim) transcriptions, some [speech disfluency](https://en.wikipedia.org/wiki/Speech_disfluency) has been removed in places and links have been added to add extra context. Extra context is given in brackets.
