...
This full text of this guidebook is freely available at [www.cdyf.me](https://www.cdyf.me/). The web version, that's all the `*.html` is searchable, browsable and linkable in any web browser. If you'd prefer to read this guidebook in ebook or pdf format, you can buy the automatically updated copy at [leanpub.com/cdyf](https://leanpub.com/cdyf), shown in figure \@ref(fig:leanpub-fig). If you'd like to read this guidebook as a mobi / kindle version, [let me know](http://www.cs.man.ac.uk/~hulld/contact.html) as these formats can also be generated from the source.
