...
1. **Me:** Hello, my name is Duncan. I'm your tour guide here. If you feel a bit lost, follow me.
...
```
(ref:captionbridge) Just like the [Manhattan Bridge](https://en.wikipedia.org/wiki/Manhattan_Bridge), your future will be easier to build once you've started to answer some fundamental design questions which are covered in the first part of this guidebook on [designing your future](bothering.html). Manhattan bridge under construction picture adapted from public domain image via Wikimedia commons [w.wiki/32Rg](https://w.wiki/32Rg)
...
Thanks to Clive Zimmerman,  his staff, the head of science (MC), Mr K. Thomas and the students of [Greendown Community School (now Lydiard Park Academy)](https://en.wikipedia.org/wiki/Lydiard_Park_Academy) in Swindon, Wiltshire for hosting my second PGCE placement.

<!--### Thanks for the no thanks {#canteach}

* https://www.writhlington.org.uk/ orchid school http://wsbeorchids.org/
* http://thebicesterschool.org.uk/
* https://www.didcotgirls.oxon.sch.uk/
* https://www.stjohns.excalibur.org.uk/
* https://www.oasisacademybrislington.org/
* https://www.redlandgreen.bristol.sch.uk/
* https://www.cheltladiescollege.org/ I was so desperate for a job that I turned to the dark side of private education, I hope you can forgive me,  

Thanks Moravian
Thanks Stockport
Thanks Shaftesbury
Steve  [Greendown Community School](https://en.wikipedia.org/wiki/Lydiard_Park_Academy) in Swindon, Wiltshire, and [St Annes RC High School](St Anne's RC Voluntary Academy), Stockport who helped me to improve my teaching. Thanks to Malcolm and
