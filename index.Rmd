...
This acknowledgements section is long because I try to practice what I preach about the importance of expressing gratitude, see section \@ref(lays) and \@ref(signposts3). It also serves as a live demonstration of [cognitive behavioural therapy](https://www.nhs.uk/mental-health/talking-therapies-medicine-treatments/talking-therapies-and-counselling/cognitive-behavioural-therapy-cbt/overview/) (CBT) so if you want to cut to the chase, go straight to chapter \@ref(rebooting).
...
Thanks to my fellow [uki-sigcse.acm.org](https://uki-sigcse.acm.org/) board members [Steven Bradley](https://www.dur.ac.uk/research/directory/staff/?mode=staff&id=106), Janet Carter, [Tom Crick](https://proftomcrick.com/), [Quintin Cutts](https://www.gla.ac.uk/schools/computing/staff/quintincutts/), [Sally Fincher](https://en.wikipedia.org/wiki/Sally_Fincher), [Samia Kamal](https://www.advance-he.ac.uk/ntfs/dr-samia-kamal), [Joseph McGuire](https://www.gla.ac.uk/schools/computing/staff/josephmaguire/) and [Sally Smith](https://www.napier.ac.uk/people/sally-smith).
...
Thanks to John Chelsom, Kal Ahmed, Clare Ashton, Mavis Cournane, Eddie Dillon, Niki Dinsey, Phil Gooch, Antony Grinyer, Gareth Hudson, Steve Horwood, Chris Joyce, Joe McCann, Keith McCann, Dave Nurse, Ian Packard, Mark Pengelly, Lillian Spearing, Omar Tamer and the rest of the team at CSW Informatics Ltd ([csw.co.uk](https://csw.co.uk/)) for lookin after me in my second job after Uni and teaching me about [Oxford Innovation](https://oxin-centres.co.uk/).

Thanks to fellow [XML summer school](https://xmlsummerschool.com/) faculty: Bob du Charme, [Paul Downey](https://twitter.com/psd), [Michael Kay](https://en.wikipedia.org/wiki/Michael_Howard_Kay) and [Jeni Tennison](https://en.wikipedia.org/wiki/Jeni_Tennison) for all the markup.
...
Thanks to [Phil Harris](https://www.coventry.ac.uk/research/research-people/professor-phil-harris/), Steph Harris, Alan Gear, Jackie Gear, Ally, Neil, Esther, Graham, [Jeremy Cherfas](https://www.jeremycherfas.net/), Morgen Cheshire, Lady Godiva (see figure \@ref(fig:coventry-fig)), [Margi Lennartsson Turner](https://pureportal.coventry.ac.uk/en/persons/margi-lennartsson-turner) at the [Henry Doubleday Research Association](https://en.wikipedia.org/wiki/Henry_Doubleday_Research_Association) and Coventry University for hosting my industrial experience year.  

```{r coventry-fig, echo = FALSE, fig.align = "center", out.width = "100%", fig.cap = "(ref:captioncoventry)"}
knitr::include_graphics("images/godiva.png")
```

(ref:captioncoventry) Covered only in her long hair, [Lady Godiva](https://en.wikipedia.org/wiki/Lady_Godiva) rode naked through the streets of Coventry to protest about taxes. Painting of *Godiva* by [John Collier](https://en.wikipedia.org/wiki/John_Collier_(painter)), cropped from a public domain image on Wikimedia Commons [w.wiki/4aCU](https://w.wiki/4aCU)

So thanks Coventry for a [magnificent cathedral](https://en.wikipedia.org/wiki/Coventry_Cathedral) and the industrial experience. 🙏
...
Thanks to everyone who has contributed via github, listed below in order of github usernames. I will credit *any* github contributors here, small or large. Even the typos, it all counts. You can easily add yourself to this roll call (see section \@ref(contributing)) by correcting my delibreate mitsakes. 😉
