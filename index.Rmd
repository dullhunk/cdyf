...
Thanks to St Laurence school ([st-laurence.com](https://st-laurence.com/)), a community I am proud and lucky to have grown up in. I'm especially grateful for the ongoing friendship of former St Laurence school students I've enjoyed music, cycling, walking, travelling and drinking with over the years, some of whom you can see figure \@ref(fig:bradlads-fig). I'm looking forward to our next adventure.
...
```
(ref:captionbradlads) Crossing the highest paved mountain pass in Europe, the [Col de l'Iseran](https://en.wikipedia.org/wiki/Col_de_l%27Iseran) in France, with my fellow [Kings of the Mountains](https://en.wikipedia.org/wiki/King_of_the_Mountains) and alpinists: Jim, Dan, Doug and Dan. Rest in Peace Dan, you were a fantastic companion and we all miss you terribly. 
...
Thanks to my [Fitzmaurice Primary School](https://www.fitzmauriceschool.info/) school teachers: Mrs Cripps, Miss Clarry, Mr Clay, Mr Fleming, Mr Jackson, Val Payne, Miss Sheldon, Hugh Solomon, Miss Uncles and Mrs White. I used to foolishly think it was secondary schools that did all the serious teaching, but they'd be *nowhere* without the foundations laid in primary school. [It takes a village](https://en.wikipedia.org/wiki/It_takes_a_village) to raise a child. [@clinton]

<!--It flows from our commitment to regard “people as our treasure” (the basis of our vision, mission and values).-->

So, thank you to the community that is St. Laurence school, Fitzmaurice Primary School and [Edmond Fitzmaurice](https://en.wikipedia.org/wiki/Edmond_Fitzmaurice,_1st_Baron_Fitzmaurice) for educating me the [West Country](https://en.wikipedia.org/wiki/West_Country) way. Proper job! 🙏
