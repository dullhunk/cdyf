...
Thanks to Martin Clutterbuck, Rebecca Clare, Richard O'Beirne, Simon Witter, Paddy, Isobel, Howard, Gavin and everyone else in the journal production team at [Blackwell Science Ltd](https://www.flickr.com/photos/dullhunk/4042838703) and Eileen for looking after me in my first job as a freshly minted graduate.
...
Special thanks my friend, former St Laurence school student and [current sixth form head](https://st-laurence.com/sixth-form) Aidan Blowers for showing me around the [Clarendon School](https://en.wikipedia.org/wiki/The_Clarendon_Academy) in Trowbridge and leading by example. Aidan's performance as Lord of the Dance (wearing a white shirt in figure \@ref(fig:uptown-funk-fig)), inspired the ongoing musical experiment that is [Tuning Complete](http://www.cs.man.ac.uk/~hulld/research.html#tuningcomplete).
