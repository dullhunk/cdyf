...
Thanks to the British Universities North America Club ([BUNAC](https://en.wikipedia.org/wiki/BUNAC)) for sponsoring my temporary worker visa which allowed me to cook breakfasts and wash pots at [Phillips Sea Food](https://phillipsseafood.com/) in [Ocean City, Maryland](https://en.wikipedia.org/wiki/Ocean_City,_Maryland).
...
Thanks [Timo Hannay](https://en.wikipedia.org/wiki/Timo_Hannay) for letting me gatecrash [Science Foo Camp](https://en.wikipedia.org/wiki/Science_Foo_Camp) at the Googleplex in California in 2007 and again in 2009.
