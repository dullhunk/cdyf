...
```{r laurence-fig, echo = FALSE, fig.show = "hold", out.width = "9.09%", fig.cap = "The badge of St. Laurence School  is an adaptation of the Fitzmaurice badge, the two [gudgeon fish](https://en.wikipedia.org/wiki/Gudgeon_(fish)) symbolising the union of the two schools it was created from: Trinity secondary modern school and Fitzmaurice Grammar School"}
