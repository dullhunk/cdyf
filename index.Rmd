...
Pictures tell stories, pictures explain. Pictures help you understand. Pictures help you imagine. So this book uses pictures (and conversations) to help you imagine your future. Other key differences between this and other guidebooks are outlined in section \@ref(thinkdifferent).
...
This guidebook is split into five parts, with two parts merged into one:

1. Chapters \@ref(rebooting) to \@ref(computing) look at *designing* your future
1. Chapters \@ref(debugging) to \@ref(researching) look at *testing* your future
1. Chapters \@ref(debugging) to \@ref(researching) also look at *building* your future
1. Chapters \@ref(ruling) to \@ref(scheduling) look at *deploying* your future
1. Chapters \@ref(raluca) to \@ref(reading) meet students who are *coding* their future

Although *presented* in a linear order, follow whatever path suits you best, as shown in figure \@ref(fig:map-fig). Many students start with chapter \@ref(debugging), but individual entry and exit points to your future will differ.

```{r map-fig, echo = FALSE, fig.align = "center", out.width = "100%", fig.cap = "(ref:captionmapping)"}
knitr::include_graphics("images/Course Map Pentagram.png")
```
(ref:captionmapping) Mapping your future: sometimes your learning follows a predictable *linear* path, as shown in the left hand side of this picture. Whatever path you take in life, your future is unlikely to be either predictable *or* linear. Consequently, this guidebook encourages you to follow a *non-linear* iterative learning journey, shown on the right hand side. Start where you like, follow your nose and be prepared to repeat stages as you progress through the early moves in your career.

Let's look in a bit more detail at each of the five parts of this guidebook, starting with design.
...
* Chapter \@ref(writing): *Writing your future* explores your soft communication skills, how they complement your hard skills and why employers value them so much
...
Once you've started to answer the design questions in the first part, you can start to implement (or build) your career and think about what your next moves will be.
...
* Chapter \@ref(surviving): *Surviving your future* looks at the moves you make after landing your first job. During your transition, how will you survive and thrive outside (and after) University
...
### Future coders {#partiv}

The final part of this guidebook, from chapter \@ref(hearing) onwards meets students who are *Coding their Future* and asks, how did they get to where they are and where are they going next? These chapters form part of a podcast which accompanies this book: *Hearing your Future*. The final chapter \@ref(reading): *Reading your future* lists everything cited in this guidebook.
...
So thanks Cambridge for [Silicon Fen](https://en.wikipedia.org/wiki/Silicon_Fen), where I had a really *[fen-tastic](https://en.wikipedia.org/wiki/The_Fens)* time. [I'll get my coat](https://en.wiktionary.org/wiki/I%27ll_get_my_coat). 🙏
...
Thanks to the British Universities North America Club ([BUNAC](https://en.wikipedia.org/wiki/BUNAC)) for sponsoring my [Exchange Visitor Student Visa](https://travel.state.gov/content/travel/en/us-visas/study/exchange.html) which allowed me spend an *awesome* summer cooking breakfasts for guests at the [Phillips Beach Plaza Hotel](https://www.oceancity.com/end-of-an-era-beach-plaza-hotel-closing-permanently/) in [Ocean City, Maryland](https://en.wikipedia.org/wiki/Ocean_City,_Maryland). They say that [the way to a person's heart is through their stomach](https://en.wiktionary.org/wiki/the_way_to_a_man%27s_heart_is_through_his_stomach), and I travelled to the heart of America through its big breakfasty stomach. Thanks to Andy B. for flagging it. 🇺🇸
