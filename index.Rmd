...
This guidebook is split into five parts:

1. In chapters \@ref(rebooting) to \@ref(computing) we look at *designing* your future
1. In chapters \@ref(debugging) to \@ref(researching) we look at *testing* your future
1. In chapters \@ref(debugging) to \@ref(researching) we also look at *building* your future
1. In chapters \@ref(ruling) to \@ref(scheduling) we look at *deploying* your future
1. In chapters \@ref(raluca) to \@ref(reading) we meet students who are *coding* their future

Although presented in a linear order, I recommend you follow whatever order suits you best, as shown in figure \@ref(fig:map-fig).
...
```
(ref:captionmapping) Mapping your future: sometimes learning is *linear*, as shown in the left hand side of this picture. This guidebook encourages you to follow a *non-linear* iterative learning journey, shown on the right hand side. Start where you like, follow your nose and be prepared to repeat stages as you progress through the early stages of your career.

Let's look in a bit more detail at each of the five parts of this guidebook.
...
* Chapter \@ref(knowing): *Knowing your future* challenges you to reflect on who you are, what makes you unique and what you have to offer
