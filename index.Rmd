...
```
(ref:captionbradlads) Crossing the highest paved mountain pass in Europe, the [Col de l'Iseran](https://en.wikipedia.org/wiki/Col_de_l%27Iseran) in France, with my fellow [Kings of the Mountains](https://en.wikipedia.org/wiki/King_of_the_Mountains) and alpinists: Jim, Dan, Doug and Dan. Rest in Peace Dan Feane, you were a fantastic companion, we all love you and miss you terribly.
...
```
(ref:captionclinton) [It takes a village](https://en.wikipedia.org/wiki/It_takes_a_village) to raise a child. [@clinton] Portrait of [Hillary Clinton](https://en.wikipedia.org/wiki/Hillary_Clinton) speaking at an event in Des Moines, Iowa in 2016 by [Gage Skidmore](https://en.wikipedia.org/wiki/Gage_Skidmore) on Wikimedia Commons [w.wiki/4Xrc](https://w.wiki/4Xrc) adapted using the [Wikipedia app](https://apps.apple.com/us/app/wikipedia/id324715238)
