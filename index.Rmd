...
1. **C**ode: Instructions contained in this guidebook
1. **D**ata: Facts and statistics collected together for analysis
1. **Y**ou: This guidebook needs you to *do* things other than just reading
1. **F**utures: Think about the future. [@thinkaboutthefuture] Try not to dwell on the past
1. **M**e: Hello, my name is Duncan. I'm your tour guide here. If you feel a bit lost, follow me.
...
1. **Speaking** articulating some written work
1. **Writing** written exercises using natural language
1. **Reading** reading stuff because its good for your soul
1. **Quizzing and assessing** activities and quizzes that will be assessed either by yourself, your peers, an employer or an academic (depending on who and where you are)
1. **Challenging** coding challenges are designed to take you out of your comfort zone by experiment with your thoughts, discussions and actions
