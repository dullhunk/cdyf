...
If you'd prefer to read this guidebook in a single ebook file, you can download the automatically updated copy at [leanpub.com/cdyf](https://leanpub.com/cdyf), shown in figure \@ref(fig:leanpub-fig). Again its free, but you can make a donation to [codeclub.org](https://codeclub.org/) if you choose.
