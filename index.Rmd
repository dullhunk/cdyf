...
1. Improve reading skills to search, browse and navigate large documents like this one. Think of it as a large wordbase, much like a large codebase, only this one is mostly written in natural language.
...
1. **Discussing** points of discussion with your peers and friends
...
(ref:captionselfportrait) [Self portrait](https://bryanmmathers.com/self-portrait/) by [Visual Thinkery](https://visualthinkery.com/) is licensed under [CC-BY-ND](https://creativecommons.org/licenses/by-nd/4.0/)
