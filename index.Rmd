...
Tell us how we can improve this guidebook and we'll give you our eternal gratitude and some [GitLab.com](https://about.gitlab.com/) swag in return, see figure \@ref(fig:gitswag-fig). The most actionable and constructive suggestions will get the best swag.
...
1. **Even Better If** (`EBI`) how can we make it better, what is missing? Which bits are boring or unclear? Which bits pointlessly replicate better resources (that are free and open) found elsewhere? Too long, didn’t read ([TL;DR](https://en.wiktionary.org/wiki/too_long;_didn%27t_read))?
