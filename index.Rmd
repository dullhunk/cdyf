...
```
(ref:captionmsc) Masters and Mistresses of Science, part of the [MSc Computer Science](https://web.archive.org/web/20030825205716/http://www.cs.man.ac.uk/Study_subweb/Postgrad/ACS-CS/webpages/handbook/CSHandbook.pdf) class of 2003. Where's Wally? You should be able to find me although I'm *not* wearing a red and white stripy jumper. Picture by [Richard Giordano](https://www.southampton.ac.uk/healthsciences/about/staff/richard_giordano.page).  
...
Thanks to [Phil Harris](https://www.coventry.ac.uk/research/research-people/professor-phil-harris/), Steph Harris, Alan Gear, Jackie Gear, Ally, Neil, Esther, Graham, [Jeremy Cherfas](https://www.jeremycherfas.net/), [Morgen Cheshire](https://cheshirenonprofitlaw.com/people/team/morgen/), [Margi Lennartsson Turner](https://pureportal.coventry.ac.uk/en/persons/margi-lennartsson-turner), Lady Godiva (see figure \@ref(fig:coventry-fig)) and everyone else at the Henry Doubleday Research Association (HDRA) and Coventry University for hosting my industrial experience year during my undergraduate degree.
