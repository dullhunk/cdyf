...
* The eleventh chapter looks at [postgraduate study](#studying) is a Masters degree or a PhD right for you?
...
I'd especially like to thank industrial experience (IE) students who completed a year in industry as part of their degree as well as those who have done summer internships, either as part of the Master of Engineering (MEng) program or otherwise. In addition, the [PASS leaders](http://www.pass.manchester.ac.uk) and facilitators, [UniCSmcr.com](https://unicsmcr.com/),  HackSoc and [Manchester Ultimate Programming](https://github.com/Man-UP) members have all been influential on the content of this book. I've trawled through hundreds of CVs too, so if you've shown me a copy of your CV, thanks! The chapter on [debugging your CV](#debugging) is based on the most common bugs (or are they features?) I've seen in CVs and resumes.
<!--
...
Thanks to my academic colleagues in the Department of Computer Science and the rest of the University of Manchester who have contributed directly (or indirectly) to this book. They include Sean Bechhofer, Gavin Brown, Barry Cheetham, Sarah Clinch, Clare Dixon, Suzanne Embury, Steve Furber, Jim Garside, Danielle George, Carole Goble, Simon Harper, Gareth Henshall, Toby Howard, Caroline Jay, Tim Morris, Colin Puleston, Paul Nutter, Steve Pettifer, Nancy Rothwell, Ulrike Sattler, Pejman Saeghe, Andrea Schalk, Robert Stevens, Tom Thomson, Markel Vigo, Louise Walker and Alex Walker.

I would especially like to thank [Jim Miles](https://en.wikipedia.org/wiki/James_John_Miles) for encouraging me to write a book shortly after he offered me a job. To be honest, I thought he was nuts but it turned out to be another one of Jim's great ideas. Thanks Jim. Optimists will tell you that “everyone has a book in them...”, although pessimists say that “...in most cases that's where it should remain”. [@everyone] I am an optimist when it comes to the power of natural language despite [Christoph Hitchens](https://en.wikipedia.org/wiki/Christopher_Hitchens) amusing and trademark cynicism shown in figure \@ref(fig:hitchens-fig).
...
Thanks also to the fantastic support staff (past and present) from professional services who make all the academic stuff possible: Jennie Ball-Foster, Chris Connolly, Gavin Donald, Miriam Cadney, Ben Carter, Hannah Cousins, Tammy Goldfeld, Penney Gordon-Lanes, Lynn Howarth, Alex Jones, Jez Lloyd, Dominic Laing, Ruth Maddocks, Chris Page, Angela Standish, Gill Lester, Karon Mee, Anne Milligan, Melanie Price, Bernard Strutt, Jannine Thomas, Elizabeth Wilkinson, Andrew Whitmore and Mabel Yau.

So, thanks to colleagues at the University of Manchester for being collegiate and making work a great place to be. 🙏
...
### Thanks to my friends and family {#fandf}  
I'm not going to namecheck all my friends and family here but thanks to all my close friends and family who have supported me and kept me sane during these difficult times. I'm lucky that they have always there when I need them for emotional support.

So, thanks to all my family and friends for your love and friendship. Σε αγαπώ παρα πολύ. 🙏

### About me {#duncan}
We haven't been introduced yet have we? Hello, my name is [Duncan Hull](http://www.cs.man.ac.uk/~hulld/) and I'm the author of this guidebook which I wrote for undergraduate and postgraduate students. I'm a lecturer in the [Department of Computer Science at the University of Manchester](https://www.cs.manchester.ac.uk/) and the primary audience is students who are interested in coding their future.

So what's *my* story? Like many people, my path has been what Helen Tupper and Sarah Ellis call a “squiggly career” rather than classic linear one. [@squiggly] I've been paid for work as a paperboy, supermarket cashier, shelf stacker, sausage factory worker, chef, dogsbody, field assistant, database administrator, consultant, secondary school teacher, postdoc, research scientist, software engineer, lecturer, external examiner, tutor and academic.

I've done a range of voluntary work too, serving as a competition judge, fundraiser, rabble rouser, [code club](https://codeclub.org) \& [coderdojo](https://coderdojo.com) leader, [digital council](https://www.manchesterdigital.com/) member, school governor, curator, beer drinker, wikipedia trainer and editor. But as Ronnie Lane and Ronnie Wood once said:
...
Images in this guidebook are published different licenses, depending on the source. For example, Bryan Mathers illustrations are licensed CC-BY-ND, others are different. Each figure caption gives details.
