...
1. **`D is for DATA`**: From big data to microdata, your data to my data. Structured data, un-structured data and semi-structured data. Facts, statistics, graphs, pictures and our data. Bytes, bits and bobs collected together for your analysis and amusement
...
1. **`.me is for ME`**: Hello, my name is Duncan, see figure \@ref(fig:hello-my-name-fig). I'm your tour guide here. If you're feeling a bit lost, follow me and together we can starting coding your future.
...
1. In chapters \@ref(debugging) to \@ref(researching) we look at *building* and *testing* your future
1. In chapters \@ref(ruling) to \@ref(scheduling) we look at *deploying* your future
1. In chapters \@ref(raluca) to \@ref(reading) we hear from students who are *coding* their future
...
(ref:captionshaha) [Alom Shaha](https://alomshaha.com/) demonstrates his awesome wave machine. Physics and jelly babies, what's not to like? You can also watch the 4 minute video embedded in this figure at [youtu.be/VE520z_ugcU](https://youtu.be/VE520z_ugcU) [@youtube-alom]
...
So thanks Cambridge for a really *[fen-tastic](https://en.wikipedia.org/wiki/The_Fens)* time in [Silicon Fen](https://en.wikipedia.org/wiki/Silicon_Fen). [I'll get my coat](https://en.wiktionary.org/wiki/I%27ll_get_my_coat). 🙏
...
So thank you for [the music](https://en.wikipedia.org/wiki/Popular_music_of_Manchester) the songs I'm singing. Thanks for all the joy they're bringing. Thanks Manchester for [the best football team in the world](https://en.wikipedia.org/wiki/Manchester_United_F.C.) and being Mancunian, see figure \@ref(fig:this-is-the-place-fig). This is the place!
...
Thanks to the British Universities North America Club ([BUNAC](https://en.wikipedia.org/wiki/BUNAC)) for sponsoring my [Exchange Visitor Student Visa](https://travel.state.gov/content/travel/en/us-visas/study/exchange.html) which allowed me spend an educational summer cooking breakfasts for guests at the [Phillips Beach Plaza Hotel](https://www.oceancity.com/end-of-an-era-beach-plaza-hotel-closing-permanently/) in [Ocean City, Maryland](https://en.wikipedia.org/wiki/Ocean_City,_Maryland). They say that [the way to a person's heart is through their stomach](https://en.wiktionary.org/wiki/the_way_to_a_man%27s_heart_is_through_his_stomach), and I travelled to the heart of America through its big breakfasty stomach. Thanks to Andy B. for flagging it. 🇺🇸
