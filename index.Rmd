...
I'm looking forward to the next revolution of our adventures, see figure \@ref(fig:bradlads-fig)
...
Thanks to all of the [school governors](https://governorsforschools.org.uk/) for holding the leaders of St. Laurence to account. ([#StateSchoolProud](https://www.93percent.club/))
...
So, thank you to the community that is St. Laurence School, for enablling my GCSE's followed by A-levels in Physics, Chemistry, Biology and General Studies. Thanks for educating me (and many others) the [West Country](https://en.wikipedia.org/wiki/West_Country) way. Proper job! 🙏 [@bristle]
