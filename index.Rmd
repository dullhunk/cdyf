...
Thanks to [Carole Goble](https://en.wikipedia.org/wiki/Carole_Goble) for patiently re-teaching me how to write by covering drafts of early drafts of my MSc thesis in red ink and later drafts (less patiently) in swear words.🤬^[the swear words didn't appear until the sixth of seventh draft]) Thanks [Steve Furber](https://en.wikipedia.org/wiki/Steve_Furber) for playing bass in our “boy band” [Tuning Complete](http://www.cs.man.ac.uk/~hulld/research.html#tuningcomplete).
...
<!-- thanks manchester thanks wikipedians-->
