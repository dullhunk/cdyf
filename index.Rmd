...
## Aiming at your future {#vaccine}
This guidebook aims to help you develop healthier habits of mind, body and soul using five key ingredients:

1. **C**ode: Instructions contained in this guidebook
1. **D**ata: Facts and statistics collected together for analysis
1. **Y**ou: Activities for you to do in addition to reading
...
* Thanks to [David Malan](https://en.wikipedia.org/wiki/David_J._Malan) ([\@malan](https://cs.harvard.edu/malan/)) for [CS50](https://en.wikipedia.org/wiki/CS50) which continues to be an inspiration to me and many others. [@cs50; @cs50mcr; @cs50zoom;]<!--@cs502021--> Thanks to [Cristian Bodnar](https://crisbodnar.github.io/) for inviting David to run [CS50 in Manchester](http://cs50.hacksoc.com) in 2017.
