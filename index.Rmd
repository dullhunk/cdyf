...
I'd especially like to thank industrial experience (IE) students who completed a year in industry as part of their degree as well as those who have done summer internships, either as part of the Master of Engineering (MEng) program or otherwise. In addition, the [PASS leaders](http://www.pass.manchester.ac.uk) and facilitators, [UniCSmcr.com](https://unicsmcr.com/),  HackSoc and [Manchester Ultimate Programming](https://github.com/Man-UP) members have all been influential on the content of this book. I've trawled through thousands of CVs too, so if you've shown me a copy of your CV, thanks! The chapters on [debugging your CV](debugging.html) and [debugging their CV](sampling.html) are based on the most common bugs (or are they features?) I've seen in CVs and resumes.
<!--
...
Thanks to current and former academic colleagues and PhD students at the University of Manchester who have contributed directly (or indirectly) to this book. They include Sean Bechhofer, Andy Brass, Gavin Brown, Barry Cheetham, Sarah Clinch, Clare Dixon, Suzanne Embury, Steve Furber, Jim Garside, Danielle George, Carole Goble, Peter Green, Simon Harper, Gareth Henshall, Matthew Horridge, Toby Howard, Caroline Jay, Douglas Kell, John Latham, Phil Lord, Tim Morris, Colin Puleston, Paul Nutter, Bijan Parsia, Steve Pettifer, Nancy Rothwell, Ulrike Sattler, Pejman Saeghe, Andrea Schalk, Kieran Smallbone, Robert Stevens, Neil Swainston, Tom Thomson, Markel Vigo, Louise Walker, Alex Walker and Crystal Wu.
...
Optimists will tell you that “everyone has a book in them...”, although pessimists will say that “...in most cases that's where it should remain”. [@everyone] Despite [Christoph Hitchens](https://en.wikipedia.org/wiki/Christopher_Hitchens) amusing cynicism shown in figure \@ref(fig:hitchens-fig), I am an optimist when it comes to the power of natural languages.  
