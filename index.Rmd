...
```
(ref:captionbath) Named after its [Roman Baths](https://en.wikipedia.org/wiki/Roman_Baths_(Bath)), [Bath](https://en.wikipedia.org/wiki/Bath,_Somerset) is the largest city in the county of Somerset, England. The city is home to the University of Bath which was named University of the year by *The Sunday Times* in 2011. Picture of [Pulteney Bridge](https://en.wikipedia.org/wiki/Pulteney_Bridge) by Diego Delso CC BY-SA via Wikimedia Commons at [w.wiki/3VWY](https://w.wiki/3VWY) adapted using the Wikipedia app
