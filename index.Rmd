...
```
(ref:captiongalway) People tell stories and stories paint pictures. Bryan Mathers, who has illustrated much of this guidebook, speaking at TEDxGalway in 2021. The image above is a screenshot, you can watch the full 15 minute talk at [youtu.be/IapGM5ZYBEw](https://youtu.be/IapGM5ZYBEw)
...
Thanks to [St. Laurence school](https://st-laurence.com/), a community I am proud and lucky to have grown up in. I'm especially grateful to school friends I've enjoyed music, cycling, walking and drinking with, see figure \@ref(fig:bradlads-fig), and I'm looking forward to our next adventure.
...
```
(ref:captionbradlads) Crossing the highest mountain pass in Europe, the [Col de l'Iseran](https://en.wikipedia.org/wiki/Col_de_l%27Iseran), with my fellow [Kings of the Mountains](https://en.wikipedia.org/wiki/King_of_the_Mountains): Jim, Dan, Doug and Dan. Rest in Peace Dan, you were a fantastic companion and we all miss you terribly.

Special thanks to fellow St Laurence student Aidan Blowers for leading by example with *Uptown Funk*, see figure \@ref(fig:uptown-funk-fig), an approach which inspired [Tuning Complete](http://www.cs.man.ac.uk/~hulld/research.html#tuningcomplete).
...
```
(ref:captionuptown) Melksham Oak Community School year 11 leavers dance to [Uptown Funk](https://en.wikipedia.org/wiki/Uptown_Funk) in 2015 with help from Mark Ronson, Bruno Mars and Aidan Blowers. The image above is a screenshot, don't believe me, just watch, come on! at [youtu.be/z8qH05teRMM](https://youtu.be/z8qH05teRMM)
