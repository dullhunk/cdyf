...
* [Vicky Tuck](http://news.bbc.co.uk/local/gloucestershire/hi/people_and_places/newsid_8741000/8741279.stm) at [Cheltenham Ladies' College](https://en.wikipedia.org/wiki/Cheltenham_Ladies%27_College), Cheltenham, Gloucestershire. This was the first time I'd set foot in a private school, managing to sneak through [Checkpoint Charlie](https://en.wikipedia.org/wiki/Checkpoint_Charlie) un-noticed to cross Michael Gove's [Berlin Wall](https://en.wikipedia.org/wiki/Berlin_Wall) of education. It was an enlightening experience! [@berlinwall; @cheltenham]
