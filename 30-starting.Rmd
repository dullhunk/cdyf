...
## Student to Professional {#gradconsult}
So you're starting a new job? Perhaps you're doing a summer internship, going on a placement year [@placement-handbook] or you've landed a shiny new graduate job? What changes will you have to adapt to as you transition from Student to Professional? Gradconsult have analysed ten of the most common transitions you're likely to encounter while adapting from student life to professional life. [@student2professional;@stp-whitepaper] The key differences between being a student and employee that they identified are:

1. **Pragmatism**: changing from perfection to efficiency
1. **Fortitude**: changing from failure avoidance to inevitable failure
1. **Task navigation**: changing the way you manage your time
1. **Accountability**: changing from a consumer to a producer
1. **Professional interaction**: changing from friends to colleagues
1. **Career navigation**: changing from structured to unstructured
1. **Diverse collaboration**: changing the diversity of your collaborators
1. **Self assessment**: changing the way you are assessed
1. **Self sufficiency**: changing who you are dependent on
1. **Wellbeing**: changing how your wellbeing and social life are provided for

These transitions are illustrated in figure \@ref(fig:stp-fig).

```{r stp-fig, echo = FALSE, fig.align = "center", out.width = "100%", fig.cap = "(ref:captionstp)"}
knitr::include_graphics("images/STP1to10.png")
```

(ref:captionstp) Ten changes you're likely to encounter on your journey from student to professional. Image reproduced from an article on [the transition from education into employment](https://www.linkedin.com/pulse/transition-from-education-employment-rebecca-fielding/) by Rebecca Fielding (with permission) [@fielding]
...
Some examples of technical badges are show in figure \@ref(fig:cloud-badges2-fig).

```{r cloud-badges2-fig, echo = FALSE, fig.align = "center", out.width = "100%", fig.cap = "(ref:captioncloudbadge)"}
knitr::include_graphics("images/cloud-badges.png")
```

There are many kinds of technical badge available besides the three shown in figure \@ref(fig:cloud-badges2-fig). In some cases, your employer might encourage or pay for you to study and get technical certifications.
...
1. `linkedin.com/learning` see [bit.ly/linkedin-learning-manchester](https://bit.ly/linkedin-learning-manchester)
...
```{r stpshort-fig, echo = FALSE, fig.align = "center", out.width = "100%", fig.cap = "(ref:captionstpshort)"}
knitr::include_graphics("images/STP1to3.png")
```

(ref:captionstpshort) Three of the changes you're likely to encounter on your journey from student to professional, perfection, failure and time management. Image excerpted from an article on [the transition from education into employment](https://www.linkedin.com/pulse/transition-from-education-employment-rebecca-fielding/) by Rebecca Fielding (with permission) [@fielding]

Making the transition from education to employment can be a big and daunting change, see figure \@ref(fig:stpshort-fig). To make the change as smooth as possible, you may need to readjust your expectations because being a student is very different to being an employee. Some key differences include:
...
* Being aware of the transitions you'll need to adapt to, see figure \@ref(fig:stp-fig)
