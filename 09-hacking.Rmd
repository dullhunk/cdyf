...
Marjorie loves version control because Marge is the master of the merge. She also has very high [emotional intelligence](https://en.wikipedia.org/wiki/Emotional_intelligence) (EQ). This superpower enables her to recognise emotions in herself and others so that she can quickly resolve people's differences, see figure \@ref(fig:margeconflict-fig).
