...
(ref:captionwikiterminal) [The Terminal](https://en.wikipedia.org/wiki/The_Terminal) is a 2004 American comedy-drama film produced and directed by Steven Spielberg and starring Tom Hanks, Catherine Zeta-Jones and Stanley Tucci. The film is about an Eastern European man who is stuck in New York's John F. Kennedy Airport terminal when he is denied entry to the United States, but is unable to return to his native country. Fair use image from [commons.wikimedia.org](https://commons.wikimedia.org) ✈️
