...
(ref:captionplns) Some people who've helped me have very grand job titles like the `THOUGHT-LEADING DISRUPTIVE INNOVATION TECHNOLOGY OVERLORD` pictured here. Others do not. Eithery way, their titles are tinsel [@shelley] but I'm grateful for what they taught me, whatever their title(s). This chapter acknowledges some of them. [PLNS figure](https://bryanmmathers.com/plns/) from a thought by [tomwhitby.com](https://tomwhitby.com) via [Aaron Davis](https://readwriterespond.com) by [Visual Thinkery](https://visualthinkery.com) is licensed under [CC-BY-ND](https://creativecommons.org/licenses/by-nd/4.0/)
