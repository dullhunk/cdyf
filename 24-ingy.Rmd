...
Ingy chose اغنيه انت تقدر .. بنك مصر رمضان see figure \@ref(fig:banque-misr-fig) as her tune.


```{r banque-misr-fig, echo = FALSE, fig.align = "center", out.width = "99%", fig.cap = "(ref:captionbanque)"}
knitr::include_url('https://www.youtube.com/embed/w6KhkbcMC6w')
```

(ref:captionbanque) You can also watch the 1.5 minute video embedded in this figure at [youtu.be/w6KhkbcMC6w'](https://youtu.be/w6KhkbcMC6w'). [@schooloflifevideo]

https://www.youtube.com/watch?v=w6KhkbcMC6w
