...
<!--The Mozilla Foundation have defined a standard for digital, online badges which recognise a person’s achievements through life. Such badges can be issued from various sources – for any kind of achievement – and a badge awardee can store them in various online collections and give out links for others to view, say on a web-based CV, or in a PDF, for prospective employers.-->
...
* `badge name` e.g. PASS leader badge
...
```
(ref:captiondatainside) what are badges [There's data inside open badges](https://bryanmmathers.com/open-badges-data-inside/) by [Visual Thinkery](https://visualthinkery.com/) is licenced under [CC-BY-ND](https://creativecommons.org/licenses/by-nd/4.0/)
...
```
(ref:captionbadgetype) There are many different activities which badges can be awarded for including including membership, participation, capability and mastery. [Badge taxonomy](https://bryanmmathers.com/badge-taxonomy-v0-2/) by [Visual Thinkery](https://visualthinkery.com/) is licensed under [CC-BY-ND](https://creativecommons.org/licenses/by-nd/4.0/)
...
```
(ref:captionskillsbills) skills ...  by [Visual Thinkery](https://visualthinkery.com/) is licenced under [CC-BY-ND](https://creativecommons.org/licenses/by-nd/4.0/)
