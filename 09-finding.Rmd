...
* traditional CV and covering letter, by email see section \@ref(we3qs)
* Phone call, these can work well with smaller employers, have your (verbal) “elevator pitch” ready see section \@ref(we3qs)
...
```
(ref:captionslavery) Unpaid internships have been likened to [modern slavery](https://en.wikipedia.org/wiki/Modern_slavery). You are vulnerable to exploitation when taking unpaid work. [@slavery] CC [BY-SA](https://creativecommons.org/licenses/by-sa/3.0/deed.en) image of footcuffs by the Collectie Stichting Nationaal Museum van Wereldculturen on Wikimedia Commons [w.wiki/6XaW](https://w.wiki/6XaW) adapted using the [Wikipedia App](https://apps.apple.com/us/app/wikipedia/id324715238)
...
Unfortunately, in the worst case, taking an unpaid internship leaves you vulnerable to exploitation by ruthless employers looking for cheap or free labour. Unpaid internships have been likened to modern slavery, see figure \@ref(fig:slavery-fig), so I recommend you avoid them. 😭
...
Your future is bright, your future needs finding. Finding your future will help you to build and test your future. Building and testing your future will help you to start coding your future.
...
In the next part, chapter \@ref(speaking): *Speaking your Future* we'll look at preparing for interviews which will test your spoken communication skills. You've used the techniques in this chapter to get an interview, now you need to get ready to demonstrate that you are a good communicator, not just in writing but in listening and speaking too.
