...
## AI verbs {#aiverbs} 
Employers routintely use various bots to screen your job application (see section \@ref(robotproof)). So it seems only fair for you to use ChatGPT or similar AI-technology to help you write your applications. While AI can *help* you get started (see figure \@ref(fig:chatgptagain-fig) and section \@ref(machines)), it won't help you finish. 
...
So make sure you *personalise* and *humanise* your writing, because it's easy for a human to spot dehumanised and depersonalised CVs and covering letters that have been generated by AI. [@aiverbs;@aiverbsagain]

## Any verbs missing? {#missing} 

Highlight at all the verbs in your CV. Arrange them into groups of related verbs, you could either use the classification of verbs in this chapter or make your own. If you put each group of verbs on it's own virtual “shelf”, which shelves are empty, see figure \@ref(fig:emptyshelf-fig)? Which verbs are missing?
