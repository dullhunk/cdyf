...
## AI verbs {#aiverbs} 
While we're on the subject of *bullshit*, we need to talk about bots and AI. Employers routintely use various bots and AI to screen your job application (see section \@ref(robotproof)). So it seems only fair for you to use ChatGPT or similar AI-technology to help you write your applications. While AI can *help* you get started (see figure \@ref(fig:chatgptagain-fig) and section \@ref(machines)), it won't help you finish. 
