...
## From Student to Professional {#gradconsult}
...
These ten transitions from education to employment are illustrated in figure \@ref(fig:stp-fig).
...
1. [codecrafters.io](https://codecrafters.io), see section \@ref(projects)
...
Making the transition from education to employment can be a big and daunting change, see figure \@ref(fig:stp-fig). To make the change as smooth as possible, you may need to readjust your expectations because being a student is very different to being an employee. Some key differences include:
