...
You might find it a bit scary thinking about your future. You might be tempted to procrastinate making important decisions as you head into the great unknown^[that is the world of employment, in case you are wondering], see figure \@ref(fig:schedule-fig). This guidebook and the live *Coding your Future* (COMP2CARS) sessions are here to help.

The live sessions will be back in September 2021, see [manchester.ac.uk/discover/key-dates](https://www.manchester.ac.uk/discover/key-dates/). In the meantime see the *Wednesday Waggle* at [waggle.cs.manchester.ac.uk](https://waggle.cs.manchester.ac.uk/)
...
```
(ref:captionschedule) The biggest waste of time is the time spent not getting started on a project. Your future might seem big and unknown but not as scary as you might think and getting started can be surprisingly enjoyable. [New Project? Every time…](hhttps://bryanmmathers.com/new-project-every-time/) by [Visual Thinkery](https://visualthinkery.com/) is licenced under [CC-BY-ND](https://creativecommons.org/licenses/by-nd/4.0/)
