...
You might find it a bit scary thinking about your future. You might be tempted to procrastinate making important decisions as you head into the great unknown world of employment, see figure \@ref(fig:schedule-fig). This guidebook and the live *Coding your Future* (COMP2CARS) sessions are here to help.
...
```
(ref:captionschedule) The biggest waste of time is the time spent not getting started on a project, and that includes your future. [New Project? Every time…](hhttps://bryanmmathers.com/new-project-every-time/) by [Visual Thinkery](https://visualthinkery.com/) is licenced under [CC-BY-ND](https://creativecommons.org/licenses/by-nd/4.0/)
