...
Inspired by the [Philip K. Dick](https://en.wikipedia.org/wiki/Philip_K._Dick) novel *The Minority Report* and subsequent film adaptation, see figure \@ref(fig:minority-fig), minority report asks:

* Are you a member of a minority group? If so which one(s)?
* What has your experience been at University and in the workplace?
* How can teaching and learning be made more [equitable, diverse and inclusive](https://en.wikipedia.org/wiki/Diversity,_equity,_and_inclusion) for members of your minority group(s)?
...
```
(ref:captionminority) *The Minority Report* is short story by Philip K. Dick first published by *Fantastic Universe* magazine in 1956. Are you in a minority? Inspired by the book [@theminorityreport] and its film adaptation [@minorityreport], we hear from our minorities. What is it like being in minority and how could universities and employers be more welcoming to your minority group? Public domain image of magazine cover by [Ed Emshwiller](https://en.wikipedia.org/wiki/Ed_Emshwiller) via Wikimedia Commons [w.wiki/5Swn](https://w.wiki/5Swn)

### One tune, one podcast and one film {#otopof}

We love our tunes, podcasts and films and make gratuitous references to them throughout *Coding your Future*. Critics say our playlist is clogged up with [DadRock](https://en.wikipedia.org/wiki/Dad_rock), cardigan-swinging indie [shoegazing](https://en.wikipedia.org/wiki/Shoegaze), Lancashire boy bands (both the Mancs and the Scousers) alongside other antiques from a bygone era. [@dadrock] So can you recommend us:
