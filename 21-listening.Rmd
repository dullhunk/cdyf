...
1. 🤴 You are the Vice Chancellor, see section \@ref(vc)
...
### You are the Vice Chancellor {#vc}
Congratulations, the [board of governors](https://www.manchester.ac.uk/discover/governance/structure/board-governors/) and [senate](https://www.manchester.ac.uk/discover/governance/structure/senate/) of the University of Manchester have just appointed you it's leader where you'll take over from the current Vice Chancellor (VC) [Nancy Rothwell](https://en.wikipedia.org/wiki/Nancy_Rothwell) shown in figure \@ref(fig:vc-fig). Nancy has served as VC since 2010, and will step down in 2024, the 200th anniversary of its foundation. You'll be taking over as VC.
...
Now that you are the VC, what would you change about how the University is run?^[Please note this is just a thought experiment]
