...
So you've done a summer job Web applications UK, which is now called, they've changed their name now to [Koder.ly](https://www.koder.ly/) with a `K`. So, you've got, you've got a sort of broad exposure to different sort of software engineering ideas, I guess, working in a team and that kind of stuff.
