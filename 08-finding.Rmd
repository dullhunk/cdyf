...
Some job vacancies are not advertised. Smaller employers do not always offer the kinds of experience described in table \@ref(tab:interntable). Making a speculative approach might be one of the few ways in, see figure \@ref(fig:gambling-fig).
...
You'll hopefully avoid the job scamming but its harder to avoid the job spamming. Not just any old spam, but jobspam. It isn't particularly difficult to find lots of job adverts and by the time you've registered with a few different systems described in section \@ref(looking), you'll find your inbox full of email, your notifications relentessly pinging and your LinkedIn feed full of jobspam, see figure \@ref(fig:jobspam-fig).

```{r spam-fig, echo = FALSE, fig.align = "center", out.width = "98%", fig.cap = "(ref:captionjobspam)"}
