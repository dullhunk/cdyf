...
It can be bewildering knowing where to start your job search, because the possibilities are endless. There are many parameters to your search. Here are some basic strategies to help you start to [decompose](https://en.wikipedia.org/wiki/Decomposition_(computer_science)) the complex problem of job hunting into smaller, more manageable problems you can start to tackle. We've already mentioned eight:
