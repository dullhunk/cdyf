...
(ref:captionblackhole) Rejection is a normal part of applying for jobs, some of your application may disappear without trace into employers black holes, especially if they are large and have a strong gravitational force on job applicants. CC-BY image of the core the black hole in [Messier 87](https://en.wikipedia.org/wiki/Messier_87) by the [Event Horizon Telescope](Event Horizon Telescope) team via Wikimedia Commons [w.wiki/3RCa](https://w.wiki/3RCa)
