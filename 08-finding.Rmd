...
* See for example [google.com/search?q=job+scam](https://www.google.com/search?q=job+scam)
...
* RateMyPlacement article on [Why I Regret Doing an Unpaid Internship](https://www.ratemyplacement.co.uk/blog/why-i-regret-doing-an-unpaid-internship/)
* See [google.com/search?q=unpaid+internships](https://www.google.com/search?q=unpaid+internships)

In science, technology and engineering, unpaid internships are much less common than in other sectors as demand for skilled engineers and scientists is generally high. Some employers, particularly startups, may offer company equity as an alternative to a salary - again you should be wary of this. Like many people, I don't endorse unpaid internships, and I'd avoid them completely.
