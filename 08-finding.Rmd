...
(ref:captionfurber) The design of a general-purpose processor, in common with most engineering endeavours, requires careful consideration of many trade-offs and compromises. [@furberarm] That's also true for your future too, what compromises and trade-offs will you make when engineering your future? CC BY-SA portrait of microprocessor designer [Steve Furber](https://en.wikipedia.org/wiki/Steve_Furber) by Peter Howkins on Wikimedia Commons [w.wiki/544E](https://w.wiki/544E) adapted using the [Wikipedia app](https://apps.apple.com/gb/app/wikipedia/id324715238)
