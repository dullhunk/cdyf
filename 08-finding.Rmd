...
Picking a sector can help you get started, by narrowing what might otherwise be a massive search space. Picking a sector will also determine the kind of salary see section \@ref(by-salary). [@letsmakelotsofmoney]
...
# Sunshine state
find_jobs(location=California)

# location isn't important
# have skills, will travel
find_jobs(location=anywhere)
````
...
# should we go for a reasonable match?
...
An employers `values` are often reflected in the organisations `culture`. What is the employers culture like? Would you enjoy working there and would you felt like you belonged and fitted in? How can you actually find this out? Do you need to sell your soul? If you're struggling with these questions, you may need to do some more soul searching, see section \@ref(soul) and chapter \@ref(knowing). Talk to employees too, this is why networking is important, see section \@(weakties).
...
Armed with knowledge of *when* to apply you can start to target employers. Timing is important because it some cases it will sometimes determine the type of organisation you apply to.
