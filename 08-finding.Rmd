...
* Stackoverlflow.com. You've probably cut-and-pasted solutions from stackoverflow but you can also use to create a profile too, see figure \@ref(fig:overflow-fig). As of March 2021 Stack Overflow had over 14 million registered users, and had received over 21 million questions and 31 million answers.
...
So, if you're happy to publish your work online, sites like LinkedIn, Github and Stackoverflow can help you find jobs using a *push* approach alongside more conventional *pull* approaches described in section \@ref(studentobs) and \@ref(generaljobs). Digital profiles can be particularly useful if you're looking for freelance, contract or part-time work.
