...
```
(ref:captiontimesink) Playing the game of job hunting can be a big drain on your time and a certain amount of time wasting is unfortunately inevitable. Employers will waste some of your valuable time and you'll waste some of theirs aswell. Beware of the recruitment [time sink](https://en.wikipedia.org/wiki/Time_sink). Public domain image of a DualShock PlayStation controller by [Evan Amos](https://en.wikipedia.org/wiki/Evan_Amos) on Wikimedia Commons [w.wiki/3VFp](https://w.wiki/3VFp)
