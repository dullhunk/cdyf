...
Some job vacancies are not advertised. Employers may deliberately hide them or make them difficult to find. Smaller employers do not always offer the kinds of experience described in table \@ref(tab:interntable). A speculative application might the only way in, see figure \@ref(fig:gambling-fig). In competitive sectors that can be harder to break into like [video games](https://en.wikipedia.org/wiki/Video_game), a speculative application is worth considering alongside getting a recruiter to help you, described in section \@ref(recruiters).
...
* Phone call, these can work well with smaller employers, have your “elevator pitch” ready see section \@ref(we3qs)
