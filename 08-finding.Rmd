...
1. Describe some of the problems with recruitment, both for employers and yourself
...
Engineering inevitably involves compromises and trade-offs, see figure \@ref(fig:furber-fig). You will have to make some compromises in the design and implementation of your career, it might be salary, location, employer or something else.
...
(ref:captionfurber) The design of a general-purpose processor, in common with most engineering endeavours, requires careful consideration of many trade-offs and compromises. [@furberarm] That's also true for your future to, what compromises and trade-offs will you make when engineering your future? CC BY-SA portrait of microprocessor designer [Steve Furber](https://en.wikipedia.org/wiki/Steve_Furber) by Peter Howkins on Wikimedia Commons [w.wiki/544E](https://w.wiki/544E) adapted using the [Wikipedia app](https://apps.apple.com/gb/app/wikipedia/id324715238)
