...
### Beware of time sink {#sink}
Finding employers that you are interested in and submitting high quality job applications takes time. Many students under-estimate the time needed to job hunt. Even if you've quickly worked out what your strengths are, what you're interested in (see chapter \@ref(knowing)) and where to apply, the actual business of applying can be very bureaucratic. Any interviews you have will take time to prepare for (see chapter \@ref(speaking)) and

One way to tackle this problem is to schedule some time every week when you work on applications, see chapter \@ref(scheduling). However, there's no getting away from the fact that it will be time consuming. Beware of the [time sink](https://en.wikipedia.org/wiki/Time_sink).
