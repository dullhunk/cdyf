...
It is a good idea to have a range of different strategies for job hunting, and change the strategy during the year. So for example, at the beginning of the academic year you might target large multinational organisations. If you're not successful, switch to smaller employers later in the academic year. Table \@ref(tab:shortcuts) shows summarises some of the when and where some employers advertise.
