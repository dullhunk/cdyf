...
````python
find_jobs(maximum_employees=50)
````
...
Our `find_jobs()` function is useful, if only as a thought experiment, but there's still the question of *when* you use it and *how often*:
