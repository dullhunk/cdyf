...
* A debugged CV or resume, see section \@ref(checklist)
* A personalised covering letter, see section \@ref(we3qs) 
...
Your networks that we described in section \@ref(weakties) can be useful in approaching employers including:
...
Making speculative applications may require you [cold calling](https://en.wikipedia.org/wiki/Cold_calling) employers, by email phone or online. The people in your networks can help you to make job applications that aren't completely cold. 
