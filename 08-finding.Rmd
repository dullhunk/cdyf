...
* [brightnetwork.co.uk](https://www.brightnetwork.co.uk/) started in 2013, but grown rapidly
...
* **LinkedIn.com** is a social media service which allows you to put professional details online, a bit like a semi-public or public CV, see figure \@ref(fig:linkedin-fig) and table \@ref(tab:linkedintable). Besides allowing you to advertise yourself, LinkedIn also:
    ...
    + is [frequently visited by recruiters](https://blog.linkedin.com/2016/10/06/now-you-can-privately-signal-to-recruiters-youre-open-to-new-job)
    + allows you to [apply for jobs directly through LinkedIn](https://www.linkedin.com/help/linkedin/answer/75815/applying-for-jobs-on-linkedin?lang=en)
    + (although [making fast applications is not always a good thing](https://medium.com/otta-blog/job-boards-making-fast-applications-is-not-a-good-thing-5a4970887ecd))
    ...
    + allows you to find alumni from your University who might be willing to help you, via the [alumni tab](https://www.linkedin.com/help/linkedin/answer/a567083/linkedin-page-alumni-tab-overview). For example, see [linkedin.com/school/university-of-manchester/people](https://www.linkedin.com/school/university-of-manchester/people/) and [your.manchester.ac.uk/get-involved/global-networks](https://your.manchester.ac.uk/get-involved/global-networks/). Whatever Unviersity you are studying at, LinkedIn can be a good way finding and contacting alumni
...
Some job vacancies are not advertised. Smaller employers do not always offer the kinds of experience described in table \@ref(tab:interntable). Making a speculative approach might be one of the few ways in. You need to: 
...
* Written a compelling and personalised covering letter, see section \@ref(we3qs) 
...
* **actual**: people you've met in real-time face to face, offline 
...
Making speculative applications may involve you [cold calling](https://en.wikipedia.org/wiki/Cold_calling) employers, by email phone or online. It's a bit of a gamble, but it can sometimes work, see figure \@ref(fig:gambling-fig). The people in your networks can help you to make job applications that aren't completely cold.
...
(ref:captiongambling) Fancy a flutter? Speculative applications are a bit of a [gamble](https://en.wikipedia.org/wiki/Gambling) to help you find unadvertised or hidden vacancies. You'll improve your odds and strengthen your hand by researching the employer (see section \@ref(bp10)) and using your social networks to connect. Public domain image of *[The Cardsharps](https://en.wikipedia.org/wiki/The_Cardsharps)* painting by [Carvaggio](https://en.wikipedia.org/wiki/Caravaggio) on Wikimedia Commons [w.wiki/6R6q](https://w.wiki/6R6q) adapted using the [Wikipedia app](https://apps.apple.com/gb/app/wikipedia/id324715238)
