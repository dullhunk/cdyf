...
Congratulations to all our students graduating from the Department of Computer Science in 2026, we're looking forward to celebrating all your hard work, growth and achievements with your friends, families and supporters in the [Whitworth Building](https://en.wikipedia.org/wiki/Whitworth_Building) and Gilbert Square.
...
Our doors are always open. If you're on LinkedIn, you can also follow the Department of Computer Science and the wider University at:
...
Your email and associated IT account is scheduled to [close on 1st August 2026](https://www.itservices.manchester.ac.uk/students/leaving/), but some services are still available to you. The Division of Development and Alumni Relations (DDAR) are here to help you stay connected with the University by: 
...
<!--see figure \@ref(fig:graduation-vid).


```{r graduation-vid, echo = FALSE, fig.align = "center", out.width = "99%", fig.cap = "(ref:captiongraduation2025)"}
knitr::include_url('https://www.youtube.com/embed/nAzPJhcZhDY')
```


(ref:captiongraduation2025) The first of two graduations for Computer Science students in 2025, with speeches from Duncan Ivison, Andrew Stewart, Gaven Smith and Ulrike Sattler.-->