...
(ref:captionhendrix) Are you experienced in Dad rock? [@hendrix] Definitions of Dad-Rock vary, but there's plenty of Dads who believe this playlist includes some of the best music ever made. By real musicians. With real instruments. Public domain image of [Jimi Hendrix](https://en.wikipedia.org/wiki/Jimi_Hendrix) performing for Dutch television show *[Hoepla](https://en.wikipedia.org/wiki/Hoepla)* in 1967 by A. Vente via Wikimedia Commons [w.wiki/5WHj](https://w.wiki/5WHj) adapted using the [Wikipedia App](https://apps.apple.com/gb/app/wikipedia/id324715238)
