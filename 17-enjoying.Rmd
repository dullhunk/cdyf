...
1. “Anything” (we chose *No Idea*) by rapper [Don Toliver](https://en.wikipedia.org/wiki/Don_Toliver) was chosen by Jason, see chapter \@ref(jason). [@noidea]
...
1. *Iguana* by singer [Inna](https://en.wikipedia.org/wiki/Inna) was chosen by Alice, see chapter \@ref(alice). [@iguana]
1. *As It Was* by [Harry Styles](https://en.wikipedia.org/wiki/Harry_Styles) was chosen by Alice, who managed to sneak two songs onto the playlist, see chapter \@ref(alice). [@asitwas]
