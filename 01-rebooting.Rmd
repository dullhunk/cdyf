...
```
(ref:captiongeekout) [Blessed are the ~~meek~~ geeks, for they shall inherit the earth](https://en.wikipedia.org/wiki/Matthew_5:5). You are a geek, so where is your inheritance? Image of stained glass window by Norbert Schnitzler via Wikimedia Commons [w.wiki/43LN](https://w.wiki/43LN) adapted using the [Wikipedia app](https://apps.apple.com/us/app/wikipedia/id324715238)
