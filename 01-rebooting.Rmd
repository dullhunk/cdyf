...
The TL;DR for this chapter is, you should read this guidebook to maximise your future, it is your own responsibility to do so. No-one else is going to do this for you. Your degree will help open up future options, but it is not enough by itself you'll need to maximise the return on your investment. If you're a procrastinator, it's too late when you graduate and *YES* this will be on the exam (set by future employers). There are signposts to help you navigate, design, build, test, debug and code your future in computing. [Bon voyage](https://en.wikipedia.org/wiki/Bon_Voyage)! 🇫🇷
