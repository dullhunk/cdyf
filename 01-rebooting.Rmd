...
A lot of scientific and technical writing is written in the third person or passive voice. It can be cold and impersonal which is fine for academic writing, but can alienate readers. I have opted to use first person narrative where possible as it is shorter, and hopefully more engaging for you to read. Where relevant, I've told people's stories, to illustrate key social points. There's plenty of emotion here too, because job searching can be an emotional rollercoaster: from anxiety, joy, depression, frustration, hope, anger and englightenment - it's all here. 
