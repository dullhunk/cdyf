...
<!--See  I don't know what I want to do, section \@ref(noclue) -->
...
(ref:captionchapters) See chapters \@ref(writing), \@ref(experiencing) and \@ref(debugging)
...
(ref:captionstartrek) This is Captain [Jean-Luc Picard](https://en.wikipedia.org/wiki/Jean-Luc_Picard), engage with your future. Make it so. Fair use image of actor Patrick Stewart adapted using the [Wikipedia app](https://apps.apple.com/us/app/wikipedia/id324715238)
