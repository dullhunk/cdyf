...
I wrote this guidebook because I needed a resource for students to help them design, build, test and code their futures. I needed a book that could help students compete for jobs while at University, or shortly after graduating. I could not find anything suitable that met all the requirements of the students I was teaching. Some problems with the resources that are already out there, and how this book addresses them are shown in table \@ref(tab:difftable)
...
+---------------------------------------------+--------------------------------------------+
| - **Paper first**: digital comes second     | - **Digital first**: paper comes second    |  
...
| - Video and audio is separate to book       | - Video and audio is integrated            |       
+---------------------------------------------+--------------------------------------------+
...
| - Career and discipline agnostic            | - Computing specific careers see \@ref(computing)|
+---------------------------------------------+--------------------------------------------+
...
| - Released late, released seldomly          | - Released early, released often, section \@ref(version)          |
+---------------------------------------------+--------------------------------------------+
