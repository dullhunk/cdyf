...
|                     | - (ref:captionchapters2)                   |          |
+---------------------+--------------------------------------------+----------+
| Employee performance| - Should we promote you?                   | pass/fail|
|                     | - Should we give you a pay rise?           |          |
|                     | - Should we extend your contract?          |          |
|                     | - (ref:captionchapters3)                   |          |
+---------------------+--------------------------------------------+----------+

<!--putting ref directly in table above causes bug in epub-->
(ref:captionchapters) Chapters \@ref(writing) and \@ref(debugging)

(ref:captionchapters2) Chapter \@ref(speaking)

(ref:captionchapters3) Chapter \@ref(surviving)

<!--needs a linebreak between each one-->
