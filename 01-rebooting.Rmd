...
You will spend lots of time in this wonderland, potentially as much as 80,000 hours of your life. [@iip1; @iip2] So join me down the rabbit hole, it's fun (honest), and sooner or later you'll have to come down here anyway. So open up the door to new possibilities.

<!-- popular languages https://spectrum.ieee.org/at-work/tech-careers/top-programming-language-2020 -->

## Opening your future {#opening}
Studying at University is about opening up to a new and exciting doors to the future, as [Lemn Sissay](https://en.wikipedia.org/wiki/Lemn_Sissay) once said (figure \@ref(fig:lemn-fig)):
...
```
(ref:captionlemn) Open the book, open the challenge, with open eyes. Open. Out. Look. Open all minds, open all dreams, research, question. Open all doors, open all senses, open all defences, ask: What were these closed for? [@sissay] Portrait of [Lemn Sissay](https://en.wikipedia.org/wiki/Lemn_Sissay) speaking in 2010 by Philosophy Football via Wikimedia Commons [w.wiki/3VYT](https://w.wiki/3VYT) adapted using the Wikipedia app
...
```
(ref:captionandysc) Nobody cares about your career except you. Unattributed quotation via [Andy Stanford-Clark](https://en.wikipedia.org/wiki/Andy_Stanford-Clark) [@andystanfordclark] Image of Andy by Gizmo~enwiki via Wikimedia Commons [w.wiki/3TSn](https://w.wiki/3TSn) adapted using the Wikipedia app
...
You might be tempted to postpone making difficult career decisions. I'll do it tomorrow. I'll do it next week. I'll do it next year. I'll finish this assignment. I'll finish this exam. I'll finish this semester. I'll finish my degree first, see figure \@ref(fig:procrastination-fig). Procrastination is a part of the [human condition](https://en.wikipedia.org/wiki/Human_condition). Software engineer [Paul Graham](https://en.wikipedia.org/wiki/Paul_Graham_(programmer)) has argued there is [good and bad procrastination](http://paulgraham.com/procrastination.html)  [@procrastination].
...
(ref:captionprocrastination) The attitude “I’ll get my degree out of the way first then worry about jobs and careers when I finish University” is bad procrastination. It's too late when you graduate to start thinking about what comes next [@procrastination] Stresssed procrastinator picture by MismibaTinasheMadando on Wikimedia Commons [w.wiki/3TXo](https://w.wiki/3TXo)
