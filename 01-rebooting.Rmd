...
You will spend lots of time in this wonderland, potentially as much as 80,000 hours of your life. [@iip1; @iip2] So join me down the rabbit hole, it's fun (honest), and sooner or later you'll have to come down here anyway. So open up to the possibilities.

<!-- popular languages https://spectrum.ieee.org/at-work/tech-careers/top-programming-language-2020 -->

## Opening your future {#opening}
Studying at University is about opening up to a new and exciting future, as [Lemn Sissay](https://en.wikipedia.org/wiki/Lemn_Sissay) once said (figure \@ref(fig:lemn-fig)):
