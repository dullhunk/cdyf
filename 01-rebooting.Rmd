...
Procrastination is a part of the [human condition](https://en.wikipedia.org/wiki/Human_condition) and its not necessarily a bad thing. Software engineer [Paul Graham](https://en.wikipedia.org/wiki/Paul_Graham_(programmer)) distinguishes between two types of procrastination:
...
* “test-driven (career) development” ([TDD](https://en.wikipedia.org/wiki/Test-driven_development)) (get experience before you graduate)
