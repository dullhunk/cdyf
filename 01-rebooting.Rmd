...
1. Help you maximise the [return on investment](https://en.wikipedia.org/wiki/Return_on_investment) (ROI) of the substantial amount of your time and money you are putting (and have put) into your education
...
+---------------------------------------------+--------------------------------------------+
| - **Divorced** from any curriculum          | - **Married**^[computationally married with kids and a mortgage] to the computing curriculum  |
...
(ref:studentvoice) Includes [student voice](https://en.wikipedia.org/wiki/Student_voice), see section \@ref(contributing) chapter \@ref(hearing)
