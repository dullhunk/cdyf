...
* your actions: what have you **done** with all of the above? How have you applied these fundamental communication skills to perform higher level communication tasks such as negotiating, persuading, leading and understanding etc. See examples of actions in chapter \@ref(actioning)
...
| - Top down, corporation driven              | - Bottom up, grassroots driven             |
+---------------------------------------------+--------------------------------------------+
...
(ref:studentmute) Often excludes [student voice](https://en.wikipedia.org/wiki/Student_voice)
