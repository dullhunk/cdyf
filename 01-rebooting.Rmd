 ...
 * ✅  You could be spending that precious time in lots of other ways right now, *YES*!
 * ✅  There are mountains of self-help guides and courses already, *YES*! *YES*!
...
Before you start either designing or coding, we need to reboot. So come with me [down the proverbial rabbit hole](https://en.wikipedia.org/wiki/Down_the_rabbit_hole) in figure \@ref(fig:rabbit-fig) and let me explain... 🐇
...
Your future is bright, your future needs rebooting, so let's reboot your future.

## What You Will Learn {#ilo1}
After reading this chapter you will be able to reboot your future by :

1. Setting your expectations for using this guidebook, and opening some doors to your future
...
You will spend lots of time in this wonderland, potentially as much as [80,000 hours](https://80000hours.org/) as part of the ~4,000 weeks of your life. [@iip2; @fourthousandweeks] So join me down the rabbit hole, it's fun (honest), and sooner or later you'll have to come down here anyway. So open up the door to the new possibilities in your future.
...
1. Help you maximise the [return on investment](https://en.wikipedia.org/wiki/Return_on_investment) (ROI) of the substantial amount of your time and money you have already put into your education, from primary school through to University [@worthit; @ifs; @euanblair]
...
All of the resources that can help you are scattered around in lots of different places. There are books, there are videos, there are podcasts, there are websites, TikToks, YouTubers and jobs boards. There are online courses, blogs, social media, newspaper columns, journal articles, AI, marketing material and many other good resources. It is overwhelming.
...
At some point during or after your study, you might find yourself applying for a graduate job or graduate scheme. EVERYONE applying for these opportunities will have a degree or be rapidly on their way to getting one. So having a degree, even a really geeky one isn't going to set you apart much from your competition. Even having a good first class degree may not distinguish you that much your competitors [@gradeinflation; @firstclass]. Some employers would rather not know (or don't care) what University you went to, so your education might not make you stand out as much as you might like anyway. [@bigfour; @eyfirm]
...
* your actions: what have you **done** with all of the above? How have you applied these fundamental communication skills to perform higher level communication tasks such as understanding, negotiating, persuading and leading etc. See examples of actions in chapter \@ref(verbalising)
...
ggplot(data = lotsofgrads) + theme_minimal () +
...
We all procrastinate because there's an infinite number of tasks we could be doing but a finite amount of time in which to do them, around [four thousand weeks](https://en.wikipedia.org/wiki/Four_Thousand_Weeks:_Time_Management_for_Mortals), depending on what you count. [@fourthousandweeks]
...
Computer scientists call this problem “search space reduction” [@searchspace]. You have a [feasible region](https://en.wikipedia.org/wiki/Feasible_region) of future possibilities and you need to narrow down the candidates. You could think of coding your future as an [optimisation problem](https://en.wikipedia.org/wiki/Optimization_problem). 

Start optimising now, by getting some experience because it's too late when you graduate. 🎓
...
It's a similar story with interviews, if you botched an interview question or came across badly, it can be really difficult to find out from the employer what you did wrong. That makes it harder to learn from your mistakes.
...
I've searched high and low but can't find anything suitable that meets all the requirements of the students I teach. Some problems with the resources that are already out there, and how this book addresses them, are shown in table \@ref(tab:difftable).

:  (\#tab:difftable) THIS guidebook to *Coding your Future* is different to all the other guidebooks! Your future is bright, your future needs CODING.

+---------------------------------------------+--------------------------------------------+
| OTHER guidebooks                            | THIS guidebook                             |
+=============================================+============================================+
| - (ref:ripoff)                              |  - (ref:betterproduct)                     |
| - Inadequate linking, inbound & outbound    |  - (ref:clinkable)                         |
| - Poor citations                            |  - (ref:signpostedtext)                    |
| - Often can't be searched                   |  - Search by any words you choose          |
+---------------------------------------------+--------------------------------------------+
| - **Born printed**: digital comes second    | - **Born digital**:  paper comes second    |
| - Websites are crippled “companions” to book| -  (ref:thewebsiteisthebook)               |
| - Ebook a clumsy afterthought               | -  (ref:ebookgum)                          |
| - Video and audio is separate to book       | - Video and audio is integrated & embedded |
+---------------------------------------------+--------------------------------------------+
| - **Divorced** from any curriculum          | - (ref:marriedwithchildren)                |
| - (ref:notusedforteaching)                  | - (ref:thisiscomp2cars)                    |
| - (ref:doingitwrong)                        | - (ref:tailormade)                         |
+---------------------------------------------+--------------------------------------------+
...
+---------------------------------------------+--------------------------------------------+
| - **Closed** source                         | - (ref:u2cancontribute)                    |
| - Small number of authors & editors         | - Anyone can contribute or comment         |
| - Released late, released seldomly          | - (ref:rero)                               |
+---------------------------------------------+--------------------------------------------+

<!--horrible table hacks to make the spacing work, I know they are not pretty but they work-->

(ref:clinkable) Every link is clickable, every section, table and figure can be linked to using short self-explanatory hyperlinks

(ref:signpostedtext) Everything cited, see section \@ref(signposted)

(ref:thewebsiteisthebook) The website [`www.cdyf.me`](https://www.cdyf.me/) **is  ** the book

(ref:ebookgum) Ebook published simultaneously, see section \@ref(downloading)

(ref:marriedwithchildren) **Married**^[computationally wedded to the curriculum with kids and a mortgage] to the computing curriculum

(ref:thisiscomp2cars) Course textbook for COMP2CARS, embedded in the curriculum <!--link-->

(ref:tailormade) Specific, tailored to computing careers, see chapters \@ref(choosing), \@ref(computing) and \@ref(hearing)

(ref:institution) Institutionalised by Universities, employers or advertisers

(ref:agnostic) Agnostic to institutions, universities, employers and advertisers

(ref:dehumanised) Top down, corporation driven, formal, bland, sometimes impersonal, risk averse, [designed by committee](https://en.wikipedia.org/wiki/Design_by_committee) and a product of [groupthink](https://en.wikipedia.org/wiki/Groupthink)  [@groupthink]
...
(ref:doingitwrong) Generic, one-size-fits-all, often career, discipline, degree and subject agnostic [@samfranklin]

(ref:studentvoice) Includes multiple student voices, see section \@ref(contributing) and chapter \@ref(hearing) [@amplifying]

(ref:studentmute) Often excludes the [student voice](https://en.wikipedia.org/wiki/Student_voice)

(ref:u2cancontribute) **Open** source, see section \@ref(contributing)

(ref:rero) Released early, released often, see section \@ref(version)

(ref:ripoff) **Expensive** paper-based books that go out of date as soon as they are printed, sometimes “high-cost but low quality” [@remzi]

(ref:betterproduct) **Free** digital versions, constantly updated with “micro-revisions” added on a daily or weekly basis [@TextbooksForAll]
...
### Your Future is Flexible {#flexible}
Nobody knows what the future holds so your future is flexible. This means you can choose your own three personal *P*'s : *Pace*, *Place* and *Pathway*: [@georgepettifer]

* **PACE**: By giving you greater control over how much, at what level, and what kind of intensity you study, I encourage you to set your own pace. Take as much or as little as you want, see section \@ref(gut)
* **PLACE**: By offering you a greater choice over the physical and virtual spaces in which you learn - remote, on campus, online, hybrid, blended and transnational. 
* **PATHWAY**: By choosing your own path through this course, you can [Go Your Own Way](https://en.wikipedia.org/wiki/Go_Your_Own_Way). [@yourownway] Collect evidence of the parts you care about with stackable microcredentials while you loop your own lifelong learning loops, see chapter \@ref(achieving)

### Your Future is Signposted {#signposted}
Some career resources claim (or imply) that they are the *all you will need* to solve a particular problem or worse: solve *all of your problems*! Just buy this book, do this course, watch these videos, listen to this podcast, pass this test and all your problems will go away!  Rather than continue this trend, this book **signposts** some of the most useful resources, see figure \@ref(fig:signposting-fig).
...
This guidebook to your future accompanies a course that has been co-designed by students for students, with input from academics and employers. It unites several disparate themes into one coherent story, from fundamental questions about identity and wellbeing through to more applied and practical advice on job hunting, career progression and life after University. Resources that do this are typically scattered around in many different places. There is usually no narrative to tie them all together to help students navigate the mountains of advice as they embark on the first stages of their careers. I'll guide you through the narrative, but it is a flexible *descriptive* story rather than an inflexible *prescriptive* one, see figure \@ref(fig:descriptive-fig).
...
(ref:captiondescriptive) Many formal education courses follow an inflexible *prescriptive pathway* (right), they lead you through a story from start to finish. This is the way of the University: “`our courses`” - our prospectus. This course is different, it follows a more flexible *descriptive pathway* (left) which means you pick your own way through the story. I'll guide you through the story but you'll need to choose *your* way: “`my way`”. You stood tall and faced it all. You did it [your waaaaaaaaaaay](https://en.wikipedia.org/wiki/My_Way). [@sinatra] [Prescriptive vs. descriptive pathways](https://bryanmmathers.com/prescriptive-vs-descriptive-pathways/) sketch by [Visual Thinkery](https://visualthinkery.com/) is licensed under [CC-BY-ND](https://creativecommons.org/licenses/by-nd/4.0/)
...
* More videos on the *Coding your Future* YouTube channel [youtube.com/\@coding-your-future](https://www.youtube.com/\@coding-your-future), some of which are already embedded here
...
### Your Future is Personal, Emotional and Sociable {#firstperson}
A lot of scientific and technical writing is written in the third person or passive voice. It can be cold and impersonal which is fine for academic writing, but can alienate readers. I have opted to use first person narrative where possible as it is shorter, and hopefully more engaging for you to read. Where relevant, I've told people's stories, to illustrate key social points. There's plenty of emotion here too, because job searching can be an emotional rollercoaster: from anxiety, joy, depression, frustration, hope, anger and englightenment - it's all here. Learning is a highly emotional process, especially at University where you may also be living away from friends and family for the first time. [@quinlanfeels]

<!--I've tried to be honest too honest broker, not sure where this fits-->

### Your Future has no Paywall or Login {#openaccess}
You don't need to pay anything to read this book online because its not hiding behind a [paywall](https://en.wikipedia.org/wiki/Paywall), see the license in section \@ref(license). Publishing this guidebook online makes it findable and accessible, something that isn't true of knowledge locked up inside other books. Your future is openly accessible, see figure \@ref(fig:nopaywall-fig).

```{r nopaywall-fig, echo = FALSE, fig.show = "hold", out.width = "32%", fig.cap = "(ref:captionnopaywall)"}
knitr::include_graphics(rep("images/padlock.png", 3))
```

(ref:captionnopaywall) Your future has no [paywall](https://en.wikipedia.org/wiki/Paywall) or login. You do not need to pay, enrol, register or remember your username and password because the content of this book is openly accessible. Unlocked padlock image by Simpleicon on Wikimedia Commons [w.wiki/6Df3](https://w.wiki/6Df3) adapted using the [Wikipedia app](https://apps.apple.com/us/app/wikipedia/id324715238). 

Because this guidebook is openly available online, it is searchable, browsable and linkable too. Everything important has a link, aka a Uniform Resource Locator ([URL](https://en.wikipedia.org/wiki/URL)) including all chapters, sections, subsections, figures, citations and tables. 

There are no usernames or passwords because your future has no login. You don't need to pay, enrol or register for this course. You don't have to use some badly-designed monolithic [learning management system](https://en.wikipedia.org/wiki/Learning_management_system) (LMS) [bloatware](https://en.wikipedia.org/wiki/Software_bloat), over-engineered [MOOC](https://en.wikipedia.org/wiki/Massive_open_online_course) or [annoying enterprise software](https://duncan.hull.name/2014/07/29/software/). Phew! [@enterprisey]

All your future needs is a web browser. Search and browse this material whenever and however you like, on a mobile, tablet, desktop - it doesn't matter. Your future is openly accessible. 
...
* videos produced by third parties that are used to illustrate key points
* audio produced by third parties that illustrates key points, both individual episodes and whole series
* short videos produced by me, which augment the written content of this book, see the [Coding your Future YouTube channel](https://www.youtube.com/channel/UCLBv_u8JmyUPqmRALIjVnLg)
* the *Coding Your Future* podcast (Hearing Your Future) which interviews undergraduate students, see figure \@ref(fig:hyf-fig) and chapter \@ref(hearing)

```{r hyf-fig, echo = FALSE, fig.show = "hold", out.width = "33%", fig.cap = "(ref:captionhyf)"}
knitr::include_graphics(rep("images/Hearing-your-future.png", 3))
```

(ref:captionhyf) Your future is audible, listen to *Hearing Your Future*, the Coding Your Future podcast wherever you get your podcasts, see chapter \@ref(hearing). Hearing sketch by [Visual Thinkery](https://visualthinkery.com/) is licensed under [CC-BY-ND](https://creativecommons.org/licenses/by-nd/4.0/)
...
(ref:captionstartrek) This is Captain [Jean-Luc Picard](https://en.wikipedia.org/wiki/Jean-Luc_Picard) of the Starship *Enterprise*. Engage! [@startrek] Fair use image of actor [Patrick Stewart](https://en.wikipedia.org/wiki/Patrick_Stewart) performing in *Star Trek* adapted using the [Wikipedia app](https://apps.apple.com/us/app/wikipedia/id324715238). Make it so.
...
Your future is bright, your future needs rebooting. Rebooting your future will help you design your future. Designing your future will help you to start coding your future.
...
It looks like the reboot has finished, so we're ready to go. Welcome to your future. In the next part, you will reflect on who you are and what your story is in chapter \@ref(exploring): *Exploring your Future*. 
