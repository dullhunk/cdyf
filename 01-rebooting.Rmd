...
| - Ebook a clumsy afterthought               | - [Ebook published simultaneously](https://leanpub.com/cdyf)   |  
| - Video and audio is separate to book       | - Video and audio is integrated            |       
+---------------------------------------------+--------------------------------------------+
| - **Divorced** from any curriculum          | - **Married** to the computing curriculum  |
| - Not used for teaching                     | - Course textbook for COMP2CARS <!--link-->  |
| - Career and discipline agnostic            | - Career specific: computing for *everyone*|
+---------------------------------------------+--------------------------------------------+
| - **Closed** source                         | - **Open** source, see section \@ref(contributing)|
| - Small number of authors & editors         | - Anyone can contribute or comment         |
| - Often excludes student voice              | - Includes student voice                   |
