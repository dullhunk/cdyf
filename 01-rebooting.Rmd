...
You have worked incredibly hard to get the grades you needed to get into University. You've spent (or are spending) a significant amount of time and money studying your chosen discipline. You are really *geeking out* by going deep into your subject for a substantial period. Geekery, by which I mean [you are interested in your subject for its own sake](https://en.wikipedia.org/wiki/Geek), is a good thing. Being called a geek is a compliment, not an insult, and you should wear your geek badge with pride! Some people even say the geeks will inherit the earth, see figure \@ref(fig:geekout-fig). You are a geek, so where is *your* inheritance?
