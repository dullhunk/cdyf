...
There are no usernames or passwords because your future has no login. You don't need to pay, enrol or register for this course. You don't have to use some bloated [learning management system](https://en.wikipedia.org/wiki/Learning_management_system) (LMS), over-engineered [MOOC](https://en.wikipedia.org/wiki/Massive_open_online_course) or [annoying enterprise software](https://duncan.hull.name/2014/07/29/software/). Phew!
