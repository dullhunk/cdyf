...
(ref:captiontldr) There's always more stuff you should be [reading](https://en.wikipedia.org/wiki/Reading). If this guidebook is **Too Long, Didn't Read** (TL;DR) then each chapter has a brief summary at the end. Public domain picture of ancient greek [muse](https://en.wikipedia.org/wiki/Muses) reading a scroll that's probably too long (Δεν το διάβασα, ήταν μακροσκελές) via Wikimedia Commons [w.wiki/3Xoh](https://w.wiki/3Xoh) adapted using the [Wikipedia app](https://apps.apple.com/us/app/wikipedia/id324715238)
