...
Stress can lead to many kinds of ill health. On describing his work for the government and why he punished himself so much in training, Alan Turing said:
...
'`
```{r anxious-fig, echo = FALSE, fig.align = "center", out.width = "0.1%", fig.cap = "(ref:captiongad)"}
