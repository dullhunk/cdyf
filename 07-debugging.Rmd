...
* University projects
    ...
    + Be *careful* publishing coursework, this can make you liable for academic malpractice. If someone copies your coursework, you will **both** be guilty of academic malpractice...
...
Again, congratulations, but third place out of how many: `3`? Not so impressive. `30`? `300`? `3000`? More impressive. Numbers make a big difference so if you're going to mention awards, quantify^[even an approximation will do] where you can so the reader can understand what the prize was for. You will be familiar with the `flibbertigibbet` competition but your reader probably won't of heard of it, so give some context. 🏆
...
... whereas this text does use a proper indent. The latter looks more professional and is easier to read, especially when you have multiple bullet points:
...
* ✅ `ada_lovelace.pdf` descriptive filname
* ❌ `cv-version1-final-FINAL-version-USE-THIS-ONE.pdf` reveals more about you than you might like!

It's fine to author your CV in Microsoft Word, but you'll want to save it as / print to PDF to make it more platform independent. LaTeX and overleaf can be used to create professional PDFs and there are plenty of good templates. See [Getting started with LaTeX (LaTeX4year1)](https://latex4year1.netlify.app/) if you've not used LaTeX before, or you need to refresh your memory. [@latex4year1]
