...
The fact that you enjoy `swimming`, `reading`, `football`, `cooking` and `hiking` is a bit vague and not likely to be a factor in the decision to interview you. There's nothing *wrong* with these pastimes but there's not much point mentioning them on your CV unless you have, for example:
