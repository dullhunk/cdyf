# (PART) TESTING & BUILDING YOUR FUTURE {-}

# Debugging your future {#debugging}

It's all very well *designing* your future but now you need to actually engineer it by *testing* and *building*. An obvious place to start is with your CV or résumé, because that's where most people get going. Just like with code, the hardest part isn't *writing* it but *debugging* and *rewriting* it. How can you create a bug-free CV, résumé or completed application form? How can you support applications with a strong personal statement or covering letter? These documents are a crucial part of your future so how can you debug them? 🕷
...
Your future is bright, your future needs debugging. Debugging your future will help you test and build your future. Testing and building your future will help you to start coding your future.
...
In the next part, chapter \@ref(experiencing): *Experiencing your Future* you will reflect on what experience you have to date and where you can get more experience to improve your CV and job applications.
