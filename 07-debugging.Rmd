...
```
(ref:captionfodder) Perhaps you managed to turn a project around when things weren't going well ((pear-shaped)[https://en.wikipedia.org/wiki/Pear-shaped])? Perhaps you've learned from painful mistakes you previously made? This is all great fodder for your CV because mistakes *can* be good, see section \@ref(estherdyson), as long as you don't repeat them. CV fodder sketch by [Visual Thinkery](https://visualthinkery.com/) is licensed under [CC-BY-ND](https://creativecommons.org/licenses/by-nd/4.0/)
