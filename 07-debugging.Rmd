...
* Identify and fix bugs in CV’s
    + Constructively criticise others CVs
...
Before we get started, let's consider some advice from software engineer [Gayle Laakmann McDowell](https://en.wikipedia.org/wiki/Gayle_Laakmann_McDowell) shown in figure \@ref(fig:gayle-fig). Gayle is an experienced software engineer who has worked at the biggest technology employers in the world, Apple, Microsoft and Google. She's also authored a cracking series of books on technology careers, particularly *Cracking the Coding Interview* [@cracking] which we'll come across in the [chapter on interviewing](http://www.cdyf.me/interviewing.html) Gayle refers to the employer “black hole”:
...
If you don't have much experience, don't worry, there are plenty of opportunities to get some.
...
If you have any open source projects
what projects have you done. fix a bug in an open source project.

You can build a mobile application, a web application, or something using open source. (FOSS) The important thing is that you are building something
