...
1. ✅ Have you added context using relevant hyperlinks than an interested reader can click on? See section \@ref(links)
...
1. ✅ Does it fit comfortably on exactly one page (resume) or a two pages (CV)? Not 1.5 pages or more than two? See section \@ref(length)
