...
1. Identify and fix bugs in CV’s by:
    + Their `content` (what you've done) and `presentation` (how you style your CV)
...
* Check your assumptions, especially if debugging makes you anxious or depressed, see chapter \@ref(nurturing)
