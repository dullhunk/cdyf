...
```
(ref:captionjonathanblack) [Jonathan Black](https://twitter.com/jonathanpblack), head of the careers service at the University of Oxford,  explains how to create a top notch CV by replacing meaningless assertions with meaningful evidence. [@topnotchcv] The image in this figure is a screenshot, you can [watch the video here](https://www.youtube.com/watch?v=yjdvCHWVtE4)
...
(ref:captiononeortwopager) How long should your CV be? Should you write a two page European style CV or an American style resume (one pager)? [@youtube-resume-or-cv] The image in the figure is a screenshot, you can [watch the video here](https://www.youtube.com/watch?v=0abDOKHS5T0)
