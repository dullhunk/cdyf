...
1. ✅ Have you shown you `C.A.R.E`. Your `Context`, `Actions`, `Results` and `Evidence` see \@ref(mycvsk)? Have you added `context` using relevant hyperlinks that an interested reader can click on? See section \@ref(links)
