...
* Bullet points with verbs first (see section \@ref(verbsfirst)) will:
  ...
  + avoid long sections of [prose](https://en.wikipedia.org/wiki/Prose) (which the reader will very probably skip anyway)
...
(ref:captioncvheader) Keep the header of your CV simple. Just your name, email phone number and any relevant links are all you really need. Anything additional information risks wasting valuable space and distracting your reader.
...
If you've done group projects at University, be sure to mention them. Your projects are important because they differentiate you from everyone else in your year group. Try to be *more* descriptive than this:
...
Similar to CAR and STAR, recruiters at Google (see Figure \@ref(fig:lopez-fig)) advise candidates to describe things using this pattern:
...
The latter is better because it is more specific, captures the result (accomplishment), by quantifying it ( “as measured by”) and talks about the actions (the doing part).
...
Here is a quick debugging check-list for your CV before you send it off to an employer:

1. ✅ Has it been reviewed by several people? Because according to [Linus's law](https://en.wikipedia.org/wiki/Linus%27s_law) “given enough eyeballs all bugs are shallow”
1. ✅ Have you reviewed other people's CV's? This will help you write a better CV, see chapter \@ref(sampling)
1. ✅ Has a “resume robot” checked it? See section \@ref(robotproof) 🤖
1. ✅ Does the style look good? Is it easy on the eye? See section \@ref(pdf)
1. ✅ Is there adequate whitespace (not too much or too little)? <!-- merge with previous-->
...
1. ✅ Have you added context using relevant hyperlinks? See section \@ref(links)
...
1. ✅ Is it balanced, including both technical and non-technical (soft) skills? See section \@ref(casual)
1. ✅ Does it have a good, clear structure? Not too many headings see section \@ref(mycvpd)?
1. ✅ Have you clearly distinguished between paid and unpaid or voluntary work?
