...
```
(ref:captionquidditch) It is debatable which, if any, of your hobbies should go on your CV. You might get lucky and your interviewer will share your esoteric passion for [Quidditch](https://en.wikipedia.org/wiki/Quidditch_(real-life_sport)), but it is unlikely. So if you do list your hobbies and interests, think carefully about *why* you are mentioning them and *what* you are trying to communicate about yourself with potential employers. Anyone for Quidditch sketch by [Visual Thinkery](https://visualthinkery.com/) is licensed under [CC-BY-ND](https://creativecommons.org/licenses/by-nd/4.0/)
