...
1. Describe your story^[actually a collection of short stories] of your relevant experience, projects and education etc
...
1. Quantify and provide evidence for any claims you make you on your CV
...
The fact that you enjoy `swimming`, `reading`, `football`, `cooking` and `hiking` is a vague and boring, making it unlikely to be a factor in the decision to invite you to interview. There's nothing *wrong* with these pastimes but there's not much point mentioning them on your CV unless you have, for example:
...
* be specific, e.g. `reading japanese novels from 20th century` rather than just `reading`
