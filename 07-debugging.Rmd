...
Résumé robots, grammar and spell checkers will improve your CV but you can't rely on them completely. The résumé robots described in section \@ref(robotproof) will encode the biases and prejudices of whoever wrote their algorithms. Spellcheckers are can't be relied on completely either, as shown in the poem below:
...
Ultimately there is no substitute for a *human* reading your CV, either a critical friend or reading it **out loud** to yourself.
