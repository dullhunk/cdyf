...
(ref:captionfeynman) Richard Feynman once chalked “What I cannot create, I do not understand” on his blackboard. Personal side projects and University projects are a great way to create new things in order to understand them. Public domain image via Dani Stefanovic [github.com/danistefanovic/build-your-own-x](https://github.com/danistefanovic/build-your-own-x)
