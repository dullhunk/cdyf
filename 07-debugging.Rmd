...
(ref:captionnotabug) Do you have bugs or [undocumented features](https://en.wikipedia.org/wiki/Undocumented_feature) on your CV or resume? Although tolerated in software, bugs in your CV or resume can be fatal. Picture of gold-dust weevil *Hypomeces squamosus* by [Basile Morin](https://commons.wikimedia.org/wiki/User:Basile_Morin) is licensed CC BY SA 4.0 via Wikimedia Commons [w.wiki/3E62 ](https://w.wiki/3E62)
...
(ref:captionshorterletter) I would have written a shorter ~~letter~~ CV but I did not have the time. This quote (or meme) is frequently attributed to Blaise Pascale in his  *[Lettres provinciales](https://en.wikipedia.org/wiki/Lettres_provinciales)* [@shorterletter] Public domain image by Gallica on Wikimedia Commons [w.wiki/3Uzn](https://w.wiki/3Uzn)
