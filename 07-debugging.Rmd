...
It is good practice to *triangulate* responses from your readers. For example, if three different people point out the same bug in your CV you know that the bug needs fixing. Such a bug is less likely to a result of bad advice from an opinionated but misguided reader.
