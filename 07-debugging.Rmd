...
(ref:captionfeynman) Richard Feynman once chalked “What I cannot create, I do not understand” on his blackboard at the [California Institute of Technology](California Institute of Technology) while teaching the [The Feynman Lectures on Physics](https://en.wikipedia.org/wiki/The_Feynman_Lectures_on_Physics). Creating things in personal side projects is a great way to build new knowledge and help your CV stand out like a sore thumb 👍. Public domain image via Dani Stefanovic [github.com/danistefanovic/build-your-own-x](https://github.com/danistefanovic/build-your-own-x)
...
1. **Why them?** Why are you applying to BigWidget
1. **Why that role?**  BigWidget employees have many roles and responsibilities, what is it about widget engineering that attracts you?
1. **Why you?** Why should they employ you, what makes you stand out from other widget engineering candidates? What is your Unique Selling Point (USP)?

### Does anyone actually read covering letters? {#elevatorpitch}
Some employers will read them very carefully, some less so.

Even if nobody reads your covering letter, it is still worth writing one because it forces you to rehearse standard interview questions shown above. See e.g. [www.careers.manchester.ac.uk/applicationsinterviews/cl/](https://www.careers.manchester.ac.uk/applicationsinterviews/cl/) for further information.
