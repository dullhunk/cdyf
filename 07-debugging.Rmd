...
1. ❎ **No `C.A.R.E.` No `story`** told for that skill. This makes for a very dull and boring read. Yawn. NEXT! 🥱
...
* **EVIDENCE**: Where evidence exists, you should point to it. It might be a certificate, a badge (see chapter \@ref(badging)) or the actual software itself
