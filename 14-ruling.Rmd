...
This rule is borrowed from software engineer Greg Wilson [\@gvwilson](https://github.com/gvwilson) in figure \@ref(fig:greg-wilson-fig), who probably adapted it from a quote frequently misattributed to President Theodore Roosevelt [@teddy].
...
(ref:captiongregwilson) “Start where you are, use what you have, help who you can.” —Greg Wilson at [third-bit.com](https://third-bit.com/) and [software-carpentry.org](https://software-carpentry.org/). CC BY Portrait of Greg Wilson by Chris Fournier on Wikimedia Commons [w.wiki/3Zy6](https://w.wiki/3Zy6)

When you're job hunting you can sometimes think that:

* “If I had a better, different degree from a different university, I'd do better...”
* “If I had more experience, more voluntary work, more internships, I'd stand a better chance...”
* “If I'd done more extra-curricular activities...” etc
...
Part of what you learn during your education is *how* to learn. But your learning shouldn't finish when you leave University. Computer science is a young and rapidly changing discipline which means you can not afford to be left behind. Never stop learning.
