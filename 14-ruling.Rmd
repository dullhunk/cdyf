...
```{r eval=knitr::is_html_output(excludes = "epub"), linkedin-tweet-fig, echo=FALSE, fig.cap = "test caption"}
library(tweetrmd)
include_tweet("https://twitter.com/dullhunk/status/1594641377060687873")
```
