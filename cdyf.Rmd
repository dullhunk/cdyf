...
* Thanks to [Jessica Wade](https://en.wikipedia.org/wiki/Jess_Wade) for inspiration
...
# Bothering with your future {#bothering}

The first half of this book is about designing your future. So before we get started, let's tackle a fundamental design issue. Why the hell would you want to bother with your future? Why should you bother with reading this pesky guidebook when you have so many other things on your plate right now:
...
You need this guidebook because it is different to all the other guidebooks! It will help you design, test, build, code and debug your future in computing. Come with me [down the rabbit-hole](https://www.gutenberg.org/files/11/11-h/11-h.htm#chap01) in Figure \@ref(fig:rabbit-fig) and let me explain... 🐇
...
<!--* What makes you happy? [@danpink; @autonomy]
* What is a SMART goal? ^[https://en.wikipedia.org/wiki/SMART_criteria]-->
...
```{r sad-fig, echo = FALSE, fig.align = "center", out.width = "99%", fig.cap = "Matthew Johnstone explains how he overcame the affects of depression, using the metaphor of the black dog [@youtube-blackdog]"}
knitr::include_graphics("images/youtube-blackdog.png")
```

### Drugs {#drugs}
Sometimes the drugs don't work, they just make you worse. [@drugsdontwork] Medication can help some people with their mental health. For example, when I was affected by depression, [selective serotonin reuptake inhibitors](https://www.nhs.uk/conditions/ssri-antidepressants/) (SSRIs) worked for me. But they don't for everybody.
...
* Designed and implemented the API which was built using a RESTful approach while pair programming with one other collaborator for two days at a hackathon
...
### Your context, action and result story {#carstar}
...
```{r oneortwopager-fig, echo = FALSE, fig.align = "center", out.width = "99%", fig.cap = "How long should your CV be? Should you write a two page European style CV or an American style resume (one pager)?"}
...
* Whose side are recruiters on, yours or somebody else?
...
```{r recruiter-fig, echo = FALSE, fig.align = "center", out.width = "99%", fig.cap = "(ref:captionbadrep)"}
knitr::include_graphics("images/beware of the recruiter.png")
```
(ref:captionbadrep) The auto-complete suggestions on Google tells you to beware of recruiters. How can they help you? Is it really true that recruiters are “shady”, “incompetent trash” who are “not your friends”? Why do recruiters have such a bad reputation? Screenshot from Google.-->
...
*(Neil is currently updating his CV)*
...
# Listening to your future {#listening}
