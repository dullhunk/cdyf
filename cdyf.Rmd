...
```
Hello and welcome to *Coding Your Future*, the guidebook that will help you to design, build, test and *code* your future in computing. Published at [cdyf.me](https://www.cdyf.me), [cdyf.pdf](https://www.cdyf.me/cdyf.pdf) & [cdyf.epub](https://www.cdyf.me/cdyf.epub), it is aimed at ALL students in higher education. Although this guide supports teaching at the University of Manchester, it doesn't actually matter:
...
1. [Surveying your future](bothering.html) discusses why you should bother reading any of this guidebook
...
1. [Actioning your future](actioning.html) gets you to think about your actions by emphasising verbs on your job applications
...
```
(ref:captiongoldengate) This guidebook will help you build bridges to your future. Picture of the iconic [Golden Gate Bridge](https://en.wikipedia.org/wiki/Golden_Gate_Bridge) in California adapted from an original by Frank Schulenburg (CC BY-SA) on Wikimedia Commons [w.wiki/37kY](https://w.wiki/37kY)
...
* Thanks to [Quintin Cutts](https://www.gla.ac.uk/schools/computing/staff/quintincutts/), [Steven Bradley](https://www.dur.ac.uk/research/directory/staff/?mode=staff&id=106), [Jane Waite](http://eecs.qmul.ac.uk/profiles/waitejanelisa.html) and [Nicola Looker](https://www.gla.ac.uk/pgrs/nicolalooker/) for helping me setup and run [SIGCSE journal club](https://sigcse.cs.manchester.ac.uk/). Thanks to all the [journal clubbers](https://sigcse.cs.manchester.ac.uk/who/) too, many of our journal club conversations have fed directly into the content of this guidebook
...
# Surveying your future {#bothering}
...
Likewise the [job hunting we describe in the chapter on searching](#searching) can take a heavy toll on your mental health because repeated rejection is an ordinary part of the process. It can be time consuming, stressful and demoralising. You may find your applications disappear into a black hole. They will be ghosted (ignored) by employers. Interviewers will blank you and refuse to give you meaningful feedback because they're too busy. This could happen multiple times. This is all *par for the course*, normal and expected, and is not necessarily a reflection on your abilities or potential. See the examples in the [coding interview section](#codinginterview). [@youtube-petia]
...
According to Stanford psychologist [Carol Dweck](https://en.wikipedia.org/wiki/Carol_Dweck) we can all be placed on a spectrum according to where we think our abilities come from. At one end, the fixed mindset assumes all kinds of abilities are fixed traits while at the other end, a growth mindset assumes these abilities can be developed over time. [@dweck] There is good evidence that adopting a growth mindset will make you a better learner who can cope with the inevitable failures and rejections in life better. This approach can be used in a range of different disciplines such as learning programming languages [@Cutts2010], music [@Davis2016] and job hunting.
...
What do they all have in common? They're all written in natural languages like the [English language](Ehttps://en.wikipedia.org/wiki/English_language), but without them, the software or hardware they describe and discuss would be useless.
...
Reading other people's code will improve your software engineering skills. Likewise, reading other peoples writing will improve your natural language engineering skills. Read anything, it might be novels, magazines, newspapers, stuff online or any of the books cited in the [references](reading.html). Find a time and place to do this every day and stick to it.
...
* IBM hosts the annual Call for Code [developer.ibm.com/callforcode](https://developer.ibm.com/callforcode) unlike other competitions, these have a [social responsibility](https://en.wikipedia.org/wiki/Social_responsibility) themes for the benefit of society at large
...
It's all very well *designing* your future but now you need to actually *build* and *test* it. An obvious place to start is with your CV, because that's where most people get going. How can you create a bug-free CV, resume or completed application form? How can you support applications with a strong personal statement or covering letter? These documents are your future so how can you debug your future? 🐛
...
* Describe the story[^most likely a collection of short stories] of your relevant experience, projects and education etc
...
1. **LENGTH**: Does it fit comfortably on (ideally) one page (for a Résumé) or two pages (for a CV)? See [your length](#length)
...
1. **SELLING**: You're trying to sell your services in a marketplace, for the best price you can get
...
As well as managing your manager, you need to manage yourself too. A good way to do this is to periodically reflect on your work. Your employer may have procedures to help you do this, such as one-to-ones with your manager on a regular basis. Whatever the setup, you will benefit from taking to to reflect on:
...
Briefly describe your roles and responsibilities. What projects have you worked on? What were the main technologies that you used?
...
Finding a job often involves moving to another city or even country. So a simple way to improve your job prospects is to [broaden and deepen your job search](finding.html) and [consider all the alternatives](broadening.html), geographically and otherwise.
