...
* *Coding your Future* (COMP2ARS and COMP2TUT) takes place every Monday at midday in semester 1, see [timetables.manchester.ac.uk](https://timetables.manchester.ac.uk/) for details, the only exception is in welcome week, see section \@ref(week0)
...
* *Either* COMP2CARS: Debug your CV (self study) using section \@ref(checklist) in *Debugging your future* (chapter \@ref(debugging))
...
* *Either* COMP2CARS: Debug your CV (self study) using section \@ref(checklist). Read *Debugging your future* (chapter \@ref(debugging)) and *Hacking your future* (chapter \@ref(hacking)):

## Week 3: Hacking and finding {#week3}   
**Monday 11th October** at midday:

* *Hacking your Future* and *Finding your future*. Lecture and workshop in MECD, see [timetables.manchester.ac.uk](https://timetables.manchester.ac.uk/). Read chapter \@ref(hacking) and \@ref(finding): What will your job search strategy be? How can you adapt and optimise your job search strategies?
...
* *Nurturing your future*, health, happiness, anxiety and depression. Lecture and workshop in MECD, see  [timetables.manchester.ac.uk](https://timetables.manchester.ac.uk/). Why should you take your mental and physical health more seriously? Read chapter \@ref(nurturing).

## Week 5: Knowing {#week5}  
**Monday 25th October** at midday:

* *Knowing your future* read chapter \@ref(knowing): How well do you know yourself? Lecture and workshop in MECD, see  [timetables.manchester.ac.uk](https://timetables.manchester.ac.uk/). What are your unique talents (superpowers) and where is your achilles heel (weakness)? What are you doing to improve both sets of skills?
...
* *Writing your future* part i of ii: Written communication in Computer Science. Lecture and workshop in MECD, see  [timetables.manchester.ac.uk](https://timetables.manchester.ac.uk/). Read chapter \@ref(writing) and [developers.google.com/tech-writing/one](https://developers.google.com/tech-writing/one)

## Week 8: Writing {#week8}  
**Monday 15th November** at midday:

* *Writing your future* part 2 of 2: Written communication in Computer Science. Lecture and workshop in MECD, see  [timetables.manchester.ac.uk](https://timetables.manchester.ac.uk/) Read chapter \@ref(writing) see [developers.google.com/tech-writing/one](https://developers.google.com/tech-writing/one)
...
* *Speaking your future* preparing for interviews. Lecture and workshop in MECD, see [timetables.manchester.ac.uk](https://timetables.manchester.ac.uk/). Preparing for both technical and non-technical interviews. Read chapter \@ref(speaking),
