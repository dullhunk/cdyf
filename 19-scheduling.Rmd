...
* A panel of students returning from industrial experience will share their stories of recruitment and employment, read *Experiencing your future* chapter \@ref(experiencing)

## Week Two {#week2}
Week starting 27th September: Depending on your when you meet your tutor

* *Either* COMP2CARS: read *Debugging your future* (chapter \@ref(debugging)) and *Hacking your future* (chapter \@ref(hacking)): CVs, Resumes and LinkedIn
...
* *Either* COMP2CARS: read *Debugging your future* (chapter \@ref(debugging)) and *Hacking your future* (chapter \@ref(hacking)): CVs, Resumes and LinkedIn (repeated session from last week for those that met their personal tutors last week)
...
* *Finding your future*, read chapter \@ref(finding): How can you adapt and optimise your job search strategies?
...
* *Nurturing your future*, health and happiness, read chapter \@ref(nurturing): mental and physical health, anxiety and depression

## Week Six {#week6}  
Week starting 25th October:

* *Knowing your future* read chapter \@ref(knowing)
...
* *Writing your future* part 1 of 2: read chapter \@ref(writing) and [developers.google.com/tech-writing/one](https://developers.google.com/tech-writing/one)

## Week Nine {#week9}  
Wee starting 15th November:

* *Writing your future* part 2 of 2: read chapter \@ref(writing) see [developers.google.com/tech-writing/one](https://developers.google.com/tech-writing/one)


## Week Ten {#week10}  
Week starting 22nd November:

* *Broadening your future* (read chapter \@ref(broadening)) and *Achieving your future* (read chapter \@ref(achieving))

## Week Eleven {#week11}  
Week starting 29th November:

* *Speaking your future* read chapter \@ref(speaking), preparing for interviews
