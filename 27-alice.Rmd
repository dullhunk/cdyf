...
```
(ref:captionromania) Romanian geography for beginners: Romania is a country located at the crossroads of Central, Eastern and Southeastern Europe shown in dark green here, looking a bit like a fish. Creative Commons [BY-SA](https://creativecommons.org/licenses/by-sa/3.0/deed.en) map of Romania by NuclearVacuum via Wikimedia Commons [w.wiki/6t8B](https://w.wiki/6t8B) adapted using the [Wikipedia App](https://apps.apple.com/us/app/wikipedia/id324715238) 🐟

You've got the [Black Sea](https://en.wikipedia.org/wiki/Black_Sea)? You've got [Bucharest](https://en.wikipedia.org/wiki/Bucharest) in the South. Are you from Bucharest or somewhere else? Right. So yeah. That's easy to locate then. 
