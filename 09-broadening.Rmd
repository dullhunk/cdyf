...
* Providing adequate food, water, shelter, energy, education and healthcare for a global population which is rapidly approaching [8 billion people](https://www.worldometers.info/world-population/)
...
* [Greener computing](https://en.wikipedia.org/wiki/Green_computing) [@greencomputing]
* Net zero computing [@netzero]
* [Smarter cities](https://en.wikipedia.org/wiki/Smart_city) which use resources more efficiently  [@smartercities]
* Technologies like [Alphafold](https://en.wikipedia.org/wiki/AlphaFold) could enable quicker and cheaper development of new vaccines and drugs [@Jumper2021]
