...
There are plenty of roles in computing working in research, either in computer science, or working alongside natural scientists, such as Physicists at CERN. There are also roles in [research software engineering](https://society-rse.org/), using software engineering practices in research applications. Some examples from the UK and Europe:

* CERN, see [careers.cern](https://careers.cern/) and [areers.cern/join-us/students](https://careers.cern/join-us/students)
* The Crick [crick.ac.uk](https://www.crick.ac.uk/) see [crick.ac.uk/careers-study/students](https://www.crick.ac.uk/careers-study/students)
* The [Daresbury Laboratory](https://stfc.ukri.org/about-us/where-we-work/daresbury-laboratory/)
* Diamond Light Source [www.diamond.ac.uk](https://www.diamond.ac.uk/) see [diamond.ac.uk/Careers/Students/Year-in-Industry.html](https://www.diamond.ac.uk/Careers/Students/Year-in-Industry.html)
* European Bioinformatics Institute [ebi.ac.uk](https://www.ebi.ac.uk/)
...
* MetOffice, see [metoffice.gov.uk/about-us/careers/apprentices-graduates-and-placements](https://www.metoffice.gov.uk/about-us/careers/apprentices-graduates-and-placements)
* Plymouth Marine Laboratory [pml.ac.uk](https://www.pml.ac.uk/) see [careers.pml.ac.uk](http://careers.pml.ac.uk/)
* Rutherford Appleton Laboratory [RAL](https://stfc.ukri.org/about-us/where-we-work/rutherford-appleton-laboratory/)
