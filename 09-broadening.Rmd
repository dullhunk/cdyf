...
* Ensuring algorithms benefit *everyone* in society, not just the (predominantly) old rich white men that control the [technocracy](https://en.wikipedia.org/wiki/Technocracy), see figure \@ref(fig:justice-fig)
