...
* Mitigating the effects of [climate change](https://en.wikipedia.org/wiki/Climate_change), see figure \@ref(fig:climate-fig)
* Tackling inequalities of wealth, income, race and gender [@stanley]
* Ensuring algorithms work for *everyone* in society, not just the (predominantly) old rich white men that control them, see figure \@ref(fig:justice-fig)
* Providing sufficient food, water, shelter, energy, education and healthcare for a global population which is rapidly approaching [8 billion people](https://www.worldometers.info/world-population/)
* Meeting all these goals [sustainably](https://en.wikipedia.org/wiki/Sustainability) and renewably without irreversibly depleting resources, both human resources and natural resources

```{r climate-fig, echo = FALSE, fig.align = "center", out.width = "100%", fig.cap = "(ref:captionclimate)"}
knitr::include_graphics("images/climate-change.jpeg")
```

(ref:captionclimate) The overwhelming scientific consensus is that our climate is changing more rapidly than we'd like. What can computing do to mitigate the effects of climate change? How could you use computing to address this, and other global grand challenges that the human race faces in the 21st century? CC BY-SA picture of temperature change in the last 50 years by NASA’s Scientific Visualisation Studio on Wikimedia Commons [w.wiki/4X5E](https://w.wiki/4X5E) adapted using the [Wikipedia App](https://apps.apple.com/gb/app/wikipedia/id324715238)
...
* Fairer algorithms: see [algorithmic bias](https://en.wikipedia.org/wiki/Algorithmic_bias) and figure \@ref(fig:justice-fig)
* Better education enabled by computing, both as a [subject in its own right](https://www.sigcse.org/), and as an enabler of the teaching and learning of everything else
* Scientific computing for the benefit of humanity, see section \@ref(rse). Creating better, cheaper and faster software and hardware for scientists and engineers:
    ...
    - Better healthcare, with [electronic health records](https://en.wikipedia.org/wiki/Electronic_health_record)s, [personal genomics](https://en.wikipedia.org/wiki/Personal_genomics) and better diagnostic tools
