...
1. Commit to Diversity \& Inclusion: value individual and cultural differences
1. Give back: serve communities generously with expertise, time and money


## Breakpoints {#bp9}
Look at these values, or choose the values of another employer you're interesteed in. Here are some [breakpoints](https://en.wikipedia.org/wiki/Breakpoint), pause your program and check these parameters and variables:
