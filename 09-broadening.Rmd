...
* Scientific computing for the benefit of humanity, see section \@ref(rse). Creating better, cheaper and faster software and hardware for scientists and engineers, for example:
    ...
    - Better healthcare, with [electronic health records](https://en.wikipedia.org/wiki/Electronic_health_record), [personal genomics](https://en.wikipedia.org/wiki/Personal_genomics) and better diagnostic tools
