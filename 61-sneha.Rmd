...
cat('<iframe data-testid="embed-iframe" style="border-radius:12px" src="https://open.spotify.com/embed/episode/3pnpxDsZsN4FV0kmojz3rF" width="100%" height="152" frameBorder="0" allowfullscreen="" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture" loading="lazy"></iframe>')
```
...
> I don't really tend to listen to many. But one podcast I do is rotten mango, see \@ref(fig:truecrime-fig). [@rottenmango] If you're into [true crime](https://en.wikipedia.org/wiki/True_crime) obviously dark topics, but she takes it from a psychological perspective and a legal perspective, all these different things, it's tied in a more lighthearted way.

```{r truecrime-fig, echo = FALSE, fig.align = "center", out.width = "100%", fig.cap = "(ref:captiontruecrime)"}
knitr::include_graphics("images/wikitruecrime.jpg")
```

(ref:captiontruecrime) [True crime](https://en.wikipedia.org/wiki/True_crime) a genre of non fiction dealing with violent crimes such as murders and serial killers, including high-profile cases. The [rottenmangopodcast.com](https://www.rottenmangopodcast.com/) is a popular true crime podcast. [@rottenmango] Public domain image a 1961 cover of _True Detective_ magazine from Wikimedia Commons [w.wiki/Ebrs](https://w.wiki/Ebrs) adapted using the [Wikipedia app](https://apps.apple.com/us/app/wikipedia/id324715238). ☠️ 🪓
...
```
(ref:captionidiots) 3 Idiots is a 2009 Indian Hindi-language coming-of-age comedy-drama film written, edited and directed by Rajkumar Hirani and co-written by Abhijat Joshi, with producer [Vidhu Vinod Chopra](https://en.wikipedia.org/wiki/Vidhu_Vinod_Chopra). [@threeidiots] [Fair use](https://en.wikipedia.org/wiki/Fair_use) image from Wikimedia Commons. 🇮🇳 
...
## Audio podcast on YouTube {#snehatube}

You can listen to this episode wherever you get your podcasts including Apple, Spotify, Amazon, YouTube and more, see section \@ref(subscribing) and figure \@ref(fig:sneha-vid)

```{r sneha-vid, echo = FALSE, fig.align = "center", out.width = "99%", fig.cap = "(ref:captionyoupodcast)"}
knitr::include_url('https://www.youtube.com/embed/xRg85UogoF4')
```
