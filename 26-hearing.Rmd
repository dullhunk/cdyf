...
This is a thought experiment, see figure \@ref(fig:vc-fig). Imagine that the [board of governors](https://www.manchester.ac.uk/discover/governance/structure/board-governors/) and [senate of the University of Manchester](https://www.manchester.ac.uk/discover/governance/structure/senate/) had appointed you (instead of [Duncan Ivison](https://en.wikipedia.org/wiki/Duncan_Ivison)) to succeed [Nancy Rothwell](https://en.wikipedia.org/wiki/Nancy_Rothwell) as Vice Chancellor. As VC, you now have responsibility for: 
...
(ref:captionvc) Professor [Nancy Rothwell](https://en.wikipedia.org/wiki/Nancy_Rothwell) served as Vice Chancellor (VC) of the University of Manchester from 2010 to 2024. If *you* were VC, what would you change about how teaching at the University? [CC BY](https://creativecommons.org/licenses/by/2.0/deed.en) portrait of Nancy Rothwell by Manchester University Maths on Wikimedia Commons [w.wiki/6WjS](https://w.wiki/6WjS) adapted using the [Wikipedia app](https://apps.apple.com/gb/app/wikipedia/id324715238)
