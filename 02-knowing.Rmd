...
... so you will need several different techniques to improve your self-awareness. Here are seven techniques to get your started:
...
You'll be lucky if you can find activities at the intersection of all four sets shown in Figure \@ref(fig:iki-fig). In practice, you may realistically only be able to achieve one, two (the `Passion`, `Mission`, `Profession` and `Vocation`) or three intersections. That said, it's still a valuable exercise to think about what is in each set for you.
