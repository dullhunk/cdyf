...
1. **EDUCATION**: Is your year of graduation, start date, degree program, University and expected (or achieved) degree classification clear? Is it in reverse chronological order with your `EDUCATION` first? Have you *summarised* what you are studying now, not just courses you have finished? See section \@ref(education)
1. **STRUCTURE**: Is the structure sensible? Is it in reverse chronological order? Are the most important (usually recent) things first? Recruiters at Google and TikTok suggest you have around five headings, see section \@ref(body)
...
1. **VERBS FIRST**: Have you talked about what you have actually done using  carefully chosen but prominent `verbs`, see chapter \@ref(verbalising)? Avoid long sections of [prose](https://en.wikipedia.org/wiki/Prose), see section \@ref(verbsfirst)
...
The `PROJECTS` section of your CV is where you can describe all your other activities, including any personal, voluntary, hackathon, freelance, professional or University projects.
...
triang_table <- tibble::tribble(
  ...
  "Recruiters & employers", "Used to reading lots of CVs, hiring people and managing staff",   "Might not know you that well personally, may be biased towards a particular sector or employer", 
...
Here are five suggestions to carry on debugging your two page CV and one page Résumé:
...
1. Triangulate all their responses, as described in section \@ref(triangulation)
...
The fourth step is important, so read your CV and re-read it. Write it and re-write it. Get as much feedback as you can. Most of your time writing is actually spent *re-writing*, see chapter \@ref(writing). 
