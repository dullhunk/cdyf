...
Once you've followed the steps described above:
...
... there's a fourth step which is to `repeat` the above. It's not an iteration if you only do it once, see figure \@ref(fig:iteration-fig).
