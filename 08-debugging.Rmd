...
It can be difficult to be **both** an *author* AND an *editor* of the same document, and your CV is no exception. This simple checklist to help you start to debug common known errors. For the *unknown* errors, you'll need help from someone (or something) else, see figure \@ref(fig:unknown-error-fig).
...
```
(ref:captionunknownerrors) This self-debugging checklist below will help you identify *known errors* in your CV. To debug the more challenging *unknown errors*, see section \@ref(cvswap). [CC BY-SA](https://creativecommons.org/licenses/by-sa/4.0/deed.en) screenshot of *something went wrong* by Revansx on Wikimedia Commons [w.wiki/9hZD](https://w.wiki/9hZD)
...
You should seek a wide variety of feedback on your CV from as many people as you are comfortable showing it too, this will help you “triangulate” all the feedback your CV, like the calculation shown in figure \@ref(fig:triangulation-fig).
