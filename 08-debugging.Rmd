...
Here are seven suggestions to carry on debugging your two page CV and one page Résumé:
...
1. Identify the holes in your `EXPERIENCE` or `PROJECTS` and think about how you might fill them, section \@ref(areuexperienced)
1. Audit your `SKILLS`, as described in section \@ref(personality)
