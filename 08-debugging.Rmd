...
1. 🔲 How does your CV compare to the examples in chapter \@ref(hacking). What is stronger or weaker about your CV than the examples? How could yours be improved?

## CV checklist: Peer-debugging {#cvswap}

Now that you've [self-assessed](https://en.wikipedia.org/wiki/Self-assessment) your CV, you should swap it with somebody and check each others work. This [peer assessment](https://en.wikipedia.org/wiki/Peer_assessment) is a two-way process so make sure you're both a giver and receiver of feedback, both will help you improve your CV: 
...
triang_table <- tibble::tribble(
  ...
  "Academics", "(ref:academentia)",   "May have limited experience of employment outside academia, might be used to reading and writing much longer academic CVs, e.g. ten pages instead of one or two [@academiccv]", 
...
(ref:wartsandall) They know you pretty well, warts and all see \@ref(fig:honest-fig)
...
(ref:worstcritic) It can be difficult to see your own faults, both on paper and in person, see section \@ref(checklist). There's a good chance you might be your own worst critic too. [@worstcritic]

```{r honest-fig, echo = FALSE, fig.show = "hold", out.width = "33%", fig.cap = "(ref:captionhonest)"}
knitr::include_graphics(rep("images/honest-frank-feedback.png", 3))
```

(ref:captionhonest) To improve your CV you want honest frank feedback on it. Frank isn't judging you, he is judging your CV. Honest feedback will see beyond good or bad and will tell you where you can improve, not just in what you've presented but also what's missing and what you need to focus on in the future to continue your professional development. So, who are the people who will give you honest feedback? [WANTED: Honest Frank Feedback](https://bryanmmathers.com/honest-frank-feedback/) artwork by [Visual Thinkery](https://visualthinkery.com/) is licensed under [CC-BY-ND](https://creativecommons.org/licenses/by-nd/4.0/) 🐝
