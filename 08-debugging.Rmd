...
1. 🔲 Is the formatting consistent, no random changes of font half-way through? Dates always in the same place? No [ugly `typewritery` underline used](https://practicaltypography.com/underlining.html), except perhaps for [hyperlinks](https://en.wikipedia.org/wiki/Hyperlink)? [@underlineno]. Have you avoided [goofy fonts](https://practicaltypography.com/goofy-fonts.html)? [@goofyfonts] 
