...
(ref:captionfledgling) Believing that feedback is only comments you receive from a teacher, employer or careers advisor disempowers you. Self assessing and peer assessing CVs empowers you to be independent on feedback from a single source. Image drawn by [Swanton Sketches](https://www.swantonsketches.co.uk/) and designed by [Jennifer Rose](https://research.manchester.ac.uk/en/persons/jennifer.rose) via the ITL conference [@itl2024]
