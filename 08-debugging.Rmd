...
1. **VERBS FIRST**: Have you talked about what you have actually done using  carefully chosen but prominent `verbs`, see chapter \@ref(verbalising)? Try to avoid long sections of [prose](https://en.wikipedia.org/wiki/Prose), see section \@ref(verbsfirst)
...
1. **SEE ALSO**: This is a quick checklist to get you started, see the longer CV checklist in section \@ref(checklist)
...
It's a good idea get feedback from as many different sources as you can on your CV. By *sources* I don't just mean humans, but also robots, see figure \@ref(fig:cvalgos-fig). Larger employers routinely use robotic [Applicant Tracking Systems](https://en.wikipedia.org/wiki/Applicant_tracking_system) (ATS) to log and trace your application and these are more likely to struggle with two column formats.
