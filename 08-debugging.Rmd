...
1. **NUMBERS**: Have you *quantified* the context, action, results and evidence of the short stories on your CV where possible? How convincing is your evidence, see figure \@ref(fig:black-vid) and (`C.A.R.E.`) in section \@ref(care)
...
1. **SEE ALSO**: This is a quick checklist to get you started, see the longer CV self-debugging checklist in section \@ref(checklist)
...
Unless you have a *significant* amount of `EXPERIENCE`, as a student or graduate the `EDUCATION` section of your CV should be the first “real” section, after the header. Since CV's are usually in reverse chronological order, the logical place to start is what you're doing now. Don't bury your education down the bottom or pretend you're not a student, there's nothing to ashamed of! You should be proud of it because your education is important, see figure \@ref(fig:blair-fig). Having said that, your description of it needs to summarise by striking a good balance between:
...
* `MISCELLANEOUS` yawn, if you can't decide what this section is about, how will your reader know
* `EXTRACURRICULAR` something like `PROJECTS` or `EXPERIENCE` might sound more interesting? 
* `RELEVANT...` if it wasn't relevant, why would it be on your CV?
* `HOBBIES` see figure \@ref(fig:quidditch-fig) 
* `INTERESTS` see figure \@ref(fig:quidditch-fig) 
...
These *seemingly* trivial typographical details like fonts and formatting all add up to make your CV look more professional. Neglect these details at your peril. Having a poorly formatted CV is like turning up to a job interview in your flip-flops and a t-shirt. Presentation matters. A [good template can take care of some of this stuff for you](https://latex4year1.netlify.app/cv). [@latex4year1]
...
1. 🔲 Have you expanded the more obscure acronyms or bombarded your reader with a barrage of [TLA](https://en.wikipedia.org/wiki/Three-letter_acronym)'s that they are probably not familiar with? 
...
1. 🔲 On your two page CV, does the page break fall in a sensible place or is it awkwardly truncating a section? On your one page Résumé, have you wasted any space by having one word taking up a whole line? Can you rephrase the sentence so it fits on one line rather than taking up two? Can you merge sections to save valuable space? See section \@ref(body)
