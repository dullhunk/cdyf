...
These titles all sound like dumping grounds for your leftovers, added as an afterthought. You might decide to have a dedicated `SKILLS` or `PERSONAL STATEMENT` section but see section \@ref(care) and \@ref(bullshit).
