...
### Your Body {#body}
Technical recruiters at Google and TikTok (see figure \@ref(fig:lopez-vid)) suggest you have just five sections in the body of your CV. Headings use lots of space so should be used carefully and precisely on every CV but especially on a one page résumé. Your sections should cover some or all of the following:
...
* `MISCELLANEOUS` or `OTHER...`: Yawn, if you don't really care (or know) what this section is about, why will your reader? 🥱
...
* `PROFILE`, `SUMMARY` or `PERSONAL STATEMENT`: These often fit better in a covering letter, where you tailor them to the job rather than writing a generic one-size-fits-all marketing spiel that just repeats information that's already on your CV anyway. See sections \@ref(covering-letters) and \@ref(bullshit)
...
While automation and AI can help improve your writing, ultimately there is no substitute for people (you know: actual *humans*) reading your CV, and the more people that read it the better. This could be potential employers, your critical friends shown in figure \@ref(fig:wonderfuldarling-fig) or just reading it **out loud** to yourself described in section \@ref(dogfooding).

Typos and spelling mistakes will distract your reader from the key messages you're trying to communicate. Instead of noticing all the great stuff you have to offer, your reader will notice the typos instead. There's good evidence to suggest that the number of typos in a CV are one of the strongest indicators of progression to the next round of application. [@typos]

```{r, eval=knitr::is_html_output(excludes = "epub"), results='asis', echo=FALSE}
cat('<iframe src="https://www.linkedin.com/embed/feed/update/urn:li:share:7392606438143062016" height="1421" width="504" frameborder="0" allowfullscreen="" title="Embedded post"></iframe>')
```
