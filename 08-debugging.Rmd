...
If you have anything else you want to highlight besides your `Education`, `Experience`, `Projects`, `Leadership and Awards` you *may* still have room for one more optional section. Try to come up with a better titles for this section than: 
...
## CV checklist: Self-debugging {#checklist}

Like [Atul Gawande](https://en.wikipedia.org/wiki/Atul_Gawande), I'm a believer in the power of simple checklists. [@checklist] So here is a quick self-assessment checklist for debugging your CV before you send it off to an employer or show it to me:
...
## CV checklist: Peer-debugging {#cvswap}

Now that you've [self-assessed](https://en.wikipedia.org/wiki/Self-assessment) your CV, you should swap it with somebody and check each others work. This [peer assessment](https://en.wikipedia.org/wiki/Peer_assessment) is a two-way process to help you [pair program](https://en.wikipedia.org/wiki/Pair_programming) your CV. Make sure you're both a giver and receiver of feedback, by playing both *driver* and *navigator* roles. Both will help you improve your CV: 
...
You should seek a wide variety of feedback on your CV from as many people as you are comfortable showing it too, this will help you “triangulate” your CV, like the calculation shown in figure \@ref(fig:triangulation-fig).
