...
(ref:captionfshaped) Employers are unlikely to actually *read* your CV in much depth, especially during a first glance. They are much more likely to be quickly *scanning* it in a hurry, a common pattern is F-shaped reading shown here. Putting the most important information first and leading with verbs (see chapter \@ref(verbalising)) will increase the chances that you'll get your key points across to your readers. [CC BY-NC](https://creativecommons.org/licenses/by-nc/4.0/) image by Jono Hey at [sketchplanations.com](https://sketchplanations.com) [@fshaped]
