...
It's all very well *designing* your future but now you need to actually engineer by building something. An obvious place to start is with your CV or résumé, because that's where most people start testing their designs. Just like with code, the hardest part isn't *writing* it but *debugging* and *rewriting* it, repeateldy. How can you create a bug-free CV, résumé or completed application form? How can you support applications with a strong personal statement or covering letter? These documents are a crucial part of your future so how can you debug them? 🕷
...
How you structure your CV and Résumé will depend on who you are and what your story is. Recruiters at Google suggest you have four or five sections, that follow a header section. Before we zoom in on those, let's look at some broader points about CVs and Résumés. Start by watching the short video shown in figure \@ref(fig:lopez-fig).
...
As Jonathan Black, director of the careers service at the University of Oxford points out in figure \@ref(fig:black-fig), there are three key things you want to demonstrate in your CV:
