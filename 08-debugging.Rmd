...
* University projects:
    ...
    + Be *careful* publishing coursework. If someone copies your coursework, you will **BOTH** be guilty of academic malpractice because you have colluded in plagiarism.
...
1. 🔲 Is your year of graduation, degree program, University and expected (and/or achieved) overall degree classification clear with GPA as a percentage? See section \@ref(mycved)
1. 🔲 Have you eaten your own dogfood (woof) by reading it out loud, see section \@ref(dogfooding)? Is *everything* relevant? e.g. no swimming certificates from ten years ago?
...
1. 🔲 Have you reviewed other people's CV's? This will put you in the shoes of an employer or recruiter, thereby helping you to write a better CV yourself, see figure \@ref(fig:cvswap-fig). See the examples in chapter \@ref(hacking). Who would *you* want to interview and why?
