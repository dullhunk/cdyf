...
You should include details of your high school education, *after* University so it's in reverse chronological order.Start with last set of exams you sat before University, bearing in mind that *some* employers screen job candidates by UCAS Tariff points. [@ucas;@pwcscraps] How far you go back will depend on how much space you have available, especially on a one pager. It is debateable how far you go back, exams that you sat aged ~16 (like GCSE's) aren't always needed. [@gcses]
