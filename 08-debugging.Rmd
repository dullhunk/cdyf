...
## CV checklist A: quick check {#quick}
Here are some common bugs (or are they features?) to pay attention to on initial draughts of your CV:
...
(ref:captionstorytime) Do you ❤️ tales? Your reader does too! On a short CV, you don't have time to give a blow-by-blow account as you gather round the camp fire, but you do need to give them the bare bones of your most important stories so the reader wants to find out more. Using numbers is a key part of that, alongside giving the `C`ontext, `A`ctions, `R`esults and `E`vidence (`C.A.R.E.`) we discuss in section \@ref(care). Storytime sketch by [Visual Thinkery](https://visualthinkery.com/) is licensed under [CC-BY-ND](https://creativecommons.org/licenses/by-nd/4.0/) 🔥
...
* [careerset.com](https://careerset.com), a free service provided by a UK based company, careerset Ltd. If you're a University of Manchester student, you can login using your Uni credentfials at [careerset.com/manchester](https://careerset.com/manchester)
...
It can be difficult to be **both** an *author* AND an *editor* of the same document, and your CV is no exception. We had a quick checklist in section \@ref(quick), this longer checklist below will help you start to self-debug known errors that you may have overlooked as an author. For the *unknown* errors, you'll need help from someone (or something) else who can play the role of editor, see figure \@ref(fig:unknown-error-fig).
...
## CV checklist E: Read, sleep, write, repeat... {#iterate}
So your next debugging steps should be:
