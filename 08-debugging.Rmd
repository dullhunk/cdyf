...
```md
* Worked in a team of six for four months to deliver a music app ... 
```

or just drop the boring `worked` altogether and pick a more interesting verb like:

```md
* Prototyped a music application in a team of six for four months ... 
```

The numbers (six people, four months etc) and other evidence are a key part of the story you want to tell potential employers. What's your story, coding glory? [@whatsthestory]
