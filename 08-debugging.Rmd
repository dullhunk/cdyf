...
You should seek a wide variety of feedback on your CV from as many people as you are comfortable showing it too. They'll probably all disagree and contradict each other, but you will be able to [triangulate](https://en.wikipedia.org/wiki/Triangulation) their feedback and draw your own conclusions. As a start, I'd suggest a *minimum* of three different sources, it's called *triangulation* for a reason. Some of the pros and cons of different angles of feedback are shown in table \@ref(tab:triangtable)
