...
* Bullet points with verbs first (see section \@ref(verbsfirst)) will:
  ...
  + avoid long sections of [flowery prose](https://en.wikipedia.org/wiki/Prose) which the reader will very probably skip anyway. Instead, you can use your beautiful prose to demonstrate your excellent written communication skills on your covering letters or personal statements instead, see section \@ref(we3qs)
