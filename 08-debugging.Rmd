...
* `RELEVANT...` if it wasn't *relevant*, why would it even be on your CV in the first place?
...
* `SUMMARY` or `PERSONAL STATEMENT` might fit better in a covering letter, see sections \@ref(covering-letters) and \@ref(bullshit)
