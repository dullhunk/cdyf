...
### Your optional extras: skills, hobbies, miscelleneous? {#misc}
...
## CV checklist: Self-assessment {#checklist}

Like [Atul Gawande](https://en.wikipedia.org/wiki/Atul_Gawande), I'm a believer in the power of simple checklists. [@checklist] So here is a quick checklist for debugging your CV before you send it off to an employer or show it to me:
...
## CV Checklist: Peer-assessment {#cvswap}

Now that you've self-assessed your CV, you should swap it with somebody and check each others work.
...
1. 🔲 Have you `triangulated` all the different feedback on your CV, because some of it is likely to be contradictory?
