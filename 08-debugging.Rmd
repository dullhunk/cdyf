...
(ref:captiongarbage)  “*If it's writing time, I write. I may write garbage, but you can always edit garbage. You can't edit a blank page*” --Jodi Picoult [@picoult] I often speak to students who tell me their CV isn't ready yet. Just as you can't edit a blank page, you can't debug an unwritten (or unseen) CV either. So write something, *anything*. Even if you *think* its garbage you won't be able to improve it until you've written it. You can't start a fire without a spark, even if we're just [dancing in the dark](https://en.wikipedia.org/wiki/Dancing_in_the_Dark_(Bruce_Springsteen_song)). [@springsteen1; @springsteen2] Likewise, if you're doing a CV swap <!--needs link to pic--> - go easy on the writer, you'll often be treading on delicate and personal ground. Public domain portrait of novelist [Jodi Picoult](https://en.wikipedia.org/wiki/Jodi_Picoult) by Lauren Gerson via the U.S. National Archives on Wikimedia Commons [w.wiki/6i4E](https://w.wiki/6i4E) adapted using the [Wikipedia app](https://apps.apple.com/us/app/wikipedia/id324715238)
