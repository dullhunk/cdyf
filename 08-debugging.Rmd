...
triang_table <- tibble::tribble(
  ...
  "Friends & family", "They know you pretty well, warts and all",   "(ref:notcritical)", 
  ...
  "Peers", "Your fellow students know you, you Uni and course pretty well",   "Probably never had to hire or manage anyone (yet), so limited knowledge of recruitment", 
...
(ref:notcritical) Might not be critical enough, see figure \@ref(fig:wonderfuldarling-fig)
...
So, review the feedback you've got from your peers, academics, friends, family, recruiters, robots and careers service staff. With all those different viewpoints from different angles, you should be able to find the point that you judge to be best for you.
