...
By now, you should have completed three of the four steps below:

1. Self-debugged, as described section \@ref(checklist)
1. Peer-debugged, as described in section \@ref(cvswap)
1. Triangulated, as described in section \@ref(triangulation)
...
The fourth step is important, so read your CV and re-read it. Write it and re-write it. Get as much feedback as you can. Read, sleep, write, repeat... 
