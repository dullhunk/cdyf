...
Here are some common bugs (or are they features?) to pay attention to on the initial drafts of your CV:
...
1. **STRUCTURE**: Is the structure sensible? Is it in reverse chronological order? Are the most important (usually recent) things first? Recruiters at Google and TikTok suggest you have have around five headings, see section \@ref(structure)
...
1. **VERBS FIRST**: Have you talked about what you have actually done using  carefully chosen by prominent `verbs`, see chapter \@ref(verbalising)? Avoid long sections of [prose](https://en.wikipedia.org/wiki/Prose), see section \@ref(verbsfirst)
