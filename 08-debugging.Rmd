...
How you structure your CV and Résumé will depend on who you are and what your story is. It can be tricky deciding what the headings should be and what you put in each section. Recruiters at Google suggest you have just four or five sections, that follow a header section. Before we zoom in on those, let's look at some broader points about CVs and Résumés. Start by watching the short videos shown in figure \@ref(fig:lopez-vid) and \@ref(fig:black-vid).
...
Besides being structured well, as described in \@ref(fig:lopez-vid) and later in section \@ref(body), your CV also needs to persuade the reader that you have some fundamental attributes. [Jonathan Black](https://www.linkedin.com/in/jonathanblack/), director of the careers service at the University of Oxford and columnist [ft.com/dear-jonathan](https://www.ft.com/dear-jonathan) points out in figure \@ref(fig:black-vid), there are three key things you want to demonstrate in your CV:

1. that you can take responsibility
1. that you achieve things
1. that you are good company (or at least a valued team member)

How will you demonstrate and provide evidence of each of these traits? 
...
### Your body {#body}
Technical recruiters at Google and TikTok (see figure \@ref(fig:lopez-vid)) suggest you have just five sections in the body of your CV. Headings use lots of space so should be used carefully. Your five sections should cover some or all of the following:
