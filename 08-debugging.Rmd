...
1. **NUMBERS**: Have you *quantified* the context, action, results and evidence of the short stories on your CV where possible? How convincing is your evidence? Are your assertions vague & meaningless or are they backed up with convincing details? Look for numbers and percentages on your CV, instead of vague statements like large, big, small, etc see figure \@ref(fig:black-vid) and (`C.A.R.E.`) in section \@ref(care)
