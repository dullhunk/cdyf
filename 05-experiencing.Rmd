...
If you're looking for a project to get stuck into, here are [Diomidis Spinellis](Dhttps://en.wikipedia.org/wiki/Diomidis_Spinellis) tips for getting started [@Spinellis]:

1. Choose a project with several active contributors, so that there is a community to help you
1. Choose a relatively popular project (with some GitHub stars) so that you can avoid abandoned software but...
1. ... Avoid “blockbuster”  projects like [tensorflow](https://github.com/tensorflow) or [vscode](https://github.com/microsoft/vscode) , so that your contributions will not get lost in the noise
