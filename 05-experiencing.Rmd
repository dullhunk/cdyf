...
It's easier than you might think to get a big name on your CV shown in figure \@ref(fig:bigname-fig). Many large employers run spring insight programmes, that typically run for one or two weeks during Easter. These are often aimed at first years, and are sometimes less competitive to get into than a longer term commitment such as a summer internship or year-long placement. A big name, can really help your CV stand out, see
...
Other ways to get a big name on your CV include joining a big name competition:

*  Google has #HashCode [codingcompetitions.withgoogle.com/hashcode/](https://codingcompetitions.withgoogle.com/hashcode/) and Summer of Code [summerofcode.withgoogle.com](https://summerofcode.withgoogle.com/)
* Facebook has [facebook.com/hackathon](https://en-gb.facebook.com/hackathon)
* Microsoft hosts the Imagine Cup [imaginecup.microsoft.com](https://imaginecup.microsoft.com/)
* there are many others like it listed at [devpost.com](https://devpost.com)
