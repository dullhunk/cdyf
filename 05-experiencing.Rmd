...
You may already have experience of paid employment as a casual or unskilled worker. This could include jobs such as waiting tables, serving in a bar or working in the retail, for example as a Saturday job. It is important to recognise that these jobs have value. Many students make the mistake of overlooking their casual work experience because they disregard it as non-technical or un-skilled. In the section on [structuring your CV](#mycvst), [@topnotchcv] one of the stories you want to tell in your job applications is that you:

1. take responsibility
1. achieve things
1. are nice to have around

Doing casual work can demonstrate all of these things. For example, from the ages of 11 to 18 I was a [paperboy](https://en.wikipedia.org/wiki/Paperboy) like the one shown in figure \@ref(fig:paperboy-fig), except I delivered newspapers directly to the doors of paying customers every morning. This is obviously not a skilled job, but it does demonstrate:

1. work ethic: getting up early *every* morning, just turning up!
...
```
(ref:captionpaperboy) Don't discount the value of casual or unskilled work on your CV. I used to be a paperboy, delivering newspapers door to door to paying customers. This demonstrates reliability and work ethic, because I did this in all weathers (sun, wind, rain, snow, hangovers etc) for a long period of time. Picture of the “Titanic paperboy”, Ned Parfett selling newspapers in London via Wikimedia Commons at [w.wiki/35HA](https://w.wiki/35HA)

If you have experience of working in retail, such as serving customers in a supermarket, this also demonstrates your ability to provide good customer service and work as part of a team. This is the “nice to have around” bit that Jonathan Black refers to [@topnotchcv] and is something your formal education will not typically provide any evidence of. So don't fall into the trap of discounting the value of casual or unskilled labour.
