...
Attending [Hackathons](https://en.wikipedia.org/wiki/Hackathon) is another way to learn by tinkering, in a collaborative and social environment, see figure \@ref(fig:hackathon-fig). The word hackathon is a portmanteau of [hacking](https://en.wikipedia.org/wiki/Hacker_culture) and [marathon](https://en.wikipedia.org/wiki/Marathon), so hackathons tend to be short but intense, see for example:
