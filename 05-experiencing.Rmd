...
You may already have experience of paid employment as a casual or part-time work. This could include jobs such as waiting tables, serving in a bar or working in the retail, for example as a Saturday job.
...
```
(ref:captionpaperboy) Don't discount the value of casual or part-time work on your CV. From the age of 11, I used to be a paperboy, delivering newspapers door to door to paying customers. This demonstrates reliability and work ethic, because I did this in all weathers (sun, wind, rain, snow, hangovers^[I just need to clarify that the hangovers didn't start until I was much older] etc) for a long period of time. Seven years, man and boy! Public domain image of the “Titanic paperboy”, Ned Parfett selling newspapers in London via Wikimedia Commons at [w.wiki/35HA](https://w.wiki/35HA)
...
Doing casual work can demonstrate all of these things. For example, from the ages of 11 to 18 I was a [paperboy](https://en.wikipedia.org/wiki/Paperboy) like the one shown in figure \@ref(fig:paperboy-fig), except I delivered newspapers directly to the doors of paying customers every morning rather than selling them in the street. This was not a particularly high skilled job, but it *does* demonstrate:

1. work ethic: getting up early *every* morning (including Saturdays). Sometimes work is about just turning up!
