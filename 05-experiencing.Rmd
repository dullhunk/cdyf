...
You might be wondering which length of experience is better, a short summer internship or year-long industrial placemnt (aka co-op). [@kaplong] Table \@ref(tab:interntable) summarises some of the advantages and disadvantages of each kind of experience:
