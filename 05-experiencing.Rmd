...
Attending [Hackathons](https://en.wikipedia.org/wiki/Hackathon) is another way to learn and gain `experience` by tinkering, in a collaborative and social environment, see figure \@ref(fig:hackathon-fig). The word hackathon is a portmanteau of hacking from [hacker culture](https://en.wikipedia.org/wiki/Hacker_culture) (not [security hacking](https://en.wikipedia.org/wiki/Security_hacker)] and [marathon](https://en.wikipedia.org/wiki/Marathon), so hackathons tend to be short but intense, see for example:
