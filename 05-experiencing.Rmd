...
It's easier than you might think to get a big name on your CV shown in figure \@ref(fig:bigname-fig). Many large employers run spring insight programmes, that typically run for one or two weeks during Easter. These are often aimed at first years, and are sometimes less competitive to get into than a longer term commitment such as a summer internship or year-long placement. A big name on your CV can help it stand out, as fluff bucket demonstrates on their CV shown in \@ref(fig:bigname-fig)
