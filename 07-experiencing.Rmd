...
* [Outreachy.org](https://www.outreachy.org/) provides internships for people subject to systemic bias and underrepresentation in the technical industry where they are living, and is backed by big employers.
...
The overwhelming majority of former Computer Science students I know that work in [Big Tech](https://en.wikipedia.org/wiki/Big_Tech) or [ “blue chip” companies](https://en.wikipedia.org/wiki/Blue_chip_(stock_market)) did so *after* working for a much smaller employer first. 
