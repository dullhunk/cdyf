...
intern_table <- tibble::tribble(
    ~ "Duration"                        , ~ "Pros",      ~ "Cons",
  "**Summer**"    , "You won't pay tuition fees to your University",        "You get less time to make a good impression and learn new skills",
  ""     , "You graduate sooner",      "Some employers don't offer summer internships, and only do year long placements",
  "**12 months**"    , "You get more time to make a good impression and learn more",      " You graduate later, after four years of study rather than three^[this might also be an advantage if demand if the economy is in recession]",
