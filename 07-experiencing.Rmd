...
The overwhelming majority of former Computer Science students I know that work in [Big Tech](https://en.wikipedia.org/wiki/Big_Tech) or [Blue Chip employers](https://en.wikipedia.org/wiki/Blue_chip_(stock_market)) did so *after* working for a much smaller employer first. 
