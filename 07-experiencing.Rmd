...
jobterm_table <- tibble::tribble(
  ...
  "Voluntary", "Unpaid, both in technical and non-technical roles for charity or nonprofit organisation e.g. in Manchester see [find-volunteering.manchester.ac.uk](https://find-volunteering.manchester.ac.uk/)",
  "Social", "Unpaid, participating in a club or society e.g. students union, sport etc e.g. in Manchester see [manchesterstudentsunion.com](https://manchesterstudentsunion.com/)",
...
intern_table <- tibble::tribble(
    ~ ""                        , ~ "Pros",      ~ "Cons",
  "Summer-long internship"    , "You won't pay tuition fees to your University",        "You get less time to make a good impression and learn new skills",
  " "     , "You graduate sooner",      "Some employers don't offer summer internships, and only do year long placements",
  "Year-long placement"    , "You get more time to make a good impression and learn more",      " You graduate later, after four years of study rather than three^[this might also be an advantage if demand if the economy is in recession]",
    " "    , "Some employers offer two sixth-month rotations, thereby giving you a wider variety of experience",      "You will have to pay tuition fees if industrial experience is a part of your degree^[See for example [https://www.studentsupport.manchester.ac.uk/finances/tuition-fees/fee-amounts/other-fees/](https://www.studentsupport.manchester.ac.uk/finances/tuition-fees/fee-amounts/other-fees/)]",
    " "    , "In the UK, there tend to be more placements available than internships, though it depends on the sector and location",      "If you hold a [student visa](https://www.gov.uk/student-visa) and [biometric residence permit](https://www.gov.uk/biometric-residence-permits) (BRP) and you need to transfer from a three year course onto a four year one in order to do a placement, you will need to extend your visa and update your BRP. This can take time and money.",
  " "     , "Unless are employed in the same location as where you studied, you will spend less time with the cohort of students in your year group that aren't doing a placement ",      "Some employers don't offer year long placements, and only have summer internships",

)
knitr::kable(intern_table, caption = "Some pros and cons of a summer internship vs. a year-long placement ", booktabs = TRUE)
```
...
1. **Tinkering**: having side projects as a playground to help you learn new skills and knowledge, either solo or collaboratively see section \@ref(tinkering). For more competitive employers, side projects are likely to be more important. To get into ultra-competitive industries like gaming, candidates are often expected to have a portfolio of one or two games developed outside of University
...
* See also [github.com/codecrafters-io/build-your-own-x](https://github.com/codecrafters-io/build-your-own-x) and [online.coolestprojects.org](https://online.coolestprojects.org/) for inspiration
...
```
(ref:captionhackathon) Hackathons are collaborative social events where you can learn how to rapidly prototype ideas in a friendly and supportive environment. Picture of participants at a Wikimedia Hackathon in Prague by [Chris Koerner](https://en.wikipedia.org/wiki/User:Ckoerner) on Wikimedia Commons [w.wiki/5rjR](https://w.wiki/5rjR) adapted using the [Wikipedia app](https://apps.apple.com/us/app/wikipedia/id324715238).
...
Side projects like these help to distinguish you from your peers, but they don't *have* to be technical, see section \@ref(casual) and \@ref(volunteering). You might feel that you are too busy to do any side projects, but if working hard on academic study and getting top grades means that you:
