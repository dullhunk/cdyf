...
There's at two kinds solutions to this problem, that involve [dogfooding](#dogfooding):

1. Eat your own dogfood, we've already talked about in section \@ref(dogfooding), this means reading your own written work ALOUD <!--self assess using the rubric-->
1. Eat somebody elses dogfood
    - Debug a friends or peers CV by swapping with them and giving them constructive feedback
    - Debug the fictitious CVs below by ranking them against a job advert
