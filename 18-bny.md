...
Graduating this year? Our friends at [BNY.com](https://www.bny.com) in Manchester are recruiting graduate data scientists. If you have expertise in AI, machine learning, [feature engineering](https://en.wikipedia.org/wiki/Feature_engineering), analytics, mathematics, statistics and distributed computing read on.

```{r bny-fig, echo = FALSE, fig.align = "center", out.width = "100%", fig.cap = "(ref:captionbny)"}
knitr::include_graphics("images/bny.jpg")
```

(ref:captionbny) [BNY.com](https://www.bny.com) is an American international financial services company headquartered in New York City. Founded in 1784 by a group that included [Alexander Hamilton](https://en.wikipedia.org/wiki/Alexander_Hamilton), BNY is one of the three oldest banks in the United States. CC licensed image of BNY offices from [en.wikipedia.org/wiki/BNY](https://en.wikipedia.org/wiki/BNY)  made with the [Wikipedia App](https://apps.apple.com/us/app/wikipedia/id324715238) 🗽🇺🇸


## BNY Analyst Program – Engineering (Data Science) 
...
* Enrollment in an undergraduate degree program with a strong focus on computer science or technology-related majors preferred
...
## BNY Benefits and Rewards {#benefits}
...
Interested? Email your [debugged](https://www.cdyf.me/debugging) CV / Resume and [covering letter](https://www.cdyf.me/debugging#covering-letters) to Sarah Raza, senior recruiter at BNY in Manchester: [linkedin.com/in/sarahraza123](https://www.linkedin.com/in/sarahraza123/), email `firstname.lastname@bny.com` where `firstname` $=$ `sarah` and `lastname` $=$ `raza`