...
You are in a lifelong learning loop, a [`while` loop](https://en.wikipedia.org/wiki/While_loop) in which you continually develop new skills and knowledge. As you loop the loop, you will collect evidence of your personal and professional achievements. Some of these achievements can be certified or “badged” in various ways. This evidence can be collected as part of your professional identity and reputation, the jar called `ME` in figure \@ref(fig:while-learning-fig).
