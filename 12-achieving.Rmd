...
Learning is a life-long process, a [`while` loop](https://en.wikipedia.org/wiki/While_loop) in which you continuously develop new skills and knowledge. As you loop the loop, you will collect evidence of your personal and professional achievements. Some of these achievements can be certified or “badged” in various ways. This evidence can be collected as part of your professional identity and reputation, the jar called `ME` in figure \@ref(fig:while-learning-fig).
...
```
(ref:captionfinegrain) What kind of picture are you trying to paint of your professional and personal achievements? [Open Badges paint a better picture…](https://bryanmmathers.com/open-badges-paint-a-better-picture/)  by [Visual Thinkery](https://visualthinkery.com/) is licenced under [CC-BY-ND](https://creativecommons.org/licenses/by-nd/4.0/)
...
Digital badges provide a solution to this problem, just like your degree certificate is a verified badge of your achievements, a digital badge does the same but in a more detailed way. Rather than being physical, a digital badge is virtual and transferable. It's just a `*.png` graphic file which has been digitally signed and contains metadata. This means it can be displayed on your CV, on social media or “stacked” into a digital portfolio collection as shown in figure \@ref(fig:badge-properties-fig).
...
```
(ref:captiondatainside) Looking inside an open digital badge. [There's data inside open badges](https://bryanmmathers.com/open-badges-data-inside/) by [Visual Thinkery](https://visualthinkery.com/) is licenced under [CC-BY-ND](https://creativecommons.org/licenses/by-nd/4.0/) for the [City and Guilds of London Institute](https://en.wikipedia.org/wiki/City_and_Guilds_of_London_Institute)
...
<!--
* What are badges
* What are we doing with them: providing badges for things they are doing already (e.g. PASS leader)
...
* Certificates edx.org [cs50.harvard.edu/x/2020/certificate](https://cs50.harvard.edu/x/2020/certificate/)
...
(ref:captionamazonbadge) An example of an [Amazon Web Services](https://en.wikipedia.org/wiki/Amazon_Web_Services) badge awarded by [credly.com](https://info.credly.com/) to an [AWS certified developer](https://www.credly.com/org/amazon-web-services/badge/aws-certified-developer-associate).
