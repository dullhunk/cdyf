...
We are all in a lifelong learning loop. We are all in a [`while` loop](https://en.wikipedia.org/wiki/While_loop), continually developing new skills and knowledge as we go. As you loop your own personal loop, you will collect evidence of your personal and professional achievements. Some of these achievements can be certified or “badged” in various ways. This evidence can be collected as part of your professional identity and reputation, the jar called `ME` in figure \@ref(fig:while-learning-fig).
...
Evidence is a key part of your “Context, Action, Result and Evidence” (`C.A.R.E.`) story described in section \@ref(care). So what evidence can you collect and how you can certify or badge these credentials, sometimes known as micro-credentials? 📛  [@microc]
