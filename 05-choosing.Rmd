...
Your future is full of possibilities, but what is possible? What opportunities are available to you as a student of computing? How will you choose which ones are best for you personally? When thinking about your future, are you a *default user* or  *weird edge case* pictured in figure \@ref(fig:default-user-fig)?  
...
(ref:captiondefaultuser) Are you a weird edge case or a default user? What are your options beyond a default graduate scheme with big [blue-chip multinational](https://en.wikipedia.org/wiki/Blue_chip_(stock_market)) employer? [Default user](https://bryanmmathers.com/default-user/) by [Visual Thinkery](https://visualthinkery.com) is licensed under [CC-BY-ND](https://creativecommons.org/licenses/by-nd/4.0/)

Perhaps you're a weird edge case. Perhaps typical graduate destinations such as large multi-national corporations, not really make you want to *[Shake Your Thang](https://en.wikipedia.org/wiki/Shake_Your_Thang)*? [@saltnpepa] Perhaps you are more interested in:
...
Your future is bright, your future needs choosing. Choosing your future is designing your future. Designing your future is coding your future. 
