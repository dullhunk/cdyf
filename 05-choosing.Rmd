...
Your future is full of exciting new possibilities, but which ones will you choose? What are all these intriguing possibilities for students of computing? How will you choose which ones are best for *you*? When choosing your future, will you opt for the `default user` path or decide on the `weird edge case` path pictured in figure \@ref(fig:default-user-fig)?  
