...
> SpiNNaker 3 is still at the conceptual stage. But Dreseden has, has spun out a company called to [SpiNNcloud.com](https://spinncloud.com/) systems [GmbH](https://en.wikipedia.org/wiki/Gesellschaft_mit_beschr%C3%A4nkter_Haftung) to commercialise SpiNNaker 2 and the expectation is that in fact, commercialisation starts moving there, and they'll want a SpiNNkaer 3 to follow on.
...
Shortly after this podcast was published Duncan Ivison was appointed VC to succeed [Nancy Rothwell](https://en.wikipedia.org/wiki/Nancy_Rothwell)'s fourteen years of service in 2024 [@duncanivison]
...
(ref:captionchipwar) One, two, three, four, I declare a **CHIP WAR**. Chris Miller's book: [Chip War: The Fight for the World's Most Critical Technology](https://en.wikipedia.org/wiki/Chip_War:_The_Fight_for_the_World%27s_Most_Critical_Technology) describes the transformation of semiconductors from relatively obscure electronics to an essential component of daily life. [@chipwar] Fair use image from Wikimedia Commons [w.wiki/8Ro9](https://w.wiki/8Ro9) 

So where's next for the microchip? As we reach the limits subatomic scale engineering, will Moore's law still hold or breakdown? [@endofmooreslaw] 

It seems like we're always going to want more computing power, but where is it going to come from?
