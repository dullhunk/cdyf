...
So we're calling this *FurbyFest* (working title) so we look forward to seeing you at that and enjoy your your retirement. 
...
The ARM1 (shown bottom left in red in figure \@ref(fig:moores-law-fig)) had **25,000** transistors, compared to the **39.5 billion** transistors in AMD [Epyc](https://en.wikipedia.org/wiki/Epyc) (shown top right in red in figure \@ref(fig:moores-law-fig)) manufactured by the [Taiwan Semiconductor Manufacturing Company](https://en.wikipedia.org/wiki/TSMC) (TSMC).
...
Wherever they are designed and whoever designs them, the manufacture of chips lies at the heart of the global economy, see \@ref(fig:silicon-supremacy-vid). The United States is bidding to regain a leading role in advanced chip manufacturing, to de-risk critical supply chains, and to combat China's rise as a technological superpower. The results of this remain to be seen. 
...
In a short space of time, the chip has gone from relatively obscure electronics, to something countries fight various kinds of wars over, see figure \@ref(fig:chipwar-fig). Chips are at the heart of US-China tensions for example. [@chipwar]
...
So where's next for the microchip?