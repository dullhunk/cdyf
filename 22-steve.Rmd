...
(ref:captionheathvid) Wiring up the 103,680 core SpiNNaker 10⁵ Machine as a [toroidal mesh](https://en.wikipedia.org/wiki/Toroid). This 1.5 minute video by Jonathan Heathcote, a former PhD student supervised by Steve [@heathcotephd], can also be watched at [youtu.be/V3MlOAru6Qk](https://youtu.be/mcBB2o7Bmwc). [@heathcotevid]
