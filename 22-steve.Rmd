...
(ref:captionfurbass) *He's all about that bass, 'bout the bass, no treble* [@allaboutthatbass] CC BY-SA Picture of Steve Furber as guest bassist for *The Suits* at the BBC Micro 30th anniversary in 2012 by Trevor Johnson on Wikimedia Commons [w.wiki/8YYg](https://w.wiki/8YYg) 
...
In a short space of time, just fifty years, the humble chip has gone from relatively obscure electronics, to something we fight battles over, see figure \@ref(fig:chipwar-fig). Chips are at the heart of US-China tensions for example. [@chipwar]
...
So where's next for the microchip? As we reach the limits subatomic scale engineering, will Moore's law still hold or breakdown? [@endofmooreslaw] It seems like we're always going to want more computing power, but where is it going to come from?
