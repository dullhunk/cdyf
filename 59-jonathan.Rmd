...
Meet Jonathan Cowling, see figure \@ref(fig:jonathan-fig), he graduated with a Bachelor of Science degree in Computer Science with Industrial Experience in 2020. Jonathan spent a year in industry working at [MoneySuperMarket.com](https://www.moneysupermarket.com/), before moving to [infinityworks.com](https://www.infinityworks.com/) as a graduate. Shortly after this interview was recorded in 2022, he moved to [equalexperts.com](https://www.equalexperts.com/).
...
cat('<iframe data-testid="embed-iframe" style="border-radius:12px" src="https://open.spotify.com/embed/episode/5e3P6Bl738OJacQNbeX6ig" width="100%" height="152" frameBorder="0" allowfullscreen="" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture" loading="lazy"></iframe>')
```
...
> Jonathan: at college, I studied engineering. I went to a [University  Technical College](https://en.wikipedia.org/wiki/University_technical_college) (UTC, see figure \@ref(fig:utc-fig)). 

```{r utc-fig, echo = FALSE, fig.align = "center", out.width = "100%", fig.cap = "(ref:captionutc)"}
knitr::include_graphics("images/utc.jpeg")
```

(ref:captionutc) A [University Technical College](https://en.wikipedia.org/wiki/University_technical_college) (UTC) is a type of specialist secondary school in England that is led by a sponsor university and has close ties to local business and industry. CC [BY-SA](https://creativecommons.org/licenses/by-sa/2.0/deed.en) picture of UTC Wigan by Dave Green via [geograph.org.uk](https://www.geograph.org.uk/) and Wikimedia Commons [w.wiki/_wCj2](https://w.wiki/_wCj2) adapted using the [Wikipedia App](https://apps.apple.com/us/app/wikipedia/id324715238)

Right is that the one in Salford? ([UTC Media City](https://en.wikipedia.org/wiki/Aldridge_UTC@MediaCityUK))

> Jonathan: So the one I went to was in [Oldham](https://en.wikipedia.org/wiki/Oldham), it's now closed down. I think the students they were targeting wasn't quite what they were they're after because University Technical Colleges target years 10 and 11, and then in college 12 and 13. And it just didn't quite work for them with the years 10 in 11 and it made it very difficult for them to run the college. 
...
knitr::include_graphics("images/herplusdatamanchester.jpeg")
```

(ref:captionherdatamcr) Meetups, like HER+DATA MCR, are regular events where communities meetup to discuss topics of shared interest. Speakers are often invited with free food and drink on offer afterwards to facilitate networking. Meetups are a great way to find out what's going on a particular field of technology while building your professional network. You'll often find them advertised on websites like meetup.com and eventbrite.com. The picture shows a screenshot from [meetup.com/herplusdatamcr](https://www.meetup.com/herplusdatamcr/)
...
(ref:captioninfinityworks) [infinityworks.com](https://www.infinityworks.com/) are a digital transformation and engineering consultancy that was acquired by [Accenture](https://en.wikipedia.org/wiki/Accenture) in 2021. Creative Commons [BY-SA](https://creativecommons.org/licenses/by-sa/3.0/deed.en) picture of Accenture offices in Grand Canal Square, London by William Murphy on Wikimedia Commons [w.wiki/6qKC](https://w.wiki/6qKC) adapted using the [Wikipedia App](https://apps.apple.com/us/app/wikipedia/id324715238)
...
> Jonathan: So it's a weird one for me. So I've got [Crohn's disease](https://en.wikipedia.org/wiki/Crohn%27s_disease). I've had Crohn's since I was as I was 10. University is a relatively stressful thing because it's a lot of work at the end of the day. My Crohn's was especially difficult around then
...
> Jonathan: For a tune, I'm gonna go for [Misery Business](https://en.wikipedia.org/wiki/Misery_Business) [@miserybusiness] by [Paramore](https://en.wikipedia.org/wiki/Paramore), see figure \@ref(fig:misery-business-fig). My music tastes haven't changed much since the middle of high school. I've no problem admitting that and its songs like that meant a lot as everyone, you know, is going through quite difficult times. It will be no surprise to most people that are getting involved in computer science, you know, I was bullied at school that happens, you know and I think university students probably more than most will have experienced that as well. And so it was it was music that really helped me get through high school and I still listen to it now because I enjoy it.
...
(ref:miserybusiness) Misery Business is a song by American rock band Paramore from their second studio album *Riot!* [@miserybusiness] [Fair use](https://en.wikipedia.org/wiki/Fair_use) image from Wikimedia Commons adapted using the [Wikipedia App](https://apps.apple.com/us/app/wikipedia/id324715238)

Yeah, good. Okay, we'll add that to the coders playlist. 

## One podcast {#syntaxfm}
...
> Jonathan: I'm gonna go for [Ready Player One](https://en.wikipedia.org/wiki/Ready_Player_One_(film)). [@readyplayerone] Watching it in the cinema was was brilliant. (See figure \@ref(fig:ready-player-one-fig)) For me, this may hurt for some people, but for me a lot of the history if pop culture and technology is I found really interesting. If that's sort of the thing you find fascinating as well, ready player one, brilliant. And even if it's not something in particular, you're interested in. It's a lot of fun. 

```{r ready-player-one-fig, echo = FALSE, fig.align = "center", out.width = "100%", fig.cap = "(ref:readyplayerone)"}
knitr::include_graphics("images/ready-player-one.jpeg")
```

(ref:readyplayerone) *Ready Player One* is set in 2045, where much of humanity uses the OASIS, a virtual reality simulation, to escape the real world. [@readyplayerone] Fair use image from Wikimedia Commons adapted using the [Wikipedia App](https://apps.apple.com/us/app/wikipedia/id324715238)
...
## Audio podcast on YouTube {#jontube}

You can listen to this episode wherever you get your podcasts including Apple, Spotify, Amazon, YouTube and more, see section \@ref(subscribing) and figure \@ref(fig:jonathan-vid)

```{r jonathan-vid, echo = FALSE, fig.align = "center", out.width = "99%", fig.cap = "(ref:captionyoupodcast)"}
knitr::include_url('https://www.youtube.com/embed/1t36XBNllzI')
```
