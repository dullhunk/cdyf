...
The flexibility of computing as a career means you have a broad range of options on where you can apply your computational skills. So how can you play your computational joker? Here's some suggestions for playing the cards in your hand:

1. Look beyond the obvious *employers*: some of the best opportunities are outside of big tech companies or other big blue-chip brands
1. Look beyond your *discipline*: some of the best opportunities are interdisciplinary, mixing computing with other playing card suits (hearts, diamonds, clubs and spades ♣♥♠♦) - see research software engineering in section \@ref(rse) or [digital humanities](https://en.wikipedia.org/wiki/Digital_humanities) for examples from academia; there's plenty more in industry too.
1. Look beyond obvious the *roles* such as software engineering: Being open-minded and flexible will avoid restricting yourself to a premature [pigeonhole](https://dictionary.cambridge.org/dictionary/english/pigeonhole) as a “one-of-these” or a “one-of-those”. As [Bill Gates](https://en.wikipedia.org/wiki/Bill_Gates) put it, your life isn't a one act play, see figure \@ref(fig:one-act-fig). [@golumberjacks] You're likely to play multiple roles in your career, some of which we've outlined in section \@ref(otheroles)

Just three ways you can play your computational joker. As [Lemmy](https://en.wikipedia.org/wiki/Lemmy) put it, *“I don't need your greed, the only card I need is the ace of spades, the ace of spades ... and don't forget the joker”*! [@theaceofspades]

You don't *have* to be studying Computer Science to take advantage of these opportunities, but it helps.
