...
Your future is bright, your future needs computing. Computing your future will help you design your future. Designing your future will help you to start coding you future. 

There are lots of opportunities in computing but you don't *need* to have studied Computer Science at Unviersity to take advantage of them. Apple co-founder [Steve Jobs](https://en.wikipedia.org/wiki/Steve_Jobs) likened the computer to a “*bicycle for the mind*”, see figure \@ref(fig:stevejobs-fig). Just as cycling is a tool we've invented that makes locomotion more efficient, so too computing is a tool which enables us to do some cognitive tasks more efficiently. While studying computing at Unviersity will help you ride your computational bike, it's not a prerequisite. Steve Jobs bike can be ridden by anyone keen enough to have a go and keep pedalling.
