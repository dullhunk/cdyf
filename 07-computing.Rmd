...
1. 🃏 Look beyond the obvious *employers*: some of the best opportunities are outside of [big tech](https://en.wikipedia.org/wiki/Big_Tech) companies or other big blue-chip brands
1. 🃏 Look beyond your *discipline*: some of the best opportunities are interdisciplinary, mixing computing with other cards (hearts, diamonds, clubs and spades ♣♥♠♦) - see research software engineering in section \@ref(rse) or [digital humanities](https://en.wikipedia.org/wiki/Digital_humanities) for examples from academia; there's plenty of equivalents in industry too.
...
```
(ref:captionlemmy) Although not a student of Computer Science, Lemmy frequently played his joker as the founder, singer, songwriter and bass guitarist in [Motörhead](https://en.wikipedia.org/wiki/Mot%C3%B6rhead). [@theaceofspades] Creative Commons [BY-SA](https://creativecommons.org/licenses/by-sa/3.0/deed.en) licensed portrait of Lemmy performing in Edmonton, Canada in 2005 by Mark Marek on Wikimedia Commons [w.wiki/CDZ9](https://w.wiki/CDZ9) adapted using the [Wikipedia app](https://apps.apple.com/gb/app/wikipedia/id324715238). 🎸


You don't *have* to be studying Computer Science or playing in Motorhead to play your joker. You don't*have* to be studying Computer Science as a major or minor part of your degree to take advantage of opportunities described in this chapter, but it helps.
