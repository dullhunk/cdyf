...
In chapter \@ref(choosing) we briefly mentioned research as one of the many roles that a Computer Science degree can lead to. Maybe your undergraduate degree has whetted your appetite and given you a taste of doing research. Maybe you enjoyed it and would like to do more. What are the options for postgraduate study and research? Where can they take you and will further study be worth investing your time and money in? You are a curious character. You like the idea of pushing the boundaries of human knowledge a little further, should you do that in the real world or a University shown in figure \@ref(fig:realworld-fig).
...
(ref:captionrealworld) Which path will you choose, University or the real world? Perhaps you can you have a bit of both? Real world sketch by [Visual Thinkery](https://visualthinkery.com/) is licensed under [CC-BY-ND](https://creativecommons.org/licenses/by-nd/4.0/)
...
When you graduate, you might think you need to choose between University or the “[real world](https://en.wikipedia.org/wiki/Real_life)”, see figure \@ref(fig:realworld-fig). That's a popular misconception and a false dichotomy. In computing it is common for people to cross back and forth between industry (sometimes known as the real world) and academia (the [ivory towers](https://en.wikipedia.org/wiki/Ivory_tower)). Being passionately curious is something that is valued in both environments, so your curiosity is a skill that can help you in both.
...
## Summarising Your Future {#tldr12}
(ref:tldr)
...
In the next section, chapter \@ref(enjoying): *Enjoying your Future* we'll take a musical interlude before meeting some students who are *Coding their Future* in the final section of this book from chapter \@ref(hearing) onwards. 
...
In the next part, chapter \@ref(ruling) *Ruling your Future* which outlines Ten Simple Rules for Coding your Future, we'll recap of some key points we’ve covered so far.