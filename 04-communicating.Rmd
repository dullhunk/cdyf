...
* [Literate programming](https://en.wikipedia.org/wiki/Literate_programming) natural language descriptions of a computational logic [@knuthlit]
...
The technique of *30 minutes per day* can be a very effective way of getting things done, incrementally over time. In my experience it works for lots of things besides writing including getting exercise (discussed in the [wellbeing chapter](wellbeing.html)) to tending an allotment. [@leendertz]
