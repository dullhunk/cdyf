...
* email
* instant messaging, Slack, Microsoft Teams, Discord, Zoom, Blackboard etc
* bug reports
* messages in [issue trackers](https://en.wikipedia.org/wiki/Comparison_of_issue-tracking_systems) like Jira, BugZilla and Trello
...
* Marketing material
* Asking and answering questions on forums like [stackoverflow.com](https://stackoverflow.com/)
...
You can use a similar approach to testing your own writing, this is sometimes known simply as **Dogfooding**. Lets say you've just written a covering letter, or filled in an application form or submitted some kind of bug report. It's natural to read it over to check for errors before you send it. However, reading it aloud will pick up errors you may not have spotted by reading alone. There's something about speaking words that flushes out errors you don't pick up when you read them.
...
You don't get good at communicating with computers (coding) by just *writing* lots of code. You also need to *read* other people's code too and be able to understand and modify it. Likewise, you don't get good communicating with people by just *writing* stuff, for example in natural languages like english. You need to *read* stuff too. Books, manuals, software documentation, articles, use cases. Reading this stuff will help you learn and you'll improve your written communication skills too. This sentiment is commonly expressed in Computer Science as [read the friendly manual (RTFM)](https://en.wikipedia.org/wiki/RTFM), as shown in figure \@ref(fig:rtfm-fig)
