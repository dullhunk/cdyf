...
(ref:captionalrtfm) Reading The Friendly Manual(s) ([RTFM](https://en.wikipedia.org/wiki/RTFM)) some of it you will love, some of it you won't. Either way, reading allows you to learn from other people's hard won experience *and* improve your own written communication skills. Just like you improve your coding skills by writing and reading code, you will improve your written communication skills by reading and writing in natural langauges like English. [The motivation for reading](https://bryanmmathers.com/the-motivation-for-reading/) by [Visual Thinkery](https://visualthinkery.com/) is licenced under [CC-BY-ND](https://creativecommons.org/licenses/by-nd/4.0/) with help from [Michael Rosen](https://en.wikipedia.org/wiki/Michael_Rosen)
