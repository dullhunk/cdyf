...
You can use a similar approach to testing your own writing, known simply as **Dogfooding**. Let's say you've just written a covering letter. It's natural to read it over to check for errors before you send it. However, **reading it aloud** will pick up errors you may not have spotted by reading alone. There's something about speaking words that flushes out errors you don't pick up when you read them.

You might want to choose carefully where you do this as it might look a bit strange, but it works well. If you talk into a mobile phone, people won't notice you're talking to yourself. But you'll probably need some privacy as the content is likely to be personal.
