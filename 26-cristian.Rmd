...
An edited podcast transcript will appear here in due course. In the meantime, an [un-edited, raw machine-generated transcript can be found here](https://github.com/dullhunk/cdyf/blob/master/raw-transcript-cristian.md) with highlights from *One Tune, One Book, One Podcast and One Film* and some show notes can bee seen below.
...
```
(ref:captionarcticmonkeys) *Do I Wanna Know Know?* is a song by English rock band [Arctic Monkeys](https://en.wikipedia.org/wiki/Arctic_Monkeys). [@doiwannaknow] (ref:fairuse) 🎸
