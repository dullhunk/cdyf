...
(ref:captionweatherall) *Fail we may, sail we must*. [@weatherall] Is it failing or sailing that you are most afraid of? Portrait of [Andrew Weatherall](https://en.wikipedia.org/wiki/Andrew_Weatherall) by Spencer Hickman on Wikimedia Commons [w.wiki/3Ag5](https://w.wiki/3Ag5) adapted using the [Wikipedia app](https://apps.apple.com/gb/app/wikipedia/id324715238) ⛵️ 
