...
This guidebook would not have been possible without the direct, and indirect contributions of everyone listed here. Thanks to everyone in this chapter, part of my PLNs, see figure \@ref(fig:plns-fig)

```{r plns-fig, echo = FALSE, fig.align = "center", out.width = "100%", fig.cap = "(ref:captionplns)"}
knitr::include_graphics("images/PLNs.png")
```

(ref:captionplns) Some people who've helped me have very grand job titles like the `THOUGHT-LEADING DISRUPTIVE INNOVATION TECHNOLOGY OVERLORD` pictured here. Others do not. Either way, their [titles are tinsel](https://duncan.hull.name/2026/03/11/titles-are-tinsel/). [@tinsel] I'm grateful for what they taught me, whatever their title(s). This chapter acknowledges some of them. [PLNS figure](https://bryanmmathers.com/plns/) from a thought by [tomwhitby.com](https://tomwhitby.com) via [Aaron Davis](https://readwriterespond.com) by [Visual Thinkery](https://visualthinkery.com) is licensed under [CC-BY-ND](https://creativecommons.org/licenses/by-nd/4.0/)
...
```
(ref:captionhitch) Optimists will tell you that “everyone has a book in them...”, but pessimists like [Christopher Hitchens](https://en.wikipedia.org/wiki/Christopher_Hitchens) will add that “...in most cases that's exactly where it should remain”. [@everyone] Despite Hitchens amusing trademark scepticism, I remain optimistic about the power of natural languages, written and spoken, by humans. CC BY portrait of Christopher Hitchens by ensceptico via Wikimedia Commons [w.wiki/3YK7](https://w.wiki/3YK7) adapted using the [Wikipedia app](https://apps.apple.com/us/app/wikipedia/id324715238)
...
* Mrs Rowland at [The Blue Coat School](https://www.blue-coat.org)
* Mrs Barrow at [Fairfield High School for Girls](https://en.wikipedia.org/wiki/Fairfield_High_School_for_Girls), Droylsden
