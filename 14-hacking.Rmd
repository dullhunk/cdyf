...
It's very easy to overlook mistakes in your own writing. That's true of any written communication such as a covering letter, personal statement, email or any message that you write. Mistakes are particularly common in CVs (or resumes) because you can spend *hours* carefully polishing the words and the formatting but not see a fatal error at the top of page one. Hacking other people's CV's will help you improve your own, and you may need to use [kludges](https://en.wikipedia.org/wiki/Kludge) like the one shown on the million dollar bridge in figure \@ref(fig:kludge-fig). Returning to the bridge analogy introduced in section \@ref(parti), fixing other peoples bridges will help you improve your own.
...
A useful hacking technique is to take somebody elses stuff and fix or improve it. That works for written communication as well as actual `code`. The [dogfooding](#dogfooding) technique, we've already talked about in section \@ref(dogfooding) is a useful hacking technique which you can use by:
