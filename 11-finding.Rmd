...
* get some more `EXPERIENCE` and `SKILLS` to help your applications stand out more, look beyond paid work as a way to enhance your CV and LinkedIn, see chapter \@ref(experiencing)
* reflect on which skills are missing from your CV, see chapter \@ref(verbalising)
...
* get a referral if you can, for competitive employers a referral from somebody you know inside the the organisation can help you bypass the early stages of selectionening. [@jobreferral] Keeping growing your networks, both [IRL](https://en.wikipedia.org/wiki/Real_life) and online. Its not not just *what* you know, but *who* you know, see section \@ref(weakties)
* pay closer attention to your mental health, rejections can make you anxious and depressed, see chapter \@ref(nurturing)
