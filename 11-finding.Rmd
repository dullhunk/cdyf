...
```
(ref:captionfirehose) Are you thirsty for job opportunities? If you try to `find_jobs()` without any parameters, you will be overwhelmed by the options, like the graduate in this picture. It's hard to drink from a [fire hose](https://en.wikipedia.org/wiki/Fire_hose). Fire hose sketch by [Visual Thinkery](https://visualthinkery.com) is licensed under [CC-BY-ND](https://creativecommons.org/licenses/by-nd/4.0/)
