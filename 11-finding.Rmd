...
There's no shortage of people saying that recruitment and hiring are broken. Here is a small sample of attention grabbing headlines: 

* “*Job interviews are a nightmare — and only getting worse*” [@worse] 
* “*Interviews are over-rated and the CV is dead*” [@howtohire]
...
* [google.com/search?q=hiring+is+broken](https://www.google.com/search?q=hiring+is+broken) a bottomless pit of pain and suffering! 

There's a strong American bias in some of those articles, and many of them claim that while hiring is broken, they've got a solution to fix it. There's no escaping the fact that the personnel an organisation hires is one of the most important decisions it can make. Hiring the wrong people can lead to all sorts of problems. Unfortunately, it seems likely that important decisions on hiring to remain complicated, time consuming and error-prone.

So beware of broken recruitment practices. Hiring is broken. Recruitment can be biased, bureaucratic, expensive, inefficient and painful for many people. It can be unfair and doesn't always select the best candidates for the post anyway. Hiring is not just unncessarily unpleasant for you, it's the same for employers too. Knowing this will help you prepare for the limitations and be patient.
