...
*Hearing Your Future* is the Coding Your Future podcast which accompanies this guidebook. We talk to [graduands](https://en.wiktionary.org/wiki/graduand) and graduates of computer science, see figure \@ref(fig:collage-fig), to hear more about their journey from student to professional. As part of their [exit interview](https://en.wikipedia.org/wiki/Exit_interview) we ask them what happens after their graduation like the one shown in figure \@ref(fig:graduation-fig)? What comes next?
