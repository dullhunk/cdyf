...
There are several ways into doing a PhD at the University of Manchester, such as AI at Manchester shown in figure \@ref(fig:aimanc-fig).
...
```{r phdcafe-fig, echo = FALSE, fig.align = "center", out.width = "100%", fig.cap = "(ref:phdcafe)"}
knitr::include_graphics("images/phdcafe.jpg")
```


(ref:captionphdcafe) Find out more and register for PhD cafe at [bit.ly/phdcafe26](https://bit.ly/phdcafe26)


*If you're looking for PhD opportunities with [Creative Manchester](https://www.creative.manchester.ac.uk), the deadline for applications has now passed (30th March 2026)*
